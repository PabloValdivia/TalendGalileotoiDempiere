...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_177 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_178 = " = ";
  protected final String TEXT_179 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_180 = "!=null && key_";
  protected final String TEXT_181 = ".trim().length()>0){" + NL + "\t\t\t";
  protected final String TEXT_182 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_183 = " - Deleting an object with key:\" + ";
  protected final String TEXT_184 = ");" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\tconn_";
  protected final String TEXT_186 = ".deleteObject(";
  protected final String TEXT_187 = ", key_";
  protected final String TEXT_188 = ");" + NL + "\t\t\t";
  protected final String TEXT_189 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_190 = " - Delete the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_191 = NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_192 = "){" + NL + "\t\t";
  protected final String TEXT_193 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_194 = ");" + NL + "\t\t";
  protected final String TEXT_195 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_196 = " - \" + e_";
  protected final String TEXT_197 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_199 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_200 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_201 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_202 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
