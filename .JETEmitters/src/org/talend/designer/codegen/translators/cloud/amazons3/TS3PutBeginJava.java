...
public class TS3PutBeginJava
{
  ...
  protected final String TEXT_179 = " - Uploading an object with key:\" + ";
  protected final String TEXT_180 = ");" + NL + "\t\t";
  protected final String TEXT_181 = NL + "\t\tcom.amazonaws.services.s3.model.PutObjectRequest putRequest_";
  protected final String TEXT_182 = " = new com.amazonaws.services.s3.model.PutObjectRequest(";
  protected final String TEXT_183 = ", ";
  protected final String TEXT_184 = ", new java.io.File(";
  protected final String TEXT_185 = "));" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_187 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_188 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\tputRequest_";
  protected final String TEXT_189 = ".setMetadata(objectMetadata_";
  protected final String TEXT_190 = ");" + NL + "\t\t";
  protected final String TEXT_191 = NL + "\t\t" + NL + "\t\tconn_";
  protected final String TEXT_192 = ".putObject(putRequest_";
  protected final String TEXT_193 = ");" + NL + "\t\t";
  protected final String TEXT_194 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_195 = " - Upload the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_197 = "){" + NL + "\t\t";
  protected final String TEXT_198 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_199 = ");" + NL + "\t\t";
  protected final String TEXT_200 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_201 = " - \" + e_";
  protected final String TEXT_202 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_204 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_205 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_206 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_207 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
