...
public class TS3BucketCreateMainJava
{
  protected static String nl;
  public static synchronized TS3BucketCreateMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TS3BucketCreateMainJava result = new TS3BucketCreateMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_179 = " - Creating a bucket with name:\" + ";
  protected final String TEXT_180 = ");" + NL + "\t\t";
  protected final String TEXT_181 = NL + "\t\tconn_";
  protected final String TEXT_182 = ".createBucket(";
  protected final String TEXT_183 = ");" + NL + "\t\t";
  protected final String TEXT_184 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_185 = " - Create the bucket successfully.\");" + NL + "\t\t";
