...
public class TAmazonRedshiftManageBeginJava
{
  ...
  protected final String TEXT_109 = ".getClusterIdentifier());" + NL + "\t";
  protected final String TEXT_110 = NL + "\t\tcom.amazonaws.services.redshift.model.RestoreFromClusterSnapshotRequest request_";
  protected final String TEXT_111 = " = new com.amazonaws.services.redshift.model.RestoreFromClusterSnapshotRequest()" + NL + "    \t\t.withSnapshotIdentifier(";
  protected final String TEXT_112 = ")" + NL + "    \t\t.withClusterIdentifier(";
  protected final String TEXT_113 = ")" + NL + "    \t\t.withPort(new Integer(";
  protected final String TEXT_114 = "))" + NL + "    \t\t.withNodeType(";
  protected final String TEXT_115 = ")" + NL + "    \t\t" + NL + "    \t\t//advanced settings" + NL + "    \t\t";
  protected final String TEXT_116 = NL + "    \t\t.withSnapshotClusterIdentifier(";
  protected final String TEXT_117 = ")" + NL + "    \t\t";
  protected final String TEXT_118 = NL + "    \t\t" + NL + "    \t\t";
  protected final String TEXT_119 = NL + "    \t\t.withClusterParameterGroupName(";
  protected final String TEXT_120 = ")" + NL + "    \t\t";
  protected final String TEXT_121 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t.withClusterSubnetGroupName(";
  protected final String TEXT_123 = ")" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\t.withPubliclyAccessible(true)" + NL + "    \t\t\t";
  protected final String TEXT_126 = NL + "    \t\t\t.withElasticIp(";
  protected final String TEXT_127 = ")" + NL + "    \t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\t.withPubliclyAccessible(false)" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t.withAvailabilityZone(";
  protected final String TEXT_132 = ")" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\t.withVpcSecurityGroupIds(";
  protected final String TEXT_135 = ".split(\",\"))" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t\t;" + NL + "\t\tcom.amazonaws.services.redshift.model.Cluster result_";
  protected final String TEXT_137 = " = client_";
  protected final String TEXT_138 = ".restoreFromClusterSnapshot(request_";
  protected final String TEXT_139 = ");" + NL + "\t\t";
  protected final String TEXT_140 = NL + "    \tlog.info(\"";
  protected final String TEXT_141 = " - cluster status : \" + result_";
  protected final String TEXT_142 = ");" + NL + "    \t";
  protected final String TEXT_143 = NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_144 = "_CLUSTER_FINAL_ID\", result_";
  protected final String TEXT_145 = ".getClusterIdentifier());" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_146 = NL + "    \t\tboolean clusterReady_";
  protected final String TEXT_147 = " = false;" + NL + "            System.out.println(\"Wating for cluster to become available.\");" + NL + "            while (!clusterReady_";
  protected final String TEXT_148 = ") {" + NL + "                com.amazonaws.services.redshift.model.DescribeClustersResult result2_";
  protected final String TEXT_149 = " = client_";
  protected final String TEXT_150 = ".describeClusters(" + NL + "                \tnew com.amazonaws.services.redshift.model.DescribeClustersRequest()" + NL + "                   \t\t.withClusterIdentifier(result_";
  protected final String TEXT_151 = ".getClusterIdentifier())" + NL + "                );" + NL + "                com.amazonaws.services.redshift.model.Cluster cluster_";
  protected final String TEXT_152 = " = result2_";
  protected final String TEXT_153 = ".getClusters().get(0);" + NL + "                String status_";
  protected final String TEXT_154 = " = cluster_";
  protected final String TEXT_155 = ".getClusterStatus();" + NL + "                " + NL + "                String restoreStatus_";
  protected final String TEXT_156 = " = cluster_";
  protected final String TEXT_157 = ".getRestoreStatus().getStatus();" + NL + "                " + NL + "                if (\"available\".equalsIgnoreCase(status_";
  protected final String TEXT_158 = ") && (\"completed\".equalsIgnoreCase(restoreStatus_";
  protected final String TEXT_159 = ") || \"failed\".equalsIgnoreCase(restoreStatus_";
  protected final String TEXT_160 = "))) {" + NL + "                    clusterReady_";
  protected final String TEXT_161 = " = true;" + NL + "                    globalMap.put(\"";
  protected final String TEXT_162 = "_ENDPOINT\", cluster_";
  protected final String TEXT_163 = ".getEndpoint().getAddress());" + NL + "                } else {" + NL + "                    System.out.print(\".\");" + NL + "                    Thread.sleep(2000);" + NL + "                }" + NL + "            }" + NL + "    \t";
  protected final String TEXT_164 = NL + "\t";
  protected final String TEXT_165 = NL + "\t\tcom.amazonaws.services.redshift.model.DeleteClusterSnapshotRequest request_";
  protected final String TEXT_166 = " = new com.amazonaws.services.redshift.model.DeleteClusterSnapshotRequest()" + NL + "    \t\t.withSnapshotIdentifier(";
  protected final String TEXT_167 = ")" + NL + "    \t\t" + NL + "    \t\t";
  protected final String TEXT_168 = NL + "    \t\t.withSnapshotClusterIdentifier(";
  protected final String TEXT_169 = ")" + NL + "    \t\t";
  protected final String TEXT_170 = NL + "\t\t;" + NL + "\t\tcom.amazonaws.services.redshift.model.Snapshot result_";
  protected final String TEXT_171 = " = client_";
  protected final String TEXT_172 = ".deleteClusterSnapshot(request_";
  protected final String TEXT_173 = ");" + NL + "\t\t";
  protected final String TEXT_174 = NL + "    \tlog.info(\"";
  protected final String TEXT_175 = " - cluster status : \" + result_";
  protected final String TEXT_176 = ");" + NL + "    \t";
  protected final String TEXT_177 = NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_178 = "_CLUSTER_FINAL_ID\", result_";
  protected final String TEXT_179 = ".getClusterIdentifier());" + NL + "\t";
