...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_177 = NL + "\tint nb_bucket_";
  protected final String TEXT_178 = " = 0;" + NL + "\t";
  protected final String TEXT_179 = NL + "\t\tlog.info(\"";
  protected final String TEXT_180 = " - Retrieving buckets from the server.\");" + NL + "\t";
  protected final String TEXT_181 = NL + "\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = ".listBuckets();" + NL + "\t";
  protected final String TEXT_184 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_185 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_186 = " : buckets_";
  protected final String TEXT_187 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_188 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_189 = " = bucket_";
  protected final String TEXT_190 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_191 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
  protected final String TEXT_192 = ");" + NL + "\t\t";
  protected final String TEXT_193 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_194 = " - Retrieving the bucket \" + nb_bucket_";
  protected final String TEXT_195 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_196 = " - Name of current bucket : \" + currentBucketName_";
