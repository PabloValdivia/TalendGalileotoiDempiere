...
public class TS3GetBeginJava
{
  ...
  protected final String TEXT_179 = " - Getting an object with key:\" + ";
  protected final String TEXT_180 = ");" + NL + "\t\t";
  protected final String TEXT_181 = NL + "\t\tconn_";
  protected final String TEXT_182 = ".getObject(new com.amazonaws.services.s3.model.GetObjectRequest(";
  protected final String TEXT_183 = ", ";
  protected final String TEXT_184 = "),new java.io.File(";
  protected final String TEXT_185 = "));" + NL + "\t\t";
  protected final String TEXT_186 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_187 = " - Get the object successfully.\");" + NL + "\t\t";
