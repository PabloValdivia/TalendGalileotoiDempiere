...
public class TS3BucketDeleteBeginJava
{
  protected static String nl;
  public static synchronized TS3BucketDeleteBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TS3BucketDeleteBeginJava result = new TS3BucketDeleteBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_179 = " - Deleting a bucket with name:\" + ";
  protected final String TEXT_180 = ");" + NL + "\t\t";
  protected final String TEXT_181 = NL + "\t\tconn_";
  protected final String TEXT_182 = ".deleteBucket(";
  protected final String TEXT_183 = ");" + NL + "\t\t";
  protected final String TEXT_184 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_185 = " - Delete the bucket successfully.\");" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_187 = "){" + NL + "\t\t";
  protected final String TEXT_188 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_189 = ");" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_191 = " - \" + e_";
  protected final String TEXT_192 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_194 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_195 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_196 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_197 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
