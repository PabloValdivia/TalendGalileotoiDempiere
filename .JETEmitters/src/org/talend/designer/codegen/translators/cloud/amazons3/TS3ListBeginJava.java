...
public class TS3ListBeginJava
{
  ...
  protected final String TEXT_177 = NL + NL + "\tint nb_bucket_";
  protected final String TEXT_178 = " = 0;" + NL + "\tint nb_bucket_object_";
  protected final String TEXT_179 = " = 0;" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_180 = NL + "\t\t\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_181 = " = conn_";
  protected final String TEXT_182 = ".listBuckets();" + NL + "\t\t\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_183 = " : buckets_";
  protected final String TEXT_184 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_185 = " = bucket_";
  protected final String TEXT_186 = ".getName();" + NL + "\t\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_188 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_189 = " + \".\");" + NL + "\t\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_191 = " = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\tobjects_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".listObjects(currentBucketName_";
  protected final String TEXT_194 = ",";
  protected final String TEXT_195 = ");" + NL + "\t\t\t\t}catch(com.amazonaws.AmazonClientException e_";
  protected final String TEXT_196 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_198 = " - Failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_199 = ");" + NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_200 = " - \"+e_";
  protected final String TEXT_201 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_202 = NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_203 = "] failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_204 = ");" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_205 = "] \"+e_";
  protected final String TEXT_206 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\t\t\tcontinue;" + NL + "\t\t\t\t}" + NL + "\t\t";
  protected final String TEXT_208 = NL + "\t\t\tjava.util.List<java.util.Map<String,String>> buckets_map_list_";
  protected final String TEXT_209 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "\t\t\tjava.util.Map<String,String> bucket_prefix_map_";
  protected final String TEXT_210 = " = null;" + NL + "\t\t\tString object_prefix_";
  protected final String TEXT_211 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_212 = NL + "\t\t\t\t\tobject_prefix_";
  protected final String TEXT_213 = " = ";
  protected final String TEXT_214 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_216 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_217 = ".put(";
  protected final String TEXT_218 = ",object_prefix_";
  protected final String TEXT_219 = ");" + NL + "\t\t\t\tbuckets_map_list_";
  protected final String TEXT_220 = ".add(bucket_prefix_map_";
  protected final String TEXT_221 = ");" + NL + "\t\t\t\tobject_prefix_";
  protected final String TEXT_222 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_223 = NL + "\t\t\tfor (java.util.Map<String,String> bucketMap_";
  protected final String TEXT_224 = ": buckets_map_list_";
  protected final String TEXT_225 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_226 = " = \"\";" + NL + "\t\t\t\tString currentPrefix_";
  protected final String TEXT_227 = " = \"\";" + NL + "\t\t\t\tfor(java.util.Map.Entry<String,String> entry_";
  protected final String TEXT_228 = ":bucketMap_";
  protected final String TEXT_229 = ".entrySet()){" + NL + "\t\t\t\t\tcurrentBucketName_";
  protected final String TEXT_230 = " = entry_";
  protected final String TEXT_231 = ".getKey();" + NL + "\t\t\t\t\tcurrentPrefix_";
  protected final String TEXT_232 = " = entry_";
  protected final String TEXT_233 = ".getValue();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_234 = " = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_236 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_237 = " + \".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_238 = NL + "\t\t\t\t\tobjects_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = ".listObjects(currentBucketName_";
  protected final String TEXT_241 = ",currentPrefix_";
  protected final String TEXT_242 = ");" + NL + "\t\t\t\t}catch(com.amazonaws.AmazonClientException e_";
  protected final String TEXT_243 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_245 = " - Failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_246 = ");" + NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_247 = " - \"+e_";
  protected final String TEXT_248 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_249 = NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_250 = "] failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_251 = ");" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_252 = "] \"+e_";
  protected final String TEXT_253 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_254 = NL + "\t\t\t\t\tcontinue;" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_255 = NL + "\t\t\t\twhile(true){" + NL + "\t\t\t\t\tjava.util.List<com.amazonaws.services.s3.model.S3ObjectSummary> list_objects_";
  protected final String TEXT_256 = " = objects_";
  protected final String TEXT_257 = ".getObjectSummaries();" + NL + "\t\t\t\t\tif(list_objects_";
  protected final String TEXT_258 = ".size()>0){" + NL + "\t\t\t\t\t\tnb_bucket_";
  protected final String TEXT_259 = "++;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tfor (com.amazonaws.services.s3.model.S3ObjectSummary objectSummary_";
  protected final String TEXT_260 = " : list_objects_";
  protected final String TEXT_261 = ") {" + NL + "\t\t\t\t\t\tnb_bucket_object_";
  protected final String TEXT_262 = "++;" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_263 = "_CURRENT_BUCKET\", currentBucketName_";
  protected final String TEXT_264 = ");" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_265 = "_CURRENT_KEY\", objectSummary_";
  protected final String TEXT_266 = ".getKey());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_268 = " - Retrieving the object \" + nb_bucket_object_";
  protected final String TEXT_269 = " + \".\");" + NL + "\t\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_270 = " - Key of current object : \" + objectSummary_";
  protected final String TEXT_271 = ".getKey());" + NL + "\t\t\t\t\t\t";
