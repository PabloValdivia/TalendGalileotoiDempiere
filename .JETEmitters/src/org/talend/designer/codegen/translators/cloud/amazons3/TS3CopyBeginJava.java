...
public class TS3CopyBeginJava
{
  ...
  protected final String TEXT_177 = NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_178 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_179 = " - Copying an object with key:\" + ";
  protected final String TEXT_180 = ");" + NL + "\t\t";
  protected final String TEXT_181 = NL + "\t\tcom.amazonaws.services.s3.model.CopyObjectRequest copyRequest_";
  protected final String TEXT_182 = " = new com.amazonaws.services.s3.model.CopyObjectRequest(";
  protected final String TEXT_183 = ", ";
  protected final String TEXT_184 = ", ";
  protected final String TEXT_185 = ", ";
  protected final String TEXT_186 = ");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_187 = NL + "\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_188 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_189 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\tcopyRequest_";
  protected final String TEXT_190 = ".setNewObjectMetadata(objectMetadata_";
  protected final String TEXT_191 = ");" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t\t" + NL + "\t\tconn_";
  protected final String TEXT_193 = ".copyObject(copyRequest_";
  protected final String TEXT_194 = ");" + NL + "\t\t";
  protected final String TEXT_195 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_196 = " - Copied the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_197 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_198 = "){" + NL + "\t\t";
  protected final String TEXT_199 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_200 = ");" + NL + "\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_202 = " - \" + e_";
  protected final String TEXT_203 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_204 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_205 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_206 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_207 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_208 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
