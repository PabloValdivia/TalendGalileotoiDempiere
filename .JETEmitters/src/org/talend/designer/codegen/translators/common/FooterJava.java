...
public class FooterJava
{
  ...
  protected final String TEXT_37 = ".add(\"--context_param\");" + NL + "            paraList_";
  protected final String TEXT_38 = ".add(instance_";
  protected final String TEXT_39 = ");";
  protected final String TEXT_40 = "  " + NL + "        String[] arrays = new String[paraList_";
  protected final String TEXT_41 = ".size()];" + NL + "        for(int i=0;i<paraList_";
  protected final String TEXT_42 = ".size();i++){" + NL + "            arrays[i] = (String)paraList_";
  protected final String TEXT_43 = ".get(i);" + NL + "        }";
  protected final String TEXT_44 = NL + "        ";
  protected final String TEXT_45 = "Class.runJobInTOS(arrays);" + NL + "       " + NL + "        String errors = (String)junitGlobalMap.get(\"tests.log\");" + NL + "        Integer nbFailure = (Integer)junitGlobalMap.get(\"tests.nbFailure\");" + NL + "        assertTrue(\"Failure=\"+nbFailure+java.lang.System.getProperty(\"line.separator\")+errors, errors.isEmpty());" + NL + "        " + NL + "         if(";
  protected final String TEXT_46 = "Class.exception!=null){" + NL + "            throw ";
  protected final String TEXT_47 = "Class.exception;" + NL + "        }" + NL + "        }";
  protected final String TEXT_48 = NL + NL + "    public String[][] runJob(String[] args) {" + NL + "" + NL + "        int exitCode = runJobInTOS(args);";
  protected final String TEXT_49 = NL + "        String[][] bufferValue = (String[][])globalBuffer.toArray(new String[globalBuffer.size()][]);";
  protected final String TEXT_50 = NL + "        String[][] bufferValue = new String[][] { { Integer.toString(exitCode) } };";
  protected final String TEXT_51 = NL + NL + "        return bufferValue;" + NL + "    }" + NL + "" + NL + "    public boolean hastBufferOutputComponent() {" + NL + "\t\tboolean hastBufferOutput = false;" + NL + "    \t";
  protected final String TEXT_52 = NL + "        \t\thastBufferOutput = true;" + NL + "    \t";
  protected final String TEXT_53 = NL + "        return hastBufferOutput;" + NL + "    }" + NL + "" + NL + "    public int runJobInTOS(String[] args) {" + NL + "\t   \t// reset status" + NL + "\t   \tstatus = \"\";" + NL + "" + NL + "        String lastStr = \"\";" + NL + "        for (String arg : args) {" + NL + "            if (arg.equalsIgnoreCase(\"--context_param\")) {" + NL + "                lastStr = arg;" + NL + "            } else if (lastStr.equals(\"\")) {" + NL + "                evalParam(arg);" + NL + "            } else {" + NL + "                evalParam(lastStr + \" \" + arg);" + NL + "                lastStr = \"\";" + NL + "            }" + NL + "        }" + NL;
  ...
  protected final String TEXT_55 = "' - Start.\");" + NL + "    \t";
  protected final String TEXT_56 = NL + NL + "        if(clientHost == null) {" + NL + "            clientHost = defaultClientHost;" + NL + "        }" + NL + "" + NL + "        if(pid == null || \"0\".equals(pid)) {" + NL + "            pid = TalendString.getAsciiRandomString(6);" + NL + "        }" + NL + "" + NL + "        if (rootPid==null) {" + NL + "            rootPid = pid;" + NL + "        }" + NL + "        if (fatherPid==null) {" + NL + "            fatherPid = pid;" + NL + "        }else{" + NL + "            isChildJob = true;" + NL + "        }" + NL;
  ...
  protected final String TEXT_58 = NL + NL + "        try {" + NL + "            //call job/subjob with an existing context, like: --context=production. if without this parameter, there will use the default context instead." + NL + "            java.io.InputStream inContext = ";
  protected final String TEXT_59 = ".class.getClassLoader().getResourceAsStream(\"";
  protected final String TEXT_60 = "/contexts/\"+contextStr+\".properties\");" + NL + "            if(isDefaultContext && inContext ==null) {" + NL + "" + NL + "            } else {" + NL + "                if (inContext!=null) {" + NL + "                    //defaultProps is in order to keep the original context value" + NL + "                    defaultProps.load(inContext);" + NL + "                    inContext.close();" + NL + "                    context = new ContextProperties(defaultProps);" + NL + "                }else{" + NL + "                    //print info and job continue to run, for case: context_param is not empty." + NL + "                    System.err.println(\"Could not find the context \" + contextStr);" + NL + "                }" + NL + "            }" + NL + "" + NL + "            if(!context_param.isEmpty()) {" + NL + "                context.putAll(context_param);" + NL + "            }";
  protected final String TEXT_61 = NL + "            \t\tString pwd_";
  protected final String TEXT_62 = "_value = context.getProperty(\"";
  protected final String TEXT_63 = "\");" + NL + "            \t\tcontext.";
  protected final String TEXT_64 = " = null;" + NL + "            \t\tif(pwd_";
  protected final String TEXT_65 = "_value!=null) {" + NL + "            \t\t\tif(context_param.containsKey(\"";
  protected final String TEXT_66 = "\")) {//no need to decrypt if it come from program argument or parent job runtime" + NL + "            \t\t\t\tcontext.";
  protected final String TEXT_67 = " = pwd_";
  protected final String TEXT_68 = "_value;" + NL + "            \t\t\t} else if (!pwd_";
  protected final String TEXT_69 = "_value.isEmpty()) {" + NL + "            \t\t\t\ttry {" + NL + "            \t\t\t\t\tcontext.";
  protected final String TEXT_70 = " = routines.system.PasswordEncryptUtil.decryptPassword(pwd_";
  protected final String TEXT_71 = "_value);" + NL + "            \t\t\t\t\tcontext.put(\"";
  protected final String TEXT_72 = "\",context.";
  protected final String TEXT_73 = ");" + NL + "            \t\t\t\t} catch (java.lang.RuntimeException e) {" + NL + "            \t\t\t\t\t//do nothing" + NL + "            \t\t\t\t}" + NL + "            \t\t\t}" + NL + "            \t\t}";
  protected final String TEXT_74 = NL + "            try{" + NL + "                String context_";
  protected final String TEXT_75 = "_value = context.getProperty(\"";
  protected final String TEXT_76 = "\");" + NL + "                if (context_";
  protected final String TEXT_77 = "_value == null){" + NL + "                    context_";
  protected final String TEXT_78 = "_value = \"\";" + NL + "                }" + NL + "                int context_";
  protected final String TEXT_79 = "_pos = context_";
  protected final String TEXT_80 = "_value.indexOf(\";\");" + NL + "                String context_";
  protected final String TEXT_81 = "_pattern =  \"yyyy-MM-dd HH:mm:ss\";" + NL + "                if(context_";
  protected final String TEXT_82 = "_pos > -1){" + NL + "                    context_";
  protected final String TEXT_83 = "_pattern = context_";
  protected final String TEXT_84 = "_value.substring(0, context_";
  protected final String TEXT_85 = "_pos);" + NL + "                    context_";
  protected final String TEXT_86 = "_value = context_";
  protected final String TEXT_87 = "_value.substring(context_";
  protected final String TEXT_88 = "_pos + 1);" + NL + "                }" + NL + "" + NL + "                context.";
  protected final String TEXT_89 = "=(java.util.Date)(new java.text.SimpleDateFormat(context_";
  protected final String TEXT_90 = "_pattern).parse(context_";
  protected final String TEXT_91 = "_value));" + NL + "" + NL + "            }catch(ParseException e)" + NL + "            {" + NL + "                context.";
  protected final String TEXT_92 = "=null;" + NL + "            }";
  protected final String TEXT_93 = NL + "                context.";
  protected final String TEXT_94 = "=(";
  protected final String TEXT_95 = ") context.getProperty(\"";
  protected final String TEXT_96 = "\");";
  protected final String TEXT_97 = NL + "             context.";
  protected final String TEXT_98 = "= new java.text.StringCharacterIterator(context.getProperty(\"";
  protected final String TEXT_99 = "\")).first();";
  protected final String TEXT_100 = NL + "             try{" + NL + "                 context.";
  protected final String TEXT_101 = "=routines.system.ParserUtils.parseTo_";
  protected final String TEXT_102 = " (context.getProperty(\"";
  protected final String TEXT_103 = "\"));" + NL + "             }catch(NumberFormatException e){" + NL + "                 context.";
  protected final String TEXT_104 = "=null;" + NL + "              }";
  protected final String TEXT_105 = NL + "        } catch (java.io.IOException ie) {" + NL + "            System.err.println(\"Could not load context \"+contextStr);" + NL + "            ie.printStackTrace();" + NL + "        }" + NL + "" + NL + "" + NL + "        // get context value from parent directly" + NL + "        if (parentContextMap != null && !parentContextMap.isEmpty()) {";
  protected final String TEXT_106 = "if (parentContextMap.containsKey(\"";
  protected final String TEXT_107 = "\")) {" + NL + "                context.";
  protected final String TEXT_108 = " = (";
  protected final String TEXT_109 = ") parentContextMap.get(\"";
  protected final String TEXT_110 = "\");" + NL + "            }";
  protected final String TEXT_111 = NL + "        }" + NL + "" + NL + "        //Resume: init the resumeUtil" + NL + "        resumeEntryMethodName = ResumeUtil.getResumeEntryMethodName(resuming_checkpoint_path);" + NL + "        resumeUtil = new ResumeUtil(resuming_logs_dir_path, isChildJob, rootPid);" + NL + "        resumeUtil.initCommonInfo(pid, rootPid, fatherPid, projectName, jobName, contextStr, jobVersion);" + NL + "" + NL + "\t\tList<String> parametersToEncrypt = new java.util.ArrayList<String>();";
  protected final String TEXT_112 = NL + "\t\t\tparametersToEncrypt.add(\"";
  protected final String TEXT_113 = "\");";
  protected final String TEXT_114 = NL + "        //Resume: jobStart" + NL + "        resumeUtil.addLog(\"JOB_STARTED\", \"JOB:\" + jobName, parent_part_launcher, Thread.currentThread().getId() + \"\", \"\",\"\",\"\",\"\",resumeUtil.convertToJsonText(context,parametersToEncrypt));" + NL;
  ...
  protected final String TEXT_117 = NL + "    try {" + NL + "        runTrace.openSocket(!isChildJob);" + NL + "        runTrace.startThreadTrace(clientHost, portTraces);" + NL + "    } catch (java.io.IOException ioException) {" + NL + "        ioException.printStackTrace();" + NL + "    }";
  protected final String TEXT_118 = NL;
  protected final String TEXT_119 = NL;
  protected final String TEXT_120 = NL + "\t";
  protected final String TEXT_121 = NL + "\t    java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap = new java.util.concurrent.ConcurrentHashMap<Object, Object>();" + NL + "\t    globalMap.put(\"concurrentHashMap\", concurrentHashMap);" + NL + "\t";
  protected final String TEXT_122 = NL + NL + "    long startUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "    long endUsedMemory = 0;" + NL + "    long end = 0;" + NL + "" + NL + "    startTime = System.currentTimeMillis();";
  protected final String TEXT_123 = NL + "        ";
  protected final String TEXT_124 = ".addMessage(\"begin\");";
  protected final String TEXT_125 = NL;
  protected final String TEXT_126 = NL;
  protected final String TEXT_127 = NL + NL + "this.globalResumeTicket = true;//to run tPreJob" + NL;
  protected final String TEXT_128 = NL;
  protected final String TEXT_129 = NL + NL;
  protected final String TEXT_130 = NL + "        try {";
  protected final String TEXT_131 = NL + "            ";
  protected final String TEXT_132 = "Process(globalMap);" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }";
  protected final String TEXT_133 = NL + NL + "this.globalResumeTicket = false;//to run others jobs" + NL;
  protected final String TEXT_134 = NL + "        runningThreadCount.add(1);" + NL + "        new Thread(){" + NL + "            public void run() {" + NL + "                java.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "                threadRunResultMap.put(\"errorCode\", null);" + NL + "                threadRunResultMap.put(\"status\", \"\");" + NL + "                threadLocal.set(threadRunResultMap);" + NL;
  protected final String TEXT_135 = NL + "                ";
  protected final String TEXT_136 = NL + "                finally {" + NL + "                    Integer localErrorCode = (Integer)(((java.util.Map)threadLocal.get()).get(\"errorCode\"));" + NL + "                    String localStatus = (String)(((java.util.Map)threadLocal.get()).get(\"status\"));" + NL + "                    if (localErrorCode != null) {" + NL + "                        if (errorCode == null || localErrorCode.compareTo(errorCode) > 0) {" + NL + "                           errorCode = localErrorCode;" + NL + "                        }" + NL + "                    }" + NL + "                    if (!status.equals(\"failure\")){" + NL + "                        status = localStatus;" + NL + "                    }" + NL + "" + NL + "                    runningThreadCount.add(-1);" + NL + "                }" + NL + "            }" + NL + "        }.start();" + NL;
  protected final String TEXT_137 = NL + "    while (runningThreadCount.getCount() > 0) {" + NL + "        try {" + NL + "            Thread.sleep(10);" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }" + NL + "    }";
  protected final String TEXT_138 = NL;
  protected final String TEXT_139 = NL + NL + "this.globalResumeTicket = true;//to run tPostJob" + NL;
  protected final String TEXT_140 = NL;
  protected final String TEXT_141 = NL;
  protected final String TEXT_142 = NL;
  protected final String TEXT_143 = NL + NL + "        end = System.currentTimeMillis();" + NL + "" + NL + "        if (watch) {" + NL + "            System.out.println((end-startTime)+\" milliseconds\");" + NL + "        }" + NL + "" + NL + "        endUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "        if (false) {" + NL + "            System.out.println((endUsedMemory - startUsedMemory) + \" bytes memory increase when running : ";
  protected final String TEXT_144 = "\");" + NL + "        }";
  protected final String TEXT_145 = NL + "        ";
  protected final String TEXT_146 = ".addMessage(status==\"\"?\"end\":status, (end-startTime));" + NL + "        try {";
  protected final String TEXT_147 = NL + "            ";
  protected final String TEXT_148 = "Process(globalMap);" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }";
  protected final String TEXT_149 = NL;
  protected final String TEXT_150 = NL + "    closeJmsConnections();";
  protected final String TEXT_151 = NL;
  protected final String TEXT_152 = NL + "    closeScpConnections();";
  protected final String TEXT_153 = NL;
  protected final String TEXT_154 = NL + "    if (false";
  protected final String TEXT_155 = " || null == eventFeature";
  protected final String TEXT_156 = " || null == registry";
  protected final String TEXT_157 = ") { // TESB-8574: Fix SAM timeout issue in Studio" + NL + "        try {" + NL + "            Thread.sleep(5000);" + NL + "        } catch (InterruptedException e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_158 = NL + NL;
  protected final String TEXT_159 = NL + "if (execStat) {" + NL + "    runStat.updateStatOnJob(RunStat.JOBEND, fatherNode);" + NL + "    runStat.stopThreadStat();" + NL + "}";
  protected final String TEXT_160 = NL + "        runTrace.stopThreadTrace();";
  protected final String TEXT_161 = NL + "    int returnCode = 0;" + NL + "    if(errorCode == null) {" + NL + "         returnCode = status != null && status.equals(\"failure\") ? 1 : 0;" + NL + "    } else {" + NL + "         returnCode = errorCode.intValue();" + NL + "    }" + NL + "    resumeUtil.addLog(\"JOB_ENDED\", \"JOB:\" + jobName, parent_part_launcher, Thread.currentThread().getId() + \"\", \"\",\"\" + returnCode,\"\",\"\",\"\");" + NL + "" + NL + "    return returnCode;" + NL + "" + NL + "  }" + NL + "" + NL + "    // only for OSGi env" + NL + "    public void destroy() {";
  protected final String TEXT_162 = NL + "    closeJmsConnections();";
  protected final String TEXT_163 = NL + "    closeScpConnections();";
  protected final String TEXT_164 = NL + "    closeSqlDbConnections();";
  protected final String TEXT_165 = NL + "    closeCassandraConnections();";
  protected final String TEXT_166 = NL + "    closeHBaseConnections();";
  protected final String TEXT_167 = NL + "    closeFtpConnections();";
  protected final String TEXT_168 = NL + "    closeS3Connections();";
  protected final String TEXT_169 = NL + "    closeLDAPConnections();";
  protected final String TEXT_170 = NL + "    closeMDMConnections();";
  protected final String TEXT_171 = NL + "    closePaloConnections();";
  protected final String TEXT_172 = NL + "    closeEXistConnections();";
  protected final String TEXT_173 = NL + "    closeGSConnections();";
  protected final String TEXT_174 = NL + NL + NL + "    }" + NL;
  protected final String TEXT_175 = NL + "    private void closeJmsConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_176 = NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_177 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((javax.jms.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_178 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_179 = NL;
  protected final String TEXT_180 = NL + "    private void closeScpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_181 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_182 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((ch.ethz.ssh2.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_183 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_184 = NL;
  protected final String TEXT_185 = NL + "    private void closeSqlDbConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_186 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_187 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((java.sql.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_188 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_189 = NL;
  protected final String TEXT_190 = NL + "    private void closeCassandraConnections() {" + NL + "        try {" + NL + "            Object obj_cluster;" + NL + "            Object obj_conn;";
  protected final String TEXT_191 = NL + "            obj_cluster = globalMap.remove(\"cluster_";
  protected final String TEXT_192 = "\");" + NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_193 = "\");" + NL + "            if(obj_conn != null) {" + NL + "                ((com.datastax.driver.core.Session) obj_conn).close();" + NL + "            }" + NL + "            if(obj_cluster != null) {" + NL + "                ((com.datastax.driver.core.Cluster) obj_cluster).close();" + NL + "            }";
  protected final String TEXT_194 = NL + "            obj_conn = globalMap.remove(\"cluster_";
  protected final String TEXT_195 = "\");" + NL + "            if(obj_conn!=null) {" + NL + "                ((me.prettyprint.hector.api.Cluster) obj_conn).getConnectionManager().shutdown();" + NL + "            }";
  ...
  protected final String TEXT_205 = ");" + NL + "\t\t        if ((hConnection_";
  protected final String TEXT_206 = " != null) && (!hConnection_";
  protected final String TEXT_207 = ".isClosed())) {" + NL + "\t\t\t\t    hConnection_";
  protected final String TEXT_208 = ".close();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_209 = NL + "\t\t\t\torg.apache.hadoop.hbase.client.HConnectionManager.deleteConnection(conn_";
  protected final String TEXT_210 = ",true);" + NL + "\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t}" + NL + "      globalMap.remove(\"conn_";
  protected final String TEXT_212 = "\");" + NL + "\t";
  protected final String TEXT_213 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_214 = NL;
  protected final String TEXT_215 = NL + "    private void closeFtpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_216 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_217 = "\");" + NL + "            if (obj_conn != null) {";
  protected final String TEXT_218 = NL + "                ((com.enterprisedt.net.ftp.FTPClient) obj_conn).quit();";
  protected final String TEXT_219 = NL + "                ((com.jcraft.jsch.ChannelSftp) obj_conn).quit();";
  protected final String TEXT_220 = NL + "                ((it.sauronsoftware.ftp4j.FTPClient) obj_conn).disconnect(true);";
  protected final String TEXT_221 = NL + "            }";
  protected final String TEXT_222 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_223 = NL;
  protected final String TEXT_224 = NL + "    private void closeS3Connections() {" + NL + "        try {";
  protected final String TEXT_225 = NL + "    \tcom.amazonaws.services.s3.AmazonS3Client conn_";
  protected final String TEXT_226 = " = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get(\"conn_";
  protected final String TEXT_227 = "\");" + NL + "\t    if(conn_";
  protected final String TEXT_228 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_229 = ".shutdown();\t" + NL + "\t\t}";
  protected final String TEXT_230 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_231 = NL;
  protected final String TEXT_232 = NL + "    private void closeLDAPConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_233 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_234 = "\");" + NL + "            if (obj_conn != null) {" + NL + "                ((javax.naming.ldap.InitialLdapContext) obj_conn).close();" + NL + "            }";
  protected final String TEXT_235 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_236 = NL;
  protected final String TEXT_237 = NL + "    private void closeMDMConnections() {" + NL + "        try {";
  protected final String TEXT_238 = NL + "        org.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_239 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(\"TMDMService_";
  protected final String TEXT_240 = "\");" + NL + "\t\tif(service_";
  protected final String TEXT_241 = " != null)" + NL + "\t\t{" + NL + "\t\t\tservice_";
  protected final String TEXT_242 = ".logout(new org.talend.mdm.webservice.WSLogout());" + NL + "\t\t}";
  protected final String TEXT_243 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_244 = NL + NL;
  protected final String TEXT_245 = NL + "    private void closePaloConnections() {" + NL + "        try {";
  protected final String TEXT_246 = NL + "    \torg.talend.jpalo.paloconnection pConn_";
  protected final String TEXT_247 = " = (org.talend.jpalo.paloconnection)globalMap.get(\"pConn_";
  protected final String TEXT_248 = "\");" + NL + "\t    if(pConn_";
  protected final String TEXT_249 = " !=null){" + NL + "\t\t\t\t\tpConn_";
  protected final String TEXT_250 = ".logout();" + NL + "\t" + NL + "\t\t}";
  protected final String TEXT_251 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_252 = NL;
  protected final String TEXT_253 = NL + "    private void closeEXistConnections() {" + NL + "        try {";
  protected final String TEXT_254 = NL + "\t\torg.xmldb.api.base.Collection col_";
  protected final String TEXT_255 = " = (org.xmldb.api.base.Collection)globalMap.get(\"col_";
  protected final String TEXT_256 = "\");" + NL + "\t    if(col_";
  protected final String TEXT_257 = " !=null){" + NL + "\t\t\t\t\tcol_";
  protected final String TEXT_258 = ".close();" + NL + "\t" + NL + "\t\t}";
  protected final String TEXT_259 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_260 = NL;
  protected final String TEXT_261 = NL + "    private void closeGSConnections() {" + NL + "        try {";
  protected final String TEXT_262 = NL + "\t\torg.jets3t.service.impl.rest.httpclient.GoogleStorageService service_";
  protected final String TEXT_263 = " = " + NL + "\t\t\t\t(org.jets3t.service.impl.rest.httpclient.GoogleStorageService)globalMap.get(\"service_";
  protected final String TEXT_264 = "\");" + NL + "\t\tif(service_";
  protected final String TEXT_265 = " !=null){" + NL + "\t\t\t\tservice_";
  protected final String TEXT_266 = ".shutdown();" + NL + "\t    }" + NL;
  protected final String TEXT_267 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_268 = NL + NL + "    private java.util.Map<String, Object> getSharedConnections4REST() {" + NL + "        java.util.Map<String, Object> connections = new java.util.HashMap<String, Object>();";
  protected final String TEXT_269 = NL + "            connections.put(\"connection_";
  protected final String TEXT_270 = "\", globalMap.get(\"connection_";
  protected final String TEXT_271 = "\"));" + NL + "            connections.put(\"session_";
  protected final String TEXT_272 = "\", globalMap.get(\"session_";
  protected final String TEXT_273 = "\"));";
  protected final String TEXT_274 = NL + "            connections.put(\"conn_";
  protected final String TEXT_275 = "\", globalMap.get(\"conn_";
  protected final String TEXT_276 = "\"));";
  protected final String TEXT_277 = NL + "            connections.put(\"conn_";
  protected final String TEXT_278 = "\", globalMap.get(\"conn_";
  protected final String TEXT_279 = "\"));";
  protected final String TEXT_280 = NL + "            connections.put(\"connection_";
  protected final String TEXT_281 = "\", globalMap.get(\"connection_";
  protected final String TEXT_282 = "\"));" + NL + "            connections.put(\"cluster_";
  protected final String TEXT_283 = "\", globalMap.get(\"cluster_";
  protected final String TEXT_284 = "\"));";
  protected final String TEXT_285 = NL + "            connections.put(\"cluster_";
  protected final String TEXT_286 = "\", globalMap.get(\"cluster_";
