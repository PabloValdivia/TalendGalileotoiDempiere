...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_296 = NL + "            \tString tableForSearch_";
  protected final String TEXT_297 = " = ";
  protected final String TEXT_298 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_299 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_300 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_301 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_302 = " =  tableForSearch_";
  protected final String TEXT_303 = ".substring(1,tableForSearch_";
  protected final String TEXT_304 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_305 = " =  tableForSearch_";
  protected final String TEXT_306 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_310 = ".getTables(null, conn_";
  protected final String TEXT_311 = ".getSchema(), tableForSearch_";
  ...
  protected final String TEXT_437 = NL + "        int keyCount_";
  protected final String TEXT_438 = " = ";
  protected final String TEXT_439 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_440 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_441 = " = tableName_";
  protected final String TEXT_442 = ";" + NL + "        tableName_";
  protected final String TEXT_443 = " = \"tmp_";
  protected final String TEXT_444 = "\" + \"_\" + pid + Thread.currentThread().getId();        " + NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_448 = " - Creating temp table ";
  protected final String TEXT_449 = "\" + tableName_";
  protected final String TEXT_450 = " + \"";
  protected final String TEXT_451 = ".\" );" + NL + "\t\t";
  protected final String TEXT_452 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_453 = ".execute(\"";
  protected final String TEXT_454 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_455 = ".close();";
  protected final String TEXT_456 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_457 = " - Create temp table ";
  protected final String TEXT_458 = "\" + tableName_";
  protected final String TEXT_459 = " + \"";
  protected final String TEXT_460 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_461 = NL + "        ";
  protected final String TEXT_462 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_463 = " =conn_";
  protected final String TEXT_464 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_465 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_466 = ".close();" + NL + "   \t\t";
  protected final String TEXT_467 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_468 = " = conn_";
  protected final String TEXT_469 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_470 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_471 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_472 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_473 = " - Bulk inserting data into ";
  protected final String TEXT_474 = "\" + tableName_";
  protected final String TEXT_475 = " + \"";
  protected final String TEXT_476 = ".\" );" + NL + "\t\t";
  protected final String TEXT_477 = NL + "        stmtTmpBulk_";
  protected final String TEXT_478 = ".execute(bulkSQL_";
  protected final String TEXT_479 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_480 = ".close();" + NL + "        " + NL + "\t\t";
  protected final String TEXT_481 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_482 = " - Bulk insert data into ";
  protected final String TEXT_483 = "\" + tableName_";
  protected final String TEXT_484 = " + \"";
  protected final String TEXT_485 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_486 = NL + "        tableName_";
  protected final String TEXT_487 = " = tmpTableName_";
  protected final String TEXT_488 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_489 = " = \"tmp_";
  protected final String TEXT_490 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_491 = " = conn_";
  protected final String TEXT_492 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_493 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_494 = " - Updating ";
  protected final String TEXT_495 = "\" + tableName_";
  protected final String TEXT_496 = " + \"";
  protected final String TEXT_497 = " from ";
  protected final String TEXT_498 = "\"+tmpTableName_";
  protected final String TEXT_499 = "+\"";
  protected final String TEXT_500 = ".\");" + NL + "\t\t";
  protected final String TEXT_501 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_502 = ".executeUpdate(\"";
  protected final String TEXT_503 = "\");" + NL + "\t\t";
  protected final String TEXT_504 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_505 = ".close();" + NL + "        tableName_";
  protected final String TEXT_506 = " = tmpTableName_";
  protected final String TEXT_507 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_508 = " = conn_";
  protected final String TEXT_509 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_510 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_511 = " - Droping temp table ";
  protected final String TEXT_512 = "\" + tableName_";
  protected final String TEXT_513 = " + \"";
  protected final String TEXT_514 = ".\");" + NL + "\t\t";
  protected final String TEXT_515 = NL + "        stmtTmpDrop_";
  protected final String TEXT_516 = ".execute(\"";
  protected final String TEXT_517 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_518 = ".close();" + NL + "\t\t";
  protected final String TEXT_519 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_520 = " - Drop temp table ";
  protected final String TEXT_521 = "\" + tableName_";
  protected final String TEXT_522 = "+ \"";
  protected final String TEXT_523 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_524 = NL + "\t    ";
  protected final String TEXT_525 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_526 = " =conn_";
  protected final String TEXT_527 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_528 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_529 = ".close();" + NL + "   \t\t";
  protected final String TEXT_530 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_531 = " = conn_";
  protected final String TEXT_532 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t";
  protected final String TEXT_533 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_534 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_535 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_536 = " - Inserting records in table ";
  protected final String TEXT_537 = "\" + tableName_";
  protected final String TEXT_538 = " + \"";
  protected final String TEXT_539 = ".\");" + NL + "\t";
  protected final String TEXT_540 = NL + "    stmtBulk_";
  protected final String TEXT_541 = ".execute(bulkSQL_";
  protected final String TEXT_542 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_543 = ".close();    " + NL + "\t";
  protected final String TEXT_544 = NL + "\t\tlog.info(\"";
  protected final String TEXT_545 = " - Insert records in table ";
  protected final String TEXT_546 = "\" + tableName_";
  protected final String TEXT_547 = " + \"";
  protected final String TEXT_548 = " has finished.\");" + NL + "\t";
