...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_230 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_233 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_234 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_235 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_236 = " =  tableForSearch_";
  protected final String TEXT_237 = ".substring(1,tableForSearch_";
  protected final String TEXT_238 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_239 = " =  tableForSearch_";
  protected final String TEXT_240 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_244 = ".getTables(null, conn_";
  protected final String TEXT_245 = ".getSchema(), tableForSearch_";
  protected final String TEXT_246 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_247 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_248 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_249 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_250 = ".close();";
  ...
  protected final String TEXT_259 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_260 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_265 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_285 = NL + "                                if(whetherExist_";
  protected final String TEXT_286 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_287 = " = conn_";
  protected final String TEXT_288 = ".createStatement();";
  protected final String TEXT_289 = NL + "                                                      stmtDrop_";
  protected final String TEXT_290 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_297 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_298 = " = conn_";
  protected final String TEXT_299 = ".createStatement();";
  protected final String TEXT_300 = NL + "                                                  stmtCreate_";
  ...
  protected final String TEXT_305 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_306 = ".";
  protected final String TEXT_307 = ", \"";
  protected final String TEXT_308 = "\")";
  protected final String TEXT_309 = ".toUpperCase()";
  protected final String TEXT_310 = ")+\")";
  protected final String TEXT_311 = "\"));";
  protected final String TEXT_312 = NL + "                                    stmtCreate_";
  protected final String TEXT_313 = ".execute(\"";
  protected final String TEXT_314 = ")\");";
  protected final String TEXT_315 = NL + "                                stmtCreate_";
  protected final String TEXT_316 = ".close();";
  protected final String TEXT_317 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_318 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_319 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_320 = " = conn_";
  protected final String TEXT_321 = ".createStatement();";
  protected final String TEXT_322 = NL + "                              stmtClear_";
  protected final String TEXT_323 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_324 = "));";
  protected final String TEXT_325 = NL + "            stmtClear_";
  protected final String TEXT_326 = ".executeUpdate(\"";
  protected final String TEXT_327 = "\");";
  protected final String TEXT_328 = NL + "            stmtClear_";
  protected final String TEXT_329 = ".close();";
  protected final String TEXT_330 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_331 = " = conn_";
  protected final String TEXT_332 = ".createStatement();";
  protected final String TEXT_333 = NL + "                              stmtTruncCount_";
  protected final String TEXT_334 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_335 = "));";
  protected final String TEXT_336 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_337 = " = stmtTruncCount_";
  protected final String TEXT_338 = ".executeQuery(\"";
  protected final String TEXT_339 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_340 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_341 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_345 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_346 = " = conn_";
  protected final String TEXT_347 = ".createStatement();";
  protected final String TEXT_348 = NL + "                              stmtTrunc_";
  protected final String TEXT_349 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_350 = "));";
  protected final String TEXT_351 = NL + "                conn_";
  protected final String TEXT_352 = ".commit();";
  protected final String TEXT_353 = NL + "            stmtTrunc_";
  protected final String TEXT_354 = ".executeUpdate(\"";
  protected final String TEXT_355 = "\");";
  protected final String TEXT_356 = NL + "                if(!conn_";
  protected final String TEXT_357 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_358 = ".commit();" + NL + "                }";
  protected final String TEXT_359 = NL + "            deletedCount_";
  protected final String TEXT_360 = " += rsTruncCountNumber_";
  protected final String TEXT_361 = ";" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_371 = NL + "                conn_";
  protected final String TEXT_372 = ".commit();";
  protected final String TEXT_373 = NL + "            stmtTrunc_";
  protected final String TEXT_374 = ".executeUpdate(\"";
  ...
  protected final String TEXT_382 = ".close();";
  ...
  protected final String TEXT_408 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_415 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_416 = ".";
  protected final String TEXT_417 = ", \"";
  protected final String TEXT_418 = "\")+\" WHERE ";
  protected final String TEXT_419 = "\";";
  protected final String TEXT_420 = NL + "        pstmt_";
  protected final String TEXT_421 = " = conn_";
  protected final String TEXT_422 = ".prepareStatement(update_";
  protected final String TEXT_423 = ");";
  protected final String TEXT_424 = NL + "                String insert_";
  ...
  protected final String TEXT_430 = "\")+\") VALUES (";
  ...
  protected final String TEXT_439 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_440 = ".";
  protected final String TEXT_441 = ")+\")\";";
  protected final String TEXT_442 = NL + "                String update_";
  protected final String TEXT_443 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_444 = " + \"\\\" SET ";
  protected final String TEXT_445 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_446 = ".";
  protected final String TEXT_447 = ", \"";
  protected final String TEXT_448 = "\")+\" WHERE ";
  protected final String TEXT_449 = "\";";
  protected final String TEXT_450 = NL + "                String update_";
  protected final String TEXT_451 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_452 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_453 = ".";
  protected final String TEXT_454 = ", \"";
  protected final String TEXT_455 = "\")+\" WHERE ";
  protected final String TEXT_456 = "\";";
  protected final String TEXT_457 = NL + "        pstmt_";
  protected final String TEXT_458 = " = conn_";
  protected final String TEXT_459 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_460 = " + \"\\\" WHERE ";
  protected final String TEXT_461 = "\");" + NL + "        pstmtInsert_";
  protected final String TEXT_462 = " = conn_";
  protected final String TEXT_463 = ".prepareStatement(insert_";
  protected final String TEXT_464 = ");" + NL + "        pstmtUpdate_";
  protected final String TEXT_465 = " = conn_";
  protected final String TEXT_466 = ".prepareStatement(update_";
  protected final String TEXT_467 = ");";
  protected final String TEXT_468 = NL + "                String insert_";
  protected final String TEXT_469 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_470 = " + \"\\\" (";
  protected final String TEXT_471 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_472 = ".";
  protected final String TEXT_473 = ", \"";
  protected final String TEXT_474 = "\")+\") VALUES (";
  protected final String TEXT_475 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_476 = ".";
  protected final String TEXT_477 = ")+\")\";";
  protected final String TEXT_478 = NL + "                String insert_";
  protected final String TEXT_479 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_480 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_481 = ".";
  protected final String TEXT_482 = ", \"";
  protected final String TEXT_483 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_484 = ".";
  protected final String TEXT_485 = ")+\")\";";
  protected final String TEXT_486 = NL + "                String update_";
  protected final String TEXT_487 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_488 = " + \"\\\" SET ";
  protected final String TEXT_489 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_490 = ".";
  protected final String TEXT_491 = ", \"";
  protected final String TEXT_492 = "\")+\" WHERE ";
  protected final String TEXT_493 = "\";";
  protected final String TEXT_494 = NL + "                String update_";
  protected final String TEXT_495 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_496 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_497 = ".";
  protected final String TEXT_498 = ", \"";
  protected final String TEXT_499 = "\")+\" WHERE ";
  protected final String TEXT_500 = "\";";
  protected final String TEXT_501 = NL + "        pstmtUpdate_";
  protected final String TEXT_502 = " = conn_";
  protected final String TEXT_503 = ".prepareStatement(update_";
  protected final String TEXT_504 = ");" + NL + "        pstmtInsert_";
  protected final String TEXT_505 = " = conn_";
  protected final String TEXT_506 = ".prepareStatement(insert_";
  protected final String TEXT_507 = ");";
  protected final String TEXT_508 = NL + "        String delete_";
  protected final String TEXT_509 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_510 = " + \"\\\" WHERE ";
  protected final String TEXT_511 = "\";" + NL + "        pstmt_";
  protected final String TEXT_512 = " = conn_";
  protected final String TEXT_513 = ".prepareStatement(delete_";
  protected final String TEXT_514 = ");";
  protected final String TEXT_515 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_516 = " = insert_";
  protected final String TEXT_517 = ".split(\"\\\\?\");";
  protected final String TEXT_518 = NL + "\t\t\tupdate_";
  protected final String TEXT_519 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_520 = " = update_";
  protected final String TEXT_521 = ".split(\"\\\\?\");";
  protected final String TEXT_522 = NL + "\t\t\tupdate_";
  protected final String TEXT_523 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_524 = " = update_";
  protected final String TEXT_525 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_526 = " = insert_";
  protected final String TEXT_527 = ".split(\"\\\\?\");";
  protected final String TEXT_528 = NL + "\t\t\tdelete_";
  protected final String TEXT_529 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_530 = " = delete_";
  protected final String TEXT_531 = ".split(\"\\\\?\");";
  protected final String TEXT_532 = NL + "\t\t\treplace_";
  protected final String TEXT_533 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_534 = " = replace_";
  protected final String TEXT_535 = ".split(\"\\\\?\");";
  protected final String TEXT_536 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_537 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_538 = " = insertIgnore_";
  protected final String TEXT_539 = ".split(\"\\\\?\");";
  protected final String TEXT_540 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_541 = " = insert_";
  protected final String TEXT_542 = ".split(\"\\\\?\");";
  protected final String TEXT_543 = NL + "        }";
  protected final String TEXT_544 = NL + "                commitEvery_";
  protected final String TEXT_545 = " = buffersSize_";
  protected final String TEXT_546 = ";";
  protected final String TEXT_547 = NL + "                batchSize_";
  protected final String TEXT_548 = " = buffersSize_";
  protected final String TEXT_549 = ";";
  protected final String TEXT_550 = NL + "        whetherReject_";
  protected final String TEXT_551 = " = false;";
  protected final String TEXT_552 = NL + "                    ";
  protected final String TEXT_553 = NL + "                        query_";
  protected final String TEXT_554 = " = ";
  protected final String TEXT_555 = ";";
  protected final String TEXT_556 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_557 = ",";
  protected final String TEXT_558 = ".";
  protected final String TEXT_559 = ", ";
  protected final String TEXT_560 = ",insertSQLSplits_";
  protected final String TEXT_561 = ");";
  protected final String TEXT_562 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_563 = ".";
  protected final String TEXT_564 = ", pstmt_";
  protected final String TEXT_565 = ", ";
  protected final String TEXT_566 = ", \"";
  protected final String TEXT_567 = "\");";
  protected final String TEXT_568 = NL + "                globalMap.put(\"";
  protected final String TEXT_569 = "_QUERY\", query_";
  protected final String TEXT_570 = ".toString().trim());";
  ...
  protected final String TEXT_575 = NL + "            ////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_580 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_581 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_582 = " = true;";
  protected final String TEXT_583 = NL + "                    throw(e_";
  ...
  protected final String TEXT_593 = NL + "                        rejectedCount_";
  protected final String TEXT_594 = " = rejectedCount_";
  protected final String TEXT_595 = " + 1;";
  protected final String TEXT_596 = NL + "                        ";
  protected final String TEXT_597 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_598 = ").getSQLState();";
  protected final String TEXT_599 = NL + "                        ";
  protected final String TEXT_600 = ".errorMessage = e_";
  protected final String TEXT_601 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_602 = ";";
  protected final String TEXT_603 = NL + "                        System.err.print(e_";
  protected final String TEXT_604 = ".getMessage());";
  ...
  protected final String TEXT_610 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_611 = ",";
  protected final String TEXT_612 = ".";
  protected final String TEXT_613 = ", ";
  protected final String TEXT_614 = ",updateSQLSplits_";
  protected final String TEXT_615 = ");";
  protected final String TEXT_616 = NL + "                    int count_";
  protected final String TEXT_617 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_618 = ".";
  protected final String TEXT_619 = ", pstmt_";
  protected final String TEXT_620 = ", ";
  protected final String TEXT_621 = ", \"";
  protected final String TEXT_622 = "\");";
  protected final String TEXT_623 = NL + "                       ";
  protected final String TEXT_624 = NL + "                       ";
  protected final String TEXT_625 = NL + "                            query_";
  ...
  protected final String TEXT_635 = NL + "                   query_";
  protected final String TEXT_636 = " = ";
  protected final String TEXT_637 = ";";
  protected final String TEXT_638 = NL + "                globalMap.put(\"";
  protected final String TEXT_639 = "_QUERY\", query_";
  protected final String TEXT_640 = ".toString().trim());";
  protected final String TEXT_641 = NL + "                pstmt_";
  protected final String TEXT_642 = ".addBatch();" + NL + "                batchSizeCounter_";
  protected final String TEXT_643 = "++;" + NL + "                nb_line_";
  protected final String TEXT_644 = "++;";
  protected final String TEXT_645 = NL + "            //////////////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_646 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_647 = " = updatedCount_";
  protected final String TEXT_648 = " + pstmt_";
  protected final String TEXT_649 = ".executeUpdate();";
  protected final String TEXT_650 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_651 = ") {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_657 = "Struct();";
  protected final String TEXT_658 = NL + "                            ";
  protected final String TEXT_659 = ".";
  protected final String TEXT_660 = " = ";
  protected final String TEXT_661 = ".";
  protected final String TEXT_662 = ";";
  protected final String TEXT_663 = NL + "                        rejectedCount_";
  protected final String TEXT_664 = " = rejectedCount_";
  protected final String TEXT_665 = " + 1;";
  protected final String TEXT_666 = NL + "                        ";
  protected final String TEXT_667 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_668 = ").getSQLState();";
  protected final String TEXT_669 = NL + "                        ";
  protected final String TEXT_670 = ".errorMessage = e_";
  protected final String TEXT_671 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_672 = ";";
  protected final String TEXT_673 = NL + "                        System.err.print(e_";
  protected final String TEXT_674 = ".getMessage());";
  protected final String TEXT_675 = NL + "            }" + NL + "            /////////////////////////////////////";
  protected final String TEXT_676 = NL + "                        ";
  protected final String TEXT_677 = NL + "                    ";
  protected final String TEXT_678 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_679 = " = pstmt_";
  protected final String TEXT_680 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_681 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_682 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_683 = " = rs_";
  protected final String TEXT_684 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_685 = " > 0) {";
  protected final String TEXT_686 = NL + "                        ";
  protected final String TEXT_687 = NL + "                            query_";
  protected final String TEXT_688 = " = ";
  protected final String TEXT_689 = ";";
  protected final String TEXT_690 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_691 = ",";
  protected final String TEXT_692 = ".";
  protected final String TEXT_693 = ", ";
  protected final String TEXT_694 = ",updateSQLSplits_";
  protected final String TEXT_695 = ");";
  protected final String TEXT_696 = NL + NL + "                        int count_";
  protected final String TEXT_697 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_698 = ".";
  protected final String TEXT_699 = ", pstmtUpdate_";
  ...
  protected final String TEXT_715 = NL + "                            query_";
  protected final String TEXT_716 = " = ";
  protected final String TEXT_717 = ";";
  protected final String TEXT_718 = NL + "                    globalMap.put(\"";
  protected final String TEXT_719 = "_QUERY\", query_";
  protected final String TEXT_720 = ".toString().trim());";
  protected final String TEXT_721 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_722 = " = updatedCount_";
  protected final String TEXT_723 = " + pstmtUpdate_";
  protected final String TEXT_724 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_725 = "++;";
  protected final String TEXT_726 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_727 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_728 = " = true;";
  protected final String TEXT_729 = NL + "                        throw(e_";
  protected final String TEXT_730 = ");";
  protected final String TEXT_731 = NL + "                        nb_line_";
  ...
  protected final String TEXT_745 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_746 = ").getSQLState();";
  protected final String TEXT_747 = NL + "                            ";
  protected final String TEXT_748 = ".errorMessage = e_";
  protected final String TEXT_749 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_750 = ";";
  protected final String TEXT_751 = NL + "                            System.err.print(e_";
  protected final String TEXT_752 = ".getMessage());";
  protected final String TEXT_753 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_762 = ",insertSQLSplits_";
  protected final String TEXT_763 = ");";
  protected final String TEXT_764 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_765 = ".";
  protected final String TEXT_766 = ", pstmtInsert_";
  protected final String TEXT_767 = ", ";
  protected final String TEXT_768 = ", \"";
  protected final String TEXT_769 = "\");";
  protected final String TEXT_770 = NL + "                    globalMap.put(\"";
  protected final String TEXT_771 = "_QUERY\", query_";
  protected final String TEXT_772 = ".toString().trim());";
  protected final String TEXT_773 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_774 = " = insertedCount_";
  protected final String TEXT_775 = " + pstmtInsert_";
  protected final String TEXT_776 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_777 = "++;";
  protected final String TEXT_778 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_779 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_780 = " = true;";
  protected final String TEXT_781 = NL + "                        throw(e_";
  protected final String TEXT_782 = ");";
  protected final String TEXT_783 = NL + "                          nb_line_";
  protected final String TEXT_784 = "++;";
  protected final String TEXT_785 = NL + "                            ";
  protected final String TEXT_786 = " = new ";
  protected final String TEXT_787 = "Struct();";
  protected final String TEXT_788 = NL + "                                ";
  protected final String TEXT_789 = ".";
  protected final String TEXT_790 = " = ";
  protected final String TEXT_791 = ".";
  protected final String TEXT_792 = ";";
  protected final String TEXT_793 = NL + "                            rejectedCount_";
  protected final String TEXT_794 = " = rejectedCount_";
  protected final String TEXT_795 = " + 1;";
  protected final String TEXT_796 = NL + "                            ";
  protected final String TEXT_797 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_798 = ").getSQLState();";
  protected final String TEXT_799 = NL + "                            ";
  protected final String TEXT_800 = ".errorMessage = e_";
  protected final String TEXT_801 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_802 = ";";
  protected final String TEXT_803 = NL + "                            System.err.print(e_";
  protected final String TEXT_804 = ".getMessage());";
  protected final String TEXT_805 = NL + "                }" + NL + "            }" + NL;
  protected final String TEXT_806 = NL + "            int updateFlag_";
  protected final String TEXT_807 = "=0;";
  protected final String TEXT_808 = NL + "                    ";
  protected final String TEXT_809 = NL + "                        query_";
  protected final String TEXT_810 = " = ";
  protected final String TEXT_811 = ";";
  protected final String TEXT_812 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_813 = ",";
  protected final String TEXT_814 = ".";
  protected final String TEXT_815 = ", ";
  protected final String TEXT_816 = ",updateSQLSplits_";
  protected final String TEXT_817 = ");";
  protected final String TEXT_818 = NL + NL + "                    int count_";
  protected final String TEXT_819 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_820 = ".";
  protected final String TEXT_821 = ", pstmtUpdate_";
  ...
  protected final String TEXT_830 = NL + "                        query_";
  protected final String TEXT_831 = " = ";
  protected final String TEXT_832 = ";";
  protected final String TEXT_833 = NL + "                    ";
  protected final String TEXT_834 = NL + "                        query_";
  protected final String TEXT_835 = " = ";
  protected final String TEXT_836 = ";";
  protected final String TEXT_837 = NL + "                        query_";
  protected final String TEXT_838 = " = ";
  protected final String TEXT_839 = ";";
  protected final String TEXT_840 = NL + "                globalMap.put(\"";
  protected final String TEXT_841 = "_QUERY\", query_";
  protected final String TEXT_842 = ".toString().trim());";
  protected final String TEXT_843 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_844 = "=pstmtUpdate_";
  protected final String TEXT_845 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_846 = " = updatedCount_";
  protected final String TEXT_847 = " + updateFlag_";
  protected final String TEXT_848 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_849 = " == 0) {";
  protected final String TEXT_850 = NL + "                query_";
  protected final String TEXT_851 = " = new StringBuffer(\"\");";
  protected final String TEXT_852 = NL + "                        ";
  protected final String TEXT_853 = NL + "                            query_";
  protected final String TEXT_854 = " = ";
  protected final String TEXT_855 = ";";
  protected final String TEXT_856 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_857 = ",";
  protected final String TEXT_858 = ".";
  protected final String TEXT_859 = ", ";
  protected final String TEXT_860 = ",insertSQLSplits_";
  ...
  protected final String TEXT_871 = NL + "                    insertedCount_";
  protected final String TEXT_872 = " = insertedCount_";
  protected final String TEXT_873 = " + pstmtInsert_";
  protected final String TEXT_874 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_875 = "++;";
  protected final String TEXT_876 = NL + "             }else{" + NL + "                nb_line_";
  protected final String TEXT_877 = "++;";
  protected final String TEXT_878 = NL + "             }" + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_879 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_880 = " = true;";
  protected final String TEXT_881 = NL + "                        throw(e_";
  ...
  protected final String TEXT_897 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_898 = ").getSQLState();";
  protected final String TEXT_899 = NL + "                            ";
  protected final String TEXT_900 = ".errorMessage = e_";
  protected final String TEXT_901 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_902 = ";";
  protected final String TEXT_903 = NL + "                            System.err.print(e_";
  protected final String TEXT_904 = ".getMessage());";
  ...
  protected final String TEXT_914 = NL + "                globalMap.put(\"";
  protected final String TEXT_915 = "_QUERY\", query_";
  protected final String TEXT_916 = ".toString().trim());";
  protected final String TEXT_917 = NL + "              pstmt_";
  protected final String TEXT_918 = ".addBatch();" + NL + "              batchSizeCounter_";
  protected final String TEXT_919 = "++;" + NL + "              nb_line_";
  protected final String TEXT_920 = "++;";
  protected final String TEXT_921 = NL + "            //////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_922 = " = deletedCount_";
  protected final String TEXT_923 = " + pstmt_";
  protected final String TEXT_924 = ".executeUpdate();" + NL + "              nb_line_";
  protected final String TEXT_925 = "++;";
  protected final String TEXT_926 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_927 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_928 = " = true;";
  protected final String TEXT_929 = NL + "                    throw(e_";
  protected final String TEXT_930 = ");";
  protected final String TEXT_931 = NL + "                    nb_line_";
  protected final String TEXT_932 = "++;";
  protected final String TEXT_933 = NL + "                        ";
  protected final String TEXT_934 = " = new ";
  protected final String TEXT_935 = "Struct();";
  protected final String TEXT_936 = NL + "                            ";
  protected final String TEXT_937 = ".";
  protected final String TEXT_938 = " = ";
  protected final String TEXT_939 = ".";
  protected final String TEXT_940 = ";";
  protected final String TEXT_941 = NL + "                        rejectedCount_";
  protected final String TEXT_942 = " = rejectedCount_";
  protected final String TEXT_943 = " + 1;";
  protected final String TEXT_944 = NL + "                        ";
  protected final String TEXT_945 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_946 = ").getSQLState();";
  protected final String TEXT_947 = NL + "                        ";
  protected final String TEXT_948 = ".errorMessage = e_";
  protected final String TEXT_949 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_950 = ";";
  protected final String TEXT_951 = NL + "                        System.err.print(e_";
  protected final String TEXT_952 = ".getMessage());";
  protected final String TEXT_953 = NL + "            }" + NL + "            //////////////////////////////////////";
  protected final String TEXT_954 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_965 = NL + "                if ((batchSize_";
  protected final String TEXT_966 = " > 0) && (batchSize_";
  protected final String TEXT_967 = " <= batchSizeCounter_";
  protected final String TEXT_968 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_969 = " = 0;" + NL + "                        int countSum_";
  protected final String TEXT_970 = " = 0;" + NL;
  protected final String TEXT_971 = NL + "                        for(int countEach_";
  protected final String TEXT_972 = ":pstmt_";
  protected final String TEXT_973 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_974 = " += (countEach_";
  protected final String TEXT_975 = " < 0 ? 0 : countEach_";
  protected final String TEXT_976 = ");" + NL + "                        }";
  protected final String TEXT_977 = NL;
  protected final String TEXT_978 = NL + "                            insertedCount_";
  protected final String TEXT_979 = " += countSum_";
  ...
  protected final String TEXT_987 = NL + "                }catch(java.sql.SQLException e_";
  protected final String TEXT_988 = "){";
  protected final String TEXT_989 = NL + "                    java.sql.SQLException e2_";
  protected final String TEXT_990 = " = e_";
  protected final String TEXT_991 = ";" + NL + "                    while (e2_";
  protected final String TEXT_992 = " != null) {";
  protected final String TEXT_993 = NL + "                        System.err.println(e_";
  protected final String TEXT_994 = ".getMessage());" + NL + "                        e2_";
  protected final String TEXT_995 = " = e2_";
  protected final String TEXT_996 = ".getNextException();" + NL + "                    }";
  protected final String TEXT_997 = NL + "            java.sql.SQLException e3_";
  protected final String TEXT_998 = " = e_";
  protected final String TEXT_999 = ";" + NL + "                    boolean isFailure = false;" + NL + "            while(e_";
  protected final String TEXT_1000 = " != null){" + NL + "                if(e_";
  protected final String TEXT_1001 = ".getErrorCode() == -2801){";
  protected final String TEXT_1002 = NL + "                    System.out.println(\" Message: \" + e_";
  protected final String TEXT_1003 = ".getMessage());" + NL + "                    e_";
  protected final String TEXT_1004 = ".printStackTrace();" + NL + "                    System.out.println();" + NL + "                }" + NL + "                else if(e_";
  protected final String TEXT_1005 = ".getErrorCode() == 1339){" + NL + "                    isFailure = true;" + NL + "                }" + NL + "                else{";
  protected final String TEXT_1006 = NL + "                    System.out.println(\" Message: \" + e_";
  protected final String TEXT_1007 = ".getMessage());" + NL + "                    e_";
  protected final String TEXT_1008 = ".printStackTrace();" + NL + "                }" + NL + "                e_";
  protected final String TEXT_1009 = " = e_";
  protected final String TEXT_1010 = ".getNextException();" + NL + "            }" + NL + "            if(isFailure && e_";
  protected final String TEXT_1011 = " != null){";
  protected final String TEXT_1012 = NL + "                System.out.println(\" Message: \" + e_";
  protected final String TEXT_1013 = ".getMessage());" + NL + "                e_";
  protected final String TEXT_1014 = ".printStackTrace();" + NL + "            }";
  protected final String TEXT_1015 = NL + "                throw (e3_";
  protected final String TEXT_1016 = ");";
  protected final String TEXT_1017 = NL + "                System.err.println(e3_";
  protected final String TEXT_1018 = ".getMessage());";
  ...
  protected final String TEXT_1023 = ") {" + NL + "                        try {";
  protected final String TEXT_1024 = NL + "                                       if (batchSizeCounter_";
  protected final String TEXT_1025 = " > 0) {" + NL + "                                           int countSum_";
  protected final String TEXT_1026 = " = 0;" + NL;
  protected final String TEXT_1027 = NL + "                                           for(int countEach_";
  protected final String TEXT_1028 = ": pstmt_";
  protected final String TEXT_1029 = ".executeBatch()) {" + NL + "                                               countSum_";
  ...
  protected final String TEXT_1034 = NL + "                                               insertedCount_";
  protected final String TEXT_1035 = " += countSum_";
  protected final String TEXT_1036 = ";";
  protected final String TEXT_1037 = NL + "                                               updatedCount_";
  protected final String TEXT_1038 = " += countSum_";
  protected final String TEXT_1039 = ";";
  protected final String TEXT_1040 = NL + "                                               deletedCount_";
  protected final String TEXT_1041 = " += countSum_";
  protected final String TEXT_1042 = ";";
  protected final String TEXT_1043 = NL + "                                           batchSizeCounter_";
  protected final String TEXT_1044 = " = 0;" + NL + "                                       }";
  protected final String TEXT_1045 = NL + "                            conn_";
  protected final String TEXT_1046 = ".commit();" + NL + "                            commitCounter_";
  protected final String TEXT_1047 = " = 0;";
  protected final String TEXT_1048 = NL + "                        }catch(java.sql.SQLException e_";
  protected final String TEXT_1049 = "){";
  protected final String TEXT_1050 = NL + "                            java.sql.SQLException e2_";
  protected final String TEXT_1051 = " = e_";
  protected final String TEXT_1052 = ";" + NL + "                            while (e2_";
  protected final String TEXT_1053 = " != null) {";
  protected final String TEXT_1054 = NL + "                                System.err.println(e_";
  protected final String TEXT_1055 = ".getMessage());" + NL + "                                e2_";
  protected final String TEXT_1056 = " = e2_";
  protected final String TEXT_1057 = ".getNextException();" + NL + "                            }";
  protected final String TEXT_1058 = NL + "                    java.sql.SQLException e3_";
  protected final String TEXT_1059 = " = e_";
  protected final String TEXT_1060 = ";" + NL + "                            boolean isFailure = false;" + NL + "                    while(e_";
  protected final String TEXT_1061 = " != null){" + NL + "                        if(e_";
  protected final String TEXT_1062 = ".getErrorCode() == -2801){";
  protected final String TEXT_1063 = NL + "                            System.out.println(\" Message: \" + e_";
  protected final String TEXT_1064 = ".getMessage());" + NL + "                            e_";
  protected final String TEXT_1065 = ".printStackTrace();" + NL + "                            System.out.println();" + NL + "                        }" + NL + "                        else if(e_";
  protected final String TEXT_1066 = ".getErrorCode() == 1339){" + NL + "                            isFailure = true;" + NL + "                        }" + NL + "                        else{";
  protected final String TEXT_1067 = NL + "                            System.out.println(\" Message: \" + e_";
  protected final String TEXT_1068 = ".getMessage());" + NL + "                            e_";
  protected final String TEXT_1069 = ".printStackTrace();" + NL + "                        }" + NL + "                        e_";
  protected final String TEXT_1070 = " = e_";
  protected final String TEXT_1071 = ".getNextException();" + NL + "                    }" + NL + "                    if(isFailure && e_";
  protected final String TEXT_1072 = " != null){";
  protected final String TEXT_1073 = NL + "                        System.out.println(\" Message: \" + e_";
  protected final String TEXT_1074 = ".getMessage());" + NL + "                        e_";
  protected final String TEXT_1075 = ".printStackTrace();" + NL + "                    }";
  protected final String TEXT_1076 = NL + "                        throw (e3_";
  protected final String TEXT_1077 = ");";
  protected final String TEXT_1078 = NL + "                        System.err.println(e3_";
  protected final String TEXT_1079 = ".getMessage());";
