...
public class TGreenplumBulkExecBeginJava {
  ...
  protected final String TEXT_291 = NL + "            \tString tableForSearch_";
  protected final String TEXT_292 = " = ";
  protected final String TEXT_293 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_294 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_295 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_296 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_297 = " =  tableForSearch_";
  protected final String TEXT_298 = ".substring(1,tableForSearch_";
  protected final String TEXT_299 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_300 = " =  tableForSearch_";
  protected final String TEXT_301 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_305 = ".getTables(null, conn_";
  protected final String TEXT_306 = ".getSchema(), tableForSearch_";
  protected final String TEXT_307 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_308 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_309 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_310 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_314 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_315 = " = dbMetaData_";
  protected final String TEXT_316 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_317 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_318 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_319 = " = rsTable_";
  protected final String TEXT_320 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_327 = NL + "\t\t\t\tif(!whetherExist_";
  ...
  protected final String TEXT_345 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_351 = " - Droping table ";
  ...
  protected final String TEXT_359 = " - Drop table ";
  ...
  protected final String TEXT_382 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_383 = " = conn_";
  protected final String TEXT_384 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_385 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_386 = " - Clearing table ";
  ...
  protected final String TEXT_394 = "- Clear table ";
  ...
  protected final String TEXT_399 = ".close();" + NL + "\t\t";
  protected final String TEXT_400 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_401 = " = conn_";
  protected final String TEXT_402 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_403 = " = stmtTruncCount_";
  protected final String TEXT_404 = ".executeQuery(\"";
  protected final String TEXT_405 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_406 = " = conn_";
  protected final String TEXT_407 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_409 = " - Trancating table ";
  protected final String TEXT_410 = "\" + tableName_";
  protected final String TEXT_411 = " + \"";
  protected final String TEXT_412 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_414 = ".executeUpdate(\"";
  protected final String TEXT_415 = "\");" + NL + "   \t    \t";
  protected final String TEXT_416 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_417 = " - Truncate table ";
  protected final String TEXT_418 = "\" + tableName_";
  protected final String TEXT_419 = " + \"";
  protected final String TEXT_420 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_421 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_422 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  ...
  protected final String TEXT_426 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_427 = ".close();" + NL + "\t\t";
  protected final String TEXT_428 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_429 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_430 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_431 = NL + "\t";
  protected final String TEXT_432 = NL + "\t        int keyCount_";
  protected final String TEXT_433 = " = ";
  protected final String TEXT_434 = ";" + NL + "\t        if(keyCount_";
  protected final String TEXT_435 = " == 0) {" + NL + "\t            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "\t        }" + NL + "\t        tmpTableName_";
  protected final String TEXT_436 = " = tableName_";
  protected final String TEXT_437 = ";" + NL + "\t        tableName_";
  protected final String TEXT_438 = " = \"tmp_";
  protected final String TEXT_439 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_443 = " - Creating temp table ";
  protected final String TEXT_444 = "\" + tableName_";
  protected final String TEXT_445 = " + \"";
  protected final String TEXT_446 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_447 = NL + "\t        stmtCreateTmp_";
  protected final String TEXT_448 = ".execute(\"";
  protected final String TEXT_449 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_450 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_451 = " - Create temp table ";
  protected final String TEXT_452 = "\" + tableName_";
  protected final String TEXT_453 = " + \"";
  protected final String TEXT_454 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_455 = NL + "\t        stmtCreateTmp_";
  protected final String TEXT_456 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_457 = NL + "\t\t\t";
  protected final String TEXT_458 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_459 = " - Bulk inserting data into ";
  protected final String TEXT_460 = "\" + tableName_";
  protected final String TEXT_461 = " + \"";
  protected final String TEXT_462 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_463 = NL + "\t        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_464 = " = conn_";
  protected final String TEXT_465 = ".createStatement();" + NL + "\t        stmtTmpBulk_";
  protected final String TEXT_466 = ".execute(bulkSQL_";
  protected final String TEXT_467 = ");" + NL + "\t        stmtTmpBulk_";
  protected final String TEXT_468 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_469 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_470 = " - Bulk insert data into ";
  protected final String TEXT_471 = "\" + tableName_";
  protected final String TEXT_472 = " + \"";
  protected final String TEXT_473 = " has finished.\");" + NL + "\t\t\t";
  protected final String TEXT_474 = NL + "\t        tableName_";
  protected final String TEXT_475 = " = tmpTableName_";
  protected final String TEXT_476 = ";" + NL + "\t        tmpTableName_";
  protected final String TEXT_477 = " = \"tmp_";
  protected final String TEXT_478 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_482 = " - Updating ";
  protected final String TEXT_483 = "\" + tableName_";
  protected final String TEXT_484 = " + \"";
  protected final String TEXT_485 = " from ";
  protected final String TEXT_486 = "\"+tmpTableName_";
  protected final String TEXT_487 = "+\"";
  protected final String TEXT_488 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_489 = NL + "\t        stmtUpdateBulk_";
  protected final String TEXT_490 = ".executeUpdate(\"";
  protected final String TEXT_491 = "\");" + NL + "\t\t\t";
  protected final String TEXT_492 = NL + "\t        stmtUpdateBulk_";
  protected final String TEXT_493 = ".close();" + NL + "\t        tableName_";
  protected final String TEXT_494 = " = tmpTableName_";
  protected final String TEXT_495 = ";" + NL + "\t        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_496 = " = conn_";
  protected final String TEXT_497 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_498 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_499 = " - Droping temp table ";
  protected final String TEXT_500 = "\" + tableName_";
  protected final String TEXT_501 = " + \"";
  protected final String TEXT_502 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_503 = NL + "\t        stmtTmpDrop_";
  protected final String TEXT_504 = ".execute(\"";
  protected final String TEXT_505 = "\");" + NL + "\t\t\t";
  protected final String TEXT_506 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_507 = " - Drop temp table ";
  protected final String TEXT_508 = "\" + tableName_";
  protected final String TEXT_509 = "+ \"";
  protected final String TEXT_510 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_511 = NL + "\t        stmtTmpDrop_";
  protected final String TEXT_512 = ".close();" + NL + "\t        ";
  protected final String TEXT_513 = NL + "\t    \tlog.debug(\"";
  protected final String TEXT_514 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_515 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_516 = " - Bulk inserting data into ";
  protected final String TEXT_517 = "\" + tableName_";
  protected final String TEXT_518 = " + \"";
  protected final String TEXT_519 = ".\" );" + NL + "\t\t";
  protected final String TEXT_520 = NL + "\t    java.sql.Statement stmtBulk_";
  protected final String TEXT_521 = " = conn_";
  protected final String TEXT_522 = ".createStatement();" + NL + "\t    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t    stmtBulk_";
  protected final String TEXT_523 = ".execute(bulkSQL_";
  protected final String TEXT_524 = ");" + NL + "\t    stmtBulk_";
  protected final String TEXT_525 = ".close();" + NL + "\t\t";
  protected final String TEXT_526 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_527 = " - Bulk insert data into ";
  protected final String TEXT_528 = "\" + tableName_";
  protected final String TEXT_529 = " + \"";
  protected final String TEXT_530 = " has finished.\");" + NL + "\t\t";
