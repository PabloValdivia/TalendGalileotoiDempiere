...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_361 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_362 = " = ";
  protected final String TEXT_363 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_364 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_365 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_366 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_367 = " =  tableForSearch_";
  protected final String TEXT_368 = ".substring(1,tableForSearch_";
  protected final String TEXT_369 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_370 = " =  tableForSearch_";
  protected final String TEXT_371 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_372 = " = conn_";
  protected final String TEXT_373 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_374 = " = dbMetaData_";
  protected final String TEXT_375 = ".getTables(null, conn_";
  protected final String TEXT_376 = ".getSchema(), tableForSearch_";
  protected final String TEXT_377 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_378 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_379 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_380 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_381 = ".close();";
  protected final String TEXT_382 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_383 = " = conn_";
  protected final String TEXT_384 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_385 = " = dbMetaData_";
  protected final String TEXT_386 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_387 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_388 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_389 = " = rsTable_";
  protected final String TEXT_390 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_391 = ".equalsIgnoreCase(";
  protected final String TEXT_392 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_393 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_394 = ".close();";
  protected final String TEXT_395 = NL + "                                if(!whetherExist_";
  protected final String TEXT_396 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_397 = " = conn_";
  protected final String TEXT_398 = ".createStatement();";
  protected final String TEXT_399 = NL + "                                                      stmtCreate_";
  ...
  protected final String TEXT_404 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_405 = ".";
  protected final String TEXT_406 = ", \"";
  protected final String TEXT_407 = "\")";
  protected final String TEXT_408 = ".toUpperCase()";
  ...
  protected final String TEXT_416 = NL + "                                if(whetherExist_";
  protected final String TEXT_417 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_418 = " = conn_";
  protected final String TEXT_419 = ".createStatement();";
  protected final String TEXT_420 = NL + "                                                      stmtDrop_";
  protected final String TEXT_421 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_422 = "));";
  protected final String TEXT_423 = NL + "                                    stmtDrop_";
  protected final String TEXT_424 = ".execute(\"";
  protected final String TEXT_425 = "\" ";
  protected final String TEXT_426 = ");";
  protected final String TEXT_427 = NL + "                                    stmtDrop_";
  protected final String TEXT_428 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_429 = " = conn_";
  protected final String TEXT_430 = ".createStatement();";
  protected final String TEXT_431 = NL + "                                                  stmtCreate_";
  protected final String TEXT_432 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_433 = "));";
  protected final String TEXT_434 = NL + "                                        stmtCreate_";
  protected final String TEXT_435 = ".execute(((\"";
  protected final String TEXT_436 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_444 = ".execute(\"";
  protected final String TEXT_445 = ")\");";
  protected final String TEXT_446 = NL + "                                stmtCreate_";
  protected final String TEXT_447 = ".close();";
  protected final String TEXT_448 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_449 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_450 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_451 = " = conn_";
  protected final String TEXT_452 = ".createStatement();";
  protected final String TEXT_453 = NL + "                              stmtClear_";
  protected final String TEXT_454 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_455 = "));";
  protected final String TEXT_456 = NL + "            stmtClear_";
  protected final String TEXT_457 = ".executeUpdate(\"";
  protected final String TEXT_458 = "\");";
  protected final String TEXT_459 = NL + "            stmtClear_";
  protected final String TEXT_460 = ".close();";
  protected final String TEXT_461 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_462 = " = conn_";
  protected final String TEXT_463 = ".createStatement();";
  protected final String TEXT_464 = NL + "                              stmtTruncCount_";
  protected final String TEXT_465 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_466 = "));";
  protected final String TEXT_467 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_468 = " = stmtTruncCount_";
  protected final String TEXT_469 = ".executeQuery(\"";
  protected final String TEXT_470 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_471 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_472 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_473 = " = rsTruncCount_";
  protected final String TEXT_474 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_475 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_476 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_477 = " = conn_";
  protected final String TEXT_478 = ".createStatement();";
  protected final String TEXT_479 = NL + "                              stmtTrunc_";
  protected final String TEXT_480 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_481 = "));";
  protected final String TEXT_482 = NL + "                conn_";
  protected final String TEXT_483 = ".commit();";
  protected final String TEXT_484 = NL + "            stmtTrunc_";
  protected final String TEXT_485 = ".executeUpdate(\"";
  protected final String TEXT_486 = "\");";
  protected final String TEXT_487 = NL + "                if(!conn_";
  protected final String TEXT_488 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_489 = ".commit();" + NL + "                }";
  ...
  protected final String TEXT_501 = ".createStatement();";
  protected final String TEXT_502 = NL + "                conn_";
  protected final String TEXT_503 = ".commit();";
  protected final String TEXT_504 = NL + "            stmtTrunc_";
  protected final String TEXT_505 = ".executeUpdate(\"";
  protected final String TEXT_506 = "\");";
  protected final String TEXT_507 = NL + "            while(rsTruncCount_";
  protected final String TEXT_508 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_509 = " += rsTruncCount_";
  protected final String TEXT_510 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_511 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_512 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_513 = ".close();";
  ...
  protected final String TEXT_553 = ".prepareStatement(update_";
  protected final String TEXT_554 = ");";
  protected final String TEXT_555 = NL + "                String insert_";
  protected final String TEXT_556 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_557 = " + \" (";
  protected final String TEXT_558 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_559 = ".";
  protected final String TEXT_560 = ", \"";
  protected final String TEXT_561 = "\")+\") VALUES (";
  protected final String TEXT_562 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_570 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_576 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_590 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_591 = " + \" WHERE ";
  protected final String TEXT_592 = "\");" + NL + "        pstmtInsert_";
  protected final String TEXT_593 = " = conn_";
  protected final String TEXT_594 = ".prepareStatement(insert_";
  protected final String TEXT_595 = ");" + NL + "        pstmtUpdate_";
  protected final String TEXT_596 = " = conn_";
  protected final String TEXT_597 = ".prepareStatement(update_";
  protected final String TEXT_598 = ");";
  protected final String TEXT_599 = NL + "                String insert_";
  protected final String TEXT_600 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_601 = " + \" (";
  protected final String TEXT_602 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_603 = ".";
  protected final String TEXT_604 = ", \"";
  protected final String TEXT_605 = "\")+\") VALUES (";
  protected final String TEXT_606 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_607 = ".";
  protected final String TEXT_608 = ")+\")\";";
  protected final String TEXT_609 = NL + "                String insert_";
  protected final String TEXT_610 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_611 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_612 = ".";
  protected final String TEXT_613 = ", \"";
  protected final String TEXT_614 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_620 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_627 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_628 = ".";
  protected final String TEXT_629 = ", \"";
  protected final String TEXT_630 = "\")+\" WHERE ";
  protected final String TEXT_631 = "\";";
  protected final String TEXT_632 = NL + "        pstmtUpdate_";
  protected final String TEXT_633 = " = conn_";
  protected final String TEXT_634 = ".prepareStatement(update_";
  protected final String TEXT_635 = ");" + NL + "        pstmtInsert_";
  protected final String TEXT_636 = " = conn_";
  protected final String TEXT_637 = ".prepareStatement(insert_";
  protected final String TEXT_638 = ");";
  protected final String TEXT_639 = NL + "        String delete_";
  protected final String TEXT_640 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_641 = " + \" WHERE ";
  protected final String TEXT_642 = "\";" + NL + "        pstmt_";
  protected final String TEXT_643 = " = conn_";
  protected final String TEXT_644 = ".prepareStatement(delete_";
  protected final String TEXT_645 = ");";
  protected final String TEXT_646 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_647 = " = insert_";
  protected final String TEXT_648 = ".split(\"\\\\?\");";
  protected final String TEXT_649 = NL + "\t\t\tupdate_";
  protected final String TEXT_650 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_651 = " = update_";
  protected final String TEXT_652 = ".split(\"\\\\?\");";
  protected final String TEXT_653 = NL + "\t\t\tupdate_";
  protected final String TEXT_654 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_655 = " = update_";
  protected final String TEXT_656 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_657 = " = insert_";
  protected final String TEXT_658 = ".split(\"\\\\?\");";
  protected final String TEXT_659 = NL + "\t\t\tdelete_";
  protected final String TEXT_660 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_661 = " = delete_";
  protected final String TEXT_662 = ".split(\"\\\\?\");";
  protected final String TEXT_663 = NL + "\t\t\treplace_";
  protected final String TEXT_664 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  ...
  protected final String TEXT_668 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_669 = " = insertIgnore_";
  protected final String TEXT_670 = ".split(\"\\\\?\");";
  protected final String TEXT_671 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_681 = NL + "            whetherReject_";
  protected final String TEXT_682 = " = false;";
  protected final String TEXT_683 = NL + "                        ";
  protected final String TEXT_684 = NL + "                        query_";
  protected final String TEXT_685 = " = ";
  protected final String TEXT_686 = ";";
  protected final String TEXT_687 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_688 = ",";
  protected final String TEXT_689 = ".";
  protected final String TEXT_690 = ", ";
  protected final String TEXT_691 = ",insertSQLSplits_";
  ...
  protected final String TEXT_703 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_704 = "++;";
  protected final String TEXT_705 = NL + "                batchSizeCounter_";
  protected final String TEXT_706 = "++;";
  protected final String TEXT_707 = NL + "        try {" + NL + "            insertedCount_";
  protected final String TEXT_708 = " = insertedCount_";
  protected final String TEXT_709 = " + pstmt_";
  protected final String TEXT_710 = ".executeUpdate();" + NL + "            nb_line_";
  protected final String TEXT_711 = "++;";
  protected final String TEXT_712 = NL + "        } catch(java.lang.Exception e) {" + NL + "            whetherReject_";
  ...
  protected final String TEXT_723 = NL + "                rejectedCount_";
  protected final String TEXT_724 = " = rejectedCount_";
  protected final String TEXT_725 = " + 1;";
  protected final String TEXT_726 = NL + "                ";
  protected final String TEXT_727 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_728 = NL + "                ";
  protected final String TEXT_729 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_730 = ";";
  protected final String TEXT_731 = NL + "                    System.err.print(e.getMessage());";
  ...
  protected final String TEXT_741 = ",updateSQLSplits_";
  protected final String TEXT_742 = ");";
  protected final String TEXT_743 = NL + "                    int count_";
  ...
  protected final String TEXT_753 = NL + "                                query_";
  protected final String TEXT_754 = " = ";
  protected final String TEXT_755 = ";";
  protected final String TEXT_756 = NL + "                                query_";
  ...
  protected final String TEXT_763 = NL + "                            query_";
  protected final String TEXT_764 = " = ";
  protected final String TEXT_765 = ";";
  protected final String TEXT_766 = NL + "                globalMap.put(\"";
  protected final String TEXT_767 = "_QUERY\", query_";
  protected final String TEXT_768 = ".toString().trim());";
  protected final String TEXT_769 = NL;
  protected final String TEXT_770 = NL + "            pstmt_";
  protected final String TEXT_771 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_772 = "++;";
  protected final String TEXT_773 = NL + "            batchSizeCounter_";
  protected final String TEXT_774 = "++;";
  protected final String TEXT_775 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_776 = " = updatedCount_";
  protected final String TEXT_777 = " + pstmt_";
  protected final String TEXT_778 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_779 = "++;";
  protected final String TEXT_780 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_781 = " = true;";
  protected final String TEXT_782 = NL + "                    throw(e);";
  protected final String TEXT_783 = NL + "                        ";
  protected final String TEXT_784 = " = new ";
  protected final String TEXT_785 = "Struct();";
  protected final String TEXT_786 = NL + "                            ";
  protected final String TEXT_787 = ".";
  protected final String TEXT_788 = " = ";
  protected final String TEXT_789 = ".";
  protected final String TEXT_790 = ";";
  protected final String TEXT_791 = NL + "                        rejectedCount_";
  protected final String TEXT_792 = " = rejectedCount_";
  protected final String TEXT_793 = " + 1;";
  protected final String TEXT_794 = NL + "                        ";
  protected final String TEXT_795 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_796 = NL + "                        ";
  protected final String TEXT_797 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_798 = ";";
  protected final String TEXT_799 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_800 = NL + "            }";
  protected final String TEXT_801 = NL + "                        ";
  protected final String TEXT_802 = NL + "                    ";
  protected final String TEXT_803 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_804 = " = pstmt_";
  protected final String TEXT_805 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_806 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_807 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_808 = " = rs_";
  protected final String TEXT_809 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_810 = " > 0) {";
  protected final String TEXT_811 = NL + "                        ";
  protected final String TEXT_812 = NL + "                            query_";
  protected final String TEXT_813 = " = ";
  protected final String TEXT_814 = ";";
  protected final String TEXT_815 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_816 = ",";
  protected final String TEXT_817 = ".";
  protected final String TEXT_818 = ", ";
  protected final String TEXT_819 = ",updateSQLSplits_";
  protected final String TEXT_820 = ");";
  protected final String TEXT_821 = NL + NL + "                        int count_";
  protected final String TEXT_822 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_823 = ".";
  protected final String TEXT_824 = ", pstmtUpdate_";
  ...
  protected final String TEXT_840 = NL + "                            query_";
  protected final String TEXT_841 = " = ";
  protected final String TEXT_842 = ";";
  protected final String TEXT_843 = NL + "                    globalMap.put(\"";
  protected final String TEXT_844 = "_QUERY\", query_";
  protected final String TEXT_845 = ".toString().trim());";
  protected final String TEXT_846 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_847 = " = updatedCount_";
  protected final String TEXT_848 = " + pstmtUpdate_";
  protected final String TEXT_849 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_850 = "++;";
  protected final String TEXT_851 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_873 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_874 = NL + "                        ";
  protected final String TEXT_875 = NL + "                            query_";
  protected final String TEXT_876 = " = ";
  protected final String TEXT_877 = ";";
  protected final String TEXT_878 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_879 = ",";
  protected final String TEXT_880 = ".";
  protected final String TEXT_881 = ", ";
  protected final String TEXT_882 = ",insertSQLSplits_";
  ...
  protected final String TEXT_890 = NL + "                    globalMap.put(\"";
  protected final String TEXT_891 = "_QUERY\", query_";
  protected final String TEXT_892 = ".toString().trim());";
  protected final String TEXT_893 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_894 = " = insertedCount_";
  protected final String TEXT_895 = " + pstmtInsert_";
  protected final String TEXT_896 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_897 = "++;";
  protected final String TEXT_898 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_899 = " = true;";
  protected final String TEXT_900 = NL + "                        throw(e);";
  protected final String TEXT_901 = NL + "                        nb_line_";
  ...
  protected final String TEXT_915 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_916 = NL + "                            ";
  protected final String TEXT_917 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_918 = ";";
  protected final String TEXT_919 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_920 = NL + "                }" + NL + "            }";
  protected final String TEXT_921 = NL + "            int updateFlag_";
  protected final String TEXT_922 = " = 0;";
  protected final String TEXT_923 = NL + "                    ";
  protected final String TEXT_924 = NL + "                        query_";
  protected final String TEXT_925 = " = ";
  protected final String TEXT_926 = ";";
  protected final String TEXT_927 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_928 = ",";
  protected final String TEXT_929 = ".";
  protected final String TEXT_930 = ", ";
  protected final String TEXT_931 = ",updateSQLSplits_";
  protected final String TEXT_932 = ");";
  protected final String TEXT_933 = NL + NL + "                    int count_";
  protected final String TEXT_934 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_935 = ".";
  protected final String TEXT_936 = ", pstmtUpdate_";
  ...
  protected final String TEXT_958 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_959 = "=pstmtUpdate_";
  protected final String TEXT_960 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_961 = " = updatedCount_";
  protected final String TEXT_962 = " + updateFlag_";
  protected final String TEXT_963 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_971 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_972 = ",";
  protected final String TEXT_973 = ".";
  protected final String TEXT_974 = ", ";
  protected final String TEXT_975 = ",insertSQLSplits_";
  protected final String TEXT_976 = ");";
  protected final String TEXT_977 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_978 = ".";
  protected final String TEXT_979 = ", pstmtInsert_";
  protected final String TEXT_980 = ", ";
  protected final String TEXT_981 = ", \"";
  protected final String TEXT_982 = "\");";
  protected final String TEXT_983 = NL + "                    globalMap.put(\"";
  protected final String TEXT_984 = "_QUERY\", query_";
  protected final String TEXT_985 = ".toString().trim());";
  protected final String TEXT_986 = NL + "                    insertedCount_";
  protected final String TEXT_987 = " = insertedCount_";
  protected final String TEXT_988 = " + pstmtInsert_";
  protected final String TEXT_989 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_990 = "++;";
  protected final String TEXT_991 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_992 = "++;";
  protected final String TEXT_993 = NL + "                }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_994 = " = true;";
  protected final String TEXT_995 = NL + "                        throw(e);";
  protected final String TEXT_996 = NL + "                        nb_line_";
  protected final String TEXT_997 = "++;";
  protected final String TEXT_998 = NL + "                            ";
  protected final String TEXT_999 = " = new ";
  protected final String TEXT_1000 = "Struct();";
  protected final String TEXT_1001 = NL + "                                ";
  protected final String TEXT_1002 = ".";
  protected final String TEXT_1003 = " = ";
  protected final String TEXT_1004 = ".";
  protected final String TEXT_1005 = ";";
  protected final String TEXT_1006 = NL + "                            rejectedCount_";
  protected final String TEXT_1007 = " = rejectedCount_";
  protected final String TEXT_1008 = " + 1;";
  protected final String TEXT_1009 = NL + "                            ";
  protected final String TEXT_1010 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1011 = NL + "                            ";
  protected final String TEXT_1012 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1013 = ";";
  protected final String TEXT_1014 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_1027 = NL + "            pstmt_";
  protected final String TEXT_1028 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_1029 = "++;";
  protected final String TEXT_1030 = NL + "            batchSizeCounter_";
  protected final String TEXT_1031 = "++;";
  protected final String TEXT_1032 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1033 = " = deletedCount_";
  protected final String TEXT_1034 = " + pstmt_";
  protected final String TEXT_1035 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1036 = "++;";
  protected final String TEXT_1037 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1038 = " = true;";
  protected final String TEXT_1039 = NL + "                    throw(e);";
  protected final String TEXT_1040 = NL + "                    nb_line_";
  ...
  protected final String TEXT_1060 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1072 = " > 0) && (batchSize_";
  protected final String TEXT_1073 = " <= batchSizeCounter_";
  protected final String TEXT_1074 = ")) {" + NL + "                try {";
  protected final String TEXT_1075 = NL + "                        pstmt_";
  protected final String TEXT_1076 = ".executeBatch();";
  protected final String TEXT_1077 = NL + "                        java.io.ByteArrayInputStream bais_";
  protected final String TEXT_1078 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_1079 = ".toString().getBytes());";
  protected final String TEXT_1080 = NL + "                            com.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_1081 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_1082 = ",template_";
  protected final String TEXT_1083 = ");" + NL + "                            vcs_";
  protected final String TEXT_1084 = ".start();" + NL + "                            vcs_";
  protected final String TEXT_1085 = ".addStream(bais_";
  protected final String TEXT_1086 = ");" + NL + "                            vcs_";
  protected final String TEXT_1087 = ".execute();" + NL + "                            vcs_";
  protected final String TEXT_1088 = ".finish();";
  protected final String TEXT_1089 = NL + "                            ((com.vertica.PGStatement)stmt_";
  protected final String TEXT_1090 = ").executeCopyIn(template_";
  protected final String TEXT_1091 = ", bais_";
  protected final String TEXT_1092 = ");";
  protected final String TEXT_1093 = NL + "                        stmtBuilder_";
  protected final String TEXT_1094 = " = null;" + NL + "                        if (bais_";
  protected final String TEXT_1095 = " != null) {" + NL + "                            bais_";
  protected final String TEXT_1096 = ".close();" + NL + "                            bais_";
  protected final String TEXT_1097 = " = null;" + NL + "                        }" + NL + "                        stmtBuilder_";
  protected final String TEXT_1098 = " = new StringBuilder();";
  protected final String TEXT_1099 = NL + "                            insertedCount_";
  protected final String TEXT_1100 = " += pstmt_";
  protected final String TEXT_1101 = ". getUpdateCount();";
  protected final String TEXT_1102 = NL + "                            updatedCount_";
  protected final String TEXT_1103 = " += pstmt_";
  protected final String TEXT_1104 = ". getUpdateCount();";
  protected final String TEXT_1105 = NL + "                            deletedCount_";
  protected final String TEXT_1106 = " += pstmt_";
  protected final String TEXT_1107 = ". getUpdateCount();";
  protected final String TEXT_1108 = NL + "                                copiedCount_";
  protected final String TEXT_1109 = " += vcs_";
  protected final String TEXT_1110 = ".getRowCount();";
  protected final String TEXT_1111 = NL + "                                copiedCount_";
  protected final String TEXT_1112 = " += stmt_";
  protected final String TEXT_1113 = ".getUpdateCount();";
  protected final String TEXT_1114 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1115 = " = 0;" + NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_1116 = NL + "                        throw(e);";
  protected final String TEXT_1117 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1118 = NL + "                }" + NL + "            }";
  protected final String TEXT_1119 = NL + "                commitCounter_";
  protected final String TEXT_1120 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1121 = " <= commitCounter_";
  protected final String TEXT_1122 = ") {" + NL;
  protected final String TEXT_1123 = NL + "                try {";
  protected final String TEXT_1124 = NL + "                            boolean isCountResult_";
  protected final String TEXT_1125 = " = false;" + NL + "                            if(batchSizeCounter_";
  protected final String TEXT_1126 = " > 0){";
  protected final String TEXT_1127 = NL + "                                pstmt_";
  protected final String TEXT_1128 = ".executeBatch();";
  protected final String TEXT_1129 = NL + "                                isCountResult_";
  protected final String TEXT_1130 = " = true;" + NL + "                                batchSizeCounter_";
  protected final String TEXT_1131 = " = 0;" + NL + "                            }";
  protected final String TEXT_1132 = NL + "                        if(isCountResult_";
  protected final String TEXT_1133 = "){";
  protected final String TEXT_1134 = NL + "                        insertedCount_";
  protected final String TEXT_1135 = " += pstmt_";
  protected final String TEXT_1136 = ".getUpdateCount();";
  protected final String TEXT_1137 = NL + "                        updatedCount_";
  protected final String TEXT_1138 = " += pstmt_";
  protected final String TEXT_1139 = ".getUpdateCount();";
  protected final String TEXT_1140 = NL + "                        deletedCount_";
  protected final String TEXT_1141 = " += pstmt_";
  protected final String TEXT_1142 = ".getUpdateCount();";
  protected final String TEXT_1143 = NL + "                        }";
  protected final String TEXT_1144 = NL + "                        if (stmtBuilder_";
  protected final String TEXT_1145 = " != null && stmtBuilder_";
  protected final String TEXT_1146 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_1147 = " start" + NL + "                            java.io.ByteArrayInputStream bais_";
  protected final String TEXT_1148 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_1149 = ".toString().getBytes());";
  protected final String TEXT_1150 = NL + "                            ((com.vertica.PGStatement)stmt_";
  protected final String TEXT_1151 = ").executeCopyIn(template_";
  protected final String TEXT_1152 = ", bais_";
  protected final String TEXT_1153 = ");";
  protected final String TEXT_1154 = NL + "                            stmtBuilder_";
  protected final String TEXT_1155 = " = null;" + NL + "                            if (bais_";
  protected final String TEXT_1156 = " != null) {" + NL + "                                bais_";
  protected final String TEXT_1157 = ".close();" + NL + "                                bais_";
  protected final String TEXT_1158 = " = null;" + NL + "                            }" + NL + "                            stmtBuilder_";
  protected final String TEXT_1159 = " = new StringBuilder();" + NL + "                            copiedCount_";
  protected final String TEXT_1160 = " += stmt_";
  protected final String TEXT_1161 = ".getUpdateCount();" + NL + "                        } // stmtBuilder_";
  protected final String TEXT_1162 = " end";
  protected final String TEXT_1163 = NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_1164 = NL + "                        throw(e);";
  protected final String TEXT_1165 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1166 = NL + NL + "                }";
  protected final String TEXT_1167 = NL + "                    conn_";
  protected final String TEXT_1168 = ".commit();";
  protected final String TEXT_1169 = NL + "                    commitCounter_";
  protected final String TEXT_1170 = "=0;" + NL + "                }";
