...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_404 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_459 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_509 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_557 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_558 = ",";
  protected final String TEXT_559 = ".";
  protected final String TEXT_560 = ", ";
  protected final String TEXT_561 = ",insertSQLSplits_";
  protected final String TEXT_562 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_563 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_564 = ".";
  protected final String TEXT_565 = ", pstmt_";
  ...
  protected final String TEXT_573 = NL + "    \t\tpstmt_";
  protected final String TEXT_574 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_575 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_576 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_577 = "++;" + NL + "    \t\t";
  protected final String TEXT_578 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_579 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_580 = " = insertedCount_";
  protected final String TEXT_581 = " + pstmt_";
  protected final String TEXT_582 = ".executeUpdate();";
  protected final String TEXT_583 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_584 = " = true;";
  protected final String TEXT_585 = NL + "                    throw(e);";
  ...
  protected final String TEXT_594 = NL + "                        rejectedCount_";
  protected final String TEXT_595 = " = rejectedCount_";
  protected final String TEXT_596 = " + 1;";
  protected final String TEXT_597 = NL + "                        ";
  protected final String TEXT_598 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_599 = NL + "                        ";
  protected final String TEXT_600 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_601 = ";";
  protected final String TEXT_602 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_608 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_609 = ",";
  protected final String TEXT_610 = ".";
  protected final String TEXT_611 = ", ";
  protected final String TEXT_612 = ",updateSQLSplits_";
  protected final String TEXT_613 = ");";
  protected final String TEXT_614 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_615 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_643 = NL + "    \t\tpstmt_";
  protected final String TEXT_644 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_645 = "++;" + NL + "\t\t\t";
  protected final String TEXT_646 = NL + "\t\t\tbatchSizeCounter_";
  protected final String TEXT_647 = "++;" + NL + "    \t\t";
  protected final String TEXT_648 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_649 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_650 = " = updatedCount_";
  protected final String TEXT_651 = " + pstmt_";
  protected final String TEXT_652 = ".executeUpdate();";
  protected final String TEXT_653 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_668 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_669 = NL + "                        ";
  protected final String TEXT_670 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_671 = ";";
  protected final String TEXT_672 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_673 = NL + "            }";
  protected final String TEXT_674 = NL + "                    \t";
  protected final String TEXT_675 = NL + "                    ";
  protected final String TEXT_676 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_677 = " = pstmt_";
  protected final String TEXT_678 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_679 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_680 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_681 = " = rs_";
  protected final String TEXT_682 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_683 = " > 0) {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_684 = NL + "                        ";
  protected final String TEXT_685 = NL + "                            query_";
  protected final String TEXT_686 = " = ";
  protected final String TEXT_687 = ";";
  protected final String TEXT_688 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_689 = ",";
  protected final String TEXT_690 = ".";
  protected final String TEXT_691 = ", ";
  protected final String TEXT_692 = ",updateSQLSplits_";
  protected final String TEXT_693 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_694 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_695 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_696 = ".";
  protected final String TEXT_697 = ", pstmtUpdate_";
  ...
  protected final String TEXT_722 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_723 = " = updatedCount_";
  protected final String TEXT_724 = " + pstmtUpdate_";
  protected final String TEXT_725 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_726 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_727 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_728 = " = true;";
  protected final String TEXT_729 = NL + "                        throw(e);";
  protected final String TEXT_730 = NL + "                    \tnb_line_";
  protected final String TEXT_731 = "++;" + NL + "                    \t";
  protected final String TEXT_732 = NL + "                            ";
  protected final String TEXT_733 = " = new ";
  protected final String TEXT_734 = "Struct();";
  protected final String TEXT_735 = NL + "                                ";
  protected final String TEXT_736 = ".";
  protected final String TEXT_737 = " = ";
  protected final String TEXT_738 = ".";
  protected final String TEXT_739 = ";";
  protected final String TEXT_740 = NL + "                            rejectedCount_";
  protected final String TEXT_741 = " = rejectedCount_";
  protected final String TEXT_742 = " + 1;";
  protected final String TEXT_743 = NL + "                            ";
  protected final String TEXT_744 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_745 = NL + "                            ";
  protected final String TEXT_746 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_747 = ";";
  protected final String TEXT_748 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_749 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_750 = NL + "                        ";
  protected final String TEXT_751 = NL + "                            query_";
  protected final String TEXT_752 = " = ";
  protected final String TEXT_753 = ";";
  protected final String TEXT_754 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_755 = ",";
  protected final String TEXT_756 = ".";
  protected final String TEXT_757 = ", ";
  protected final String TEXT_758 = ",insertSQLSplits_";
  protected final String TEXT_759 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_760 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_761 = ".";
  protected final String TEXT_762 = ", pstmtInsert_";
  ...
  protected final String TEXT_769 = NL + "                    insertedCount_";
  protected final String TEXT_770 = " = insertedCount_";
  protected final String TEXT_771 = " + pstmtInsert_";
  protected final String TEXT_772 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_773 = "++;";
  protected final String TEXT_774 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_775 = " = true;";
  protected final String TEXT_776 = NL + "                        throw(e);";
  protected final String TEXT_777 = NL + "                \t\tnb_line_";
  ...
  protected final String TEXT_791 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_792 = NL + "                            ";
  protected final String TEXT_793 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_794 = ";";
  protected final String TEXT_795 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_796 = NL + "                }" + NL + "    \t\t}" + NL + "" + NL + "    \t\t";
  protected final String TEXT_797 = NL + "    \t    int updateFlag_";
  protected final String TEXT_798 = "=0;" + NL + "            try {" + NL + "    \t    ";
  protected final String TEXT_799 = NL + "                    ";
  protected final String TEXT_800 = NL + "                        query_";
  protected final String TEXT_801 = " = ";
  protected final String TEXT_802 = ";";
  protected final String TEXT_803 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_804 = ",";
  protected final String TEXT_805 = ".";
  protected final String TEXT_806 = ", ";
  protected final String TEXT_807 = ",updateSQLSplits_";
  protected final String TEXT_808 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_809 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_810 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_811 = ".";
  protected final String TEXT_812 = ", pstmtUpdate_";
  ...
  protected final String TEXT_837 = NL + "                updateFlag_";
  protected final String TEXT_838 = "=pstmtUpdate_";
  protected final String TEXT_839 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_840 = " = updatedCount_";
  protected final String TEXT_841 = "+updateFlag_";
  protected final String TEXT_842 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_843 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_844 = NL + "\t\t\t\tquery_";
  protected final String TEXT_845 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_846 = NL + "                        ";
  protected final String TEXT_847 = NL + "                            query_";
  protected final String TEXT_848 = " = ";
  protected final String TEXT_849 = ";";
  protected final String TEXT_850 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_851 = ",";
  protected final String TEXT_852 = ".";
  protected final String TEXT_853 = ", ";
  protected final String TEXT_854 = ",insertSQLSplits_";
  protected final String TEXT_855 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_856 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_857 = ".";
  protected final String TEXT_858 = ", pstmtInsert_";
  ...
  protected final String TEXT_865 = NL + "                    insertedCount_";
  protected final String TEXT_866 = " = insertedCount_";
  protected final String TEXT_867 = " + pstmtInsert_";
  protected final String TEXT_868 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_869 = "++;";
  protected final String TEXT_870 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_871 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_872 = NL + "    \t\t\t}" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_873 = " = true;";
  protected final String TEXT_874 = NL + "                        throw(e);";
  ...
  protected final String TEXT_879 = "Struct();";
  protected final String TEXT_880 = NL + "                                ";
  protected final String TEXT_881 = ".";
  protected final String TEXT_882 = " = ";
  protected final String TEXT_883 = ".";
  protected final String TEXT_884 = ";";
  protected final String TEXT_885 = NL + "                            rejectedCount_";
  protected final String TEXT_886 = " = rejectedCount_";
  protected final String TEXT_887 = " + 1;";
  protected final String TEXT_888 = NL + "                            ";
  protected final String TEXT_889 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_890 = NL + "                            ";
  protected final String TEXT_891 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_892 = ";";
  protected final String TEXT_893 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_894 = NL + "                }";
  protected final String TEXT_895 = NL + "                    \t";
  protected final String TEXT_896 = NL + "\t                        query_";
  protected final String TEXT_897 = " = ";
  protected final String TEXT_898 = ";" + NL + "\t                        ";
  protected final String TEXT_899 = NL;
  protected final String TEXT_900 = NL + "                    ";
  protected final String TEXT_901 = NL + "                        query_";
  protected final String TEXT_902 = " = ";
  protected final String TEXT_903 = ";";
  protected final String TEXT_904 = NL + "                globalMap.put(\"";
  protected final String TEXT_905 = "_QUERY\", query_";
  protected final String TEXT_906 = ".toString().trim());";
  ...
  protected final String TEXT_913 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_914 = " = deletedCount_";
  protected final String TEXT_915 = " + pstmt_";
  protected final String TEXT_916 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_917 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_918 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_919 = " = true;";
  protected final String TEXT_920 = NL + "                    throw(e);";
  protected final String TEXT_921 = NL + "            \t\tnb_line_";
  protected final String TEXT_922 = "++;" + NL + "                \t";
  protected final String TEXT_923 = NL + "                        ";
  protected final String TEXT_924 = " = new ";
  protected final String TEXT_925 = "Struct();";
  ...
  protected final String TEXT_933 = " + 1;";
  protected final String TEXT_934 = NL + "                        ";
  protected final String TEXT_935 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_936 = NL + "                        ";
  protected final String TEXT_937 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_938 = ";";
  protected final String TEXT_939 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_940 = NL + "            }" + NL + "    \t";
  protected final String TEXT_941 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_952 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_953 = " > 0) && (batchSize_";
  protected final String TEXT_954 = " <= batchSizeCounter_";
  protected final String TEXT_955 = ")) {" + NL + "    \t\t\t    try {" + NL + "    \t\t\t    \t";
  protected final String TEXT_956 = NL + "                            pstmt_";
  protected final String TEXT_957 = ".executeBatch();";
  protected final String TEXT_958 = NL + "                            int countSum_";
  protected final String TEXT_959 = " = 0;" + NL + "                            for(int countEach_";
  protected final String TEXT_960 = ": pstmt_";
  protected final String TEXT_961 = ".executeBatch()) {" + NL + "                                countSum_";
  protected final String TEXT_962 = " += (countEach_";
  protected final String TEXT_963 = " < 0 ? 0 : countEach_";
  protected final String TEXT_964 = ");" + NL + "                            }";
  protected final String TEXT_965 = NL + "                                updatedCount_";
  protected final String TEXT_966 = " += countSum_";
  protected final String TEXT_967 = ";";
  protected final String TEXT_968 = NL + "                                deletedCount_";
  protected final String TEXT_969 = " += countSum_";
  protected final String TEXT_970 = ";";
  protected final String TEXT_971 = NL + "                    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_972 = "){";
  protected final String TEXT_973 = NL + "                            throw(e_";
  ...
  protected final String TEXT_978 = ".getUpdateCounts()) {" + NL + "                                    countSum_";
  protected final String TEXT_979 = " += (countEach_";
  protected final String TEXT_980 = " < 0 ? 0 : countEach_";
  protected final String TEXT_981 = ");" + NL + "                                }";
  protected final String TEXT_982 = NL + "                                updatedCount_";
  protected final String TEXT_983 = " += countSum_";
  protected final String TEXT_984 = ";";
  protected final String TEXT_985 = NL + "                                deletedCount_";
  protected final String TEXT_986 = " += countSum_";
  protected final String TEXT_987 = ";";
  protected final String TEXT_988 = NL + "                            System.err.println(e_";
  protected final String TEXT_989 = ".getMessage());";
  protected final String TEXT_990 = NL + "                    }";
  protected final String TEXT_991 = NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_992 = " = pstmt_";
  protected final String TEXT_993 = ".getUpdateCount();" + NL + "                        insertedCount_";
  protected final String TEXT_994 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_995 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_996 = ":0);";
  protected final String TEXT_997 = NL + "                    batchSizeCounter_";
  protected final String TEXT_998 = " = 0;" + NL + "\t\t\t\t}" + NL + "\t    \t\t";
  ...
  protected final String TEXT_1004 = " > 0){" + NL + "    \t                try {" + NL + "    \t                \t";
  protected final String TEXT_1005 = NL + "                                pstmt_";
  protected final String TEXT_1006 = ".executeBatch();";
  protected final String TEXT_1007 = NL + "                                int countSum_";
  protected final String TEXT_1008 = " = 0;" + NL + "                                for(int countEach_";
  protected final String TEXT_1009 = ": pstmt_";
  protected final String TEXT_1010 = ".executeBatch()) {" + NL + "                                    countSum_";
  protected final String TEXT_1011 = " += (countEach_";
  protected final String TEXT_1012 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1013 = ");" + NL + "                                }";
  protected final String TEXT_1014 = NL + "                                    updatedCount_";
  protected final String TEXT_1015 = " += countSum_";
  protected final String TEXT_1016 = ";";
  protected final String TEXT_1017 = NL + "                                    deletedCount_";
  protected final String TEXT_1018 = " += countSum_";
  protected final String TEXT_1019 = ";";
  protected final String TEXT_1020 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1021 = "){";
  protected final String TEXT_1022 = NL + "                                throw(e_";
  protected final String TEXT_1023 = ");";
  protected final String TEXT_1024 = NL + "                                    int countSum_";
  protected final String TEXT_1025 = " = 0;" + NL + "                                    for(int countEach_";
  protected final String TEXT_1026 = ": e_";
  protected final String TEXT_1027 = ".getUpdateCounts()) {" + NL + "                                        countSum_";
  protected final String TEXT_1028 = " += (countEach_";
  protected final String TEXT_1029 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1030 = ");" + NL + "                                    }";
  protected final String TEXT_1031 = NL + "                                    updatedCount_";
  protected final String TEXT_1032 = " += countSum_";
  protected final String TEXT_1033 = ";";
  protected final String TEXT_1034 = NL + "                                    deletedCount_";
  protected final String TEXT_1035 = " += countSum_";
  protected final String TEXT_1036 = ";";
  protected final String TEXT_1037 = NL + "                                System.err.println(e_";
  protected final String TEXT_1038 = ".getMessage());";
  protected final String TEXT_1039 = NL + "                        }";
  protected final String TEXT_1040 = NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_1041 = " = pstmt_";
  protected final String TEXT_1042 = ".getUpdateCount();" + NL + "                            insertedCount_";
  protected final String TEXT_1043 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_1044 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_1045 = ":0);";
  protected final String TEXT_1046 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1047 = " = 0;" + NL + "                    }" + NL + "\t                ";
  protected final String TEXT_1048 = NL + "\t                \t";
  protected final String TEXT_1049 = NL + "                        conn_";
  protected final String TEXT_1050 = ".commit();";
  protected final String TEXT_1051 = NL + "                        commitCounter_";
  protected final String TEXT_1052 = "=0;" + NL + "                    }";
