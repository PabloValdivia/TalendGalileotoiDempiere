...
public class TSybaseIQBulkExecBeginJava {
  ...
  protected final String TEXT_256 = " = \"jdbc:odbc:dsn=\"+";
  protected final String TEXT_257 = ";";
  protected final String TEXT_258 = NL + "            String url_";
  protected final String TEXT_259 = " = \"jdbc:odbc:FileDSN=\"+";
  protected final String TEXT_260 = ";";
  protected final String TEXT_261 = NL + "            url_";
  protected final String TEXT_262 = " +=\";DatabaseName=\"+";
  protected final String TEXT_263 = ";";
  protected final String TEXT_264 = NL + "        String driverClass_";
  protected final String TEXT_265 = " = \"ianywhere.ml.jdbcodbc.IDriver\";";
  protected final String TEXT_266 = NL + NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_267 = ");" + NL;
  protected final String TEXT_268 = NL;
  protected final String TEXT_269 = " " + NL + "\tfinal String decryptedPassword_";
  ...
  protected final String TEXT_275 = NL + "    String dbPwd_";
  protected final String TEXT_276 = " = decryptedPassword_";
  protected final String TEXT_277 = ";" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_278 = " = null;" + NL;
  protected final String TEXT_279 = NL + NL + "    String tableName_";
  protected final String TEXT_280 = " = dbUser_";
  protected final String TEXT_281 = " + \".\" + ";
  protected final String TEXT_282 = ";" + NL + "    if(dbschema_";
  protected final String TEXT_283 = " != null && !\"\".equals(dbschema_";
  protected final String TEXT_284 = ") && !\"\\\"\\\"\".equals(dbschema_";
  protected final String TEXT_285 = ")) {" + NL + "        tableName_";
  protected final String TEXT_286 = " = dbschema_";
  protected final String TEXT_287 = " + \".\" + ";
  protected final String TEXT_288 = ";" + NL + "    }";
  protected final String TEXT_289 = NL + "int deletedCount_";
  protected final String TEXT_290 = " = 0;";
  protected final String TEXT_291 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_295 = " - Droping table ";
  ...
  protected final String TEXT_303 = " - Drop table ";
  ...
  protected final String TEXT_308 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_326 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_330 = " - Creating table ";
  ...
  protected final String TEXT_338 = " - Create table ";
  ...
  protected final String TEXT_343 = ".close();" + NL + "\t\t";
  protected final String TEXT_344 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_345 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_346 = " = conn_";
  protected final String TEXT_347 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_348 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_349 = " = tableNameForSearch_";
  protected final String TEXT_350 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_351 = " = tableNameForSearch_";
  protected final String TEXT_352 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_353 = " = dbMetaData_";
  protected final String TEXT_354 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_355 = ", tableNameForSearch_";
  protected final String TEXT_356 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_357 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_358 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_359 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_369 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_370 = " = rsTable_";
  protected final String TEXT_371 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_372 = ".equalsIgnoreCase(";
  protected final String TEXT_373 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_374 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_375 = ") || dbschema_";
  protected final String TEXT_376 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_377 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_378 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_380 = " = conn_";
  protected final String TEXT_381 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_382 = " = dbMetaData_";
  protected final String TEXT_383 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_384 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_385 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_386 = " = rsTable_";
  protected final String TEXT_387 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_388 = " = rsTable_";
  protected final String TEXT_389 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_390 = ".equals(";
  protected final String TEXT_391 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_392 = ".equals(schema_";
  protected final String TEXT_393 = ") || (schema_";
  protected final String TEXT_394 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_395 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_399 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_400 = " = conn_";
  protected final String TEXT_401 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_402 = " = dbMetaData_";
  protected final String TEXT_403 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_404 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_405 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_406 = " == null || dbschema_";
  protected final String TEXT_407 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_408 = " = conn_";
  protected final String TEXT_409 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_410 = " = stmtSchema_";
  protected final String TEXT_411 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_412 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_413 = " = rsSchema_";
  protected final String TEXT_414 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_415 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_416 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_417 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_418 = " = rsTable_";
  protected final String TEXT_419 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_420 = " = rsTable_";
  protected final String TEXT_421 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_422 = ".equals";
  protected final String TEXT_423 = "IgnoreCase";
  protected final String TEXT_424 = "(";
  protected final String TEXT_425 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_426 = ".equals";
  protected final String TEXT_427 = "IgnoreCase";
  protected final String TEXT_428 = "(dbschema_";
  protected final String TEXT_429 = ") || ((dbschema_";
  protected final String TEXT_430 = " ==null || dbschema_";
  protected final String TEXT_431 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_432 = ".equals";
  protected final String TEXT_433 = "IgnoreCase";
  protected final String TEXT_434 = "(schema_";
  protected final String TEXT_435 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_436 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_437 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_438 = NL + "            \tString tableForSearch_";
  protected final String TEXT_439 = " = ";
  protected final String TEXT_440 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_441 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_442 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_443 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_444 = " =  tableForSearch_";
  protected final String TEXT_445 = ".substring(1,tableForSearch_";
  protected final String TEXT_446 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_447 = " =  tableForSearch_";
  protected final String TEXT_448 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_449 = " = conn_";
  protected final String TEXT_450 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_451 = " = dbMetaData_";
  protected final String TEXT_452 = ".getTables(null, conn_";
  protected final String TEXT_453 = ".getSchema(), tableForSearch_";
  protected final String TEXT_454 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_455 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_456 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_457 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_458 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_459 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_460 = " = conn_";
  protected final String TEXT_461 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_462 = " = dbMetaData_";
  protected final String TEXT_463 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_464 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_465 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_466 = " = rsTable_";
  protected final String TEXT_467 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_468 = ".equals";
  protected final String TEXT_469 = "IgnoreCase";
  protected final String TEXT_470 = "(";
  protected final String TEXT_471 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_472 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_473 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_474 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_475 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_476 = " = conn_";
  protected final String TEXT_477 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_478 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_479 = " - Creating table ";
  protected final String TEXT_480 = "\" + tableName_";
  ...
  protected final String TEXT_487 = " - Create table ";
  protected final String TEXT_488 = "\" + tableName_";
  protected final String TEXT_489 = " + \"";
  protected final String TEXT_490 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_491 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_492 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_493 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_494 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_498 = " - Droping table ";
  protected final String TEXT_499 = "\" + tableName_";
  protected final String TEXT_500 = " + \"";
  protected final String TEXT_501 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_502 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_503 = ".execute(\"";
  protected final String TEXT_504 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_505 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_506 = " - Drop table ";
  protected final String TEXT_507 = "\" + tableName_";
  protected final String TEXT_508 = " + \"";
  protected final String TEXT_509 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_510 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_511 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_512 = " = conn_";
  protected final String TEXT_513 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_514 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_515 = " - Creating table ";
  ...
  protected final String TEXT_523 = " - Create table ";
  protected final String TEXT_524 = "\" + tableName_";
  protected final String TEXT_525 = " + \"";
  protected final String TEXT_526 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_527 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_528 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_529 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_530 = " = conn_";
  protected final String TEXT_531 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_532 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_533 = " - Clearing table ";
  protected final String TEXT_534 = "\" + tableName_";
  protected final String TEXT_535 = " + \"";
  protected final String TEXT_536 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_537 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_538 = ".executeUpdate(\"";
  protected final String TEXT_539 = "\");" + NL + "\t\t\t";
  protected final String TEXT_540 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_541 = "- Clear table ";
  protected final String TEXT_542 = "\" + tableName_";
  protected final String TEXT_543 = " + \"";
  protected final String TEXT_544 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_545 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_546 = ".close();" + NL + "\t\t";
  protected final String TEXT_547 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_548 = " = conn_";
  protected final String TEXT_549 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_550 = " = stmtTruncCount_";
  protected final String TEXT_551 = ".executeQuery(\"";
  protected final String TEXT_552 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_553 = " = conn_";
  protected final String TEXT_554 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_555 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_556 = " - Trancating table ";
  protected final String TEXT_557 = "\" + tableName_";
  protected final String TEXT_558 = " + \"";
  protected final String TEXT_559 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_560 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_561 = ".executeUpdate(\"";
  protected final String TEXT_562 = "\");" + NL + "   \t    \t";
  protected final String TEXT_563 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_564 = " - Truncate table ";
  protected final String TEXT_565 = "\" + tableName_";
  protected final String TEXT_566 = " + \"";
  protected final String TEXT_567 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_568 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_569 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_570 = " += rsTruncCount_";
  protected final String TEXT_571 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_572 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_573 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_574 = ".close();" + NL + "\t\t";
  protected final String TEXT_575 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_576 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_577 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_578 = NL + "    java.sql.Statement stmt_";
  protected final String TEXT_579 = " = conn_";
  protected final String TEXT_580 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_581 = ".execute(insertLocationSql_";
  protected final String TEXT_582 = ".toString());" + NL + "/*" + NL + "    try{" + NL + "       if(!stmt_";
  protected final String TEXT_583 = ".isClosed()){" + NL + "           stmt_";
  protected final String TEXT_584 = ".close();" + NL + "       }" + NL + "    }catch(Exception e){" + NL + "        e.printStackTrace();" + NL + "    }catch(java.lang.Error err){" + NL + "        err.printStackTrace();" + NL + "    }" + NL + "*/";
  protected final String TEXT_585 = NL + "        if(conn_";
  protected final String TEXT_586 = " != null && !conn_";
  protected final String TEXT_587 = ".isClosed()) {" + NL + "            conn_";
  protected final String TEXT_588 = ".close();" + NL + "        }";
  protected final String TEXT_589 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_590 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_591 = "\");" + NL + "\tString dbschema_";
  protected final String TEXT_592 = "= (String)globalMap.get(\"";
  protected final String TEXT_593 = "\");" + NL + "\tString dbUser_";
  protected final String TEXT_594 = " = (String)globalMap.get(\"";
  protected final String TEXT_595 = "\");";
  protected final String TEXT_596 = NL + "\tString dbschema_";
  protected final String TEXT_597 = " = ";
  protected final String TEXT_598 = ";" + NL + "\tString dbUser_";
  protected final String TEXT_599 = " = ";
  protected final String TEXT_600 = ";";
  protected final String TEXT_601 = NL;
  protected final String TEXT_602 = NL + "\t\t\tString url_";
  protected final String TEXT_603 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_604 = " + \":\" + ";
  protected final String TEXT_605 = " + \"/\" + ";
  protected final String TEXT_606 = ";";
  protected final String TEXT_607 = NL + "\t\t\tString url_";
  protected final String TEXT_608 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_609 = " + \":\" + ";
  protected final String TEXT_610 = " + \"/\" + ";
  protected final String TEXT_611 = " + \"?\" + ";
  protected final String TEXT_612 = ";";
  protected final String TEXT_613 = NL + "\t\t String driverClass_";
  protected final String TEXT_614 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";";
  protected final String TEXT_615 = NL + "\t\t\tString url_";
  protected final String TEXT_616 = " = \"jdbc:odbc:dsn=\"+";
  protected final String TEXT_617 = ";";
  protected final String TEXT_618 = NL + "\t\t\tString url_";
  protected final String TEXT_619 = " = \"jdbc:odbc:FileDSN=\"+";
  protected final String TEXT_620 = ";";
  protected final String TEXT_621 = NL + "\t\t\turl_";
  protected final String TEXT_622 = " +=\";DatabaseName=\"+";
  protected final String TEXT_623 = ";";
  protected final String TEXT_624 = NL + "\t\tString driverClass_";
  protected final String TEXT_625 = " = \"ianywhere.ml.jdbcodbc.IDriver\";";
  protected final String TEXT_626 = NL + NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_627 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_628 = NL + NL + "\t";
  protected final String TEXT_629 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_630 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_631 = ");";
  protected final String TEXT_632 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_633 = " = ";
  protected final String TEXT_634 = "; ";
  protected final String TEXT_635 = NL + "\tString dbPwd_";
  protected final String TEXT_636 = " = decryptedPassword_";
  protected final String TEXT_637 = ";" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_638 = " = null;" + NL;
  protected final String TEXT_639 = NL + NL + "\tString tableName_";
  protected final String TEXT_640 = " = dbUser_";
  protected final String TEXT_641 = " + \".\" + ";
  protected final String TEXT_642 = ";" + NL + "\tif(dbschema_";
  protected final String TEXT_643 = " != null && dbschema_";
  protected final String TEXT_644 = ".trim().length() != 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_645 = " = dbschema_";
  protected final String TEXT_646 = " + \".\" + ";
  protected final String TEXT_647 = ";" + NL + "\t}";
  protected final String TEXT_648 = NL + "int deletedCount_";
  protected final String TEXT_649 = " = 0;";
  protected final String TEXT_650 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_651 = " = conn_";
  protected final String TEXT_652 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_653 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_654 = " - Droping table ";
  protected final String TEXT_655 = "\" + tableName_";
  protected final String TEXT_656 = " + \"";
  protected final String TEXT_657 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_658 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_659 = ".execute(\"";
  protected final String TEXT_660 = "\");" + NL + "\t\t\t";
  protected final String TEXT_661 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_662 = " - Drop table ";
  protected final String TEXT_663 = "\" + tableName_";
  protected final String TEXT_664 = " + \"";
  protected final String TEXT_665 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_666 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_667 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_668 = " = conn_";
  protected final String TEXT_669 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_670 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_671 = " - Creating table ";
  protected final String TEXT_672 = "\" + tableName_";
  protected final String TEXT_673 = " + \"";
  protected final String TEXT_674 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_675 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_676 = ".execute(\"";
  protected final String TEXT_677 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_678 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_679 = " - Create table ";
  protected final String TEXT_680 = "\" + tableName_";
  protected final String TEXT_681 = " + \"";
  protected final String TEXT_682 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_683 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_684 = ".close();" + NL + "\t\t";
  protected final String TEXT_685 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_686 = " = conn_";
  protected final String TEXT_687 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_688 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_689 = " - Creating table ";
  protected final String TEXT_690 = "\" + tableName_";
  protected final String TEXT_691 = " + \"";
  protected final String TEXT_692 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_693 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_694 = ".execute(\"";
  protected final String TEXT_695 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_696 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_697 = " - Create table ";
  protected final String TEXT_698 = "\" + tableName_";
  protected final String TEXT_699 = " + \"";
  protected final String TEXT_700 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_701 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_702 = ".close();" + NL + "\t\t";
  protected final String TEXT_703 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_704 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_705 = " = conn_";
  protected final String TEXT_706 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_707 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_708 = " = tableNameForSearch_";
  protected final String TEXT_709 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_710 = " = tableNameForSearch_";
  protected final String TEXT_711 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_712 = " = dbMetaData_";
  protected final String TEXT_713 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_714 = ", tableNameForSearch_";
  protected final String TEXT_715 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_716 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_717 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_718 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_719 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_720 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_721 = " = conn_";
  protected final String TEXT_722 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_723 = " = dbMetaData_";
  protected final String TEXT_724 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_725 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_726 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_727 = " = rsTable_";
  protected final String TEXT_728 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_729 = " = rsTable_";
  protected final String TEXT_730 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_731 = ".equalsIgnoreCase(";
  protected final String TEXT_732 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_733 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_734 = ") || dbschema_";
  protected final String TEXT_735 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_736 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_737 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_738 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_739 = " = conn_";
  protected final String TEXT_740 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_741 = " = dbMetaData_";
  protected final String TEXT_742 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_743 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_744 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_745 = " = rsTable_";
  protected final String TEXT_746 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_747 = " = rsTable_";
  protected final String TEXT_748 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_749 = ".equals(";
  protected final String TEXT_750 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_751 = ".equals(schema_";
  protected final String TEXT_752 = ") || (schema_";
  protected final String TEXT_753 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_754 = ".equalsIgnoreCase(bkSchema_";
  protected final String TEXT_755 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_756 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_757 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_758 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_759 = " = conn_";
  protected final String TEXT_760 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_761 = " = dbMetaData_";
  protected final String TEXT_762 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_763 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_764 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_765 = " == null || dbschema_";
  protected final String TEXT_766 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_767 = " = conn_";
  protected final String TEXT_768 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_769 = " = stmtSchema_";
  protected final String TEXT_770 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_771 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_772 = " = rsSchema_";
  protected final String TEXT_773 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_774 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_775 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_776 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_777 = " = rsTable_";
  protected final String TEXT_778 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_779 = " = rsTable_";
  protected final String TEXT_780 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_781 = ".equals";
  protected final String TEXT_782 = "IgnoreCase";
  protected final String TEXT_783 = "(";
  protected final String TEXT_784 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_785 = ".equals";
  protected final String TEXT_786 = "IgnoreCase";
  protected final String TEXT_787 = "(dbschema_";
  protected final String TEXT_788 = ") || ((dbschema_";
  protected final String TEXT_789 = " ==null || dbschema_";
  protected final String TEXT_790 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_791 = ".equals";
  protected final String TEXT_792 = "IgnoreCase";
  protected final String TEXT_793 = "(schema_";
  protected final String TEXT_794 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_795 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_796 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_797 = NL + "            \tString tableForSearch_";
  protected final String TEXT_798 = " = ";
  protected final String TEXT_799 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_800 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_801 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_802 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_803 = " =  tableForSearch_";
  protected final String TEXT_804 = ".substring(1,tableForSearch_";
  protected final String TEXT_805 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_806 = " =  tableForSearch_";
  protected final String TEXT_807 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_808 = " = conn_";
  protected final String TEXT_809 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_810 = " = dbMetaData_";
  protected final String TEXT_811 = ".getTables(null, conn_";
  protected final String TEXT_812 = ".getSchema(), tableForSearch_";
  protected final String TEXT_813 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_814 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_815 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_816 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_817 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_818 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_819 = " = conn_";
  protected final String TEXT_820 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_821 = " = dbMetaData_";
  protected final String TEXT_822 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_823 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_824 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_825 = " = rsTable_";
  protected final String TEXT_826 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_827 = ".equals";
  protected final String TEXT_828 = "IgnoreCase";
  protected final String TEXT_829 = "(";
  protected final String TEXT_830 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_831 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_832 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_833 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_834 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_835 = " = conn_";
  protected final String TEXT_836 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_837 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_838 = " - Creating table ";
  protected final String TEXT_839 = "\" + tableName_";
  protected final String TEXT_840 = " + \"";
  protected final String TEXT_841 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_842 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_843 = ".execute(\"";
  protected final String TEXT_844 = ")\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_845 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_846 = " - Create table ";
  protected final String TEXT_847 = "\" + tableName_";
  protected final String TEXT_848 = " + \"";
  protected final String TEXT_849 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_850 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_851 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_852 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_853 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_854 = " = conn_";
  protected final String TEXT_855 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_856 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_857 = " - Droping table ";
  protected final String TEXT_858 = "\" + tableName_";
  protected final String TEXT_859 = " + \"";
  protected final String TEXT_860 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_861 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_862 = ".execute(\"";
  protected final String TEXT_863 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_864 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_865 = " - Drop table ";
  protected final String TEXT_866 = "\" + tableName_";
  protected final String TEXT_867 = " + \"";
  protected final String TEXT_868 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_869 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_870 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_871 = " = conn_";
  protected final String TEXT_872 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_873 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_874 = " - Creating table ";
  protected final String TEXT_875 = "\" + tableName_";
  protected final String TEXT_876 = " + \"";
  protected final String TEXT_877 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_878 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_879 = ".execute(\"";
  protected final String TEXT_880 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_881 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_882 = " - Create table ";
  protected final String TEXT_883 = "\" + tableName_";
  protected final String TEXT_884 = " + \"";
  protected final String TEXT_885 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_886 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_887 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_888 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_889 = " = conn_";
  protected final String TEXT_890 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_891 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_892 = " - Clearing table ";
  protected final String TEXT_893 = "\" + tableName_";
  protected final String TEXT_894 = " + \"";
  protected final String TEXT_895 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_896 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_897 = ".executeUpdate(\"";
  protected final String TEXT_898 = "\");" + NL + "\t\t\t";
  protected final String TEXT_899 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_900 = "- Clear table ";
  protected final String TEXT_901 = "\" + tableName_";
  protected final String TEXT_902 = " + \"";
  protected final String TEXT_903 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_904 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_905 = ".close();" + NL + "\t\t";
  protected final String TEXT_906 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_907 = " = conn_";
  protected final String TEXT_908 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_909 = " = stmtTruncCount_";
  protected final String TEXT_910 = ".executeQuery(\"";
  protected final String TEXT_911 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_912 = " = conn_";
  protected final String TEXT_913 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_914 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_915 = " - Trancating table ";
  protected final String TEXT_916 = "\" + tableName_";
  protected final String TEXT_917 = " + \"";
  protected final String TEXT_918 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_919 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_920 = ".executeUpdate(\"";
  protected final String TEXT_921 = "\");" + NL + "   \t    \t";
  protected final String TEXT_922 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_923 = " - Truncate table ";
  protected final String TEXT_924 = "\" + tableName_";
  protected final String TEXT_925 = " + \"";
  protected final String TEXT_926 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_927 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_928 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_929 = " += rsTruncCount_";
  protected final String TEXT_930 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_931 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_932 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_933 = ".close();" + NL + "\t\t";
  protected final String TEXT_934 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_935 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_936 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_937 = NL + NL + "\t\tStringBuilder loadingCols_";
  protected final String TEXT_938 = " = new StringBuilder();";
  protected final String TEXT_939 = NL + "    \tloadingCols_";
  protected final String TEXT_940 = ".append(\"(\");";
  protected final String TEXT_941 = NL + "        loadingCols_";
  protected final String TEXT_942 = ".append(\"";
  protected final String TEXT_943 = "\" + \" \");";
  protected final String TEXT_944 = NL + "\t\tloadingCols_";
  protected final String TEXT_945 = ".append(\"ASCII(\" + ";
  protected final String TEXT_946 = " + \"),\");";
  protected final String TEXT_947 = NL + "        loadingCols_";
  protected final String TEXT_948 = ".append(\"'\" + ";
  protected final String TEXT_949 = " + \"' ";
  protected final String TEXT_950 = "NULL(BLANKS)";
  protected final String TEXT_951 = "\" + \",\");";
  protected final String TEXT_952 = NL + "\t\tloadingCols_";
  protected final String TEXT_953 = ".append(\"ASCII(\" + ";
  protected final String TEXT_954 = " + \")\");";
  protected final String TEXT_955 = NL + "        \tloadingCols_";
  protected final String TEXT_956 = ".append(\"'\" + ";
  protected final String TEXT_957 = " + \"' ";
  protected final String TEXT_958 = "NULL(BLANKS)";
  protected final String TEXT_959 = "\");";
  protected final String TEXT_960 = NL + "    loadingCols_";
  protected final String TEXT_961 = ".append(\")\");";
  protected final String TEXT_962 = NL + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_963 = "=conn_";
  protected final String TEXT_964 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_965 = ".execute(\"SET TEMPORARY OPTION ESCAPE_CHARACTER='ON'\");" + NL + "    stmt_";
  protected final String TEXT_966 = ".execute(\"SET TEMPORARY OPTION LOAD_ZEROLENGTH_ASNULL='ON'\");" + NL + "" + NL + "    //stmt_";
  protected final String TEXT_967 = ".execute(\"SET TEMPORARY OPTION ALLOW_READ_CLIENT_FILE='ON'\");//sybaseIQ 15 whether is set?" + NL + "" + NL + "    String strSQL_";
  protected final String TEXT_968 = " = \"LOAD TABLE \" + tableName_";
  protected final String TEXT_969 = " + loadingCols_";
  protected final String TEXT_970 = ".toString() ;";
  protected final String TEXT_971 = NL + "\t\tstrSQL_";
  protected final String TEXT_972 = " +=\" from '\" + ";
  protected final String TEXT_973 = " + \"' \";";
  protected final String TEXT_974 = NL + "\t\tstrSQL_";
  protected final String TEXT_975 = " +=\" USING CLIENT FILE '\" + ";
  protected final String TEXT_976 = " + \"' \";";
  protected final String TEXT_977 = NL;
  protected final String TEXT_978 = NL + "     strSQL_";
  protected final String TEXT_979 = " = strSQL_";
  protected final String TEXT_980 = " + \" row delimited by '\" + ";
  protected final String TEXT_981 = " + \"'\";" + NL + "\t strSQL_";
  protected final String TEXT_982 = "=strSQL_";
  protected final String TEXT_983 = " + \" quotes off\";";
  protected final String TEXT_984 = NL + "\tstrSQL_";
  protected final String TEXT_985 = "=strSQL_";
  protected final String TEXT_986 = " + \" quotes on \";";
  protected final String TEXT_987 = NL + "\tstrSQL_";
  protected final String TEXT_988 = "=strSQL_";
  protected final String TEXT_989 = " + \" quotes off \";";
  protected final String TEXT_990 = NL + "    strSQL_";
  protected final String TEXT_991 = " =strSQL_";
  protected final String TEXT_992 = " + \" escapes off \";" + NL;
  protected final String TEXT_993 = NL + "\tstrSQL_";
  protected final String TEXT_994 = " =strSQL_";
  protected final String TEXT_995 = " + \" skip 1 \";";
  protected final String TEXT_996 = NL + "\t\tlog.info(\"";
  protected final String TEXT_997 = " - Bulk load SQL:\"+strSQL_";
  protected final String TEXT_998 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_999 = " - Bulk loading data into ";
  protected final String TEXT_1000 = "\" + tableName_";
  protected final String TEXT_1001 = " + \"";
  protected final String TEXT_1002 = ".\" );" + NL + "\t";
  protected final String TEXT_1003 = NL + NL + "    stmt_";
  protected final String TEXT_1004 = ".execute(strSQL_";
  protected final String TEXT_1005 = ");" + NL;
  protected final String TEXT_1006 = NL + "    if(conn_";
  protected final String TEXT_1007 = " != null && !conn_";
  protected final String TEXT_1008 = ".isClosed()) {";
