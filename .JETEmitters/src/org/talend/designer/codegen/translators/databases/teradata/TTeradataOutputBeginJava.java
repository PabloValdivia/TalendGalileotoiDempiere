...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_217 = ".createStatement();";
  protected final String TEXT_218 = NL + "                              stmtDrop_";
  protected final String TEXT_219 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_220 = ")));";
  protected final String TEXT_221 = NL + "            stmtDrop_";
  protected final String TEXT_222 = ".execute(\"";
  protected final String TEXT_223 = "\" ";
  protected final String TEXT_224 = ");";
  protected final String TEXT_225 = NL + "            stmtDrop_";
  protected final String TEXT_226 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".createStatement();";
  protected final String TEXT_229 = NL + "                              stmtCreate_";
  protected final String TEXT_230 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_231 = "));";
  protected final String TEXT_232 = NL + "                    stmtCreate_";
  protected final String TEXT_233 = ".execute(((\"";
  protected final String TEXT_234 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_235 = ".";
  protected final String TEXT_236 = ", \"";
  protected final String TEXT_237 = "\")";
  protected final String TEXT_238 = ".toUpperCase()";
  ...
  protected final String TEXT_245 = ".close();";
  protected final String TEXT_246 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_247 = " = conn_";
  protected final String TEXT_248 = ".createStatement();";
  protected final String TEXT_249 = NL + "                              stmtCreate_";
  protected final String TEXT_250 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_251 = "));";
  protected final String TEXT_252 = NL + "                    stmtCreate_";
  protected final String TEXT_253 = ".execute(((\"";
  protected final String TEXT_254 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_261 = NL + "                stmtCreate_";
  protected final String TEXT_262 = ".execute(\"";
  protected final String TEXT_263 = ")\");";
  protected final String TEXT_264 = NL + "            stmtCreate_";
  protected final String TEXT_265 = ".close();";
  protected final String TEXT_266 = NL;
  protected final String TEXT_267 = NL + "                    String keyCheckTable_";
  protected final String TEXT_268 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_275 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_276 = " = conn_";
  protected final String TEXT_277 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_278 = " + \"]\";";
  protected final String TEXT_279 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_280 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_281 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_282 = ")== null){//}";
  protected final String TEXT_283 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_284 = " = conn_";
  protected final String TEXT_285 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_286 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_287 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_288 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_289 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_290 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  protected final String TEXT_291 = ".close();";
  protected final String TEXT_292 = NL + "                                ";
  protected final String TEXT_293 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_294 = " = conn_";
  protected final String TEXT_295 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_296 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_297 = " = tableNameForSearch_";
  protected final String TEXT_298 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_299 = " = tableNameForSearch_";
  protected final String TEXT_300 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_301 = " = dbMetaData_";
  protected final String TEXT_302 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_303 = ", tableNameForSearch_";
  protected final String TEXT_304 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_305 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_306 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_307 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_308 = ".close();" + NL;
  protected final String TEXT_309 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_310 = " = conn_";
  protected final String TEXT_311 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_312 = " = dbMetaData_";
  protected final String TEXT_313 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_314 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_315 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_316 = " = rsTable_";
  protected final String TEXT_317 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_318 = " = rsTable_";
  protected final String TEXT_319 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  ...
  protected final String TEXT_328 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_336 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_347 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_352 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_353 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_354 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_355 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_356 = ".close();";
  protected final String TEXT_357 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_358 = " = conn_";
  protected final String TEXT_359 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_360 = " = dbMetaData_";
  protected final String TEXT_361 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_362 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_363 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_364 = " == null || dbschema_";
  protected final String TEXT_365 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_366 = " = conn_";
  protected final String TEXT_367 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_368 = " = stmtSchema_";
  protected final String TEXT_369 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_370 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_371 = " = rsSchema_";
  protected final String TEXT_372 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_373 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_374 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_375 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_376 = " = rsTable_";
  protected final String TEXT_377 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_378 = " = rsTable_";
  protected final String TEXT_379 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_380 = ".equals";
  protected final String TEXT_381 = "IgnoreCase";
  protected final String TEXT_382 = "(";
  protected final String TEXT_383 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_384 = ".equals";
  protected final String TEXT_385 = "IgnoreCase";
  protected final String TEXT_386 = "(dbschema_";
  protected final String TEXT_387 = ") || ((dbschema_";
  protected final String TEXT_388 = " ==null || dbschema_";
  protected final String TEXT_389 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_390 = ".equals";
  protected final String TEXT_391 = "IgnoreCase";
  protected final String TEXT_392 = "(schema_";
  protected final String TEXT_393 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_394 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_395 = ".close();";
  protected final String TEXT_396 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_397 = " = ";
  protected final String TEXT_398 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_399 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_400 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_401 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_402 = " =  tableForSearch_";
  protected final String TEXT_403 = ".substring(1,tableForSearch_";
  protected final String TEXT_404 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_405 = " =  tableForSearch_";
  protected final String TEXT_406 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_407 = " = conn_";
  protected final String TEXT_408 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_409 = " = dbMetaData_";
  protected final String TEXT_410 = ".getTables(null, conn_";
  protected final String TEXT_411 = ".getSchema(), tableForSearch_";
  protected final String TEXT_412 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_413 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_414 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_415 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_416 = ".close();";
  protected final String TEXT_417 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_418 = " = conn_";
  protected final String TEXT_419 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_420 = " = dbMetaData_";
  protected final String TEXT_421 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_422 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_423 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_424 = " = rsTable_";
  protected final String TEXT_425 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_426 = ".equalsIgnoreCase(";
  protected final String TEXT_427 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_428 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_429 = ".close();";
  protected final String TEXT_430 = NL + "                                if(!whetherExist_";
  protected final String TEXT_431 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_432 = " = conn_";
  protected final String TEXT_433 = ".createStatement();";
  protected final String TEXT_434 = NL + "                                                      stmtCreate_";
  protected final String TEXT_435 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_436 = "));";
  protected final String TEXT_437 = NL + "                                            stmtCreate_";
  protected final String TEXT_438 = ".execute(((\"";
  protected final String TEXT_439 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_440 = ".";
  protected final String TEXT_441 = ", \"";
  protected final String TEXT_442 = "\")";
  protected final String TEXT_443 = ".toUpperCase()";
  protected final String TEXT_444 = ")+\")";
  protected final String TEXT_445 = "\"));";
  protected final String TEXT_446 = NL + "                                        stmtCreate_";
  protected final String TEXT_447 = ".execute(\"";
  protected final String TEXT_448 = ")\");";
  protected final String TEXT_449 = NL + "                                    stmtCreate_";
  protected final String TEXT_450 = ".close();" + NL + "                                }";
  protected final String TEXT_451 = NL + "                                if(whetherExist_";
  protected final String TEXT_452 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_453 = " = conn_";
  protected final String TEXT_454 = ".createStatement();";
  protected final String TEXT_455 = NL + "                                                      stmtDrop_";
  protected final String TEXT_456 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_457 = "));";
  protected final String TEXT_458 = NL + "                                    stmtDrop_";
  protected final String TEXT_459 = ".execute(\"";
  protected final String TEXT_460 = "\" ";
  protected final String TEXT_461 = ");";
  protected final String TEXT_462 = NL + "                                    stmtDrop_";
  protected final String TEXT_463 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_464 = " = conn_";
  protected final String TEXT_465 = ".createStatement();";
  protected final String TEXT_466 = NL + "                                                  stmtCreate_";
  protected final String TEXT_467 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_468 = "));";
  protected final String TEXT_469 = NL + "                                        stmtCreate_";
  protected final String TEXT_470 = ".execute(((\"";
  protected final String TEXT_471 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_478 = NL + "                                    stmtCreate_";
  protected final String TEXT_479 = ".execute(\"";
  protected final String TEXT_480 = ")\");";
  protected final String TEXT_481 = NL + "                                stmtCreate_";
  protected final String TEXT_482 = ".close();";
  protected final String TEXT_483 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_484 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_485 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_486 = " = conn_";
  protected final String TEXT_487 = ".createStatement();";
  protected final String TEXT_488 = NL + "                              stmtClear_";
  protected final String TEXT_489 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_490 = "));";
  protected final String TEXT_491 = NL + "            stmtClear_";
  protected final String TEXT_492 = ".executeUpdate(\"";
  protected final String TEXT_493 = "\");";
  protected final String TEXT_494 = NL + "            stmtClear_";
  protected final String TEXT_495 = ".close();";
  protected final String TEXT_496 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_497 = " = conn_";
  protected final String TEXT_498 = ".createStatement();";
  protected final String TEXT_499 = NL + "                              stmtTruncCount_";
  protected final String TEXT_500 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_501 = "));";
  protected final String TEXT_502 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_503 = " = stmtTruncCount_";
  protected final String TEXT_504 = ".executeQuery(\"";
  protected final String TEXT_505 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_506 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_507 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_508 = " = rsTruncCount_";
  protected final String TEXT_509 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_510 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_511 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_512 = " = conn_";
  protected final String TEXT_513 = ".createStatement();";
  protected final String TEXT_514 = NL + "                              stmtTrunc_";
  protected final String TEXT_515 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_516 = "));";
  protected final String TEXT_517 = NL + "                conn_";
  protected final String TEXT_518 = ".commit();";
  protected final String TEXT_519 = NL + "            stmtTrunc_";
  protected final String TEXT_520 = ".executeUpdate(\"";
  protected final String TEXT_521 = "\");";
  protected final String TEXT_522 = NL + "                if(!conn_";
  protected final String TEXT_523 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_524 = ".commit();" + NL + "                }";
  protected final String TEXT_525 = NL + "            deletedCount_";
  protected final String TEXT_526 = " += rsTruncCountNumber_";
  protected final String TEXT_527 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_528 = ".close();";
  protected final String TEXT_529 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_530 = " = conn_";
  protected final String TEXT_531 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_532 = " = stmtTruncCount_";
  protected final String TEXT_533 = ".executeQuery(\"";
  protected final String TEXT_534 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_535 = " = conn_";
  protected final String TEXT_536 = ".createStatement();";
  protected final String TEXT_537 = NL + "                conn_";
  protected final String TEXT_538 = ".commit();";
  protected final String TEXT_539 = NL + "            stmtTrunc_";
  protected final String TEXT_540 = ".executeUpdate(\"";
  protected final String TEXT_541 = "\");";
  protected final String TEXT_542 = NL + "            while(rsTruncCount_";
  protected final String TEXT_543 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_544 = " += rsTruncCount_";
  protected final String TEXT_545 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_546 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_547 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_548 = ".close();";
  ...
  protected final String TEXT_553 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_561 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_567 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_568 = " + \"\\\" WHERE ";
  ...
  protected final String TEXT_580 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_581 = " = conn_";
  protected final String TEXT_582 = ".prepareStatement(update_";
  ...
  protected final String TEXT_588 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_589 = " = conn_";
  protected final String TEXT_590 = ".prepareStatement(update_";
  ...
  protected final String TEXT_595 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
