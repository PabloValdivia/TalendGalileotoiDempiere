...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_148 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_175 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_179 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_180 = "));";
  protected final String TEXT_181 = NL + "                    stmtCreate_";
  protected final String TEXT_182 = ".execute(((\"";
  protected final String TEXT_183 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_196 = NL + "                    String keyCheckTable_";
  protected final String TEXT_197 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_204 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_207 = " + \"]\";";
  protected final String TEXT_208 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_209 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_210 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_325 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_326 = " = ";
  protected final String TEXT_327 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_328 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_329 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_330 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_331 = " =  tableForSearch_";
  protected final String TEXT_332 = ".substring(1,tableForSearch_";
  protected final String TEXT_333 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_334 = " =  tableForSearch_";
  protected final String TEXT_335 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_339 = ".getTables(null, conn_";
  protected final String TEXT_340 = ".getSchema(), tableForSearch_";
  protected final String TEXT_341 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_342 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_343 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_344 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_345 = ".close();";
  protected final String TEXT_346 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_347 = " = conn_";
  protected final String TEXT_348 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_349 = " = dbMetaData_";
  protected final String TEXT_350 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_351 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_352 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_353 = " = rsTable_";
  protected final String TEXT_354 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_355 = ".equalsIgnoreCase(";
  protected final String TEXT_356 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_357 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_358 = ".close();";
  protected final String TEXT_359 = NL + "                                if(!whetherExist_";
  protected final String TEXT_360 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_368 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_369 = ".";
  protected final String TEXT_370 = ", \"";
  protected final String TEXT_371 = "\")";
  protected final String TEXT_372 = ".toUpperCase()";
  protected final String TEXT_373 = ")+\")";
  protected final String TEXT_374 = "\"));";
  protected final String TEXT_375 = NL + "                                        stmtCreate_";
  protected final String TEXT_376 = ".execute(\"";
  protected final String TEXT_377 = ")\");";
  protected final String TEXT_378 = NL + "                                    stmtCreate_";
  protected final String TEXT_379 = ".close();" + NL + "                                }";
  protected final String TEXT_380 = NL + "                                if(whetherExist_";
  protected final String TEXT_381 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_394 = ".createStatement();";
  protected final String TEXT_395 = NL + "                                                  stmtCreate_";
  protected final String TEXT_396 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_413 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_414 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_424 = ".close();";
  ...
  protected final String TEXT_428 = NL + "                              stmtTruncCount_";
  protected final String TEXT_429 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_430 = "));";
  protected final String TEXT_431 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_432 = " = stmtTruncCount_";
  protected final String TEXT_433 = ".executeQuery(\"";
  protected final String TEXT_434 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_435 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_436 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_454 = NL + "            deletedCount_";
  protected final String TEXT_455 = " += rsTruncCountNumber_";
  protected final String TEXT_456 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_457 = ".close();";
  protected final String TEXT_458 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_459 = " = conn_";
  protected final String TEXT_460 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_461 = " = stmtTruncCount_";
  protected final String TEXT_462 = ".executeQuery(\"";
  protected final String TEXT_463 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_464 = " = conn_";
  protected final String TEXT_465 = ".createStatement();";
  protected final String TEXT_466 = NL + "                conn_";
  protected final String TEXT_467 = ".commit();";
  protected final String TEXT_468 = NL + "            stmtTrunc_";
  protected final String TEXT_469 = ".executeUpdate(\"";
  protected final String TEXT_470 = "\");";
  protected final String TEXT_471 = NL + "            while(rsTruncCount_";
  protected final String TEXT_472 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_476 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_477 = ".close();";
  ...
  protected final String TEXT_490 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_494 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_495 = " = conn_";
  protected final String TEXT_496 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_521 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_522 = " + \"\\\" (";
  protected final String TEXT_523 = ") VALUES (";
  protected final String TEXT_524 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_525 = " = conn_";
  protected final String TEXT_526 = ".prepareStatement(insert_";
  protected final String TEXT_527 = ");" + NL + "\t    ";
  protected final String TEXT_528 = NL + "\t    String delete_";
  protected final String TEXT_529 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_533 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_566 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_567 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_568 = " =null;" + NL + "\t";
  protected final String TEXT_569 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_570 = " = null;" + NL + "\t\t";
  protected final String TEXT_571 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_576 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_577 = " = null;";
  protected final String TEXT_578 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_579 = " = null;";
  protected final String TEXT_580 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_581 = " = null;";
  protected final String TEXT_582 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_583 = " = null;";
  protected final String TEXT_584 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_585 = " = null;";
  protected final String TEXT_586 = NL + "class SetPrepareStatementUtil_";
  protected final String TEXT_587 = " {";
  protected final String TEXT_588 = NL + "\t\t\tvoid set";
  protected final String TEXT_589 = "_";
  protected final String TEXT_590 = "(" + NL + "\t\t\t\tfinal ";
  protected final String TEXT_591 = "Struct ";
  protected final String TEXT_592 = "," + NL + "\t\t\t\tfinal java.sql.PreparedStatement";
  protected final String TEXT_593 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_594 = NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_595 = NL + "\t\t\t\tpstmtUpdate_";
  protected final String TEXT_596 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal StringBuffer query_";
  protected final String TEXT_597 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal String[] ";
  protected final String TEXT_598 = NL + "\t\t\t) throws java.sql.SQLException {" + NL + "\t\t\t//}";
  ...
  protected final String TEXT_604 = NL + "}" + NL + "" + NL + "SetPrepareStatementUtil_";
  protected final String TEXT_605 = " setPrepareStatementUtil_";
  protected final String TEXT_606 = " = new SetPrepareStatementUtil_";
  protected final String TEXT_607 = "();" + NL;
  protected final String TEXT_608 = NL + NL + "class DataPropagateUtil_";
  protected final String TEXT_609 = " {";
  protected final String TEXT_610 = NL + "\t\t\tvoid assign_";
  protected final String TEXT_611 = "_";
  protected final String TEXT_612 = "(final ";
  protected final String TEXT_613 = "Struct ";
  protected final String TEXT_614 = ",final ";
  ...
  protected final String TEXT_624 = NL + "}" + NL + "" + NL + "DataPropagateUtil_";
  protected final String TEXT_625 = " dataPropagateUtil_";
  protected final String TEXT_626 = " = new DataPropagateUtil_";
  protected final String TEXT_627 = "();" + NL + NL + NL;
