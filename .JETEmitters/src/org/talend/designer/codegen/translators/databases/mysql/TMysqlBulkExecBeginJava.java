...
public class TMysqlBulkExecBeginJava {
  ...
  protected final String TEXT_257 = NL + "            \tString tableForSearch_";
  protected final String TEXT_258 = " = ";
  protected final String TEXT_259 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_260 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_261 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_262 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_263 = " =  tableForSearch_";
  protected final String TEXT_264 = ".substring(1,tableForSearch_";
  protected final String TEXT_265 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_266 = " =  tableForSearch_";
  protected final String TEXT_267 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_273 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_274 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_275 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_276 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_397 = NL + "String lines_separator_";
  protected final String TEXT_398 = " = ";
  protected final String TEXT_399 = ";" + NL + "String field_separator_";
  protected final String TEXT_400 = " = ";
  protected final String TEXT_401 = ";" + NL + "String escaped_str_";
  protected final String TEXT_402 = " = ";
  protected final String TEXT_403 = ";" + NL + "String enclosed_str_";
  protected final String TEXT_404 = " = ";
  protected final String TEXT_405 = ";" + NL + "String file_";
  protected final String TEXT_406 = " = ";
  protected final String TEXT_407 = ";" + NL + "file_";
  protected final String TEXT_408 = " = file_";
  protected final String TEXT_409 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "String replace_";
  ...
  protected final String TEXT_414 = " == 0) {" + NL + "\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "\t\t}" + NL + "\t\ttableName_";
  protected final String TEXT_415 = " = \"tmp_";
  protected final String TEXT_416 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtTmpCreate_";
  ...
  protected final String TEXT_420 = " - Creating temp table \" + tableName_";
  protected final String TEXT_421 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_422 = NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_423 = ".execute(\"";
  protected final String TEXT_424 = ")\");" + NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_425 = ".close();" + NL + "" + NL + "\t\tjava.sql.Statement stmtTmpBulk_";
  ...
  protected final String TEXT_429 = " - Create temp table \" + tableName_";
  protected final String TEXT_430 = " + \" has succeeded.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_431 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_432 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_433 = NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_434 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_435 = ");" + NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_436 = ".execute(" + NL + "\t\t\t\"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_437 = " + \"' \"" + NL + "\t\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_438 = NL + "\t\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_439 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_440 = ")?\"\\\\\":\"\")+ enclosed_str_";
  protected final String TEXT_441 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ESCAPED BY '\" +(\"'\".equals(escaped_str_";
  protected final String TEXT_442 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_443 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\")+ \"'\"" + NL + "\t\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_444 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_445 = "\"";
  protected final String TEXT_446 = NL + "\t\t\t+ \" SET\"";
  protected final String TEXT_447 = NL + "\t\t\t+ \" ";
  protected final String TEXT_448 = "=CAST(@";
  protected final String TEXT_449 = "_";
  protected final String TEXT_450 = " AS UNSIGNED)\"";
  protected final String TEXT_451 = NL + "\t\t\t+ \",\"";
  protected final String TEXT_452 = NL + "\t\t);" + NL + "\t\t";
  protected final String TEXT_453 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_454 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_455 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_456 = NL + "\t\ttableName_";
  protected final String TEXT_457 = " = ";
  protected final String TEXT_458 = ";" + NL + "\t\tString tmpTableName_";
  protected final String TEXT_459 = " = \"tmp_";
  protected final String TEXT_460 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_461 = " = conn_";
  protected final String TEXT_462 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_463 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_464 = " - Updating \" + tableName_";
  protected final String TEXT_465 = " + \" from \"+tmpTableName_";
  protected final String TEXT_466 = "+\".\");" + NL + "\t\t";
  protected final String TEXT_467 = NL + "\t\tstmtUpdateBulk_";
  protected final String TEXT_468 = ".executeUpdate(\"";
  protected final String TEXT_469 = "\");" + NL + "\t\t";
  protected final String TEXT_470 = NL + "\t\tstmtUpdateBulk_";
  protected final String TEXT_471 = ".close();" + NL + "\t\ttableName_";
  protected final String TEXT_472 = " = tmpTableName_";
  protected final String TEXT_473 = ";" + NL + "\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_474 = " = conn_";
  protected final String TEXT_475 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_476 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_477 = " - Droping temp table \" + tableName_";
  protected final String TEXT_478 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_479 = NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_480 = ".execute(\"";
  protected final String TEXT_481 = "\");" + NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_482 = ".close();" + NL + "\t\t";
  protected final String TEXT_483 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_484 = " - Drop temp table \" + tableName_";
  protected final String TEXT_485 = "+ \" has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_486 = NL + "\t\t";
  protected final String TEXT_487 = NL + "\t\treplace_";
  protected final String TEXT_488 = " = \"REPLACE\";" + NL + "\t\t";
  protected final String TEXT_489 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_490 = " - Replacing records in table \" + tableName_";
  protected final String TEXT_491 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_492 = NL + "\t\treplace_";
  protected final String TEXT_493 = " = \"IGNORE\";" + NL + "\t\t";
  protected final String TEXT_494 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_495 = " - Loading data ignore records in table \" + tableName_";
  protected final String TEXT_496 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_497 = NL + "\t\treplace_";
  protected final String TEXT_498 = " = \"\";" + NL + "\t\t";
  protected final String TEXT_499 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_500 = " - Inserting records in table \" + tableName_";
  protected final String TEXT_501 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_502 = NL + "\tString bulkSQL_";
  protected final String TEXT_503 = " = \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_504 = " + \"' \"" + NL + "\t\t+ replace_";
  protected final String TEXT_505 = NL + "\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_506 = NL + "\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_507 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_508 = ")?\"\\\\\":\"\") + enclosed_str_";
  protected final String TEXT_509 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ESCAPED BY '\" + (\"'\".equals(escaped_str_";
  protected final String TEXT_510 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_511 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_512 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_513 = "\"";
  protected final String TEXT_514 = NL + "\t\t+ \" SET\"";
  protected final String TEXT_515 = NL + "\t\t+ \" ";
  protected final String TEXT_516 = "=CAST(@";
  protected final String TEXT_517 = "_";
  protected final String TEXT_518 = " AS UNSIGNED)\"";
  protected final String TEXT_519 = NL + "\t\t+ \",\"";
  protected final String TEXT_520 = ";" + NL + "\t";
  protected final String TEXT_521 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_522 = "=conn_";
  protected final String TEXT_523 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_524 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_525 = ");" + NL + "\t" + NL + "\tstmt_";
  protected final String TEXT_526 = ".execute(bulkSQL_";
  protected final String TEXT_527 = ");" + NL + "\t";
  protected final String TEXT_528 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_529 = " - Replace records in table \" + tableName_";
  protected final String TEXT_530 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_531 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_532 = " - Load data ignore records in table \" + tableName_";
  protected final String TEXT_533 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_534 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_535 = " - Insert records in table \" + tableName_";
  protected final String TEXT_536 = " + \" has finished.\");" + NL + "\t\t";
