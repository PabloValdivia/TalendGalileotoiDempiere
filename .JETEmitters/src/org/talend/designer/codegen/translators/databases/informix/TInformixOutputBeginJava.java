...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_134 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_145 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_146 = "));";
  protected final String TEXT_147 = NL + "                    stmtCreate_";
  protected final String TEXT_148 = ".execute(((\"";
  protected final String TEXT_149 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_161 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_162 = " = conn_";
  protected final String TEXT_163 = ".createStatement();";
  protected final String TEXT_164 = NL + "                              stmtCreate_";
  protected final String TEXT_165 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_166 = "));";
  protected final String TEXT_167 = NL + "                    stmtCreate_";
  protected final String TEXT_168 = ".execute(((\"";
  protected final String TEXT_169 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_170 = ".";
  protected final String TEXT_171 = ", \"";
  protected final String TEXT_172 = "\")";
  protected final String TEXT_173 = ".toUpperCase()";
  ...
  protected final String TEXT_271 = ".close();";
  ...
  protected final String TEXT_311 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_312 = " = ";
  protected final String TEXT_313 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_314 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_315 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_316 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_317 = " =  tableForSearch_";
  protected final String TEXT_318 = ".substring(1,tableForSearch_";
  protected final String TEXT_319 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_320 = " =  tableForSearch_";
  protected final String TEXT_321 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_322 = " = conn_";
  protected final String TEXT_323 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_324 = " = dbMetaData_";
  protected final String TEXT_325 = ".getTables(null, conn_";
  protected final String TEXT_326 = ".getSchema(), tableForSearch_";
  protected final String TEXT_327 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_328 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_329 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_330 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_354 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_355 = ".";
  protected final String TEXT_356 = ", \"";
  protected final String TEXT_357 = "\")";
  protected final String TEXT_358 = ".toUpperCase()";
  ...
  protected final String TEXT_366 = NL + "                                if(whetherExist_";
  protected final String TEXT_367 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_371 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_372 = "));";
  protected final String TEXT_373 = NL + "                                    stmtDrop_";
  protected final String TEXT_374 = ".execute(\"";
  protected final String TEXT_375 = "\" ";
  protected final String TEXT_376 = ");";
  protected final String TEXT_377 = NL + "                                    stmtDrop_";
  protected final String TEXT_378 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_386 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_394 = ".execute(\"";
  protected final String TEXT_395 = ")\");";
  protected final String TEXT_396 = NL + "                                stmtCreate_";
  protected final String TEXT_397 = ".close();";
  protected final String TEXT_398 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_399 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_400 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_410 = ".close();";
  protected final String TEXT_411 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_412 = " = conn_";
  protected final String TEXT_413 = ".createStatement();";
  protected final String TEXT_414 = NL + "                              stmtTruncCount_";
  protected final String TEXT_415 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_416 = "));";
  protected final String TEXT_417 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_418 = " = stmtTruncCount_";
  protected final String TEXT_419 = ".executeQuery(\"";
  protected final String TEXT_420 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_421 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_422 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_423 = " = rsTruncCount_";
  protected final String TEXT_424 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_425 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_426 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_433 = ".commit();";
  protected final String TEXT_434 = NL + "            stmtTrunc_";
  protected final String TEXT_435 = ".executeUpdate(\"";
  protected final String TEXT_436 = "\");";
  protected final String TEXT_437 = NL + "                if(!conn_";
  protected final String TEXT_438 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_439 = ".commit();" + NL + "                }";
  protected final String TEXT_440 = NL + "            deletedCount_";
  protected final String TEXT_441 = " += rsTruncCountNumber_";
  protected final String TEXT_442 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_443 = ".close();";
  protected final String TEXT_444 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_447 = " = stmtTruncCount_";
  protected final String TEXT_448 = ".executeQuery(\"";
  protected final String TEXT_449 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_450 = " = conn_";
  protected final String TEXT_451 = ".createStatement();";
  protected final String TEXT_452 = NL + "                conn_";
  protected final String TEXT_453 = ".commit();";
  protected final String TEXT_454 = NL + "            stmtTrunc_";
  protected final String TEXT_455 = ".executeUpdate(\"";
  protected final String TEXT_456 = "\");";
  protected final String TEXT_457 = NL + "            while(rsTruncCount_";
  protected final String TEXT_458 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_459 = " += rsTruncCount_";
  protected final String TEXT_460 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_461 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_462 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_463 = ".close();";
  ...
  protected final String TEXT_480 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_481 = " = conn_";
  protected final String TEXT_482 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_488 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_495 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_501 = " + \" SET ";
  protected final String TEXT_502 = " WHERE ";
  protected final String TEXT_503 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_504 = " = conn_";
  protected final String TEXT_505 = ".prepareStatement(update_";
  ...
  protected final String TEXT_524 = " = insert_";
  protected final String TEXT_525 = ".split(\"\\\\?\");";
  protected final String TEXT_526 = NL + "\t\t\tupdate_";
  protected final String TEXT_527 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_528 = " = update_";
  protected final String TEXT_529 = ".split(\"\\\\?\");";
  protected final String TEXT_530 = NL + "\t\t\tupdate_";
  protected final String TEXT_531 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_532 = " = update_";
  protected final String TEXT_533 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_534 = " = insert_";
  protected final String TEXT_535 = ".split(\"\\\\?\");";
  protected final String TEXT_536 = NL + "\t\t\tdelete_";
  protected final String TEXT_537 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_538 = " = delete_";
  protected final String TEXT_539 = ".split(\"\\\\?\");";
  protected final String TEXT_540 = NL + "\t\t\treplace_";
  protected final String TEXT_541 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_542 = " = replace_";
  protected final String TEXT_543 = ".split(\"\\\\?\");";
  protected final String TEXT_544 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_545 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_546 = " = insertIgnore_";
  protected final String TEXT_547 = ".split(\"\\\\?\");";
  protected final String TEXT_548 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_549 = " = insert_";
  protected final String TEXT_550 = ".split(\"\\\\?\");";
  protected final String TEXT_551 = NL + NL + "        int commitEvery_";
  protected final String TEXT_552 = " = ";
  protected final String TEXT_553 = ";" + NL + "" + NL + "        int commitCounter_";
  protected final String TEXT_554 = " = 0;" + NL;
  protected final String TEXT_555 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_556 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_557 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_558 = " =null;" + NL + "\t";
  protected final String TEXT_559 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_560 = " = null;" + NL + "\t\t";
  protected final String TEXT_561 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_562 = " = null;";
  protected final String TEXT_563 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_564 = " =  null;";
  protected final String TEXT_565 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_566 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_570 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_571 = " = null;";
  protected final String TEXT_572 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
