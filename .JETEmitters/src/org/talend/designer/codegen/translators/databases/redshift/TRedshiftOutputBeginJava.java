...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_99 = NL + NL + "    java.lang.Class.forName(\"com.amazon.redshift.jdbc41.Driver\");";
  protected final String TEXT_100 = NL + "    ";
  protected final String TEXT_101 = NL + "\t\tString url_";
  protected final String TEXT_102 = " = \"jdbc:redshift://\"+";
  protected final String TEXT_103 = "+\":\"+";
  protected final String TEXT_104 = "+\"/\"+";
  protected final String TEXT_105 = ";" + NL + "\t";
  protected final String TEXT_106 = NL + "\t\tString url_";
  protected final String TEXT_107 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_108 = " + \":\" + ";
  protected final String TEXT_109 = " + \"/\" + ";
  protected final String TEXT_110 = " + \"?\" + ";
  protected final String TEXT_111 = ";" + NL + "\t";
  protected final String TEXT_112 = NL + "    " + NL + "    String dbUser_";
  ...
  protected final String TEXT_127 = ",dbUser_";
  protected final String TEXT_128 = ",dbPwd_";
  protected final String TEXT_129 = ");" + NL + "\t";
  protected final String TEXT_130 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_131 = "\", conn_";
  protected final String TEXT_132 = ");" + NL + "    conn_";
  protected final String TEXT_133 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_134 = NL + "        int commitEvery_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_137 = " = 0;";
  protected final String TEXT_138 = NL + "int count_";
  ...
  protected final String TEXT_145 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_156 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_157 = "));";
  protected final String TEXT_158 = NL + "                    stmtCreate_";
  protected final String TEXT_159 = ".execute(((\"";
  protected final String TEXT_160 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_161 = ".";
  protected final String TEXT_162 = ", \"";
  protected final String TEXT_163 = "\")";
  protected final String TEXT_164 = ".toUpperCase()";
  ...
  protected final String TEXT_171 = ".close();";
  ...
  protected final String TEXT_176 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_193 = NL + "                    String keyCheckTable_";
  protected final String TEXT_194 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_201 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_204 = " + \"]\";";
  protected final String TEXT_205 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_206 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_207 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_234 = ".close();" + NL;
  ...
  protected final String TEXT_322 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_323 = " = ";
  protected final String TEXT_324 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_325 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_326 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_327 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_328 = " =  tableForSearch_";
  protected final String TEXT_329 = ".substring(1,tableForSearch_";
  protected final String TEXT_330 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_331 = " =  tableForSearch_";
  protected final String TEXT_332 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_336 = ".getTables(null, conn_";
  protected final String TEXT_337 = ".getSchema(), tableForSearch_";
  protected final String TEXT_338 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_339 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_340 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_341 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_342 = ".close();";
  protected final String TEXT_343 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_344 = " = conn_";
  protected final String TEXT_345 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_346 = " = dbMetaData_";
  protected final String TEXT_347 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_348 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_349 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_350 = " = rsTable_";
  protected final String TEXT_351 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_352 = ".equalsIgnoreCase(";
  protected final String TEXT_353 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_354 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_355 = ".close();";
  protected final String TEXT_356 = NL + "                                if(!whetherExist_";
  protected final String TEXT_357 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_365 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_366 = ".";
  protected final String TEXT_367 = ", \"";
  protected final String TEXT_368 = "\")";
  protected final String TEXT_369 = ".toUpperCase()";
  protected final String TEXT_370 = ")+\")";
  protected final String TEXT_371 = "\"));";
  protected final String TEXT_372 = NL + "                                        stmtCreate_";
  protected final String TEXT_373 = ".execute(\"";
  protected final String TEXT_374 = ")\");";
  protected final String TEXT_375 = NL + "                                    stmtCreate_";
  protected final String TEXT_376 = ".close();" + NL + "                                }";
  protected final String TEXT_377 = NL + "                                if(whetherExist_";
  protected final String TEXT_378 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_384 = NL + "                                    stmtDrop_";
  protected final String TEXT_385 = ".execute(\"";
  ...
  protected final String TEXT_397 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_408 = ".close();";
  protected final String TEXT_409 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_410 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_411 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_418 = ".executeUpdate(\"";
  protected final String TEXT_419 = "\");";
  protected final String TEXT_420 = NL + "            stmtClear_";
  protected final String TEXT_421 = ".close();";
  protected final String TEXT_422 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_423 = " = conn_";
  protected final String TEXT_424 = ".createStatement();";
  protected final String TEXT_425 = NL + "                              stmtTruncCount_";
  protected final String TEXT_426 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_427 = "));";
  protected final String TEXT_428 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_429 = " = stmtTruncCount_";
  protected final String TEXT_430 = ".executeQuery(\"";
  protected final String TEXT_431 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_432 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_433 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_434 = " = rsTruncCount_";
  protected final String TEXT_435 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_436 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_437 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_438 = " = conn_";
  protected final String TEXT_439 = ".createStatement();";
  protected final String TEXT_440 = NL + "                              stmtTrunc_";
  protected final String TEXT_441 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_442 = "));";
  protected final String TEXT_443 = NL + "                conn_";
  protected final String TEXT_444 = ".commit();";
  protected final String TEXT_445 = NL + "            stmtTrunc_";
  protected final String TEXT_446 = ".executeUpdate(\"";
  protected final String TEXT_447 = "\");";
  protected final String TEXT_448 = NL + "                if(!conn_";
  protected final String TEXT_449 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_450 = ".commit();" + NL + "                }";
  protected final String TEXT_451 = NL + "            deletedCount_";
  protected final String TEXT_452 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_457 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_458 = " = stmtTruncCount_";
  protected final String TEXT_459 = ".executeQuery(\"";
  protected final String TEXT_460 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_461 = " = conn_";
  protected final String TEXT_462 = ".createStatement();";
  protected final String TEXT_463 = NL + "                conn_";
  protected final String TEXT_464 = ".commit();";
  protected final String TEXT_465 = NL + "            stmtTrunc_";
  protected final String TEXT_466 = ".executeUpdate(\"";
  protected final String TEXT_467 = "\");";
  protected final String TEXT_468 = NL + "            while(rsTruncCount_";
  protected final String TEXT_469 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_470 = " += rsTruncCount_";
  protected final String TEXT_471 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_472 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_473 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_477 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_478 = " + \"\\\" (";
  protected final String TEXT_479 = ") VALUES (";
  protected final String TEXT_480 = ")\");";
  protected final String TEXT_481 = NL + "\t\t\tint rowCount";
  protected final String TEXT_482 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_483 = " {";
  protected final String TEXT_484 = NL + "                            ";
  protected final String TEXT_485 = " ";
  protected final String TEXT_486 = ";";
  protected final String TEXT_487 = NL + NL + "\t            public BufferLine_";
  protected final String TEXT_488 = "(";
  protected final String TEXT_489 = NL + "                                ,";
  protected final String TEXT_490 = NL + "                            ";
  protected final String TEXT_491 = " ";
  protected final String TEXT_492 = NL + "\t\t\t\t){";
  protected final String TEXT_493 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_494 = " = ";
  protected final String TEXT_495 = ";";
  protected final String TEXT_496 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_497 = "> exInsertColValueList";
  protected final String TEXT_498 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_499 = " exInsertColValue";
  protected final String TEXT_500 = " = null;" + NL + "" + NL + "" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_501 = " = new StringBuilder();" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_502 = "=0;i_";
  protected final String TEXT_503 = " < ";
  protected final String TEXT_504 = ";i_";
  protected final String TEXT_505 = "++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_506 = ".append(\"(";
  protected final String TEXT_507 = ")\");" + NL + "\t\t\t\t if (i_";
  protected final String TEXT_508 = "!=";
  protected final String TEXT_509 = "-1) extendInsertValueStmt_";
  protected final String TEXT_510 = ".append(\",\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tString insert_";
  ...
  protected final String TEXT_514 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_515 = " =  conn_";
  protected final String TEXT_516 = ".prepareStatement(insert_";
  protected final String TEXT_517 = ");";
  protected final String TEXT_518 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_521 = " + \"\\\" SET ";
  protected final String TEXT_522 = " WHERE ";
  protected final String TEXT_523 = "\");" + NL + "\t    ";
  protected final String TEXT_524 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_525 = " = conn_";
  protected final String TEXT_526 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_530 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_531 = " + \"\\\" (";
  protected final String TEXT_532 = ") VALUES (";
  protected final String TEXT_533 = ")\");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_534 = " = conn_";
  protected final String TEXT_535 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_536 = " + \"\\\" SET ";
  protected final String TEXT_537 = " WHERE ";
  protected final String TEXT_538 = "\");" + NL + "\t    ";
  protected final String TEXT_539 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_540 = " = conn_";
  protected final String TEXT_541 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_542 = " + \"\\\" SET ";
  protected final String TEXT_543 = " WHERE ";
  protected final String TEXT_544 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_545 = " = conn_";
  protected final String TEXT_546 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_547 = " + \"\\\" (";
  protected final String TEXT_548 = ") VALUES (";
  protected final String TEXT_549 = ")\");" + NL + "\t    ";
  protected final String TEXT_550 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_551 = " = conn_";
  protected final String TEXT_552 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_553 = " + \"\\\" WHERE ";
  protected final String TEXT_554 = "\");" + NL + "\t    ";
  protected final String TEXT_555 = NL + "\tclass BufferLine_";
  protected final String TEXT_556 = " {";
  protected final String TEXT_557 = NL + "            ";
  protected final String TEXT_558 = " ";
  protected final String TEXT_559 = ";";
  protected final String TEXT_560 = NL + "\t\t\troutines.system.Dynamic ";
  protected final String TEXT_561 = ";" + NL + "\t\t";
  protected final String TEXT_562 = NL + NL + "\t    public BufferLine_";
  ...
  protected final String TEXT_570 = " routines.system.Dynamic ";
  protected final String TEXT_571 = NL + "\t\t\t";
  protected final String TEXT_572 = NL + "\t    ){" + NL + "\t        ";
  protected final String TEXT_573 = NL + "\t                this.";
  protected final String TEXT_574 = " = ";
  protected final String TEXT_575 = ";" + NL + "\t                ";
  protected final String TEXT_576 = NL + "\t\t\t\t\tthis.";
  protected final String TEXT_577 = "=";
  protected final String TEXT_578 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_579 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_580 = "> exInsertColValueList";
  protected final String TEXT_581 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_582 = " exInsertColValue";
  protected final String TEXT_583 = " = null;" + NL + "    String insert_";
  protected final String TEXT_584 = " = \"\";" + NL + "    int rowCount";
  protected final String TEXT_585 = " = 0;";
  protected final String TEXT_586 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_587 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_588 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
