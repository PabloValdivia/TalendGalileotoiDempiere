...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_163 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_170 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_174 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_175 = "));";
  protected final String TEXT_176 = NL + "                    stmtCreate_";
  protected final String TEXT_177 = ".execute(((\"";
  protected final String TEXT_178 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_190 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_194 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_195 = "));";
  protected final String TEXT_196 = NL + "                    stmtCreate_";
  protected final String TEXT_197 = ".execute(((\"";
  protected final String TEXT_198 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = ", \"";
  protected final String TEXT_201 = "\")";
  protected final String TEXT_202 = ".toUpperCase()";
  ...
  protected final String TEXT_211 = NL + "                    String keyCheckTable_";
  protected final String TEXT_212 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_219 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_222 = " + \"]\";";
  protected final String TEXT_223 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_224 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_225 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_226 = ")== null){//}";
  protected final String TEXT_227 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_228 = " = conn_";
  protected final String TEXT_229 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_230 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_231 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_232 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_233 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_234 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_239 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_240 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_241 = " = tableNameForSearch_";
  protected final String TEXT_242 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_243 = " = tableNameForSearch_";
  protected final String TEXT_244 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_245 = " = dbMetaData_";
  protected final String TEXT_246 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_247 = ", tableNameForSearch_";
  ...
  protected final String TEXT_272 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_283 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_284 = " = rsTable_";
  protected final String TEXT_285 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  ...
  protected final String TEXT_291 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_295 = ") || (dbschema_";
  protected final String TEXT_296 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_297 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_298 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_299 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_300 = ".close();";
  protected final String TEXT_301 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_302 = " = conn_";
  protected final String TEXT_303 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_304 = " = dbMetaData_";
  protected final String TEXT_305 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_306 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_307 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_308 = " == null || dbschema_";
  protected final String TEXT_309 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_310 = " = conn_";
  protected final String TEXT_311 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_312 = " = stmtSchema_";
  protected final String TEXT_313 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_314 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_315 = " = rsSchema_";
  protected final String TEXT_316 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_317 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_318 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_319 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_320 = " = rsTable_";
  protected final String TEXT_321 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_322 = " = rsTable_";
  protected final String TEXT_323 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_324 = ".equals";
  protected final String TEXT_325 = "IgnoreCase";
  protected final String TEXT_326 = "(";
  protected final String TEXT_327 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_328 = ".equals";
  protected final String TEXT_329 = "IgnoreCase";
  protected final String TEXT_330 = "(dbschema_";
  protected final String TEXT_331 = ") || ((dbschema_";
  protected final String TEXT_332 = " ==null || dbschema_";
  protected final String TEXT_333 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_334 = ".equals";
  protected final String TEXT_335 = "IgnoreCase";
  protected final String TEXT_336 = "(schema_";
  protected final String TEXT_337 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_338 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_339 = ".close();";
  protected final String TEXT_340 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_341 = " = ";
  protected final String TEXT_342 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_343 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_344 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_345 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_346 = " =  tableForSearch_";
  protected final String TEXT_347 = ".substring(1,tableForSearch_";
  protected final String TEXT_348 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_349 = " =  tableForSearch_";
  protected final String TEXT_350 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_354 = ".getTables(null, conn_";
  protected final String TEXT_355 = ".getSchema(), tableForSearch_";
  ...
  protected final String TEXT_498 = NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_503 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_504 = " = null;" + NL + "\t\tString keyPsmt_";
  protected final String TEXT_505 = " = conn_";
  protected final String TEXT_506 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_507 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_508 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_509 = ",insert_";
  protected final String TEXT_510 = ",keyPsmt_";
  ...
  protected final String TEXT_528 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_535 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_536 = " = conn_";
  protected final String TEXT_537 = ".prepareStatement(update_";
  ...
  protected final String TEXT_543 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_544 = " = conn_";
  protected final String TEXT_545 = ".prepareStatement(update_";
  ...
  protected final String TEXT_550 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_551 = " = conn_";
  protected final String TEXT_552 = ".prepareStatement(insert_";
  protected final String TEXT_553 = ");";
  protected final String TEXT_554 = NL + "        String delete_";
  protected final String TEXT_555 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_556 = " + \"] WHERE ";
  protected final String TEXT_557 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_558 = " = conn_";
  protected final String TEXT_559 = ".prepareStatement(delete_";
  protected final String TEXT_560 = ");";
  protected final String TEXT_561 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_562 = " = conn_";
  protected final String TEXT_563 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_569 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_570 = " = conn_";
  protected final String TEXT_571 = ".prepareStatement(insert_";
  protected final String TEXT_572 = ");";
  protected final String TEXT_573 = NL + NL + "    class BufferLine_";
  protected final String TEXT_574 = " {";
  protected final String TEXT_575 = NL + "                ";
  protected final String TEXT_576 = " ";
  protected final String TEXT_577 = ";";
  protected final String TEXT_578 = NL + NL + "        public BufferLine_";
  ...
  protected final String TEXT_587 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_588 = "> sInsertColValueList";
  protected final String TEXT_589 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_590 = " sInsertColValue";
  protected final String TEXT_591 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_592 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_593 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_594 = ".append(\"(";
  protected final String TEXT_595 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_596 = "-1) extendInsertValueStmt_";
  protected final String TEXT_597 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_598 = " = \"INSERT INTO \"+";
  protected final String TEXT_599 = "+\" (";
  protected final String TEXT_600 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_601 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_602 = " =  conn_";
  protected final String TEXT_603 = ".prepareStatement(insert_";
  protected final String TEXT_604 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_605 = " = \"";
  protected final String TEXT_606 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_607 = " =  \"";
  protected final String TEXT_608 = "\";" + NL + "    int rowCount";
  protected final String TEXT_609 = " = 0;";
  protected final String TEXT_610 = NL + "        StringBuffer query_";
  protected final String TEXT_611 = " = null;" + NL + "       \t";
  protected final String TEXT_612 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_634 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_635 = " = insertIgnore_";
  protected final String TEXT_636 = ".split(\"\\\\?\");";
  protected final String TEXT_637 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_638 = " = insert_";
  protected final String TEXT_639 = ".split(\"\\\\?\");";
  protected final String TEXT_640 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_641 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_642 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_643 = "\") == true;";
  protected final String TEXT_644 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_645 = " = conn_";
  protected final String TEXT_646 = ".createStatement();";
  protected final String TEXT_647 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_648 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_649 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_650 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_651 = NL + "     \t\tstmt_";
  protected final String TEXT_652 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_653 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_654 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_655 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_656 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_657 = " =null;" + NL + "\t";
  protected final String TEXT_658 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_659 = " = null;" + NL + "\t\t";
  protected final String TEXT_660 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_661 = " = null;";
  protected final String TEXT_662 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_663 = " =  null;";
  protected final String TEXT_664 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_665 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_666 = " = null;";
  protected final String TEXT_667 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_668 = " = null;";
  protected final String TEXT_669 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_670 = " = null;";
  protected final String TEXT_671 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_672 = " = null;";
  protected final String TEXT_673 = NL + "\t\t \tString[] insertSQLSplits_";
