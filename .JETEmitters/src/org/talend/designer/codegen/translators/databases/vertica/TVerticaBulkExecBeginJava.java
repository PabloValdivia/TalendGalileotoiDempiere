...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_267 = NL + "            \tString tableForSearch_";
  protected final String TEXT_268 = " = ";
  protected final String TEXT_269 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_270 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_271 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_272 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_273 = " =  tableForSearch_";
  protected final String TEXT_274 = ".substring(1,tableForSearch_";
  protected final String TEXT_275 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_276 = " =  tableForSearch_";
  protected final String TEXT_277 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_281 = ".getTables(null, conn_";
  protected final String TEXT_282 = ".getSchema(), tableForSearch_";
  protected final String TEXT_283 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_284 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_285 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_286 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_296 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_304 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_305 = " = conn_";
  protected final String TEXT_306 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_308 = " - Creating table ";
  protected final String TEXT_309 = "\" + tableName_";
  ...
  protected final String TEXT_316 = " - Create table ";
  protected final String TEXT_317 = "\" + tableName_";
  protected final String TEXT_318 = " + \"";
  protected final String TEXT_319 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_320 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_321 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_323 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_340 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_344 = " - Creating table ";
  protected final String TEXT_345 = "\" + tableName_";
  ...
  protected final String TEXT_352 = " - Create table ";
  protected final String TEXT_353 = "\" + tableName_";
  protected final String TEXT_354 = " + \"";
  protected final String TEXT_355 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_357 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_358 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_381 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_385 = " - Trancating table ";
  protected final String TEXT_386 = "\" + tableName_";
  ...
  protected final String TEXT_393 = " - Truncate table ";
  protected final String TEXT_394 = "\" + tableName_";
  protected final String TEXT_395 = " + \"";
  protected final String TEXT_396 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_404 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_405 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_406 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_407 = NL + "try{";
  protected final String TEXT_408 = NL + "        int keyCount_";
  protected final String TEXT_409 = " = ";
  protected final String TEXT_410 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_411 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tableName_";
  protected final String TEXT_412 = " = \"tmp_";
  protected final String TEXT_413 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_414 = " != null && dbschema_";
  protected final String TEXT_415 = ".trim().length() != 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_416 = " = dbschema_";
  protected final String TEXT_417 = " + \".\" + tableName_";
  protected final String TEXT_418 = ";" + NL + "\t\t}" + NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_433 = " has succeeded.\");";
  protected final String TEXT_434 = NL + "        stmtCreateTmp_";
  protected final String TEXT_435 = ".close();";
  protected final String TEXT_436 = NL + "\t\tCharacter OUT_DELIM_";
  protected final String TEXT_437 = " = ";
  protected final String TEXT_438 = ".charAt(0);" + NL + "\t\t";
  protected final String TEXT_439 = NL + "\t\tString escapechar_";
  protected final String TEXT_440 = " = ";
  protected final String TEXT_441 = ";" + NL + "\t\tif(!escapechar_";
  protected final String TEXT_442 = ".isEmpty()){" + NL + "\t\t\tescapechar_";
  protected final String TEXT_443 = " = \"\" + escapechar_";
  protected final String TEXT_444 = ".charAt(0);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_445 = NL + "\t\tString sql_";
  protected final String TEXT_446 = " = \"COPY \" + tableName_";
  protected final String TEXT_447 = " " + NL + "\t\t";
  protected final String TEXT_448 = NL + "\t\t\t+ \"";
  protected final String TEXT_449 = "\"" + NL + "\t\t";
  protected final String TEXT_450 = "\t\t" + NL + "\t\t+ \" FROM STDIN DELIMITER '\" +OUT_DELIM_";
  protected final String TEXT_451 = " + \"'\" " + NL + "\t\t";
  protected final String TEXT_452 = NL + "\t\t+ \"ESCAPE AS '\" + escapechar_";
  protected final String TEXT_453 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_454 = NL + "\t\t+\" NO ESCAPE\"" + NL + "\t\t";
  protected final String TEXT_455 = NL + "\t    ";
  protected final String TEXT_456 = " + \" NULL '\"  + ";
  protected final String TEXT_457 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_458 = NL + "\t\t";
  protected final String TEXT_459 = " + \" DIRECT\"";
  protected final String TEXT_460 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_461 = NL + "\t\t\t+ \" REJECTED DATA '\" + ";
  protected final String TEXT_462 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_463 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_464 = NL + "\t\t\t+ \" EXCEPTIONS '\" + ";
  protected final String TEXT_465 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_466 = NL + "\t\t;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_467 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_468 = " - Bulk SQL:\"+sql_";
  protected final String TEXT_469 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_470 = " - Bulk inserting data into ";
  protected final String TEXT_471 = "\" + tableName_";
  protected final String TEXT_472 = " + \"";
  protected final String TEXT_473 = ".\" );";
  protected final String TEXT_474 = NL + "    \tfis_";
  protected final String TEXT_475 = " = new java.io.FileInputStream(new java.io.File(";
  protected final String TEXT_476 = "));";
  protected final String TEXT_477 = NL + "\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_478 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_479 = ",sql_";
  protected final String TEXT_480 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_481 = ".start();" + NL + "\t\tvcs_";
  protected final String TEXT_482 = ".addStream(fis_";
  protected final String TEXT_483 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_484 = ".execute();" + NL + "\t\tvcs_";
  protected final String TEXT_485 = ".finish();" + NL + "\t\t";
  protected final String TEXT_486 = NL + "            log.info(\"";
  protected final String TEXT_487 = " - Bulk insert data into ";
  protected final String TEXT_488 = "\" + tableName_";
  protected final String TEXT_489 = " + \"";
  protected final String TEXT_490 = " has finished.\");";
  protected final String TEXT_491 = NL + "\t\tlong copyNumber_";
  protected final String TEXT_492 = " = vcs_";
  protected final String TEXT_493 = ".getRowCount();" + NL + "\t\t" + NL + "\t\t//get rejected and accepted row number" + NL + "\t\tjava.sql.Statement stmt_accept_reject_";
  protected final String TEXT_494 = " = conn_";
  protected final String TEXT_495 = ".createStatement();" + NL + "\t\t" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_496 = " = stmt_accept_reject_";
  protected final String TEXT_497 = ".executeQuery(\"select get_num_accepted_rows()\");" + NL + "\t    int accetpedRowNumber_";
  protected final String TEXT_498 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_499 = ".next()) {" + NL + "\t    \taccetpedRowNumber_";
  protected final String TEXT_500 = " = rs_";
  protected final String TEXT_501 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t    rs_";
  protected final String TEXT_502 = " = stmt_accept_reject_";
  protected final String TEXT_503 = ".executeQuery(\"select get_num_rejected_rows()\");" + NL + "\t    int rejectedRowNumber_";
  protected final String TEXT_504 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_505 = ".next()) {" + NL + "\t    \trejectedRowNumber_";
  protected final String TEXT_506 = " = rs_";
  protected final String TEXT_507 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tstmt_accept_reject_";
  protected final String TEXT_508 = ".close();" + NL + "\t\t" + NL + "\t\tif(";
  protected final String TEXT_509 = " && copyNumber_";
  protected final String TEXT_510 = " <= 0){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted into component ";
  protected final String TEXT_511 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_512 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_513 = " - Number of records inserted into table ";
  protected final String TEXT_514 = "\" + tableName_";
  protected final String TEXT_515 = " + \"";
  protected final String TEXT_516 = " by ";
  protected final String TEXT_517 = ": \" + (copyNumber_";
  protected final String TEXT_518 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_519 = NL + "\t\t\tSystem.out.println(\"Number of records inserted into table ";
  protected final String TEXT_520 = "\" + tableName_";
  protected final String TEXT_521 = " + \"";
  protected final String TEXT_522 = " by ";
  protected final String TEXT_523 = ": \" + (copyNumber_";
  protected final String TEXT_524 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_525 = "_ACCEPTED_ROW_NUMBER\",accetpedRowNumber_";
  protected final String TEXT_526 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_527 = "_REJECTED_ROW_NUMBER\",rejectedRowNumber_";
  protected final String TEXT_528 = ");";
  protected final String TEXT_529 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_530 = " = conn_";
  protected final String TEXT_531 = ".createStatement();" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_532 = " = stmt_";
  protected final String TEXT_533 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_534 = ");" + NL + "\t    int nbLineBeforeLoad_";
  protected final String TEXT_535 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_536 = ".next()) {" + NL + "\t    \tnbLineBeforeLoad_";
  protected final String TEXT_537 = " = rs_";
  protected final String TEXT_538 = ".getInt(1);" + NL + "\t\t}" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_539 = ").startCopyIn(sql_";
  protected final String TEXT_540 = ", fis_";
  protected final String TEXT_541 = ");" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_542 = ").addStreamToCopyIn(fis_";
  protected final String TEXT_543 = ");" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_544 = ").finishCopyIn();" + NL + "\t    ";
  protected final String TEXT_545 = NL + "            log.info(\"";
  protected final String TEXT_546 = " - Bulk insert data into ";
  protected final String TEXT_547 = "\" + tableName_";
  protected final String TEXT_548 = " + \"";
  protected final String TEXT_549 = " has finished.\");";
  protected final String TEXT_550 = NL + "\t\trs_";
  protected final String TEXT_551 = " = stmt_";
  protected final String TEXT_552 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_553 = ");" + NL + "\t    int nbLineAfterLoad_";
  protected final String TEXT_554 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_555 = ".next()) {" + NL + "\t    \tnbLineAfterLoad_";
  protected final String TEXT_556 = " = rs_";
  protected final String TEXT_557 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\tstmt_";
  protected final String TEXT_558 = ".close();" + NL + "\t\tif(";
  protected final String TEXT_559 = " && nbLineBeforeLoad_";
  protected final String TEXT_560 = " >= nbLineAfterLoad_";
  protected final String TEXT_561 = "){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted in component ";
  protected final String TEXT_562 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_563 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_564 = " - Number of records inserted to table ";
  protected final String TEXT_565 = "\" + tableName_";
  protected final String TEXT_566 = " + \"";
  protected final String TEXT_567 = " by ";
  protected final String TEXT_568 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_569 = " - nbLineBeforeLoad_";
  protected final String TEXT_570 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_571 = NL + "\t\t\tSystem.out.println(\"Number of records inserted to table ";
  protected final String TEXT_572 = "\" + tableName_";
  protected final String TEXT_573 = " + \"";
  protected final String TEXT_574 = " by ";
  protected final String TEXT_575 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_576 = " - nbLineBeforeLoad_";
  protected final String TEXT_577 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_578 = "_ACCEPTED_ROW_NUMBER\",nbLineAfterLoad_";
  protected final String TEXT_579 = " - nbLineBeforeLoad_";
  protected final String TEXT_580 = ");";
  protected final String TEXT_581 = NL + "        String tmpTableName_";
  protected final String TEXT_582 = " = \"tmp_";
  protected final String TEXT_583 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_584 = " == null || dbschema_";
  protected final String TEXT_585 = ".trim().length() == 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_586 = " = ";
  protected final String TEXT_587 = ";" + NL + "\t\t} else {" + NL + "\t    \ttableName_";
  protected final String TEXT_588 = " = dbschema_";
  protected final String TEXT_589 = " + \".\" + ";
  protected final String TEXT_590 = ";" + NL + "\t    \ttmpTableName_";
  protected final String TEXT_591 = "=dbschema_";
  protected final String TEXT_592 = " + \".\" + tmpTableName_";
  protected final String TEXT_593 = ";" + NL + "\t\t}" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_594 = " = conn_";
  protected final String TEXT_595 = ".createStatement();" + NL + "\t";
  protected final String TEXT_596 = NL + "\t\tlog.info(\"";
  protected final String TEXT_597 = " - Updating ";
  protected final String TEXT_598 = "\" + tableName_";
  protected final String TEXT_599 = " + \"";
  protected final String TEXT_600 = " from ";
  protected final String TEXT_601 = "\"+tmpTableName_";
  protected final String TEXT_602 = "+\"";
  protected final String TEXT_603 = ".\");" + NL + "\t";
  protected final String TEXT_604 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_605 = ".executeUpdate(\"";
  protected final String TEXT_606 = "\");" + NL + "\t";
  protected final String TEXT_607 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_608 = ".close();" + NL + "        tableName_";
  protected final String TEXT_609 = " = tmpTableName_";
  protected final String TEXT_610 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_611 = " = conn_";
  protected final String TEXT_612 = ".createStatement();" + NL + "\t";
  protected final String TEXT_613 = NL + "\t\tlog.info(\"";
  protected final String TEXT_614 = " - Droping temp table ";
  protected final String TEXT_615 = "\" + tableName_";
  protected final String TEXT_616 = " + \"";
  protected final String TEXT_617 = ".\");" + NL + "\t";
  protected final String TEXT_618 = NL + "        stmtTmpDrop_";
  protected final String TEXT_619 = ".execute(\"";
  protected final String TEXT_620 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_621 = ".close();        " + NL + "\t";
  protected final String TEXT_622 = NL + "\t\tlog.info(\"";
  protected final String TEXT_623 = " - Drop temp table ";
  protected final String TEXT_624 = "\" + tableName_";
  protected final String TEXT_625 = "+ \"";
  protected final String TEXT_626 = " has succeeded.\");" + NL + "\t";
  protected final String TEXT_627 = NL + "}finally{" + NL + "\tif(fis_";
  protected final String TEXT_628 = "!=null)" + NL + "\t\tfis_";
  protected final String TEXT_629 = ".close();";
  protected final String TEXT_630 = NL + "}" + NL + NL + NL + NL + NL + NL + NL;
