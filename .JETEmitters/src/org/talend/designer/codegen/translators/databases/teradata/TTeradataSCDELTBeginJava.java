...
public class TTeradataSCDELTBeginJava {
  protected static String nl;
  public static synchronized TTeradataSCDELTBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataSCDELTBeginJava result = new TTeradataSCDELTBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_43 = NL + "    String dbUser_";
  protected final String TEXT_44 = " = ";
  protected final String TEXT_45 = ";" + NL + "    String dbschema_";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = ";" + NL + "    String tableName_";
  protected final String TEXT_48 = " = ";
  protected final String TEXT_49 = ";" + NL + "    String sourceTable_";
  protected final String TEXT_50 = " = dbschema_";
  protected final String TEXT_51 = " + \".\" + ";
  protected final String TEXT_52 = ";";
  protected final String TEXT_53 = NL + "        java.sql.Connection conn_";
  protected final String TEXT_54 = " = (java.sql.Connection) globalMap.get(\"";
  protected final String TEXT_55 = "\");";
  protected final String TEXT_56 = NL + "        java.lang.Class.forName(\"com.teradata.jdbc.TeraDriver\");";
  protected final String TEXT_57 = NL + "        String url_";
  protected final String TEXT_58 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_59 = " + \"/DATABASE=\" + ";
  protected final String TEXT_60 = ";";
  protected final String TEXT_61 = NL + "        String url_";
  protected final String TEXT_62 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_63 = " + \"/DATABASE=\" + ";
  ...
  protected final String TEXT_72 = NL + "        String dbPwd_";
  protected final String TEXT_73 = " = decryptedPassword_";
  protected final String TEXT_74 = ";" + NL + "" + NL + "        java.sql.Connection conn_";
  ...
  protected final String TEXT_80 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_81 = " = conn_";
  protected final String TEXT_82 = ".createStatement();";
  protected final String TEXT_83 = NL + "                              stmtDrop_";
  protected final String TEXT_84 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_85 = ")));";
  protected final String TEXT_86 = NL + "            stmtDrop_";
  ...
  protected final String TEXT_115 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_116 = "));";
  protected final String TEXT_117 = NL + "                    stmtCreate_";
  protected final String TEXT_118 = ".execute(((\"";
  protected final String TEXT_119 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_120 = ".";
  protected final String TEXT_121 = ", \"";
  protected final String TEXT_122 = "\")";
  protected final String TEXT_123 = ".toUpperCase()";
  ...
  protected final String TEXT_132 = NL + "                    String keyCheckTable_";
  protected final String TEXT_133 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_134 = "+\"][\"+";
  protected final String TEXT_135 = "+\"][\"+";
  protected final String TEXT_136 = "+\"][\"+";
  protected final String TEXT_137 = "+\"][\"+";
  protected final String TEXT_138 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_139 = " + \"]\";";
  protected final String TEXT_140 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_143 = " + \"]\";";
  protected final String TEXT_144 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_145 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_146 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_147 = ")== null){//}";
  protected final String TEXT_148 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_149 = " = conn_";
  protected final String TEXT_150 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_151 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_152 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_153 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_154 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_155 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  protected final String TEXT_156 = ".close();";
  protected final String TEXT_157 = NL + "                                ";
  protected final String TEXT_158 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_161 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_162 = " = tableNameForSearch_";
  protected final String TEXT_163 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_164 = " = tableNameForSearch_";
  protected final String TEXT_165 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_166 = " = dbMetaData_";
  protected final String TEXT_167 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_168 = ", tableNameForSearch_";
  protected final String TEXT_169 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_170 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_171 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_172 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_176 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_177 = " = dbMetaData_";
  protected final String TEXT_178 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_193 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  protected final String TEXT_194 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_198 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_199 = " = dbMetaData_";
  protected final String TEXT_200 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_201 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_217 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_218 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_224 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_225 = " = dbMetaData_";
  protected final String TEXT_226 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_227 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_228 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_229 = " == null || dbschema_";
  protected final String TEXT_230 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_233 = " = stmtSchema_";
  protected final String TEXT_234 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_235 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_236 = " = rsSchema_";
  protected final String TEXT_237 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_238 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_239 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_240 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_241 = " = rsTable_";
  protected final String TEXT_242 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_243 = " = rsTable_";
  protected final String TEXT_244 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_245 = ".equals";
  protected final String TEXT_246 = "IgnoreCase";
  protected final String TEXT_247 = "(";
  protected final String TEXT_248 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_253 = " ==null || dbschema_";
  protected final String TEXT_254 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_255 = ".equals";
  protected final String TEXT_256 = "IgnoreCase";
  protected final String TEXT_257 = "(schema_";
  ...
  protected final String TEXT_261 = NL + "\t\t\t\t            \tString tableForSearch_";
  ...
  protected final String TEXT_270 = " =  tableForSearch_";
  protected final String TEXT_271 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_275 = ".getTables(null, conn_";
  protected final String TEXT_276 = ".getSchema(), tableForSearch_";
  protected final String TEXT_277 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_278 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_279 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_280 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_281 = ".close();";
  protected final String TEXT_282 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_283 = " = conn_";
  protected final String TEXT_284 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_285 = " = dbMetaData_";
  protected final String TEXT_286 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_287 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_288 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_289 = " = rsTable_";
  protected final String TEXT_290 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_291 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_296 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_317 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_327 = NL + "                                    stmtDrop_";
  protected final String TEXT_328 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_348 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_349 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_350 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_351 = " = conn_";
  protected final String TEXT_352 = ".createStatement();";
  protected final String TEXT_353 = NL + "                              stmtClear_";
  protected final String TEXT_354 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_355 = "));";
  protected final String TEXT_356 = NL + "            stmtClear_";
  protected final String TEXT_357 = ".executeUpdate(\"";
  protected final String TEXT_358 = "\");";
  protected final String TEXT_359 = NL + "            stmtClear_";
  ...
  protected final String TEXT_364 = NL + "                              stmtTruncCount_";
  protected final String TEXT_365 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_366 = "));";
  protected final String TEXT_367 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_387 = NL + "                if(!conn_";
  protected final String TEXT_388 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_389 = ".commit();" + NL + "                }";
  protected final String TEXT_390 = NL + "            deletedCount_";
  protected final String TEXT_391 = " += rsTruncCountNumber_";
  protected final String TEXT_392 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_393 = ".close();";
  protected final String TEXT_394 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_395 = " = conn_";
  protected final String TEXT_396 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_397 = " = stmtTruncCount_";
  protected final String TEXT_398 = ".executeQuery(\"";
  protected final String TEXT_399 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_403 = ".commit();";
  ...
  protected final String TEXT_415 = NL + "        String updateForType1_";
  protected final String TEXT_416 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_417 = " +\" FROM \"+ sourceTable_";
  protected final String TEXT_418 = " + \" t SET ";
  protected final String TEXT_419 = " WHERE ";
  protected final String TEXT_420 = " AND (";
  protected final String TEXT_421 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_422 = " = conn_";
  protected final String TEXT_423 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_424 = ".executeUpdate(updateForType1_";
  protected final String TEXT_425 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_426 = ".close();";
  protected final String TEXT_427 = NL + "        String updateForType2_";
  protected final String TEXT_428 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_429 = NL + "                                        + \" FROM \" + sourceTable_";
  protected final String TEXT_430 = " + \" t\"" + NL + "                                        + \" SET ";
  protected final String TEXT_431 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_432 = "\")))" + NL + "                                        + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')";
  protected final String TEXT_433 = ", ";
  protected final String TEXT_434 = " = 0";
  protected final String TEXT_435 = " \"" + NL + "                                        + \" WHERE ";
  protected final String TEXT_436 = " AND (";
  protected final String TEXT_437 = ") AND \" + tableName_";
  protected final String TEXT_438 = " + \".";
  protected final String TEXT_439 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_440 = " = conn_";
  protected final String TEXT_441 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_442 = ".executeUpdate(updateForType2_";
  protected final String TEXT_443 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_444 = ".close();";
  protected final String TEXT_445 = NL + "        String insertForType2_";
  protected final String TEXT_446 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_447 = " + \"(";
  protected final String TEXT_448 = ", ";
  protected final String TEXT_449 = ") SELECT ";
  protected final String TEXT_450 = "\" + ";
  protected final String TEXT_451 = " + \".NEXTVAL, ";
  protected final String TEXT_452 = "t.";
  protected final String TEXT_453 = ", cast('\" +" + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_454 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL";
  protected final String TEXT_455 = ", 1";
  protected final String TEXT_456 = ", d.";
  protected final String TEXT_457 = " + 1";
  protected final String TEXT_458 = " FROM \" +" + NL + "        sourceTable_";
  protected final String TEXT_459 = " + \" t, \" + tableName_";
  protected final String TEXT_460 = " + \" d WHERE ";
  protected final String TEXT_461 = " AND (";
  protected final String TEXT_462 = ") AND d.";
  protected final String TEXT_463 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_464 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_465 = " = conn_";
  protected final String TEXT_466 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_467 = ".executeUpdate(insertForType2_";
  protected final String TEXT_468 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_469 = ".close();";
  protected final String TEXT_470 = NL + "    String insert_";
  protected final String TEXT_471 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_472 = " + \"(";
  protected final String TEXT_473 = ", ";
  protected final String TEXT_474 = ") SELECT ";
  protected final String TEXT_475 = "\" + ";
  protected final String TEXT_476 = " + \".NEXTVAL, ";
  protected final String TEXT_477 = "t.";
  protected final String TEXT_478 = "\"";
  protected final String TEXT_479 = " + \", cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_480 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL\"";
  protected final String TEXT_481 = NL + "    + \"";
  protected final String TEXT_482 = ", 1";
  protected final String TEXT_483 = ", 1";
  protected final String TEXT_484 = " FROM \" +" + NL + "    sourceTable_";
  protected final String TEXT_485 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_486 = " + \" d ON ";
  protected final String TEXT_487 = " WHERE (";
  protected final String TEXT_488 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_489 = " = conn_";
  protected final String TEXT_490 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_491 = ".executeUpdate(insert_";
  protected final String TEXT_492 = ");" + NL + "    stmtInsert_";
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    if(scdType2Enabled && isEnableActive) {
    stringBuffer.append(TEXT_482);
    }
    if(scdType2Enabled && isEnableVersion) {
