...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_158 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_165 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_185 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".createStatement();";
  protected final String TEXT_188 = NL + "                              stmtCreate_";
  protected final String TEXT_189 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_190 = "));";
  protected final String TEXT_191 = NL + "                    stmtCreate_";
  protected final String TEXT_192 = ".execute(((\"";
  protected final String TEXT_193 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_194 = ".";
  protected final String TEXT_195 = ", \"";
  protected final String TEXT_196 = "\")";
  protected final String TEXT_197 = ".toUpperCase()";
  ...
  protected final String TEXT_206 = NL + "                    String keyCheckTable_";
  protected final String TEXT_207 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_214 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_217 = " + \"]\";";
  protected final String TEXT_218 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_219 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_220 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_221 = ")== null){//}";
  protected final String TEXT_222 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_225 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_226 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_227 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_228 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_229 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_234 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_235 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_236 = " = tableNameForSearch_";
  protected final String TEXT_237 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_238 = " = tableNameForSearch_";
  protected final String TEXT_239 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_240 = " = dbMetaData_";
  protected final String TEXT_241 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_242 = ", tableNameForSearch_";
  protected final String TEXT_243 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_244 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_245 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_246 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_247 = ".close();" + NL;
  protected final String TEXT_248 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_249 = " = conn_";
  protected final String TEXT_250 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_251 = " = dbMetaData_";
  protected final String TEXT_252 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_253 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_267 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  protected final String TEXT_268 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_269 = ".close();";
  protected final String TEXT_270 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_271 = " = conn_";
  protected final String TEXT_272 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_273 = " = dbMetaData_";
  protected final String TEXT_274 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_278 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_279 = " = rsTable_";
  protected final String TEXT_280 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_281 = ".equals";
  protected final String TEXT_282 = "IgnoreCase";
  protected final String TEXT_283 = "((";
  protected final String TEXT_284 = ")";
  protected final String TEXT_285 = ".toUpperCase()";
  protected final String TEXT_286 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_291 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_292 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_301 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_302 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_303 = " == null || dbschema_";
  protected final String TEXT_304 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_305 = " = conn_";
  protected final String TEXT_306 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_307 = " = stmtSchema_";
  protected final String TEXT_308 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_309 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_310 = " = rsSchema_";
  protected final String TEXT_311 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_312 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_313 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_314 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_315 = " = rsTable_";
  protected final String TEXT_316 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_317 = " = rsTable_";
  protected final String TEXT_318 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_319 = ".equals";
  protected final String TEXT_320 = "IgnoreCase";
  protected final String TEXT_321 = "(";
  protected final String TEXT_322 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_323 = ".equals";
  protected final String TEXT_324 = "IgnoreCase";
  protected final String TEXT_325 = "(dbschema_";
  protected final String TEXT_326 = ") || ((dbschema_";
  protected final String TEXT_327 = " ==null || dbschema_";
  protected final String TEXT_328 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_329 = ".equals";
  protected final String TEXT_330 = "IgnoreCase";
  protected final String TEXT_331 = "(schema_";
  ...
  protected final String TEXT_335 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_336 = " = ";
  protected final String TEXT_337 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_338 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_339 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_340 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_341 = " =  tableForSearch_";
  protected final String TEXT_342 = ".substring(1,tableForSearch_";
  protected final String TEXT_343 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_344 = " =  tableForSearch_";
  protected final String TEXT_345 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_349 = ".getTables(null, conn_";
  protected final String TEXT_350 = ".getSchema(), tableForSearch_";
  protected final String TEXT_351 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_352 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_353 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_354 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_355 = ".close();";
  protected final String TEXT_356 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_357 = " = conn_";
  protected final String TEXT_358 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_359 = " = dbMetaData_";
  protected final String TEXT_360 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_361 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_362 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_363 = " = rsTable_";
  protected final String TEXT_364 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_365 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_372 = ".createStatement();";
  protected final String TEXT_373 = NL + "                                                      stmtCreate_";
  protected final String TEXT_374 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_390 = NL + "                                if(whetherExist_";
  protected final String TEXT_391 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_392 = " = conn_";
  protected final String TEXT_393 = ".createStatement();";
  protected final String TEXT_394 = NL + "                                                      stmtDrop_";
  protected final String TEXT_395 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_396 = "));";
  protected final String TEXT_397 = NL + "                                    stmtDrop_";
  protected final String TEXT_398 = ".execute(\"";
  protected final String TEXT_399 = "\" ";
  protected final String TEXT_400 = ");";
  protected final String TEXT_401 = NL + "                                    stmtDrop_";
  protected final String TEXT_402 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_422 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_423 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_424 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_425 = " = conn_";
  protected final String TEXT_426 = ".createStatement();";
  protected final String TEXT_427 = NL + "                              stmtClear_";
  protected final String TEXT_428 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_429 = "));";
  protected final String TEXT_430 = NL + "            stmtClear_";
  protected final String TEXT_431 = ".executeUpdate(\"";
  ...
  protected final String TEXT_438 = NL + "                              stmtTruncCount_";
  protected final String TEXT_439 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_440 = "));";
  protected final String TEXT_441 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_442 = " = stmtTruncCount_";
  protected final String TEXT_443 = ".executeQuery(\"";
  protected final String TEXT_444 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_445 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_446 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_447 = " = rsTruncCount_";
  protected final String TEXT_448 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_449 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_450 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_451 = " = conn_";
  protected final String TEXT_452 = ".createStatement();";
  protected final String TEXT_453 = NL + "                              stmtTrunc_";
  protected final String TEXT_454 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_455 = "));";
  protected final String TEXT_456 = NL + "                conn_";
  protected final String TEXT_457 = ".commit();";
  protected final String TEXT_458 = NL + "            stmtTrunc_";
  protected final String TEXT_459 = ".executeUpdate(\"";
  protected final String TEXT_460 = "\");";
  protected final String TEXT_461 = NL + "                if(!conn_";
  protected final String TEXT_462 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_463 = ".commit();" + NL + "                }";
  protected final String TEXT_464 = NL + "            deletedCount_";
  protected final String TEXT_465 = " += rsTruncCountNumber_";
  protected final String TEXT_466 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_467 = ".close();";
  protected final String TEXT_468 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_469 = " = conn_";
  protected final String TEXT_470 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_471 = " = stmtTruncCount_";
  protected final String TEXT_472 = ".executeQuery(\"";
  protected final String TEXT_473 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_474 = " = conn_";
  protected final String TEXT_475 = ".createStatement();";
  protected final String TEXT_476 = NL + "                conn_";
  protected final String TEXT_477 = ".commit();";
  protected final String TEXT_478 = NL + "            stmtTrunc_";
  protected final String TEXT_479 = ".executeUpdate(\"";
  protected final String TEXT_480 = "\");";
  protected final String TEXT_481 = NL + "            while(rsTruncCount_";
  protected final String TEXT_482 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_483 = " += rsTruncCount_";
  protected final String TEXT_484 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_485 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_486 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_487 = ".close();";
  protected final String TEXT_488 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_489 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_490 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_491 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_492 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_493 = ".append (\"`\" +  ";
  protected final String TEXT_494 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_495 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_500 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_501 = " + \"` (";
  protected final String TEXT_502 = ") VALUES (";
  protected final String TEXT_503 = ")\";";
  protected final String TEXT_504 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_505 = " += \tduplidateClause_";
  protected final String TEXT_506 = ".toString();";
  protected final String TEXT_507 = NL + "\t\t\t\t";
  protected final String TEXT_508 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_509 = " = new StringBuffer(insert_";
  protected final String TEXT_510 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_511 = ".insert(insert_";
  protected final String TEXT_512 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_513 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_514 = " =insertStringBuffer_";
  ...
  protected final String TEXT_522 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_523 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_524 = " = conn_";
  protected final String TEXT_525 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_526 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_527 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_528 = ",insert_";
  protected final String TEXT_529 = ",keyPsmt_";
  protected final String TEXT_530 = ");";
  protected final String TEXT_531 = NL;
  protected final String TEXT_532 = NL + "\t            class BufferLine_";
  protected final String TEXT_533 = " {" + NL + "    \t            ";
  protected final String TEXT_534 = NL + "                            ";
  protected final String TEXT_535 = " ";
  protected final String TEXT_536 = ";";
  protected final String TEXT_537 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_538 = "(";
  protected final String TEXT_539 = NL + "                                ,";
  protected final String TEXT_540 = NL + "                            ";
  protected final String TEXT_541 = " ";
  protected final String TEXT_542 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_543 = NL + "                                this.";
  protected final String TEXT_544 = " = ";
  protected final String TEXT_545 = ";";
  protected final String TEXT_546 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_547 = "> exInsertColValueList";
  protected final String TEXT_548 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_549 = " exInsertColValue";
  protected final String TEXT_550 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_551 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_552 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_553 = ".append(\"(";
  protected final String TEXT_554 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_555 = "-1) extendInsertValueStmt_";
  protected final String TEXT_556 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_557 = " = \"INSERT INTO `\"+";
  protected final String TEXT_558 = "+\"` (";
  protected final String TEXT_559 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_560 = ".toString();";
  protected final String TEXT_561 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_562 = " += \tduplidateClause_";
  protected final String TEXT_563 = ".toString();";
  ...
  protected final String TEXT_573 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_574 = " =  conn_";
  protected final String TEXT_575 = ".prepareStatement(insert_";
  protected final String TEXT_576 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_577 = " = \"";
  protected final String TEXT_578 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_579 = " =  \"";
  protected final String TEXT_580 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_581 = " = 0;";
  protected final String TEXT_582 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_583 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_584 = " + \"` (";
  protected final String TEXT_585 = ") VALUES (";
  protected final String TEXT_586 = ")\";";
  protected final String TEXT_587 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_588 = " += \tduplidateClause_";
  protected final String TEXT_589 = ".toString();";
  protected final String TEXT_590 = NL + "\t\t        int batchSize_";
  protected final String TEXT_591 = " = ";
  protected final String TEXT_592 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  ...
  protected final String TEXT_607 = " = \"UPDATE `\" + ";
  protected final String TEXT_608 = " + \"` SET ";
  protected final String TEXT_609 = " WHERE ";
  protected final String TEXT_610 = "\";" + NL + "\t    ";
  protected final String TEXT_611 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_612 = " = new StringBuffer(update_";
  protected final String TEXT_613 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_614 = ".insert(update_";
  protected final String TEXT_615 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_616 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_617 = " =updateStringBuffer_";
  protected final String TEXT_618 = ".toString(); ";
  protected final String TEXT_619 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_620 = " = conn_";
  protected final String TEXT_621 = ".prepareStatement(update_";
  protected final String TEXT_622 = ");" + NL + "\t    ";
  protected final String TEXT_623 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_624 = " = conn_";
  protected final String TEXT_625 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_626 = " + \"` WHERE ";
  protected final String TEXT_627 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_628 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_629 = " + \"` (";
  protected final String TEXT_630 = ") VALUES (";
  protected final String TEXT_631 = ")\";" + NL + "\t    ";
  protected final String TEXT_632 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_633 = " = new StringBuffer(insert_";
  protected final String TEXT_634 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_635 = ".insert(insert_";
  protected final String TEXT_636 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_637 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_638 = " =insertStringBuffer_";
  protected final String TEXT_639 = ".toString(); ";
  protected final String TEXT_640 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_661 = " = \"UPDATE `\" + ";
  protected final String TEXT_662 = " + \"` SET ";
  protected final String TEXT_663 = " WHERE ";
  protected final String TEXT_664 = "\";" + NL + "\t    ";
  protected final String TEXT_665 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_666 = " = new StringBuffer(update_";
  protected final String TEXT_667 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_668 = ".insert(update_";
  protected final String TEXT_669 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_670 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_671 = " =updateStringBuffer_";
  protected final String TEXT_672 = ".toString(); ";
  protected final String TEXT_673 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_674 = " = conn_";
  protected final String TEXT_675 = ".prepareStatement(update_";
  protected final String TEXT_676 = ");" + NL + "\t    String insert_";
  protected final String TEXT_677 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_678 = " + \"` (";
  protected final String TEXT_679 = ") VALUES (";
  protected final String TEXT_680 = ")\";" + NL + "\t     ";
  protected final String TEXT_681 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_682 = " = new StringBuffer(insert_";
  protected final String TEXT_683 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_684 = ".insert(insert_";
  protected final String TEXT_685 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_686 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_687 = " =insertStringBuffer_";
  protected final String TEXT_688 = ".toString(); ";
  protected final String TEXT_689 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_690 = " = conn_";
  protected final String TEXT_691 = ".prepareStatement(insert_";
  protected final String TEXT_692 = ");" + NL + "\t    ";
  protected final String TEXT_693 = NL + "\t    String delete_";
  protected final String TEXT_694 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_695 = " + \"` WHERE ";
  protected final String TEXT_696 = "\";" + NL + "\t    ";
  protected final String TEXT_697 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_698 = " = new StringBuffer(delete_";
  protected final String TEXT_699 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_700 = ".insert(delete_";
  protected final String TEXT_701 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_702 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_703 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_707 = ".prepareStatement(delete_";
  protected final String TEXT_708 = ");" + NL + "\t    ";
  protected final String TEXT_709 = NL + "\t    String replace_";
  protected final String TEXT_710 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_711 = " + \"` (";
  protected final String TEXT_712 = ") VALUES (";
  protected final String TEXT_713 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_714 = " = conn_";
  protected final String TEXT_715 = ".prepareStatement(replace_";
  protected final String TEXT_716 = ");" + NL + "\t    ";
  protected final String TEXT_717 = NL + "\t    String insertIgnore_";
  protected final String TEXT_718 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_719 = " + \"` (";
  protected final String TEXT_720 = ") VALUES (";
  protected final String TEXT_721 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_722 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_723 = " = conn_";
  protected final String TEXT_724 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_725 = ");" + NL + "\t    ";
  protected final String TEXT_726 = NL + "\t    String insert_";
  protected final String TEXT_727 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_728 = " + \"` (";
  protected final String TEXT_729 = ") VALUES (";
  protected final String TEXT_730 = ")\";" + NL + "\t    ";
  protected final String TEXT_731 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_732 = " = new StringBuffer(insert_";
  protected final String TEXT_733 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_734 = ".insert(insert_";
  protected final String TEXT_735 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_736 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_737 = " =insertStringBuffer_";
  protected final String TEXT_738 = ".toString(); ";
  protected final String TEXT_739 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_740 = " = conn_";
  protected final String TEXT_741 = ".prepareStatement(insert_";
  protected final String TEXT_742 = ");" + NL + "\t    ";
  protected final String TEXT_743 = NL + "        StringBuffer query_";
  protected final String TEXT_744 = " = null;" + NL + "       \t";
  protected final String TEXT_745 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_746 = " = insert_";
  protected final String TEXT_747 = ".split(\"\\\\?\");";
  protected final String TEXT_748 = NL + "\t\t\tupdate_";
  protected final String TEXT_749 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_750 = " = update_";
  protected final String TEXT_751 = ".split(\"\\\\?\");";
  protected final String TEXT_752 = NL + "\t\t\tupdate_";
  protected final String TEXT_753 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_754 = " = update_";
  protected final String TEXT_755 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_756 = " = insert_";
  protected final String TEXT_757 = ".split(\"\\\\?\");";
  protected final String TEXT_758 = NL + "\t\t\tdelete_";
  protected final String TEXT_759 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_760 = " = delete_";
  protected final String TEXT_761 = ".split(\"\\\\?\");";
  protected final String TEXT_762 = NL + "\t\t\treplace_";
  protected final String TEXT_763 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_764 = " = replace_";
  protected final String TEXT_765 = ".split(\"\\\\?\");";
  protected final String TEXT_766 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_767 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_768 = " = insertIgnore_";
  protected final String TEXT_769 = ".split(\"\\\\?\");";
  protected final String TEXT_770 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_771 = " = insert_";
  protected final String TEXT_772 = ".split(\"\\\\?\");";
  protected final String TEXT_773 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_774 = " {" + NL + "    \t            ";
  protected final String TEXT_775 = NL + "                            ";
  protected final String TEXT_776 = " ";
  protected final String TEXT_777 = ";";
  protected final String TEXT_778 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_779 = ";" + NL + "\t\t\t";
  protected final String TEXT_780 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_781 = "(";
  protected final String TEXT_782 = NL + "                                ,";
  protected final String TEXT_783 = NL + "                            ";
  protected final String TEXT_784 = " ";
  protected final String TEXT_785 = NL + "\t\t\t\t, routines.system.Dynamic ";
  ...
  protected final String TEXT_794 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_795 = "> exInsertColValueList";
  protected final String TEXT_796 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_797 = " exInsertColValue";
  protected final String TEXT_798 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_799 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_800 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_801 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_802 = "=1;";
  protected final String TEXT_803 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_804 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_805 = "=0;";
  protected final String TEXT_806 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_807 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_808 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_809 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_810 = "=0;" + NL + "\t";
  protected final String TEXT_811 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_812 = " = null;" + NL + "\t\t";
  protected final String TEXT_813 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_814 = " = null;";
  protected final String TEXT_815 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_816 = " =  null;";
  protected final String TEXT_817 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_818 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_822 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_823 = " = null;";
  protected final String TEXT_824 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_825 = " = null;";
  protected final String TEXT_826 = NL + "\t\t \tString[] insertSQLSplits_";
