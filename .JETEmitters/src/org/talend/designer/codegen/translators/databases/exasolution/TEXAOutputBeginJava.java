...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_52 = NL + "// schema is mandatory" + NL + "String tableName_";
  ...
  protected final String TEXT_64 = NL + "int nb_line_";
  protected final String TEXT_65 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_66 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_67 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_68 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_69 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_70 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_71 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_72 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_73 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_74 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_75 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_80 = NL + "        if (null == conn_";
  protected final String TEXT_81 = ") {" + NL + "            java.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_82 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "            conn_";
  protected final String TEXT_83 = " = dataSources_";
  protected final String TEXT_84 = ".get(";
  protected final String TEXT_85 = ").getConnection();" + NL + "        }";
  ...
  protected final String TEXT_93 = NL + "    java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\");" + NL + "    String url_";
  protected final String TEXT_94 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_95 = " + \":\" + ";
  protected final String TEXT_96 = " + \";schema=\" + ";
  protected final String TEXT_97 = " + \";\" + ";
  protected final String TEXT_98 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_126 = NL + "   int batchSize_";
  protected final String TEXT_127 = " = ";
  protected final String TEXT_128 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_129 = "=0;";
  protected final String TEXT_130 = NL;
  protected final String TEXT_131 = NL + "int count_";
  ...
  protected final String TEXT_471 = ")\";" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_479 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_485 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_486 = " + \" WHERE ";
  protected final String TEXT_487 = "\");" + NL + "        String insert_";
  protected final String TEXT_488 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_489 = " + \" (";
  protected final String TEXT_490 = ") VALUES (";
  protected final String TEXT_491 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_492 = " = conn_";
  protected final String TEXT_493 = ".prepareStatement(insert_";
  protected final String TEXT_494 = ");" + NL + "        String update_";
  protected final String TEXT_495 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_496 = " + \" SET ";
  protected final String TEXT_497 = " WHERE ";
  protected final String TEXT_498 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_506 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_507 = " = conn_";
  protected final String TEXT_508 = ".prepareStatement(update_";
  ...
  protected final String TEXT_513 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_514 = " = conn_";
  protected final String TEXT_515 = ".prepareStatement(insert_";
  protected final String TEXT_516 = ");";
  protected final String TEXT_517 = NL + "        String delete_";
  protected final String TEXT_518 = " = \"DELETE FROM \" + tableName_";
  ...
  protected final String TEXT_522 = ".prepareStatement(delete_";
  protected final String TEXT_523 = ");";
  protected final String TEXT_524 = NL + "        StringBuffer query_";
  protected final String TEXT_525 = " = null;";
  protected final String TEXT_526 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_527 = " = insert_";
  protected final String TEXT_528 = ".split(\"\\\\?\");";
  protected final String TEXT_529 = NL + "\t\t\tupdate_";
  protected final String TEXT_530 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_531 = " = update_";
  protected final String TEXT_532 = ".split(\"\\\\?\");";
  protected final String TEXT_533 = NL + "\t\t\tupdate_";
  protected final String TEXT_534 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_535 = " = update_";
  protected final String TEXT_536 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_537 = " = insert_";
  protected final String TEXT_538 = ".split(\"\\\\?\");";
  protected final String TEXT_539 = NL + "\t\t\tdelete_";
  protected final String TEXT_540 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_541 = " = delete_";
  protected final String TEXT_542 = ".split(\"\\\\?\");";
  protected final String TEXT_543 = NL + "\t\t\treplace_";
  protected final String TEXT_544 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_545 = " = replace_";
  protected final String TEXT_546 = ".split(\"\\\\?\");";
  protected final String TEXT_547 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_548 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_549 = " = insertIgnore_";
  protected final String TEXT_550 = ".split(\"\\\\?\");";
  protected final String TEXT_551 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_552 = " = insert_";
  protected final String TEXT_553 = ".split(\"\\\\?\");";
  protected final String TEXT_554 = NL + "    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_555 = " =null;" + NL + "    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_556 = " =null;" + NL + "    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_557 = " =null;";
  protected final String TEXT_558 = NL + "        StringBuffer query_";
  protected final String TEXT_559 = " = null;";
  protected final String TEXT_560 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_561 = " = null;";
  protected final String TEXT_562 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_563 = " =  null;";
  protected final String TEXT_564 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_565 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_566 = " = null;";
  protected final String TEXT_567 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_568 = " = null;";
  protected final String TEXT_569 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_570 = " = null;";
  protected final String TEXT_571 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_572 = " = null;";
  protected final String TEXT_573 = NL + "\t\t \tString[] insertSQLSplits_";
