...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_173 = NL + "    java.util.Properties atnParamsPrope_";
  protected final String TEXT_174 = " = new java.util.Properties();" + NL + "    atnParamsPrope_";
  protected final String TEXT_175 = ".put(\"user\",dbUser_";
  protected final String TEXT_176 = ");" + NL + "    atnParamsPrope_";
  protected final String TEXT_177 = ".put(\"password\",dbPwd_";
  protected final String TEXT_178 = ");" + NL + "    if(";
  protected final String TEXT_179 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_180 = ") && !\"\".equals(";
  protected final String TEXT_181 = ")){" + NL + "        atnParamsPrope_";
  protected final String TEXT_182 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_183 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "    }";
  protected final String TEXT_184 = NL + "    conn_";
  protected final String TEXT_185 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_186 = ", atnParamsPrope_";
  protected final String TEXT_187 = ");";
  protected final String TEXT_188 = NL;
  protected final String TEXT_189 = NL + "String tableName_";
  protected final String TEXT_190 = " = null;" + NL + "if(\"ORACLE_RAC\".equals(\"";
  protected final String TEXT_191 = "\")||dbschema_";
  protected final String TEXT_192 = " == null || dbschema_";
  protected final String TEXT_193 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_194 = " = ";
  protected final String TEXT_195 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_196 = " = dbschema_";
  protected final String TEXT_197 = " + \".\" + ";
  protected final String TEXT_198 = ";" + NL + "}";
  protected final String TEXT_199 = NL + "    String tmpTableName_";
  protected final String TEXT_200 = " = tableName_";
  protected final String TEXT_201 = ";" + NL + "" + NL + "    String uniqueTableName_";
  protected final String TEXT_202 = " = \"t\" + java.util.UUID.randomUUID().toString().replace(\"-\",\"\").substring(0,28);" + NL + "    tableName_";
  protected final String TEXT_203 = " = uniqueTableName_";
  protected final String TEXT_204 = ";";
  protected final String TEXT_205 = NL;
  protected final String TEXT_206 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_209 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_210 = " - Droping table ";
  protected final String TEXT_211 = "\" + tableName_";
  ...
  protected final String TEXT_218 = " - Drop table ";
  protected final String TEXT_219 = "\" + tableName_";
  ...
  protected final String TEXT_227 = " - Creating table ";
  ...
  protected final String TEXT_235 = " - Create table ";
  protected final String TEXT_236 = "\" + tableName_";
  protected final String TEXT_237 = " + \"";
  protected final String TEXT_238 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_245 = " - Creating table ";
  protected final String TEXT_246 = "\" + tableName_";
  protected final String TEXT_247 = " + \"";
  protected final String TEXT_248 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_249 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_250 = ".execute(\"";
  protected final String TEXT_251 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_252 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_253 = " - Create table ";
  protected final String TEXT_254 = "\" + tableName_";
  protected final String TEXT_255 = " + \"";
  protected final String TEXT_256 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_257 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_258 = ".close();" + NL + "\t\t";
  protected final String TEXT_259 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_261 = " = conn_";
  protected final String TEXT_262 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_263 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_264 = " = tableNameForSearch_";
  protected final String TEXT_265 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_266 = " = tableNameForSearch_";
  protected final String TEXT_267 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_268 = " = dbMetaData_";
  protected final String TEXT_269 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_270 = ", tableNameForSearch_";
  protected final String TEXT_271 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_272 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_273 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_274 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_275 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_281 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_289 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_290 = ") || dbschema_";
  protected final String TEXT_291 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_292 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_293 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_295 = " = conn_";
  protected final String TEXT_296 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_297 = " = dbMetaData_";
  protected final String TEXT_298 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_299 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_300 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_301 = " = rsTable_";
  protected final String TEXT_302 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_303 = " = rsTable_";
  protected final String TEXT_304 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_305 = ".equals(";
  protected final String TEXT_306 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_307 = ".equals(schema_";
  protected final String TEXT_308 = ") || (schema_";
  protected final String TEXT_309 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_310 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_383 = ".equals";
  protected final String TEXT_384 = "IgnoreCase";
  protected final String TEXT_385 = "(";
  protected final String TEXT_386 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_387 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_388 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_389 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_390 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_394 = " - Creating table ";
  protected final String TEXT_395 = "\" + tableName_";
  ...
  protected final String TEXT_402 = " - Create table ";
  protected final String TEXT_403 = "\" + tableName_";
  protected final String TEXT_404 = " + \"";
  protected final String TEXT_405 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_406 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_407 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_413 = " - Droping table ";
  protected final String TEXT_414 = "\" + tableName_";
  protected final String TEXT_415 = " + \"";
  protected final String TEXT_416 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_418 = ".execute(\"";
  protected final String TEXT_419 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_420 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_421 = " - Drop table ";
  protected final String TEXT_422 = "\" + tableName_";
  protected final String TEXT_423 = " + \"";
  protected final String TEXT_424 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_426 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_427 = " = conn_";
  protected final String TEXT_428 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_429 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_430 = " - Creating table ";
  protected final String TEXT_431 = "\" + tableName_";
  protected final String TEXT_432 = " + \"";
  protected final String TEXT_433 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_434 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_435 = ".execute(\"";
  protected final String TEXT_436 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_437 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_438 = " - Create table ";
  ...
  protected final String TEXT_444 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_447 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_448 = " - Clearing table ";
  protected final String TEXT_449 = "\" + tableName_";
  protected final String TEXT_450 = " + \"";
  protected final String TEXT_451 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_452 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_453 = ".executeUpdate(\"";
  protected final String TEXT_454 = "\");" + NL + "\t\t\t";
  protected final String TEXT_455 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_456 = "- Clear table ";
  protected final String TEXT_457 = "\" + tableName_";
  protected final String TEXT_458 = " + \"";
  protected final String TEXT_459 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_460 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_471 = " - Trancating table ";
  protected final String TEXT_472 = "\" + tableName_";
  protected final String TEXT_473 = " + \"";
  protected final String TEXT_474 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_475 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_476 = ".executeUpdate(\"";
  protected final String TEXT_477 = "\");" + NL + "   \t    \t";
  protected final String TEXT_478 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_479 = " - Truncate table ";
  protected final String TEXT_480 = "\" + tableName_";
  protected final String TEXT_481 = " + \"";
  protected final String TEXT_482 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_483 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_484 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_485 = " += rsTruncCount_";
  protected final String TEXT_486 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_487 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_488 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_489 = ".close();" + NL + "\t\t";
  protected final String TEXT_490 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_491 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_492 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_493 = NL + "    String ctlf_";
  protected final String TEXT_494 = " = ";
  protected final String TEXT_495 = ";" + NL + "    String logf_";
  protected final String TEXT_496 = " = ";
  protected final String TEXT_497 = "+\".log\";";
  protected final String TEXT_498 = NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_499 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_500 = ".append(\"OPTIONS (\");";
  protected final String TEXT_501 = NL + "            optionClause_";
  protected final String TEXT_502 = ".append(\", \");";
  protected final String TEXT_503 = NL + "                    optionClause_";
  protected final String TEXT_504 = ".append(\"";
  protected final String TEXT_505 = "=(";
  protected final String TEXT_506 = ")\");";
  protected final String TEXT_507 = NL + "                    optionClause_";
  protected final String TEXT_508 = ".append(\"";
  protected final String TEXT_509 = "=";
  protected final String TEXT_510 = "\");";
  protected final String TEXT_511 = NL + "                if(";
  protected final String TEXT_512 = ".split(\",\").length>1){" + NL + "                    optionClause_";
  protected final String TEXT_513 = ".append(\"";
  protected final String TEXT_514 = "=(\"+";
  protected final String TEXT_515 = "+\")\");" + NL + "                }else{" + NL + "                    optionClause_";
  protected final String TEXT_516 = ".append(\"";
  protected final String TEXT_517 = "=\"+";
  protected final String TEXT_518 = ");" + NL + "                }";
  protected final String TEXT_519 = NL + "                optionClause_";
  protected final String TEXT_520 = ".append(\"";
  protected final String TEXT_521 = "=";
  protected final String TEXT_522 = "\");";
  protected final String TEXT_523 = NL + "                optionClause_";
  protected final String TEXT_524 = ".append(\"";
  protected final String TEXT_525 = "='\"+";
  protected final String TEXT_526 = "+\"'\");";
  protected final String TEXT_527 = NL + "                optionClause_";
  protected final String TEXT_528 = ".append(\"";
  protected final String TEXT_529 = "=";
  protected final String TEXT_530 = "\");";
  protected final String TEXT_531 = NL + "                optionClause_";
  protected final String TEXT_532 = ".append(\"";
  protected final String TEXT_533 = "=\"+";
  protected final String TEXT_534 = ");";
  protected final String TEXT_535 = NL + "    optionClause_";
  protected final String TEXT_536 = ".append(\")\");";
  protected final String TEXT_537 = NL + "    String dataf_";
  protected final String TEXT_538 = " = ";
  protected final String TEXT_539 = " + Thread.currentThread().getId();" + NL + "" + NL + "    String ctlf_";
  protected final String TEXT_540 = " = dataf_";
  protected final String TEXT_541 = " + \".ctl\";" + NL + "" + NL + "    String badf_";
  protected final String TEXT_542 = " = dataf_";
  protected final String TEXT_543 = " + \".bad\";" + NL + "" + NL + "    String dscf_";
  protected final String TEXT_544 = " = dataf_";
  protected final String TEXT_545 = " + \".dsc\";" + NL + "" + NL + "    String logf_";
  protected final String TEXT_546 = " = dataf_";
  protected final String TEXT_547 = " + \".log\";" + NL + "" + NL + "    dataf_";
  protected final String TEXT_548 = " = ";
  protected final String TEXT_549 = ";" + NL + "" + NL + "    java.io.File badFile_";
  protected final String TEXT_550 = " = new java.io.File(badf_";
  protected final String TEXT_551 = ");" + NL + "" + NL + "    if(badFile_";
  protected final String TEXT_552 = ".exists()){" + NL + "" + NL + "        badFile_";
  protected final String TEXT_553 = ".delete();" + NL + "" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_554 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_555 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_556 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_557 = " ,false) ;" + NL + "" + NL + "    pw_";
  protected final String TEXT_558 = ".println(optionClause_";
  protected final String TEXT_559 = ".toString());" + NL + "" + NL + "    pw_";
  protected final String TEXT_560 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_561 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_562 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_563 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_564 = " + \"'\");" + NL;
  protected final String TEXT_565 = NL + "        bw_";
  protected final String TEXT_566 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_567 = NL + NL + NL;
  protected final String TEXT_568 = NL + "        bw_";
  protected final String TEXT_569 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_570 = " + \"'\\\"\");";
  protected final String TEXT_571 = NL + "        bw_";
  protected final String TEXT_572 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_573 = " + \"\\\"\");";
  protected final String TEXT_574 = NL + "        bw_";
  protected final String TEXT_575 = ".write(\" \\\"var \" + ";
  protected final String TEXT_576 = " + \"\\\"\");";
  protected final String TEXT_577 = NL + "    pw_";
  protected final String TEXT_578 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_579 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_580 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_581 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_582 = " + \"'\");";
  protected final String TEXT_583 = NL + "        pw_";
  protected final String TEXT_584 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_585 = NL + "        bw_";
  protected final String TEXT_586 = ".write(";
  protected final String TEXT_587 = ");";
  protected final String TEXT_588 = NL + "            pw_";
  protected final String TEXT_589 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_590 = ");" + NL + "            pw_";
  protected final String TEXT_591 = ".println(\"INSERT\");";
  protected final String TEXT_592 = NL + "            pw_";
  protected final String TEXT_593 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_594 = ");" + NL + "            pw_";
  protected final String TEXT_595 = ".println(\"";
  protected final String TEXT_596 = "\");";
  protected final String TEXT_597 = NL + "                pw_";
  protected final String TEXT_598 = ".println(\"WHEN \" + ";
  protected final String TEXT_599 = ");";
  protected final String TEXT_600 = NL + "            bw_";
  protected final String TEXT_601 = ".write(\"FIELDS TERMINATED BY ";
  protected final String TEXT_602 = "\");";
  protected final String TEXT_603 = NL + "            bw_";
  protected final String TEXT_604 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_605 = " + \"\\\"\");";
  protected final String TEXT_606 = NL + "                bw_";
  protected final String TEXT_607 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_608 = NL + "                bw_";
  protected final String TEXT_609 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_610 = NL + "            bw_";
  protected final String TEXT_611 = ".write(\"'\" + ";
  protected final String TEXT_612 = " + \"'\");";
  protected final String TEXT_613 = NL + "                bw_";
  protected final String TEXT_614 = ".write(\" AND '\" + ";
  protected final String TEXT_615 = " + \"'\");";
  protected final String TEXT_616 = NL + "            pw_";
  protected final String TEXT_617 = ".println(\"\");";
  protected final String TEXT_618 = NL + "            pw_";
  protected final String TEXT_619 = ".println(\"\");";
  protected final String TEXT_620 = NL + "            pw_";
  protected final String TEXT_621 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_622 = NL + "            pw_";
  protected final String TEXT_623 = ".println(\"";
  protected final String TEXT_624 = "\");";
  protected final String TEXT_625 = NL + "    bw_";
  protected final String TEXT_626 = ".close();" + NL + "    pw_";
  protected final String TEXT_627 = ".close();";
  protected final String TEXT_628 = NL + "String command_";
  protected final String TEXT_629 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_630 = " + \"/\" + dbPwd_";
  protected final String TEXT_631 = " + \"@\" + serviceUrl_";
  protected final String TEXT_632 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_633 = " + \"' LOG='\" + logf_";
  protected final String TEXT_634 = " + \"'\";" + NL + "String printableCommand = \"sqlldr '\" + dbUser_";
  protected final String TEXT_635 = " + \"/\" + \"....\" + \"@\" + serviceUrl_";
  protected final String TEXT_636 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_637 = " + \"' LOG='\" + logf_";
  protected final String TEXT_638 = " + \"'\";" + NL;
  protected final String TEXT_639 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_640 = " = conn_";
  protected final String TEXT_641 = ".createStatement();";
  protected final String TEXT_642 = NL + "        log.info(\"";
  protected final String TEXT_643 = " - Creating temp table ";
  protected final String TEXT_644 = "\" + tableName_";
  protected final String TEXT_645 = " + \"";
  protected final String TEXT_646 = ".\" );";
  protected final String TEXT_647 = NL + "    stmtCreateTmp_";
  protected final String TEXT_648 = ".execute(\"";
  protected final String TEXT_649 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_650 = ".close();";
  protected final String TEXT_651 = NL + "        log.info(\"";
  protected final String TEXT_652 = " - Create temp table ";
  protected final String TEXT_653 = "\" + tableName_";
  protected final String TEXT_654 = " + \"";
  protected final String TEXT_655 = " has succeeded.\");" + NL + "        log.info(\"";
  protected final String TEXT_656 = " - Executing command:'\" + printableCommand + \"'.\");";
  protected final String TEXT_657 = NL + "    final Process process_";
  protected final String TEXT_658 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_659 = ");";
  protected final String TEXT_660 = NL + "        java.util.ArrayList<String> envParam_";
  protected final String TEXT_661 = "=new java.util.ArrayList<String>();" + NL + "        java.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_662 = " = System.getenv();" + NL + "        for (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_663 = ".entrySet())" + NL + "        {" + NL + "           envParam_";
  protected final String TEXT_664 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "        }";
  protected final String TEXT_665 = NL + "        envParam_";
  protected final String TEXT_666 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_667 = "\");";
  protected final String TEXT_668 = NL + "        envParam_";
  protected final String TEXT_669 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_670 = "\");";
  protected final String TEXT_671 = NL + "            envParam_";
  protected final String TEXT_672 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_673 = "\");";
  protected final String TEXT_674 = NL + "        envParam_";
  protected final String TEXT_675 = ".add(\"";
  protected final String TEXT_676 = "=";
  protected final String TEXT_677 = "\");";
  protected final String TEXT_678 = NL + "        log.info(\"";
  protected final String TEXT_679 = " - Executing command:'\" + printableCommand + \"'.\");";
  protected final String TEXT_680 = NL + "    final Process process_";
  protected final String TEXT_681 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_682 = ",envParam_";
  protected final String TEXT_683 = ".toArray(new String[0]));";
  protected final String TEXT_684 = NL + NL + "//System.out.println(command_";
  protected final String TEXT_685 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_686 = " = new Thread() {" + NL + "    public void run() {" + NL + "        try {" + NL + "            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_687 = ".getInputStream()));" + NL + "            String line = \"\";" + NL + "            try {" + NL + "                while((line = reader.readLine()) != null) {";
  protected final String TEXT_688 = NL + "                        System.out.println(line);";
  protected final String TEXT_689 = NL + "                        globalMap.put(\"";
  protected final String TEXT_690 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_691 = "_OUTPUT\") + \"\\n\" + line);";
  protected final String TEXT_692 = NL + "                }" + NL + "            } finally {" + NL + "                 reader.close();" + NL + "            }" + NL + "        }catch(java.io.IOException ioe) {";
  protected final String TEXT_693 = NL + "            ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_694 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_695 = " = new Thread() {" + NL + "    public void run() {" + NL + "       try {" + NL + "           java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_696 = ".getErrorStream()));" + NL + "           String line = \"\";" + NL + "           try {" + NL + "               while((line = reader.readLine()) != null) {" + NL + "                  globalMap.put(\"";
  protected final String TEXT_697 = "_SQLLOAD_ERROR\", \"true\");";
  protected final String TEXT_698 = NL + "                       System.err.println(line);";
  protected final String TEXT_699 = NL + "                       globalMap.put(\"";
  protected final String TEXT_700 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_701 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_702 = NL + "               }" + NL + "            } finally {" + NL + "                reader.close();" + NL + "            }" + NL + "        } catch(java.io.IOException ioe) {";
  protected final String TEXT_703 = NL + "           ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_704 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_705 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_706 = " = process_";
  protected final String TEXT_707 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_708 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_709 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_710 = "_SQLLOAD_ERROR\"))) {" + NL + "    throw new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_711 = "\" , globalMap);" + NL + "}";
  protected final String TEXT_712 = NL + "    log.info(\"";
  protected final String TEXT_713 = " - Excute command: '\" + printableCommand + \"' has finished.\");" + NL + "    log.info(\"";
  protected final String TEXT_714 = " - Retrieving information from oracle log file: '\" + logf_";
  protected final String TEXT_715 = " + \"'.\");";
  protected final String TEXT_716 = NL + "java.io.BufferedReader lr_";
  protected final String TEXT_717 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_718 = "));" + NL + "int nb_line_data_";
  protected final String TEXT_719 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_720 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_721 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_722 = " = 0;" + NL + "" + NL + "/*  1.get log file all lines count" + NL + "    2.get \"Total logical records read\" line number from file end." + NL + "    3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "String tempLine_";
  protected final String TEXT_723 = " = \"\";" + NL + "int countLines_";
  protected final String TEXT_724 = " =0;//log file lines count" + NL + "//1" + NL + "class LogUtil_";
  protected final String TEXT_725 = "{" + NL + "    public int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "\t\tif(br == null)" + NL + "\t\t{" + NL + "\t\t\treturn 0;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString tempLine = br.readLine();\t\t\t\t" + NL + "\t\tint count = 0;" + NL + "\t\twhile(tempLine != null){" + NL + "\t\t\tcount++;" + NL + "\t\t\ttempLine = br.readLine();" + NL + "\t\t}" + NL + "\t\tbr.close();" + NL + "\t\t" + NL + "\t\treturn count;" + NL + "    }" + NL + " " + NL + "}" + NL + "int lastTableLine_";
  protected final String TEXT_726 = " = 0;//Line Number of the last table name" + NL + "while ((tempLine_";
  protected final String TEXT_727 = " = lr_";
  protected final String TEXT_728 = ".readLine() )!= null) {" + NL + "    countLines_";
  protected final String TEXT_729 = "++;" + NL + "    if(tempLine_";
  protected final String TEXT_730 = ".toUpperCase().indexOf(\"TABLE \"+(tableName_";
  protected final String TEXT_731 = ").toUpperCase())>-1){" + NL + "        lastTableLine_";
  protected final String TEXT_732 = " = countLines_";
  protected final String TEXT_733 = ";" + NL + "    }" + NL + "}" + NL + "lr_";
  protected final String TEXT_734 = ".close();" + NL + "" + NL + "java.io.File dateFileTemp_";
  protected final String TEXT_735 = " = new java.io.File(dataf_";
  protected final String TEXT_736 = ");" + NL + "java.io.File badFileTemp_";
  protected final String TEXT_737 = " = new java.io.File(badf_";
  protected final String TEXT_738 = ");" + NL + "java.io.File dscFileTemp_";
  protected final String TEXT_739 = " = new java.io.File(dscf_";
  protected final String TEXT_740 = ");" + NL + "\t\t" + NL + "java.io.BufferedReader dateFile_br_";
  protected final String TEXT_741 = " = null;" + NL + "java.io.BufferedReader badFile_br_";
  protected final String TEXT_742 = " = null;" + NL + "java.io.BufferedReader dscFile_br_";
  protected final String TEXT_743 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t" + NL + "try" + NL + "{\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t" + NL + "    if(dateFileTemp_";
  protected final String TEXT_744 = ".exists()){" + NL + "\t    dateFile_br_";
  protected final String TEXT_745 = " = new java.io.BufferedReader(" + NL + "\t\t    new java.io.FileReader(dataf_";
  protected final String TEXT_746 = "));" + NL + "    }" + NL + "\t\t\t\t" + NL + "    if(badFileTemp_";
  protected final String TEXT_747 = ".exists()){" + NL + "\t    badFile_br_";
  protected final String TEXT_748 = " = new java.io.BufferedReader(" + NL + "\t\t    new java.io.FileReader(badf_";
  protected final String TEXT_749 = "));" + NL + "    }" + NL + "\t\t\t\t" + NL + "    if(dscFileTemp_";
  protected final String TEXT_750 = ".exists()){" + NL + "        dscFile_br_";
  protected final String TEXT_751 = " = new java.io.BufferedReader(" + NL + "\t\t    new java.io.FileReader(dscf_";
  protected final String TEXT_752 = "));" + NL + "    }  " + NL + "    " + NL + "    LogUtil_";
  protected final String TEXT_753 = " lu_";
  protected final String TEXT_754 = " = new LogUtil_";
  protected final String TEXT_755 = "();" + NL + "    nb_line_data_";
  protected final String TEXT_756 = " = lu_";
  protected final String TEXT_757 = ".getNumber(dateFile_br_";
  protected final String TEXT_758 = ");//get the number of data line" + NL + "    nb_line_bad_";
  protected final String TEXT_759 = " = lu_";
  protected final String TEXT_760 = ".getNumber(badFile_br_";
  protected final String TEXT_761 = ");//get the number of reject data line" + NL + "    nb_line_discarded_";
  protected final String TEXT_762 = " = lu_";
  protected final String TEXT_763 = ".getNumber(dscFile_br_";
  protected final String TEXT_764 = ");//get the number of discarded data line" + NL + "    nb_line_inserted_";
  protected final String TEXT_765 = " = nb_line_data_";
  protected final String TEXT_766 = " - nb_line_bad_";
  protected final String TEXT_767 = " - nb_line_discarded_";
  protected final String TEXT_768 = "; " + NL + "}    " + NL + "finally" + NL + "{" + NL + "\tif(dateFile_br_";
  protected final String TEXT_769 = " != null)" + NL + "\t{" + NL + "\t\tdateFile_br_";
  protected final String TEXT_770 = ".close();" + NL + "\t}" + NL + "\tif(badFile_br_";
  protected final String TEXT_771 = " != null)" + NL + "\t{" + NL + "\t\tbadFile_br_";
  protected final String TEXT_772 = ".close();" + NL + "\t}" + NL + "\tif(dscFile_br_";
  protected final String TEXT_773 = " != null)" + NL + "\t{" + NL + "\t\tdscFile_br_";
  protected final String TEXT_774 = ".close();" + NL + "\t}" + NL + "}" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_775 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_776 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_777 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_778 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_779 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_780 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_781 = "_RETURN_CODE\", exitCode_";
  protected final String TEXT_782 = ");";
  protected final String TEXT_783 = NL + "    log.info(\"";
  protected final String TEXT_784 = " - Retrieved number of line: \" + nb_line_data_";
  protected final String TEXT_785 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_786 = " - Retrieved number of bad line: \" + nb_line_bad_";
  protected final String TEXT_787 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_788 = " - Retrieved number of inserted line: \" + nb_line_inserted_";
  protected final String TEXT_789 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_790 = " - Retrieved information from oracle log file: '\" + logf_";
  protected final String TEXT_791 = " + \"' finish.\");";
