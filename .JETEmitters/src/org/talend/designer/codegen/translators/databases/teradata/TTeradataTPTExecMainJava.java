...
public class TTeradataTPTExecMainJava
{
  ...
  protected final String TEXT_590 = ".write(\"            ,TargetTable = '\" + tableFullName_";
  ...
  protected final String TEXT_657 = ".close();" + NL + "" + NL + "                //run tbuild (TPT) command";
  protected final String TEXT_658 = NL + "                            String[] sb_";
  protected final String TEXT_659 = "= {\"cmd\",\"/c\",\"tbuild -f \\\"\"+";
  protected final String TEXT_660 = "+";
  protected final String TEXT_661 = "+\".script\\\" -e \"+";
  protected final String TEXT_662 = "+\" > \\\"\"+";
  protected final String TEXT_663 = "+\"\\\" 2>&1\"};";
  protected final String TEXT_664 = NL + "                            String[] sb_";
  protected final String TEXT_665 = "= {\"sh\",\"-c\",\"tbuild -f \\\"\"+";
  protected final String TEXT_666 = "+";
  protected final String TEXT_667 = "+\".scr\\\" -e \"+";
  protected final String TEXT_668 = "+\" > \\\"\"+";
  protected final String TEXT_669 = "+\"\\\" 2>&1\"};";
  protected final String TEXT_670 = NL + "                        String[] sb_";
  protected final String TEXT_671 = "= {\"cmd\",\"/c\",\"tbuild -f \\\"\"+";
  protected final String TEXT_672 = "+";
  protected final String TEXT_673 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_674 = "+\"\\\" 2>&1\"};";
  protected final String TEXT_675 = NL + "                        String[] sb_";
  protected final String TEXT_676 = "= {\"sh\",\"-c\",\"tbuild -f \\\"\"+";
  protected final String TEXT_677 = "+";
  protected final String TEXT_678 = "+\".scr\\\" > \\\"\"+";
  protected final String TEXT_679 = "+\"\\\" 2>&1\"};";
  protected final String TEXT_680 = NL + "                \tString cmdStr_";
  protected final String TEXT_681 = " = java.util.Arrays.toString(sb_";
  protected final String TEXT_682 = ");" + NL + "                    log.info(\"";
  protected final String TEXT_683 = " - Executing command: '\" + cmdStr_";
  protected final String TEXT_684 = " + \"'.\");";
  protected final String TEXT_685 = NL + "                final Process process_";
  protected final String TEXT_686 = " = Runtime.getRuntime().exec(sb_";
  protected final String TEXT_687 = ");" + NL + "                Thread normal_";
  protected final String TEXT_688 = " = new Thread() {" + NL + "                    public void run() {" + NL + "                        try {" + NL + "                            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_689 = ".getInputStream()));" + NL + "                            String line = \"\";" + NL + "                            try {" + NL + "                                while((line = reader.readLine()) != null) {" + NL + "                                   System.out.println(line);" + NL + "                                }" + NL + "                            } finally {" + NL + "                                 reader.close();" + NL + "                            }" + NL + "                        }catch(java.io.IOException ioe) {";
  protected final String TEXT_690 = NL + "                            ioe.printStackTrace();" + NL + "                        }" + NL + "                    }" + NL + "                };" + NL + "                normal_";
  protected final String TEXT_691 = ".start();" + NL + "" + NL + "                Thread error_";
  protected final String TEXT_692 = " = new Thread() {" + NL + "                    public void run() {" + NL + "                        try {" + NL + "                            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_693 = ".getErrorStream()));" + NL + "                            String line = \"\";" + NL + "                            try {" + NL + "                                while((line = reader.readLine()) != null) {" + NL + "                                    System.err.println(line);" + NL + "                                }" + NL + "                            } finally {" + NL + "                                reader.close();" + NL + "                            }" + NL + "                        } catch(java.io.IOException ioe) {";
  protected final String TEXT_694 = NL + "                           ioe.printStackTrace();" + NL + "                        }" + NL + "                    }" + NL + "                };" + NL + "                error_";
  protected final String TEXT_695 = ".start();" + NL + "" + NL + "                process_";
  protected final String TEXT_696 = ".waitFor();" + NL + "" + NL + "                normal_";
  protected final String TEXT_697 = ".interrupt();" + NL + "" + NL + "                error_";
  protected final String TEXT_698 = ".interrupt();" + NL + "" + NL + "                globalMap.put(\"";
  protected final String TEXT_699 = "_EXIT_VALUE\", process_";
  protected final String TEXT_700 = ".exitValue());" + NL;
  protected final String TEXT_701 = NL + "                    if(process_";
  protected final String TEXT_702 = ".exitValue()>=";
  protected final String TEXT_703 = ") {" + NL + "                        throw new RuntimeException(\"TPT returned exit code \"+process_";
  protected final String TEXT_704 = ".exitValue());" + NL + "                    }";
  protected final String TEXT_705 = NL + "                    log.info(\"";
  protected final String TEXT_706 = " - Excute command:'\" + cmdStr_";
  protected final String TEXT_707 = " + \"' has finished.\");";
  protected final String TEXT_708 = NL + "}finally{" + NL + "\ttry{" + NL + "\t\tfile_";
  protected final String TEXT_709 = ".delete();" + NL + "\t}catch(Exception e_";
...
if(columnList!=null){
    ...
    stringBuffer.append(TEXT_602);
								...
								if(!isArrType){//Varchar or table name
									...
									if(isTableType || "ERRORTABLE".equalsIgnoreCase(key)){
