...
public class TInformixBulkExecBeginJava {
  ...
  protected final String TEXT_411 = NL + NL + "\t\tString fileName_";
  protected final String TEXT_412 = " = ";
  protected final String TEXT_413 = ";" + NL + "\t\tString cmdFile_";
  protected final String TEXT_414 = " = fileName_";
  protected final String TEXT_415 = " + \".cmd\";" + NL + "\t\tString logFile_";
  protected final String TEXT_416 = " = fileName_";
  protected final String TEXT_417 = " + \".log\";" + NL + "\t\tCharacter field_separator_";
  protected final String TEXT_418 = " = (";
  protected final String TEXT_419 = ").charAt(0);" + NL + " \t\tjava.io.BufferedWriter bw_";
  protected final String TEXT_420 = " = new java.io.BufferedWriter(new java.io.FileWriter(cmdFile_";
  protected final String TEXT_421 = "));" + NL + "    \tjava.io.PrintWriter pw_";
  protected final String TEXT_422 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_423 = " ,false) ;" + NL + "    \t//file \"c:\\informix_bulk.txt\" delimiter \"|\" 7 ;insert into feature9999;" + NL + "    \tpw_";
  protected final String TEXT_424 = ".print(\"FILE \\\"\" + ";
  protected final String TEXT_425 = " + \"\\\"\" );" + NL + "    \tpw_";
  protected final String TEXT_426 = ".print(\" DELIMITER \\\"\" + field_separator_";
  protected final String TEXT_427 = " + \"\\\"\");" + NL + "    \tpw_";
  protected final String TEXT_428 = ".println(\" \" + ";
  protected final String TEXT_429 = " +\" ;\" );";
  protected final String TEXT_430 = NL + "\t\tpw_";
  protected final String TEXT_431 = ".println(\"INSERT INTO \" + tableName_";
  protected final String TEXT_432 = " + \"(";
  protected final String TEXT_433 = ");\" );";
  protected final String TEXT_434 = NL + "\tbw_";
  protected final String TEXT_435 = ".close();" + NL + "\tpw_";
  protected final String TEXT_436 = ".close();" + NL + "\t//-----------------------dbload command" + NL + "\tStringBuilder command_";
  protected final String TEXT_437 = " =  new StringBuilder();" + NL + "\t//-------------------------1. add dbload cmd";
  protected final String TEXT_438 = NL + "\tcommand_";
  protected final String TEXT_439 = ".append(\"dbload \");";
  protected final String TEXT_440 = NL + "\tcommand_";
  protected final String TEXT_441 = ".append(\"./dbload \");";
  protected final String TEXT_442 = NL + "\t//-------------------------2.add database name" + NL + "\tcommand_";
  protected final String TEXT_443 = ".append(\"-d \" + dbName_";
  protected final String TEXT_444 = " + \" \");" + NL + "\t//-------------------------3.add command file" + NL + "\tcommand_";
  protected final String TEXT_445 = ".append(\"-c \" + cmdFile_";
  protected final String TEXT_446 = " + \" \");" + NL + "\t//-------------------------4.add  error log file" + NL + "\tcommand_";
  protected final String TEXT_447 = ".append(\"-l \" + logFile_";
  protected final String TEXT_448 = " + \" \");" + NL + "\t//-------------------------5.add  bad rows before abort" + NL + "\tcommand_";
  protected final String TEXT_449 = ".append(\"-e \" + ";
  protected final String TEXT_450 = " + \" \");" + NL + "\t//-------------------------6.add commit interval" + NL + "\tcommand_";
  protected final String TEXT_451 = ".append(\"-n \" + ";
  protected final String TEXT_452 = " + \";\"); " + NL + "\t" + NL + "\t//----------------get envionment variables";
  protected final String TEXT_453 = NL + "\tProcess ev_";
  protected final String TEXT_454 = " = Runtime.getRuntime().exec(\"cmd /c set\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_455 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_456 = ".getInputStream()));";
  protected final String TEXT_457 = NL + NL + "\tProcess ev_";
  protected final String TEXT_458 = " = Runtime.getRuntime().exec(\"env\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_459 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_460 = ".getInputStream()));";
  protected final String TEXT_461 = NL + "\tjava.util.List<String> evPara_";
  protected final String TEXT_462 = " = new java.util.ArrayList();" + NL + "\tString line_";
  protected final String TEXT_463 = " = null;" + NL + "\twhile((line_";
  protected final String TEXT_464 = " = evReader_";
  protected final String TEXT_465 = ".readLine()) != null) {" + NL + "\t   evPara_";
  protected final String TEXT_466 = ".add(line_";
  protected final String TEXT_467 = ");" + NL + "\t}" + NL + "\tevReader_";
  protected final String TEXT_468 = ".close();" + NL + "" + NL + "\tevPara_";
  protected final String TEXT_469 = ".add(\"INFORMIXDIR=\" + ";
  protected final String TEXT_470 = ");" + NL + "\tevPara_";
  protected final String TEXT_471 = ".add(\"INFORMIXSERVER=\" + dbServer_";
  protected final String TEXT_472 = ");" + NL + "\tevPara_";
  protected final String TEXT_473 = ".add(\"DBDATE=\" + \"";
  protected final String TEXT_474 = "\");" + NL + "\t";
  protected final String TEXT_475 = NL + "\tevPara_";
  protected final String TEXT_476 = ".add(\"DBMONEY=\" + ";
  protected final String TEXT_477 = ");";
  protected final String TEXT_478 = NL + "\t//----------------get envionment variables end" + NL + "\t" + NL + "\t//------------------get dbload directory" + NL + "\tjava.io.File dbLoadDirectory_";
  protected final String TEXT_479 = " = new java.io.File (";
  protected final String TEXT_480 = "+\"/bin\");" + NL + "\tboolean dbloadExist_";
  protected final String TEXT_481 = " = dbLoadDirectory_";
  protected final String TEXT_482 = ".exists();" + NL + "\tif(!dbloadExist_";
  protected final String TEXT_483 = "){" + NL + "\t\tthrow new RuntimeException(dbLoadDirectory_";
  protected final String TEXT_484 = "+\"' is not exist!\");" + NL + "\t}" + NL + "\t";
  protected final String TEXT_485 = NL + "\t\tlog.info(\"";
  protected final String TEXT_486 = " - Executing '\"+command_";
  protected final String TEXT_487 = ".toString()+\"'.\");" + NL + "\t";
  protected final String TEXT_488 = NL + " \tRuntime runtime_";
  protected final String TEXT_489 = " = Runtime.getRuntime();";
  protected final String TEXT_490 = NL + "\tfinal Process ps_";
  protected final String TEXT_491 = " = runtime_";
  protected final String TEXT_492 = ".exec(new String[]{\"cmd.exe\",\"/c\",command_";
  protected final String TEXT_493 = ".toString()}," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_494 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_495 = ");";
  protected final String TEXT_496 = NL + "\tfinal Process ps_";
  protected final String TEXT_497 = " = runtime_";
  protected final String TEXT_498 = ".exec(command_";
  protected final String TEXT_499 = ".toString()," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_500 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_501 = ");";
  protected final String TEXT_502 = NL;
  protected final String TEXT_503 = NL + NL + "Thread normal_";
  protected final String TEXT_504 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_505 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_506 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_507 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_508 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_509 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_510 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_511 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_512 = ".start();" + NL + "" + NL + "Thread error_";
  ...
  protected final String TEXT_514 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_515 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  ...
  protected final String TEXT_520 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_521 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_522 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_523 = ".interrupt();" + NL + "error_";
  protected final String TEXT_524 = ".interrupt();";
  protected final String TEXT_525 = NL + "        log.info(\"";
  protected final String TEXT_526 = " - Execute '\"+command_";
  protected final String TEXT_527 = ".toString()+\"' has finished。\");";
  protected final String TEXT_528 = NL + NL + NL + NL;
