...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_384 = NL + "            \tString tableForSearch_";
  protected final String TEXT_385 = " = ";
  protected final String TEXT_386 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_387 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_388 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_389 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_390 = " =  tableForSearch_";
  protected final String TEXT_391 = ".substring(1,tableForSearch_";
  protected final String TEXT_392 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_393 = " =  tableForSearch_";
  protected final String TEXT_394 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_395 = " = conn_";
  protected final String TEXT_396 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_397 = " = dbMetaData_";
  protected final String TEXT_398 = ".getTables(null, conn_";
  protected final String TEXT_399 = ".getSchema(), tableForSearch_";
  protected final String TEXT_400 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_401 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_402 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_403 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_404 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_406 = " = conn_";
  protected final String TEXT_407 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_408 = " = dbMetaData_";
  protected final String TEXT_409 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_410 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_411 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_412 = " = rsTable_";
  protected final String TEXT_413 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_414 = ".equals";
  protected final String TEXT_415 = "IgnoreCase";
  protected final String TEXT_416 = "(";
  protected final String TEXT_417 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_418 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_419 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_420 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_421 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_425 = " - Creating table ";
  protected final String TEXT_426 = "\" + tableName_";
  ...
  protected final String TEXT_433 = " - Create table ";
  protected final String TEXT_434 = "\" + tableName_";
  protected final String TEXT_435 = " + \"";
  protected final String TEXT_436 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_437 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_438 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_439 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_440 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_444 = " - Droping table ";
  protected final String TEXT_445 = "\" + tableName_";
  protected final String TEXT_446 = " + \"";
  protected final String TEXT_447 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_448 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_449 = ".execute(\"";
  protected final String TEXT_450 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_452 = " - Drop table ";
  protected final String TEXT_453 = "\" + tableName_";
  protected final String TEXT_454 = " + \"";
  protected final String TEXT_455 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_456 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_457 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_461 = " - Creating table ";
  ...
  protected final String TEXT_469 = " - Create table ";
  protected final String TEXT_470 = "\" + tableName_";
  protected final String TEXT_471 = " + \"";
  protected final String TEXT_472 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_473 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_474 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_475 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_479 = " - Clearing table ";
  protected final String TEXT_480 = "\" + tableName_";
  protected final String TEXT_481 = " + \"";
  protected final String TEXT_482 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_483 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_487 = "- Clear table ";
  ...
  protected final String TEXT_493 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_494 = " = conn_";
  protected final String TEXT_495 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_496 = " = stmtTruncCount_";
  protected final String TEXT_497 = ".executeQuery(\"";
  protected final String TEXT_498 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_499 = " = conn_";
  protected final String TEXT_500 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_501 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_502 = " - Trancating table ";
  protected final String TEXT_503 = "\" + tableName_";
  ...
  protected final String TEXT_510 = " - Truncate table ";
  protected final String TEXT_511 = "\" + tableName_";
  protected final String TEXT_512 = " + \"";
  protected final String TEXT_513 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_514 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_515 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_516 = " += rsTruncCount_";
  protected final String TEXT_517 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_518 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_519 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_520 = ".close();" + NL + "\t\t";
  protected final String TEXT_521 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_522 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_523 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_524 = NL + "    \t";
  protected final String TEXT_525 = NL + "    \t\tjava.sql.Statement stmtBulkInsert_";
  protected final String TEXT_526 = " = conn_";
  protected final String TEXT_527 = ".createStatement();" + NL + "    \t\tString bulkSQL_";
  protected final String TEXT_528 = " = \"BULK INSERT ";
  protected final String TEXT_529 = "\" + tableName_";
  protected final String TEXT_530 = " + \"";
  protected final String TEXT_531 = " FROM '\" + ";
  protected final String TEXT_532 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_533 = " + \"',DATAFILETYPE='";
  protected final String TEXT_534 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_535 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_536 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_537 = "+\"')\";" + NL + "    \t\t";
  protected final String TEXT_538 = NL + "    \t\t\tlog.debug(\"";
  protected final String TEXT_539 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_540 = "+\".\");" + NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_541 = " - Bulk inserting data into ";
  protected final String TEXT_542 = "\" + tableName_";
  protected final String TEXT_543 = " + \"";
  protected final String TEXT_544 = ".\" );" + NL + "    \t\t";
  protected final String TEXT_545 = NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_546 = ".execute(bulkSQL_";
  protected final String TEXT_547 = ");" + NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_548 = ".close();" + NL + "    \t\t";
  protected final String TEXT_549 = NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_550 = " - Bulk insert data into ";
  protected final String TEXT_551 = "\" + tableName_";
  protected final String TEXT_552 = " + \"";
  protected final String TEXT_553 = " has finished.\");" + NL + "    \t\t";
  protected final String TEXT_554 = NL + "    \t\t\tint keyCount_";
  protected final String TEXT_555 = " = ";
  protected final String TEXT_556 = ";" + NL + "    \t\t\tif(keyCount_";
  protected final String TEXT_557 = " == 0) {" + NL + "    \t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "    \t\t\t}" + NL + "    \t\t\tString tmpTableName_";
  protected final String TEXT_558 = " = tableName_";
  protected final String TEXT_559 = ";" + NL + "    \t\t\ttableName_";
  protected final String TEXT_560 = " = \"tmp_";
  protected final String TEXT_561 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_565 = " - Creating temp table ";
  protected final String TEXT_566 = "\" + tableName_";
  protected final String TEXT_567 = " + \"";
  protected final String TEXT_568 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_569 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_570 = ".execute(\"";
  protected final String TEXT_571 = ")\");" + NL + "    \t\t\t";
  protected final String TEXT_572 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_573 = " - Create temp table ";
  protected final String TEXT_574 = "\" + tableName_";
  protected final String TEXT_575 = " + \"";
  protected final String TEXT_576 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_577 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_578 = ".close();" + NL + "    \t\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_579 = " = conn_";
  protected final String TEXT_580 = ".createStatement();" + NL + "    \t\t\tString bulkSQL_";
  protected final String TEXT_581 = " = \"BULK INSERT ";
  protected final String TEXT_582 = "\" + tableName_";
  protected final String TEXT_583 = " + \"";
  protected final String TEXT_584 = " FROM '\" + ";
  protected final String TEXT_585 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_586 = " + \"',DATAFILETYPE='";
  protected final String TEXT_587 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_588 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_589 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_590 = "+\"')\";" + NL + "    \t\t\t";
  protected final String TEXT_591 = NL + "    \t\t\t\tlog.debug(\"";
  protected final String TEXT_592 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_593 = "+\".\");" + NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_594 = " - Bulk inserting data into ";
  protected final String TEXT_595 = "\" + tableName_";
  protected final String TEXT_596 = " + \"";
  protected final String TEXT_597 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_598 = NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_599 = ".execute(bulkSQL_";
  protected final String TEXT_600 = ");" + NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_601 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_602 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_603 = " - Bulk insert data into ";
  protected final String TEXT_604 = "\" + tableName_";
  protected final String TEXT_605 = " + \"";
  protected final String TEXT_606 = " has finished.\");" + NL + "    \t\t\t";
  protected final String TEXT_607 = NL + "    \t\t\ttableName_";
  protected final String TEXT_608 = " = tmpTableName_";
  protected final String TEXT_609 = ";" + NL + "    \t\t\ttmpTableName_";
  protected final String TEXT_610 = " = \"tmp_";
  protected final String TEXT_611 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_612 = " = conn_";
  protected final String TEXT_613 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_614 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_615 = " - Updating ";
  protected final String TEXT_616 = "\" + tableName_";
  protected final String TEXT_617 = " + \"";
  protected final String TEXT_618 = " from ";
  protected final String TEXT_619 = "\"+tmpTableName_";
  protected final String TEXT_620 = "+\"";
  protected final String TEXT_621 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_622 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_623 = ".executeUpdate(\"";
  protected final String TEXT_624 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_625 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_626 = ".close();" + NL + "    \t\t\ttableName_";
  protected final String TEXT_627 = " = \"tmp_";
  protected final String TEXT_628 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_629 = " = conn_";
  protected final String TEXT_630 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_631 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_632 = " - Droping temp table ";
  protected final String TEXT_633 = "\" + tableName_";
  protected final String TEXT_634 = " + \"";
  protected final String TEXT_635 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_636 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_637 = ".execute(\"";
  protected final String TEXT_638 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_639 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_640 = " - Drop temp table ";
  protected final String TEXT_641 = "\" + tableName_";
  protected final String TEXT_642 = "+ \"";
  protected final String TEXT_643 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_644 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_645 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_646 = NL + "\t\tif(conn_";
  protected final String TEXT_647 = " != null && !conn_";
  protected final String TEXT_648 = ".isClosed()) {" + NL + "\t\t   ";
