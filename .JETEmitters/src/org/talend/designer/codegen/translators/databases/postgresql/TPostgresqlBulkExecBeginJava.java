...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_327 = NL + "            \tString tableForSearch_";
  protected final String TEXT_328 = " = ";
  protected final String TEXT_329 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_330 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_331 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_332 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_333 = " =  tableForSearch_";
  protected final String TEXT_334 = ".substring(1,tableForSearch_";
  protected final String TEXT_335 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_336 = " =  tableForSearch_";
  protected final String TEXT_337 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_341 = ".getTables(null, conn_";
  protected final String TEXT_342 = ".getSchema(), tableForSearch_";
  protected final String TEXT_343 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_344 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_345 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_346 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_357 = ".equals";
  protected final String TEXT_358 = "IgnoreCase";
  ...
  protected final String TEXT_368 = " - Creating table ";
  ...
  protected final String TEXT_376 = " - Create table ";
  ...
  protected final String TEXT_381 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_387 = " - Droping table ";
  protected final String TEXT_388 = "\" + tableName_";
  protected final String TEXT_389 = " + \"";
  protected final String TEXT_390 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_391 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_392 = ".execute(\"";
  protected final String TEXT_393 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_395 = " - Drop table ";
  protected final String TEXT_396 = "\" + tableName_";
  protected final String TEXT_397 = " + \"";
  protected final String TEXT_398 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_418 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_422 = " - Clearing table ";
  ...
  protected final String TEXT_430 = "- Clear table ";
  protected final String TEXT_431 = "\" + tableName_";
  protected final String TEXT_432 = " + \"";
  protected final String TEXT_433 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_434 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_435 = ".close();" + NL + "\t\t";
  protected final String TEXT_436 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_437 = " = conn_";
  protected final String TEXT_438 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_439 = " = stmtTruncCount_";
  protected final String TEXT_440 = ".executeQuery(\"";
  protected final String TEXT_441 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_442 = " = conn_";
  protected final String TEXT_443 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_444 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_445 = " - Trancating table ";
  protected final String TEXT_446 = "\" + tableName_";
  ...
  protected final String TEXT_453 = " - Truncate table ";
  protected final String TEXT_454 = "\" + tableName_";
  protected final String TEXT_455 = " + \"";
  protected final String TEXT_456 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_464 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_465 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_466 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_467 = NL + "\t";
  protected final String TEXT_468 = NL + "        int keyCount_";
  protected final String TEXT_469 = " = ";
  protected final String TEXT_470 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_471 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        tmpTableName_";
  protected final String TEXT_472 = " = tableName_";
  protected final String TEXT_473 = ";" + NL + "        tableName_";
  protected final String TEXT_474 = " = \"tmp_";
  protected final String TEXT_475 = "\" + \"_\" + pid + Thread.currentThread().getId() ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_479 = " - Creating temp table ";
  protected final String TEXT_480 = "\" + tableName_";
  protected final String TEXT_481 = " + \"";
  protected final String TEXT_482 = ".\" );" + NL + "\t\t";
  protected final String TEXT_483 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_484 = ".execute(\"";
  protected final String TEXT_485 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_486 = ".close();";
  protected final String TEXT_487 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_488 = " - Create temp table ";
  protected final String TEXT_489 = "\" + tableName_";
  protected final String TEXT_490 = " + \"";
  protected final String TEXT_491 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_492 = NL + "        ";
  protected final String TEXT_493 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_494 = " =conn_";
  protected final String TEXT_495 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_496 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_497 = ".close();" + NL + "   \t\t";
  protected final String TEXT_498 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_499 = " = conn_";
  protected final String TEXT_500 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_501 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_502 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_503 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_504 = " - Bulk inserting data into ";
  protected final String TEXT_505 = "\" + tableName_";
  protected final String TEXT_506 = " + \"";
  protected final String TEXT_507 = ".\" );" + NL + "\t\t";
  protected final String TEXT_508 = NL + "        stmtTmpBulk_";
  protected final String TEXT_509 = ".execute(bulkSQL_";
  protected final String TEXT_510 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_511 = ".close();" + NL + "        " + NL + "\t\t";
  protected final String TEXT_512 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_513 = " - Bulk insert data into ";
  protected final String TEXT_514 = "\" + tableName_";
  protected final String TEXT_515 = " + \"";
  protected final String TEXT_516 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_517 = NL + "        tableName_";
  protected final String TEXT_518 = " = tmpTableName_";
  protected final String TEXT_519 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_520 = " = \"tmp_";
  protected final String TEXT_521 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_522 = " = conn_";
  protected final String TEXT_523 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_524 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_525 = " - Updating ";
  protected final String TEXT_526 = "\" + tableName_";
  protected final String TEXT_527 = " + \"";
  protected final String TEXT_528 = " from ";
  protected final String TEXT_529 = "\"+tmpTableName_";
  protected final String TEXT_530 = "+\"";
  protected final String TEXT_531 = ".\");" + NL + "\t\t";
  protected final String TEXT_532 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_533 = ".executeUpdate(\"";
  protected final String TEXT_534 = "\");" + NL + "\t\t";
  protected final String TEXT_535 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_536 = ".close();" + NL + "        tableName_";
  protected final String TEXT_537 = " = tmpTableName_";
  protected final String TEXT_538 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_542 = " - Droping temp table ";
  protected final String TEXT_543 = "\" + tableName_";
  protected final String TEXT_544 = " + \"";
  protected final String TEXT_545 = ".\");" + NL + "\t\t";
  protected final String TEXT_546 = NL + "        stmtTmpDrop_";
  protected final String TEXT_547 = ".execute(\"";
  protected final String TEXT_548 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_549 = ".close();" + NL + "\t\t";
  protected final String TEXT_550 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_551 = " - Drop temp table ";
  protected final String TEXT_552 = "\" + tableName_";
  protected final String TEXT_553 = "+ \"";
  protected final String TEXT_554 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_555 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_556 = " =conn_";
  protected final String TEXT_557 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_558 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_559 = ".close();";
  protected final String TEXT_560 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_561 = " = conn_";
  protected final String TEXT_562 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t";
  protected final String TEXT_563 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_564 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_565 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_566 = " - Inserting records in table ";
  protected final String TEXT_567 = "\" + tableName_";
  protected final String TEXT_568 = " + \"";
  protected final String TEXT_569 = ".\");" + NL + "\t";
  protected final String TEXT_570 = NL + "    stmtBulk_";
  protected final String TEXT_571 = ".execute(bulkSQL_";
  protected final String TEXT_572 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_573 = ".close();    " + NL + "\t";
  protected final String TEXT_574 = NL + "\t\tlog.info(\"";
  protected final String TEXT_575 = " - Insert records in table ";
  protected final String TEXT_576 = "\" + tableName_";
  protected final String TEXT_577 = " + \"";
  protected final String TEXT_578 = " has finished.\");" + NL + "\t";
