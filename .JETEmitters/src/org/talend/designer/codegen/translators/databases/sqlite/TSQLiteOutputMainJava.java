...
public class TSQLiteOutputMainJava {
  ...
  protected final String TEXT_409 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_410 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_411 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_412 = NL + "\t                    for(int countEach_";
  protected final String TEXT_413 = ": pstmt_";
  protected final String TEXT_414 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_415 = " += (countEach_";
  protected final String TEXT_416 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_428 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_429 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_430 = NL + "                        throw(e);";
  protected final String TEXT_431 = NL + "                        int countSum_";
  protected final String TEXT_432 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_433 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_434 = " += (countEach_";
  protected final String TEXT_435 = " < 0 ? 0 : countEach_";
  protected final String TEXT_436 = ");" + NL + "                        }";
  protected final String TEXT_437 = NL + "                            insertedCount_";
  protected final String TEXT_438 = " += countSum_";
  protected final String TEXT_439 = ";";
  protected final String TEXT_440 = NL + "                            updatedCount_";
  protected final String TEXT_441 = " += countSum_";
  protected final String TEXT_442 = ";";
  protected final String TEXT_443 = NL + "                            deletedCount_";
  protected final String TEXT_444 = " += countSum_";
  protected final String TEXT_445 = ";";
  protected final String TEXT_446 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_447 = NL + "                }";
  protected final String TEXT_448 = NL + "                ";
  protected final String TEXT_449 = NL + "                conn_";
  protected final String TEXT_450 = ".commit();";
  protected final String TEXT_451 = NL + "                commitCounter_";
  protected final String TEXT_452 = "=0;" + NL + "            }";
