...
public class TTeradataFastLoadBeginJava
{
  ...
  protected final String TEXT_73 = "=0;" + NL + "\t" + NL + "\tString driverClass_";
  protected final String TEXT_74 = " = \"com.teradata.jdbc.TeraDriver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_75 = ");" + NL + "\tString url_";
  protected final String TEXT_76 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_77 = "+\"/TYPE=FASTLOAD\";" + NL + "\t" + NL + "\tString dbProperties_";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = ";" + NL + "\tif(dbProperties_";
  protected final String TEXT_80 = " != null && dbProperties_";
  protected final String TEXT_81 = ".trim().length() > 0) {" + NL + "\t\turl_";
  protected final String TEXT_82 = " +=\",\"+dbProperties_";
  protected final String TEXT_83 = ";" + NL + "\t}" + NL + "" + NL + "\tString dbUser_";
  ...
  protected final String TEXT_93 = NL + "\tString dbPwd_";
  protected final String TEXT_94 = " = decryptedPassword_";
  protected final String TEXT_95 = ";" + NL + "" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_96 = " = null;" + NL + "\t";
  protected final String TEXT_97 = NL + "\t" + NL + "\tString tableName_";
  protected final String TEXT_98 = " = ";
  protected final String TEXT_99 = ";" + NL + "\tString dbname_";
  protected final String TEXT_100 = " = ";
  protected final String TEXT_101 = ";" + NL + "\tif(dbname_";
  protected final String TEXT_102 = " == null || dbname_";
  protected final String TEXT_103 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  protected final String TEXT_106 = " = dbname_";
  protected final String TEXT_107 = " + \".\" + ";
  protected final String TEXT_108 = ";" + NL + "\t}" + NL + "" + NL + "\tint commitCounter_";
  protected final String TEXT_109 = " = 0;";
  protected final String TEXT_110 = NL + "\tint commitEvery_";
  protected final String TEXT_111 = " = ";
  protected final String TEXT_112 = ";" + NL + "\tconn_";
  protected final String TEXT_113 = ".setAutoCommit(false);";
  protected final String TEXT_114 = NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_115 = " = null;" + NL;
  protected final String TEXT_116 = NL + NL + "\tpstmt_";
  protected final String TEXT_117 = " = conn_";
  protected final String TEXT_118 = ".prepareStatement(\"INSERT INTO \" + tableName_";
