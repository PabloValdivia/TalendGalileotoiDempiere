...
public class TFirebirdOutputMainJava {
  ...
  protected final String TEXT_398 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_399 = " <= commitCounter_";
  protected final String TEXT_400 = ") {";
  protected final String TEXT_401 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_402 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_403 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_404 = NL + "\t                    for(int countEach_";
  protected final String TEXT_405 = ": pstmt_";
  protected final String TEXT_406 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_407 = " += (countEach_";
  protected final String TEXT_408 = " < 0 ? 0 : countEach_";
  protected final String TEXT_409 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_410 = NL + "\t                    ";
  protected final String TEXT_411 = NL + "\t                        insertedCount_";
  protected final String TEXT_412 = " += countSum_";
  protected final String TEXT_413 = ";" + NL + "\t                    ";
  protected final String TEXT_414 = NL + "\t                        updatedCount_";
  protected final String TEXT_415 = " += countSum_";
  protected final String TEXT_416 = ";" + NL + "\t                    ";
  protected final String TEXT_417 = NL + "\t                        deletedCount_";
  protected final String TEXT_418 = " += countSum_";
  protected final String TEXT_419 = ";" + NL + "\t                    ";
  protected final String TEXT_420 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_421 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_422 = NL + "                        throw(e);";
  protected final String TEXT_423 = NL + "                        int countSum_";
  protected final String TEXT_424 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_425 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_426 = " += (countEach_";
  protected final String TEXT_427 = " < 0 ? 0 : countEach_";
  protected final String TEXT_428 = ");" + NL + "                        }";
  protected final String TEXT_429 = NL + "                            insertedCount_";
  protected final String TEXT_430 = " += countSum_";
  protected final String TEXT_431 = ";";
  protected final String TEXT_432 = NL + "                            updatedCount_";
  protected final String TEXT_433 = " += countSum_";
  protected final String TEXT_434 = ";";
  protected final String TEXT_435 = NL + "                            deletedCount_";
  protected final String TEXT_436 = " += countSum_";
  protected final String TEXT_437 = ";";
  protected final String TEXT_438 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_439 = NL + "                }";
  protected final String TEXT_440 = NL + "                ";
  protected final String TEXT_441 = NL + "                conn_";
  protected final String TEXT_442 = ".commit();";
  protected final String TEXT_443 = NL + "                commitCounter_";
  protected final String TEXT_444 = "=0;" + NL + "            }";
