...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_118 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_119 = ")));";
  protected final String TEXT_120 = NL + "            stmtDrop_";
  protected final String TEXT_121 = ".execute(\"";
  protected final String TEXT_122 = "\" ";
  protected final String TEXT_123 = ");";
  protected final String TEXT_124 = NL + "            stmtDrop_";
  protected final String TEXT_125 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_129 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_130 = "));";
  protected final String TEXT_131 = NL + "                    stmtCreate_";
  protected final String TEXT_132 = ".execute(((\"";
  protected final String TEXT_133 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_134 = ".";
  protected final String TEXT_135 = ", \"";
  protected final String TEXT_136 = "\")";
  protected final String TEXT_137 = ".toUpperCase()";
  ...
  protected final String TEXT_166 = NL + "                    String keyCheckTable_";
  protected final String TEXT_167 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_174 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_177 = " + \"]\";";
  protected final String TEXT_178 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_179 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_180 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_295 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_296 = " = ";
  protected final String TEXT_297 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_298 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_299 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_300 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_301 = " =  tableForSearch_";
  protected final String TEXT_302 = ".substring(1,tableForSearch_";
  protected final String TEXT_303 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_304 = " =  tableForSearch_";
  protected final String TEXT_305 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_309 = ".getTables(null, conn_";
  protected final String TEXT_310 = ".getSchema(), tableForSearch_";
  protected final String TEXT_311 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_312 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_313 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_314 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_351 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_352 = " = conn_";
  protected final String TEXT_353 = ".createStatement();";
  protected final String TEXT_354 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_362 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_382 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_383 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_384 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_398 = NL + "                              stmtTruncCount_";
  protected final String TEXT_399 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_400 = "));";
  protected final String TEXT_401 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_402 = " = stmtTruncCount_";
  protected final String TEXT_403 = ".executeQuery(\"";
  protected final String TEXT_404 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_405 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_406 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_410 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_411 = " = conn_";
  protected final String TEXT_412 = ".createStatement();";
  protected final String TEXT_413 = NL + "                              stmtTrunc_";
  protected final String TEXT_414 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_415 = "));";
  protected final String TEXT_416 = NL + "                conn_";
  protected final String TEXT_417 = ".commit();";
  protected final String TEXT_418 = NL + "            stmtTrunc_";
  protected final String TEXT_419 = ".executeUpdate(\"";
  protected final String TEXT_420 = "\");";
  protected final String TEXT_421 = NL + "                if(!conn_";
  protected final String TEXT_422 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_423 = ".commit();" + NL + "                }";
  protected final String TEXT_424 = NL + "            deletedCount_";
  protected final String TEXT_425 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_430 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_431 = " = stmtTruncCount_";
  protected final String TEXT_432 = ".executeQuery(\"";
  protected final String TEXT_433 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_437 = ".commit();";
  protected final String TEXT_438 = NL + "            stmtTrunc_";
  protected final String TEXT_439 = ".executeUpdate(\"";
  protected final String TEXT_440 = "\");";
  protected final String TEXT_441 = NL + "            while(rsTruncCount_";
  protected final String TEXT_442 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_443 = " += rsTruncCount_";
  protected final String TEXT_444 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_445 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_446 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_452 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_453 = " = conn_";
  protected final String TEXT_454 = ".prepareStatement(insert_";
  protected final String TEXT_455 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_456 = NL + "\t    String update_";
  protected final String TEXT_457 = " = \"UPDATE \" + ";
  protected final String TEXT_458 = " + \" SET ";
  protected final String TEXT_459 = " WHERE ";
  ...
  protected final String TEXT_466 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_472 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_476 = " = \"UPDATE \" + ";
  protected final String TEXT_477 = " + \" SET ";
  protected final String TEXT_478 = " WHERE ";
  protected final String TEXT_479 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_484 = " = \"UPDATE \" + ";
  protected final String TEXT_485 = " + \" SET ";
  protected final String TEXT_486 = " WHERE ";
  protected final String TEXT_487 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_491 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_499 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_536 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_537 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_538 = " =null;" + NL + "\t";
  protected final String TEXT_539 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_540 = " = null;" + NL + "\t\t";
  protected final String TEXT_541 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_546 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_547 = " = null;";
  protected final String TEXT_548 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_552 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_556 = NL + NL + NL;
