...
public class THiveConnectionBeginJava
{
  ...
  protected final String TEXT_153 = " + \";\";" + NL + "" + NL + "\t\t\t\t\t// Add HADOOP_CONF_DIR to the classpath if it's present" + NL + "\t\t\t\t\tString hadoopConfDir_";
  ...
  protected final String TEXT_187 = " += urlKerberosParameter + \";ssl=true\" +\";sslTrustStore=\" + tldHiveSslTsPath + \";trustStorePassword=\" + tldHiveSslTsPassword;";
  protected final String TEXT_188 = NL + "\t\t\t\t\t\t\t\turl_";
  protected final String TEXT_189 = " += urlKerberosParameter + \";sasl.qop=auth-conf\";";
  protected final String TEXT_190 = NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\turl_";
  protected final String TEXT_191 = " += urlKerberosParameter;" + NL + "\t\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t// SSL configurations" + NL + "\t\t\t\t\t\tif(tldHiveEnc.equalsIgnoreCase(\"ssl\")){" + NL + "\t\t\t\t\t\t\turl_";
  protected final String TEXT_192 = " += \";ssl=true\" +\";sslTrustStore=\" + tldHiveSslTsPath + \";trustStorePassword=\" + tldHiveSslTsPassword;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}";
  protected final String TEXT_193 = NL + "\t\t\t\t            System.setProperty(\"pname\", \"MapRLogin\");" + NL + "\t\t\t\t            System.setProperty(\"https.protocols\", \"TLSv1.2\");" + NL + "\t\t\t\t            System.setProperty(\"mapr.home.dir\", ";
  protected final String TEXT_194 = ");" + NL + "\t\t\t\t            System.setProperty(\"hadoop.login\", ";
  protected final String TEXT_195 = ");" + NL + "\t\t\t\t            ";
  protected final String TEXT_196 = NL + "\t\t\t\t\t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_197 = ", ";
  protected final String TEXT_198 = ");";
  protected final String TEXT_199 = NL + "                            com.mapr.login.client.MapRLoginHttpsClient maprLogin_";
  protected final String TEXT_200 = " = new com.mapr.login.client.MapRLoginHttpsClient();" + NL + "                            maprLogin_";
  protected final String TEXT_201 = ".getMapRCredentialsViaKerberos(";
  protected final String TEXT_202 = ", ";
  protected final String TEXT_203 = ");";
  protected final String TEXT_204 = NL + "\t\t\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  protected final String TEXT_205 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_206 = ");";
  protected final String TEXT_207 = NL + "\t\t\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  protected final String TEXT_208 = " = ";
  protected final String TEXT_209 = ";";
  protected final String TEXT_210 = NL + "\t\t\t\t\t\t\t\tString url_";
  protected final String TEXT_211 = " = \"jdbc:";
  protected final String TEXT_212 = "://\" + ";
  protected final String TEXT_213 = " + \":\" + ";
  protected final String TEXT_214 = " + \"/\" + ";
  protected final String TEXT_215 = " + \";principal=\" + ";
  protected final String TEXT_216 = "+\";ssl=true\" +\";sslTrustStore=\" + ";
  protected final String TEXT_217 = " + \";trustStorePassword=\" + decryptedSslStorePassword_";
  protected final String TEXT_218 = ";";
  protected final String TEXT_219 = NL + "\t\t\t\t\t\t\tString url_";
  protected final String TEXT_220 = " = \"jdbc:";
  protected final String TEXT_221 = "://\" + ";
  protected final String TEXT_222 = " + \":\" + ";
  protected final String TEXT_223 = " + \"/\" + ";
  protected final String TEXT_224 = " + \";principal=\" + ";
  protected final String TEXT_225 = "+\";sasl.qop=auth-conf\";";
  protected final String TEXT_226 = NL + "\t\t\t\t\t\tString url_";
  protected final String TEXT_227 = " = \"jdbc:";
  protected final String TEXT_228 = "://\" + ";
  protected final String TEXT_229 = " + \":\" + ";
  protected final String TEXT_230 = " + \"/\" + ";
  protected final String TEXT_231 = " + \";principal=\" + ";
  protected final String TEXT_232 = ";";
  protected final String TEXT_233 = NL + "\t\t\t\t            System.setProperty(\"pname\", \"MapRLogin\");" + NL + "\t\t\t\t            System.setProperty(\"https.protocols\", \"TLSv1.2\");" + NL + "\t\t\t\t            System.setProperty(\"mapr.home.dir\", ";
  protected final String TEXT_234 = ");" + NL + "\t\t\t\t            com.mapr.login.client.MapRLoginHttpsClient maprLogin_";
  protected final String TEXT_235 = " = new com.mapr.login.client.MapRLoginHttpsClient();" + NL + "\t\t\t\t            ";
  protected final String TEXT_236 = NL + "\t\t\t\t                System.setProperty(\"hadoop.login\", ";
  protected final String TEXT_237 = ");" + NL + "\t\t\t\t                ";
  protected final String TEXT_238 = NL + "\t\t\t\t                maprLogin_";
  protected final String TEXT_239 = ".setCheckUGI(false);" + NL + "\t\t\t\t                ";
  protected final String TEXT_240 = NL + "                                String decryptedMaprPassword_";
  protected final String TEXT_241 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_242 = ");";
  protected final String TEXT_243 = NL + "                                String decryptedMaprPassword_";
  ...
  protected final String TEXT_252 = NL + "\t\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  ...
  protected final String TEXT_259 = " = \"jdbc:";
  protected final String TEXT_260 = "://\" + ";
  protected final String TEXT_261 = " + \":\" + ";
  protected final String TEXT_262 = " + \"/\" + ";
  protected final String TEXT_263 = "+ \";ssl=true\" +\";sslTrustStore=\" + ";
  protected final String TEXT_264 = " + \";trustStorePassword=\" + decryptedSslStorePassword_";
  ...
  protected final String TEXT_274 = ";" + NL + "\t\t\t\tif(!\"\".equals(additionalJdbcSettings_";
  protected final String TEXT_275 = ".trim())) {" + NL + "\t\t\t\t\tif(!additionalJdbcSettings_";
  protected final String TEXT_276 = ".startsWith(\";\")) {" + NL + "\t\t\t\t\t\tadditionalJdbcSettings_";
  protected final String TEXT_277 = " = \";\" + additionalJdbcSettings_";
  protected final String TEXT_278 = ";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\turl_";
  protected final String TEXT_279 = " += additionalJdbcSettings_";
  protected final String TEXT_280 = ";" + NL + "\t\t\t\t}";
  protected final String TEXT_281 = NL + "\t\t\tconn_";
  protected final String TEXT_282 = ".setAutoCommit(";
  protected final String TEXT_283 = ");";
  protected final String TEXT_284 = NL + NL + "\t";
  protected final String TEXT_285 = NL + NL + "\tString dbUser_";
  protected final String TEXT_286 = " = ";
  protected final String TEXT_287 = ";";
  protected final String TEXT_288 = NL + "\t" + NL + "\t";
  protected final String TEXT_289 = NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_298 = NL + "\t\tString dbPwd_";
  protected final String TEXT_299 = " = decryptedPassword_";
  protected final String TEXT_300 = ";" + NL + "\t";
  protected final String TEXT_301 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_302 = " = null;" + NL + "\t";
  protected final String TEXT_303 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_304 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_305 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_306 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_307 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_309 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_310 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_311 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_312 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_313 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_314 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_315 = " - Written records count: \" + nb_line_";
  protected final String TEXT_316 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_318 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_319 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_320 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_321 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_323 = " - Writing the record \" + nb_line_";
  protected final String TEXT_324 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_326 = " - Processing the record \" + nb_line_";
  protected final String TEXT_327 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_328 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_329 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_330 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_331 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_332 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_333 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_335 = " - Uses an existing connection ";
  protected final String TEXT_336 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_337 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_338 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_339 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_340 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\tconn_";
  protected final String TEXT_343 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_344 = ", dbUser_";
  protected final String TEXT_345 = ", dbPwd_";
  protected final String TEXT_346 = ");" + NL + "\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\tconn_";
  protected final String TEXT_348 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\tconn_";
  protected final String TEXT_350 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_351 = NL + "\t\t\tconn_";
  protected final String TEXT_352 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_353 = NL + "\t\t\t\tconn_";
  protected final String TEXT_354 = ".setAutoCommit(";
  protected final String TEXT_355 = ");" + NL + "\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\tlog.";
  protected final String TEXT_357 = "(\"";
  protected final String TEXT_358 = " - \" + ";
  protected final String TEXT_359 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_360 = NL + "\t    \t\tlog.";
  protected final String TEXT_361 = "(\"";
  protected final String TEXT_362 = "\");" + NL + "\t\t\t";
  protected final String TEXT_363 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_364 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_366 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_367 = ": pstmt_";
  protected final String TEXT_368 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_369 = " += (countEach_";
  protected final String TEXT_370 = " < 0 ? 0 : ";
  protected final String TEXT_371 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_372 = NL + "\t";
  protected final String TEXT_373 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_374 = ")) {";
  protected final String TEXT_375 = NL + "\t\t";
  protected final String TEXT_376 = NL + "\t\t";
  protected final String TEXT_377 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_378 = "\", conn_";
  protected final String TEXT_379 = ");";
  protected final String TEXT_380 = NL + "\t}";
  protected final String TEXT_381 = NL + "\tif (null != conn_";
  protected final String TEXT_382 = ") {" + NL + "\t\t";
  protected final String TEXT_383 = NL + "\t}";
  protected final String TEXT_384 = NL;
  protected final String TEXT_385 = NL + "\tglobalMap.put(\"current_client_path_separator\", System.getProperty(\"path.separator\"));" + NL + "\tSystem.setProperty(\"path.separator\", ";
  protected final String TEXT_386 = ");" + NL + "" + NL + "\tjava.sql.Statement init_";
  ...
  protected final String TEXT_390 = ".execute(\"SET mapred.job.map.memory.mb=\" + ";
  protected final String TEXT_391 = ");" + NL + "\t    init_";
  protected final String TEXT_392 = ".execute(\"SET mapred.job.reduce.memory.mb=\" + ";
  protected final String TEXT_393 = ");";
  protected final String TEXT_394 = NL + "\t\tinit_";
  protected final String TEXT_395 = ".execute(\"SET dfs.namenode.kerberos.principal=\" + ";
  protected final String TEXT_396 = ");";
  protected final String TEXT_397 = NL + "\t\t\tinit_";
  protected final String TEXT_398 = ".execute(\"SET mapreduce.jobtracker.kerberos.principal=\" + ";
  protected final String TEXT_399 = ");";
  protected final String TEXT_400 = NL + "\t\t\tinit_";
  protected final String TEXT_401 = ".execute(\"SET yarn.resourcemanager.principal=\" + ";
  protected final String TEXT_402 = ");";
  protected final String TEXT_403 = NL + "    \t\tinit_";
  protected final String TEXT_404 = ".execute(\"SET mapreduce.framework.name=yarn\");" + NL + "    \t\tinit_";
  protected final String TEXT_405 = ".execute(\"SET yarn.resourcemanager.address=\" + ";
  protected final String TEXT_406 = ");";
  protected final String TEXT_407 = NL + "\t\t\tinit_";
  protected final String TEXT_408 = ".execute(\"SET mapreduce.jobhistory.address=\" + ";
  protected final String TEXT_409 = ");" + NL + "\t\t\t";
  protected final String TEXT_410 = NL + "\t\t\tinit_";
  protected final String TEXT_411 = ".execute(\"SET dfs.client.use.datanode.hostname=true\");";
  protected final String TEXT_412 = NL + "\t\t\tinit_";
  protected final String TEXT_413 = ".execute(\"SET yarn.resourcemanager.scheduler.address=\" + ";
  protected final String TEXT_414 = ");";
  protected final String TEXT_415 = NL + "\t\t\tinit_";
  protected final String TEXT_416 = ".execute(\"SET fs.default.name=\" + ";
  protected final String TEXT_417 = ");";
  protected final String TEXT_418 = NL + "\t\t\t\tinit_";
  protected final String TEXT_419 = ".execute(\"SET mapreduce.app-submission.cross-platform=true\");";
  protected final String TEXT_420 = NL + "\t\t\t\tinit_";
  protected final String TEXT_421 = ".execute(\"SET mapreduce.job.map.output.collector.class=org.apache.hadoop.mapred.MapRFsOutputBuffer\");" + NL + "\t\t\t\tinit_";
  protected final String TEXT_422 = ".execute(\"SET mapreduce.job.reduce.shuffle.consumer.plugin.class=org.apache.hadoop.mapreduce.task.reduce.DirectShuffle\");";
  protected final String TEXT_423 = NL + "\t\t\t\tinit_";
  protected final String TEXT_424 = ".execute(\"SET mapreduce.application.classpath=";
  protected final String TEXT_425 = "\");";
  protected final String TEXT_426 = NL + "\t\t\tinit_";
  protected final String TEXT_427 = ".execute(\"SET yarn.application.classpath=";
  protected final String TEXT_428 = "\");";
  protected final String TEXT_429 = NL + "\t\t\tinit_";
  protected final String TEXT_430 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_431 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_432 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_433 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_434 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_435 = ");";
  protected final String TEXT_436 = NL + "\t\t\tinit_";
  protected final String TEXT_437 = ".execute(\"SET \"+";
  protected final String TEXT_438 = "+\"=\"+";
  protected final String TEXT_439 = ");";
  protected final String TEXT_440 = NL + NL + "\t";
  protected final String TEXT_441 = NL;
  protected final String TEXT_442 = NL + "    \t\tinit_";
  protected final String TEXT_443 = ".execute(\"SET hive.execution.engine=tez\");";
  protected final String TEXT_444 = NL + "                        System.err.println(\"Please set the path of Tez lib in 'Tez lib path'!\");";
  protected final String TEXT_445 = NL;
  protected final String TEXT_446 = NL + "        String username_";
  protected final String TEXT_447 = " = (";
  protected final String TEXT_448 = " != null && !\"\".equals(";
  protected final String TEXT_449 = ")) ? ";
  protected final String TEXT_450 = " : System.getProperty(\"user.name\");;" + NL + "        org.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_451 = " = null;";
  protected final String TEXT_452 = NL + "        org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_453 = " = new org.apache.hadoop.conf.Configuration(); " + NL + "        conf_";
  protected final String TEXT_454 = ".set(\"";
  protected final String TEXT_455 = "\", ";
  protected final String TEXT_456 = ");" + NL + "        ";
  protected final String TEXT_457 = NL + "            conf_";
  protected final String TEXT_458 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_459 = NL + "        \t\tconf_";
  protected final String TEXT_460 = ".set(";
  protected final String TEXT_461 = " ,";
  protected final String TEXT_462 = ");" + NL + "        \t";
  protected final String TEXT_463 = NL + "            username_";
  protected final String TEXT_464 = " = null;" + NL + "    \t\tconf_";
  protected final String TEXT_465 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_466 = ");" + NL + "    \t\t";
  protected final String TEXT_467 = NL + "    \t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_468 = ", ";
  protected final String TEXT_469 = ");" + NL + "    \t\t";
  protected final String TEXT_470 = NL + "\t\t\tconf_";
  protected final String TEXT_471 = ".set(\"hadoop.job.ugi\",username_";
  protected final String TEXT_472 = "+\",\"+username_";
  protected final String TEXT_473 = ");" + NL + "        \tfs_";
  protected final String TEXT_474 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL + "        \t" + NL + "        \tif(username_";
  protected final String TEXT_477 = " == null || \"\".equals(username_";
  protected final String TEXT_478 = ")){" + NL + "        \t\tfs_";
  protected final String TEXT_479 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_480 = ");" + NL + "        \t}else{" + NL + "        \t\tfs_";
  protected final String TEXT_481 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_482 = ".get(\"";
  protected final String TEXT_483 = "\")),conf_";
  protected final String TEXT_484 = ",username_";
  protected final String TEXT_485 = ");" + NL + "        \t}\t";
  protected final String TEXT_486 = NL + "                    String hdfsUserName_";
  protected final String TEXT_487 = " = (";
  protected final String TEXT_488 = " != null && !\"\".equals(";
  protected final String TEXT_489 = ")) ? ";
  protected final String TEXT_490 = " : System.getProperty(\"user.name\");" + NL + "                    String tezLibPath_";
  protected final String TEXT_491 = " = \"/tmp/\" + hdfsUserName_";
  protected final String TEXT_492 = " + \"/talend_tez_libs/";
  protected final String TEXT_493 = "\";";
  protected final String TEXT_494 = NL + "                    String tezLibPath_";
  protected final String TEXT_495 = " = ";
  protected final String TEXT_496 = ";";
  protected final String TEXT_497 = NL + "                fs_";
  protected final String TEXT_498 = ".mkdirs(new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_499 = "));";
  protected final String TEXT_500 = NL + "                String[] classPaths_";
  protected final String TEXT_501 = " = System.getProperty(\"java.class.path\").split(";
  protected final String TEXT_502 = "String.valueOf(globalMap.get(\"current_client_path_separator\"))";
  protected final String TEXT_503 = "System.getProperty(\"path.separator\")";
  protected final String TEXT_504 = ");" + NL + "                String tezLibLocalPath_";
  protected final String TEXT_505 = " = null;" + NL + "                for(String classPath_";
  protected final String TEXT_506 = " : classPaths_";
  protected final String TEXT_507 = "){";
  protected final String TEXT_508 = NL + "                        if(classPath_";
  protected final String TEXT_509 = ".endsWith(\"";
  protected final String TEXT_510 = "\")){" + NL + "                            org.apache.hadoop.fs.Path tezJarPath_";
  protected final String TEXT_511 = " = new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_512 = " + \"/";
  protected final String TEXT_513 = "\");" + NL + "                            if(!fs_";
  protected final String TEXT_514 = ".exists(tezJarPath_";
  protected final String TEXT_515 = ")){" + NL + "                                fs_";
  protected final String TEXT_516 = ".copyFromLocalFile(false, false, new org.apache.hadoop.fs.Path(classPath_";
  protected final String TEXT_517 = "), tezJarPath_";
  protected final String TEXT_518 = ");" + NL + "                            }" + NL + "                        }";
  protected final String TEXT_519 = NL + "                }";
  protected final String TEXT_520 = NL + "                String tezLibPath_";
  protected final String TEXT_521 = " = ";
  protected final String TEXT_522 = ";";
  protected final String TEXT_523 = NL + "\t\t\tStringBuilder script_";
  protected final String TEXT_524 = " = new StringBuilder();" + NL + "\t\t\tString[] tezLibPaths_";
  protected final String TEXT_525 = " = tezLibPath_";
  protected final String TEXT_526 = ".split(\",\");" + NL + "\t\t\tscript_";
  protected final String TEXT_527 = ".append(\"SET tez.lib.uris=\");" + NL + "\t\t\tint tezLibPathCount_";
  protected final String TEXT_528 = " = 1;" + NL + "\t\t\tfor(String tezLibPathKey_";
  protected final String TEXT_529 = " : tezLibPaths_";
  protected final String TEXT_530 = "){" + NL + "\t\t\t\t script_";
  protected final String TEXT_531 = ".append(";
  protected final String TEXT_532 = " + \"/\" + tezLibPathKey_";
  protected final String TEXT_533 = ");" + NL + "\t\t\t\t if(tezLibPathCount_";
  protected final String TEXT_534 = " < tezLibPaths_";
  protected final String TEXT_535 = ".length){" + NL + "\t\t\t\t \tscript_";
  protected final String TEXT_536 = ".append(\",\");" + NL + "\t\t\t\t }" + NL + "\t\t\t\t tezLibPathCount_";
  protected final String TEXT_537 = "++;" + NL + "\t\t\t}" + NL + "\t\t\tinit_";
  protected final String TEXT_538 = ".execute(script_";
  protected final String TEXT_539 = ".toString());" + NL + "\t\t";
  protected final String TEXT_540 = NL + "\t";
  protected final String TEXT_541 = NL + NL + "\tinit_";
  protected final String TEXT_542 = ".close();" + NL + "" + NL + "\t";
  protected final String TEXT_543 = NL + "\t\tjava.sql.Statement statement_";
  protected final String TEXT_544 = " = conn_";
  protected final String TEXT_545 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_546 = NL + "\t\t\tstatement_";
  protected final String TEXT_547 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_548 = ");" + NL + "\t\t";
  protected final String TEXT_549 = NL + NL + "\t\t";
  protected final String TEXT_550 = NL + "\t\t\tstatement_";
  protected final String TEXT_551 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_552 = ");" + NL + "\t\t";
  protected final String TEXT_553 = NL + NL + "\t\t";
  protected final String TEXT_554 = NL + "\t\t\tstatement_";
  protected final String TEXT_555 = ".execute(\"SET zookeeper.znode.parent=\"+";
  protected final String TEXT_556 = ");" + NL + "\t\t";
  protected final String TEXT_557 = NL + NL + "\t\t";
  protected final String TEXT_558 = NL + "\t\t\tstatement_";
  protected final String TEXT_559 = ".execute(\"SET hbase.security.authentication=kerberos\");" + NL + "\t\t\tstatement_";
  protected final String TEXT_560 = ".execute(\"SET hbase.rpc.engine=org.apache.hadoop.hbase.ipc.SecureRpcEngine\");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_561 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_562 = ".execute(\"SET hbase.master.kerberos.principal=\"+";
  protected final String TEXT_563 = ");" + NL + "\t\t\t";
  protected final String TEXT_564 = NL + "\t\t\t";
  protected final String TEXT_565 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_566 = ".execute(\"SET hbase.regionserver.kerberos.principal=\"+";
  protected final String TEXT_567 = ");" + NL + "\t\t\t";
  protected final String TEXT_568 = NL + "\t\t";
  protected final String TEXT_569 = NL + NL + "\t\t";
  protected final String TEXT_570 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_571 = ".execute(\"add jar \"+";
  protected final String TEXT_572 = ");" + NL + "\t\t";
  protected final String TEXT_573 = NL + "\t\tstatement_";
  protected final String TEXT_574 = ".close();" + NL + "\t";
  protected final String TEXT_575 = NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_576 = "\",conn_";
  protected final String TEXT_577 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  ...
  protected final String TEXT_582 = ");" + NL + "\t\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "\t}" + NL + "" + NL + "\tString currentClientUsername_";
  protected final String TEXT_583 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "\tif(currentClientUsername_";
  protected final String TEXT_584 = "!=null) {" + NL + "\t\tSystem.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_585 = ");" + NL + "\t\tglobalMap.put(\"current_client_user_name\", null);" + NL + "\t}" + NL + "" + NL + "\tString originalHadoopUsername_";
  protected final String TEXT_586 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_587 = "\");" + NL + "\tif(originalHadoopUsername_";
  protected final String TEXT_588 = "!=null) {" + NL + "\t\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_589 = ");" + NL + "\t\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_590 = "\", null);" + NL + "\t} else {" + NL + "\t\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "\t}";
