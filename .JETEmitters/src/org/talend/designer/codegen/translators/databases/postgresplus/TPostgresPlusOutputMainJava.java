...
public class TPostgresPlusOutputMainJava {
  ...
  protected final String TEXT_394 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_395 = " <= commitCounter_";
  protected final String TEXT_396 = ") {";
  protected final String TEXT_397 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_398 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_399 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_400 = NL + "\t                    for(int countEach_";
  protected final String TEXT_401 = ": pstmt_";
  protected final String TEXT_402 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_403 = " += (countEach_";
  protected final String TEXT_404 = " < 0 ? 0 : countEach_";
  protected final String TEXT_405 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_406 = NL + "\t                    ";
  protected final String TEXT_407 = NL + "\t                        insertedCount_";
  protected final String TEXT_408 = " += countSum_";
  protected final String TEXT_409 = ";" + NL + "\t                    ";
  protected final String TEXT_410 = NL + "\t                        updatedCount_";
  protected final String TEXT_411 = " += countSum_";
  protected final String TEXT_412 = ";" + NL + "\t                    ";
  protected final String TEXT_413 = NL + "\t                        deletedCount_";
  protected final String TEXT_414 = " += countSum_";
  protected final String TEXT_415 = ";" + NL + "\t                    ";
  protected final String TEXT_416 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_417 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_418 = NL + "                        throw(e);";
  protected final String TEXT_419 = NL + "                        int countSum_";
  protected final String TEXT_420 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_421 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_422 = " += (countEach_";
  protected final String TEXT_423 = " < 0 ? 0 : countEach_";
  protected final String TEXT_424 = ");" + NL + "                        }";
  protected final String TEXT_425 = NL + "                            insertedCount_";
  protected final String TEXT_426 = " += countSum_";
  protected final String TEXT_427 = ";";
  protected final String TEXT_428 = NL + "                            updatedCount_";
  protected final String TEXT_429 = " += countSum_";
  protected final String TEXT_430 = ";";
  protected final String TEXT_431 = NL + "                            deletedCount_";
  protected final String TEXT_432 = " += countSum_";
  ...
  protected final String TEXT_439 = NL + "                commitCounter_";
  protected final String TEXT_440 = "=0;" + NL + "            }";
