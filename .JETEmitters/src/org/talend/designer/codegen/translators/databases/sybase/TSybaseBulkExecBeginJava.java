...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_283 = NL + "            \tString tableForSearch_";
  protected final String TEXT_284 = " = ";
  protected final String TEXT_285 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_286 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_287 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_288 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_289 = " =  tableForSearch_";
  protected final String TEXT_290 = ".substring(1,tableForSearch_";
  protected final String TEXT_291 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_292 = " =  tableForSearch_";
  protected final String TEXT_293 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_297 = ".getTables(null, conn_";
  protected final String TEXT_298 = ".getSchema(), tableForSearch_";
  protected final String TEXT_299 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_300 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_301 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_302 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_303 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_304 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_305 = " = conn_";
  protected final String TEXT_306 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_307 = " = dbMetaData_";
  protected final String TEXT_308 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_309 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_310 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_311 = " = rsTable_";
  protected final String TEXT_312 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_319 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_320 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_321 = " = conn_";
  protected final String TEXT_322 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_323 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_324 = " - Creating table ";
  ...
  protected final String TEXT_332 = " - Create table ";
  protected final String TEXT_333 = "\" + tableName_";
  protected final String TEXT_334 = " + \"";
  protected final String TEXT_335 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_336 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_337 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_338 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_339 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_343 = " - Droping table ";
  ...
  protected final String TEXT_351 = " - Drop table ";
  protected final String TEXT_352 = "\" + tableName_";
  protected final String TEXT_353 = " + \"";
  protected final String TEXT_354 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_356 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_360 = " - Creating table ";
  ...
  protected final String TEXT_368 = " - Create table ";
  ...
  protected final String TEXT_378 = " - Clearing table ";
  ...
  protected final String TEXT_386 = "- Clear table ";
  protected final String TEXT_387 = "\" + tableName_";
  protected final String TEXT_388 = " + \"";
  protected final String TEXT_389 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_391 = ".close();" + NL + "\t\t";
  protected final String TEXT_392 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_393 = " = conn_";
  protected final String TEXT_394 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_395 = " = stmtTruncCount_";
  protected final String TEXT_396 = ".executeQuery(\"";
  protected final String TEXT_397 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_401 = " - Trancating table ";
  protected final String TEXT_402 = "\" + tableName_";
  protected final String TEXT_403 = " + \"";
  protected final String TEXT_404 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_406 = ".executeUpdate(\"";
  protected final String TEXT_407 = "\");" + NL + "   \t    \t";
  protected final String TEXT_408 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_409 = " - Truncate table ";
  protected final String TEXT_410 = "\" + tableName_";
  protected final String TEXT_411 = " + \"";
  protected final String TEXT_412 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_414 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_415 = " += rsTruncCount_";
  protected final String TEXT_416 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_417 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_418 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_419 = ".close();" + NL + "\t\t";
  protected final String TEXT_420 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_421 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_422 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_423 = NL + "\t";
  protected final String TEXT_424 = NL + NL + "StringBuilder command_";
  protected final String TEXT_425 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_426 = ".append(";
  protected final String TEXT_427 = " + \" \");";
  protected final String TEXT_428 = NL + "    String tmpTableName_";
  protected final String TEXT_429 = " = tableName_";
  protected final String TEXT_430 = ";" + NL + "    tableName_";
  protected final String TEXT_431 = " = \"tmp_";
  protected final String TEXT_432 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_433 = " != null && dbschema_";
  protected final String TEXT_434 = ".trim().length() != 0) {" + NL + "    \ttableName_";
  protected final String TEXT_435 = "=dbschema_";
  protected final String TEXT_436 = " + \".\" + tableName_";
  protected final String TEXT_437 = ";" + NL + "    }";
  protected final String TEXT_438 = NL + "if(dbschema_";
  protected final String TEXT_439 = " != null && dbschema_";
  protected final String TEXT_440 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_441 = ".append(db_";
  protected final String TEXT_442 = " + \".\" + tableName_";
  protected final String TEXT_443 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_444 = ".append(db_";
  protected final String TEXT_445 = " + \"..\" + tableName_";
  protected final String TEXT_446 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_447 = ".append(\" in \" + ";
  protected final String TEXT_448 = ");" + NL + "String headRow_";
  protected final String TEXT_449 = " = ";
  protected final String TEXT_450 = ";" + NL + "if(headRow_";
  protected final String TEXT_451 = " != null && headRow_";
  protected final String TEXT_452 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_453 = ".append(\" -F \" + headRow_";
  protected final String TEXT_454 = ");" + NL + "}" + NL;
  protected final String TEXT_455 = NL + "\tcommand_";
  protected final String TEXT_456 = ".append(\" -b \" + ";
  protected final String TEXT_457 = ");";
  protected final String TEXT_458 = NL + NL + "command_";
  protected final String TEXT_459 = ".append(\" -t \" + ";
  protected final String TEXT_460 = ");" + NL + "command_";
  protected final String TEXT_461 = ".append(\" -r \" + ";
  protected final String TEXT_462 = ");" + NL + "command_";
  protected final String TEXT_463 = ".append(\" -c -U \" + dbUser_";
  protected final String TEXT_464 = " + \" -P \" + dbPwd_";
  protected final String TEXT_465 = ");";
  protected final String TEXT_466 = NL + "command_";
  protected final String TEXT_467 = ".append(\" -I \" + ";
  protected final String TEXT_468 = ");";
  protected final String TEXT_469 = NL + "    command_";
  protected final String TEXT_470 = ".append(\" -S \" + ";
  protected final String TEXT_471 = ");";
  protected final String TEXT_472 = NL + "\tcommand_";
  protected final String TEXT_473 = ".append(\" -S \" + host_";
  protected final String TEXT_474 = ");";
  protected final String TEXT_475 = NL + "String encoding_";
  protected final String TEXT_476 = " = ";
  protected final String TEXT_477 = ";" + NL + "if(encoding_";
  protected final String TEXT_478 = " != null && encoding_";
  protected final String TEXT_479 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_480 = ".append(\" -J \" + encoding_";
  protected final String TEXT_481 = ");" + NL + "}" + NL;
  protected final String TEXT_482 = NL + "\tlog.info(\"";
  protected final String TEXT_483 = " - Executing command:'\" + command_";
  protected final String TEXT_484 = " + \"'.\");";
  protected final String TEXT_485 = NL + "    Runtime runtime_";
  protected final String TEXT_486 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_487 = " = runtime_";
  protected final String TEXT_488 = ".exec(command_";
  protected final String TEXT_489 = ".toString());";
  protected final String TEXT_490 = NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_491 = " = conn_";
  protected final String TEXT_492 = ".createStatement();";
  protected final String TEXT_493 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_494 = " - Creating temp table ";
  protected final String TEXT_495 = "\" + tableName_";
  protected final String TEXT_496 = " + \"";
  protected final String TEXT_497 = ".\" );" + NL + "\t\t";
  protected final String TEXT_498 = NL + "        stmtCreateTmp_";
  protected final String TEXT_499 = ".execute(\"";
  protected final String TEXT_500 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_501 = ".close();            ";
  protected final String TEXT_502 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_503 = " - Create temp table ";
  protected final String TEXT_504 = "\" + tableName_";
  protected final String TEXT_505 = " + \"";
  protected final String TEXT_506 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_507 = NL + "        Runtime runtime_";
  protected final String TEXT_508 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_509 = " = runtime_";
  protected final String TEXT_510 = ".exec(command_";
  protected final String TEXT_511 = ".toString());       ";
  protected final String TEXT_512 = NL + NL + "Thread normal_";
  protected final String TEXT_513 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_514 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_515 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_516 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_517 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_518 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_519 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_520 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_521 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_522 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_523 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_524 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_525 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_526 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_527 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_528 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_529 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_530 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_531 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_532 = ".interrupt();" + NL + "error_";
  protected final String TEXT_533 = ".interrupt();";
  protected final String TEXT_534 = NL + "\tlog.info(\"";
  protected final String TEXT_535 = " - Excute command: '\" + command_";
  protected final String TEXT_536 = " + \"' has finished.\");";
