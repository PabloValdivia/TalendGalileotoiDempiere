...
public class TGreenplumOutputMainJava {
  ...
  protected final String TEXT_335 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_336 = " <= commitCounter_";
  protected final String TEXT_337 = ") {";
  protected final String TEXT_338 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_339 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_340 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_341 = NL + "\t                    for(int countEach_";
  protected final String TEXT_342 = ": pstmt_";
  protected final String TEXT_343 = ".executeBatch()) {" + NL + "\t                        countSum_";
  ...
  protected final String TEXT_348 = NL + "\t                        insertedCount_";
  protected final String TEXT_349 = " += countSum_";
  protected final String TEXT_350 = ";" + NL + "\t                    ";
  protected final String TEXT_351 = NL + "\t                        updatedCount_";
  protected final String TEXT_352 = " += countSum_";
  protected final String TEXT_353 = ";" + NL + "\t                    ";
  protected final String TEXT_354 = NL + "\t                        deletedCount_";
  protected final String TEXT_355 = " += countSum_";
  protected final String TEXT_356 = ";" + NL + "\t                    ";
  protected final String TEXT_357 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_358 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_359 = NL + "                        throw(e);";
  protected final String TEXT_360 = NL + "                        int countSum_";
  protected final String TEXT_361 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_362 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_363 = " += (countEach_";
  protected final String TEXT_364 = " < 0 ? 0 : countEach_";
  protected final String TEXT_365 = ");" + NL + "                        }";
  protected final String TEXT_366 = NL + "                            insertedCount_";
  protected final String TEXT_367 = " += countSum_";
  protected final String TEXT_368 = ";";
  protected final String TEXT_369 = NL + "                            updatedCount_";
  protected final String TEXT_370 = " += countSum_";
  protected final String TEXT_371 = ";";
  protected final String TEXT_372 = NL + "                            deletedCount_";
  protected final String TEXT_373 = " += countSum_";
  protected final String TEXT_374 = ";";
  protected final String TEXT_375 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_376 = NL + "                }";
  protected final String TEXT_377 = NL + "                ";
  protected final String TEXT_378 = NL + "                conn_";
  protected final String TEXT_379 = ".commit();";
  protected final String TEXT_380 = NL + "                commitCounter_";
  protected final String TEXT_381 = "=0;" + NL + "            }";
