...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_398 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_399 = ".";
  protected final String TEXT_400 = ",\"";
  protected final String TEXT_401 = "\")";
  protected final String TEXT_402 = ".toUpperCase()";
  protected final String TEXT_403 = "+\") VALUES (";
  protected final String TEXT_404 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_426 = "    " + NL + "" + NL + "\t\t\t\tpstmt_";
  ...
  protected final String TEXT_432 = " + \" SET ";
  protected final String TEXT_433 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_434 = ".";
  protected final String TEXT_435 = ", \"";
  protected final String TEXT_436 = "\")";
  protected final String TEXT_437 = ".toUpperCase()";
  protected final String TEXT_438 = "+\" WHERE ";
  protected final String TEXT_439 = "\";";
  protected final String TEXT_440 = NL + "\t\t\t\t\t\tString update_";
  protected final String TEXT_441 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_442 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_443 = ".";
  protected final String TEXT_444 = ", \"";
  protected final String TEXT_445 = "\")";
  protected final String TEXT_446 = ".toUpperCase()";
  protected final String TEXT_447 = "+\" WHERE ";
  protected final String TEXT_448 = "\";";
  protected final String TEXT_449 = NL + "\t\t\t\t";
  protected final String TEXT_450 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_451 = " = new StringBuffer(update_";
  protected final String TEXT_452 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_453 = ".insert(update_";
  protected final String TEXT_454 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_455 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_456 = " =updateStringBuffer_";
  protected final String TEXT_457 = ".toString(); ";
  protected final String TEXT_458 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_459 = " = conn_";
  protected final String TEXT_460 = ".prepareStatement(update_";
  protected final String TEXT_461 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_462 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_463 = " = conn_";
  protected final String TEXT_464 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_474 = ".toUpperCase()";
  protected final String TEXT_475 = "+\") VALUES (";
  protected final String TEXT_476 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_485 = ".toUpperCase()";
  protected final String TEXT_486 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_487 = ".";
  protected final String TEXT_488 = ")+\")\";";
  protected final String TEXT_489 = NL + "\t\t\t\t\t\tString update_";
  protected final String TEXT_490 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_491 = " + \" SET ";
  protected final String TEXT_492 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_493 = ".";
  protected final String TEXT_494 = ", \"";
  protected final String TEXT_495 = "\")";
  protected final String TEXT_496 = ".toUpperCase()";
  protected final String TEXT_497 = "+\" WHERE ";
  protected final String TEXT_498 = "\";";
  protected final String TEXT_499 = NL + "\t\t\t\t\t\tString update_";
  protected final String TEXT_500 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_501 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_509 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_510 = " = new StringBuffer(insert_";
  protected final String TEXT_511 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_512 = ".insert(insert_";
  protected final String TEXT_513 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_514 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_515 = " =insertStringBuffer_";
  protected final String TEXT_516 = ".toString(); ";
  ...
  protected final String TEXT_521 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_522 = " = new StringBuffer(update_";
  protected final String TEXT_523 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_524 = ".insert(update_";
  protected final String TEXT_525 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_526 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_527 = " =updateStringBuffer_";
  protected final String TEXT_528 = ".toString(); ";
  protected final String TEXT_529 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_551 = ".toUpperCase()";
  protected final String TEXT_552 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_553 = ".";
  protected final String TEXT_554 = ")+\")\";";
  protected final String TEXT_555 = NL + "\t\t\t\t\t\t\tString update_";
  protected final String TEXT_556 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_557 = " + \" SET ";
  protected final String TEXT_558 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_559 = ".";
  protected final String TEXT_560 = ", \"";
  protected final String TEXT_561 = "\")";
  protected final String TEXT_562 = ".toUpperCase()";
  protected final String TEXT_563 = "+\" WHERE ";
  protected final String TEXT_564 = "\";";
  protected final String TEXT_565 = NL + "\t\t\t\t\t\t\tString update_";
  protected final String TEXT_566 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_567 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_568 = ".";
  protected final String TEXT_569 = ", \"";
  protected final String TEXT_570 = "\")";
  protected final String TEXT_571 = ".toUpperCase()";
  ...
  protected final String TEXT_583 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_587 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_588 = " = new StringBuffer(insert_";
  protected final String TEXT_589 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_590 = ".insert(insert_";
  protected final String TEXT_591 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_592 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_593 = " =insertStringBuffer_";
  protected final String TEXT_594 = ".toString(); ";
  protected final String TEXT_595 = "    " + NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_596 = " = conn_";
  protected final String TEXT_597 = ".prepareStatement(insert_";
  protected final String TEXT_598 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_599 = NL + "\t\t\t\tString delete_";
  protected final String TEXT_600 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_601 = " + \" WHERE ";
  protected final String TEXT_602 = "\";" + NL + "\t\t\t\t";
  protected final String TEXT_603 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_604 = " = new StringBuffer(delete_";
  protected final String TEXT_605 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_606 = ".insert(delete_";
  protected final String TEXT_607 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_608 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_609 = " =deleteStringBuffer_";
  protected final String TEXT_610 = ".toString();  ";
  protected final String TEXT_611 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_612 = " = conn_";
  protected final String TEXT_613 = ".prepareStatement(delete_";
  protected final String TEXT_614 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_615 = NL + "\t\t\t   ";
  protected final String TEXT_616 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_617 = " = insert_";
  ...
  protected final String TEXT_624 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_625 = " = update_";
  protected final String TEXT_626 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_627 = " = insert_";
  protected final String TEXT_628 = ".split(\"\\\\?\");";
  protected final String TEXT_629 = NL + "\t\t\tdelete_";
  protected final String TEXT_630 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_631 = " = delete_";
  protected final String TEXT_632 = ".split(\"\\\\?\");";
  protected final String TEXT_633 = NL + "\t\t\treplace_";
  protected final String TEXT_634 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_635 = " = replace_";
  protected final String TEXT_636 = ".split(\"\\\\?\");";
  protected final String TEXT_637 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_638 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_639 = " = insertIgnore_";
  protected final String TEXT_640 = ".split(\"\\\\?\");";
  protected final String TEXT_641 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_642 = " = insert_";
  protected final String TEXT_643 = ".split(\"\\\\?\");";
  protected final String TEXT_644 = NL + "\t\t\t   ";
  protected final String TEXT_645 = NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_646 = NL + "\t\tquery_";
  protected final String TEXT_647 = " = new StringBuffer(\"\");";
  protected final String TEXT_648 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_649 = " = buffersSize_";
  protected final String TEXT_650 = ";";
  protected final String TEXT_651 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_652 = " = buffersSize_";
  protected final String TEXT_653 = ";";
  protected final String TEXT_654 = NL + NL;
  protected final String TEXT_655 = NL + "        whetherReject_";
  protected final String TEXT_656 = " = false;";
  protected final String TEXT_657 = NL + "\t\t\t\t\t     \t// TODO unable to parse integer: ";
  protected final String TEXT_658 = NL + "\t\t\t\t\t     \t// TODO error: ";
  protected final String TEXT_659 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_660 = NL + "                    \torg.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_661 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_662 = ".";
  protected final String TEXT_663 = ";" + NL + "\t                    com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_664 = " = tGeometry_";
  protected final String TEXT_665 = "._getInternalGeometry();" + NL + "" + NL + "                    \tcom.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_666 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_667 = "\");" + NL + "                    \tif (extends_";
  protected final String TEXT_668 = " == null) {" + NL + "                    \t    geometryColumnToExtends.put(\"";
  protected final String TEXT_669 = "\", geometry_";
  protected final String TEXT_670 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "                    \telse {" + NL + "                    \t    extends_";
  protected final String TEXT_671 = ".expandToInclude(geometry_";
  protected final String TEXT_672 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "" + NL + "\t\t\t\t\t\tString wkt_";
  protected final String TEXT_673 = " = geometry_";
  protected final String TEXT_674 = ".toText();" + NL + "\t\t\t\t\t\toracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_675 = " = new oracle.spatial.util.WKT();" + NL + "\t\t\t\t\t\toracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_676 = " = oracle_wkt_";
  protected final String TEXT_677 = ".toJGeometry(wkt_";
  protected final String TEXT_678 = ".getBytes());" + NL;
  protected final String TEXT_679 = NL + "\t\t\t\t\t\t\tjgeometry_";
  protected final String TEXT_680 = ".setSRID(";
  protected final String TEXT_681 = ");";
  protected final String TEXT_682 = NL + "               \t\tpstmt_";
  protected final String TEXT_683 = ".setObject(";
  protected final String TEXT_684 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  protected final String TEXT_685 = ", conn_";
  protected final String TEXT_686 = "));" + NL + "                \t";
  protected final String TEXT_687 = NL + "                    ";
  protected final String TEXT_688 = NL + "                        query_";
  protected final String TEXT_689 = " = ";
  protected final String TEXT_690 = ";";
  protected final String TEXT_691 = NL + "\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_692 = ",";
  protected final String TEXT_693 = ".";
  protected final String TEXT_694 = ", ";
  protected final String TEXT_695 = ",insertSQLSplits_";
  protected final String TEXT_696 = ");";
  protected final String TEXT_697 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_708 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_709 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_710 = "++;";
  protected final String TEXT_711 = NL + "    \t\t";
  protected final String TEXT_712 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_713 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_714 = " = insertedCount_";
  protected final String TEXT_715 = " + pstmt_";
  protected final String TEXT_716 = ".executeUpdate();";
  protected final String TEXT_717 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_718 = " = true;";
  protected final String TEXT_719 = NL + "                    throw(e);";
  ...
  protected final String TEXT_732 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_733 = NL + "                        ";
  protected final String TEXT_734 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_735 = ";";
  protected final String TEXT_736 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_748 = NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_774 = NL + "                globalMap.put(\"";
  protected final String TEXT_775 = "_QUERY\", query_";
  protected final String TEXT_776 = ".toString().trim());";
  protected final String TEXT_777 = NL + "    \t\t";
  protected final String TEXT_778 = NL + "    \t\tpstmt_";
  protected final String TEXT_779 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_780 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_781 = "++;" + NL + "    \t\t";
  protected final String TEXT_782 = NL + "    \t\t";
  protected final String TEXT_783 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_784 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_785 = " = updatedCount_";
  protected final String TEXT_786 = " + pstmt_";
  protected final String TEXT_787 = ".executeUpdate();";
  protected final String TEXT_788 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_789 = " = true;";
  protected final String TEXT_790 = NL + "                    throw(e);";
  protected final String TEXT_791 = NL + "                        ";
  protected final String TEXT_792 = " = new ";
  protected final String TEXT_793 = "Struct();";
  protected final String TEXT_794 = NL + "                            ";
  protected final String TEXT_795 = ".";
  protected final String TEXT_796 = " = ";
  protected final String TEXT_797 = ".";
  protected final String TEXT_798 = ";";
  protected final String TEXT_799 = NL + "                        rejectedCount_";
  protected final String TEXT_800 = " = rejectedCount_";
  protected final String TEXT_801 = " + 1;";
  protected final String TEXT_802 = NL + "                        ";
  protected final String TEXT_803 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_804 = NL + "                        ";
  protected final String TEXT_805 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_806 = ";";
  protected final String TEXT_807 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_808 = NL + "            }" + NL + "    \t\t";
  protected final String TEXT_809 = NL;
  protected final String TEXT_810 = NL + NL + "    \t    ";
  protected final String TEXT_811 = NL + "\t\t\t\t\t";
  protected final String TEXT_812 = NL + "                    \t";
  protected final String TEXT_813 = NL + "                    ";
  protected final String TEXT_814 = NL + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_815 = " = pstmt_";
  protected final String TEXT_816 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_817 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_818 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_819 = " = rs_";
  protected final String TEXT_820 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_821 = " > 0) {";
  protected final String TEXT_822 = NL + "                        ";
  protected final String TEXT_823 = NL + "                            query_";
  protected final String TEXT_824 = " = ";
  protected final String TEXT_825 = ";";
  protected final String TEXT_826 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_827 = ",";
  protected final String TEXT_828 = ".";
  protected final String TEXT_829 = ", ";
  protected final String TEXT_830 = ",updateSQLSplits_";
  protected final String TEXT_831 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_832 = NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_833 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_834 = ".";
  protected final String TEXT_835 = ", pstmtUpdate_";
  ...
  protected final String TEXT_846 = NL + "\t\t\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_859 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_860 = " = updatedCount_";
  protected final String TEXT_861 = " + pstmtUpdate_";
  ...
  protected final String TEXT_886 = NL + "                }" + NL + "    \t\t} else {";
  protected final String TEXT_887 = NL + "                        ";
  protected final String TEXT_888 = NL + "                            query_";
  protected final String TEXT_889 = " = ";
  protected final String TEXT_890 = ";";
  protected final String TEXT_891 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_892 = ",";
  protected final String TEXT_893 = ".";
  protected final String TEXT_894 = ", ";
  protected final String TEXT_895 = ",insertSQLSplits_";
  protected final String TEXT_896 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_897 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_898 = ".";
  protected final String TEXT_899 = ", pstmtInsert_";
  ...
  protected final String TEXT_906 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_911 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_912 = " = true;";
  protected final String TEXT_913 = NL + "                        throw(e);";
  protected final String TEXT_914 = NL + "                    \tnb_line_";
  protected final String TEXT_915 = "++;" + NL + "                    \t";
  protected final String TEXT_916 = NL + "                            ";
  protected final String TEXT_917 = " = new ";
  protected final String TEXT_918 = "Struct();";
  protected final String TEXT_919 = NL + "                                ";
  protected final String TEXT_920 = ".";
  protected final String TEXT_921 = " = ";
  protected final String TEXT_922 = ".";
  protected final String TEXT_923 = ";";
  protected final String TEXT_924 = NL + "                            rejectedCount_";
  protected final String TEXT_925 = " = rejectedCount_";
  protected final String TEXT_926 = " + 1;";
  protected final String TEXT_927 = NL + "                            ";
  protected final String TEXT_928 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_929 = NL + "                            ";
  protected final String TEXT_930 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_931 = ";";
  protected final String TEXT_932 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_933 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_934 = NL + "    \t    int updateFlag_";
  protected final String TEXT_935 = " = 0;" + NL + "    \t    ";
  protected final String TEXT_936 = NL + "                    ";
  protected final String TEXT_937 = NL + "                        query_";
  protected final String TEXT_938 = " = ";
  protected final String TEXT_939 = ";";
  protected final String TEXT_940 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_941 = ",";
  protected final String TEXT_942 = ".";
  protected final String TEXT_943 = ", ";
  protected final String TEXT_944 = ",updateSQLSplits_";
  protected final String TEXT_945 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_946 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_947 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_974 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_975 = " = pstmtUpdate_";
  protected final String TEXT_976 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_977 = " = updatedCount_";
  protected final String TEXT_978 = "+updateFlag_";
  protected final String TEXT_979 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_980 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_981 = NL + "\t\t\t\tquery_";
  protected final String TEXT_982 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_983 = NL + "                        ";
  protected final String TEXT_984 = NL + "                            query_";
  protected final String TEXT_985 = " = ";
  protected final String TEXT_986 = ";";
  protected final String TEXT_987 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_988 = ",";
  protected final String TEXT_989 = ".";
  protected final String TEXT_990 = ", ";
  protected final String TEXT_991 = ",insertSQLSplits_";
  protected final String TEXT_992 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_993 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_994 = ".";
  protected final String TEXT_995 = ", pstmtInsert_";
  ...
  protected final String TEXT_1001 = ".toString().trim());";
  protected final String TEXT_1002 = NL + "                    insertedCount_";
  protected final String TEXT_1003 = " = insertedCount_";
  protected final String TEXT_1004 = " + pstmtInsert_";
  protected final String TEXT_1005 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1006 = "++;";
  protected final String TEXT_1007 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_1008 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_1009 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1010 = " = true;";
  protected final String TEXT_1011 = NL + "                        throw(e);";
  protected final String TEXT_1012 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_1045 = NL + "    \t\tpstmt_";
  protected final String TEXT_1046 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_1047 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_1048 = "++;" + NL + "    \t\t";
  protected final String TEXT_1049 = NL + "    \t\t";
  protected final String TEXT_1050 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1051 = " = deletedCount_";
  protected final String TEXT_1052 = " + pstmt_";
  protected final String TEXT_1053 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1054 = "++;";
  protected final String TEXT_1055 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1056 = " = true;";
  protected final String TEXT_1057 = NL + "                    throw(e);";
  protected final String TEXT_1058 = NL + "                \tnb_line_";
  protected final String TEXT_1059 = "++;" + NL + "                \t";
  protected final String TEXT_1060 = NL + "                        ";
  protected final String TEXT_1061 = " = new ";
  protected final String TEXT_1062 = "Struct();";
  protected final String TEXT_1063 = NL + "                            ";
  protected final String TEXT_1064 = ".";
  protected final String TEXT_1065 = " = ";
  protected final String TEXT_1066 = ".";
  protected final String TEXT_1067 = ";";
  protected final String TEXT_1068 = NL + "                        rejectedCount_";
  protected final String TEXT_1069 = " = rejectedCount_";
  protected final String TEXT_1070 = " + 1;";
  protected final String TEXT_1071 = NL + "                        ";
  protected final String TEXT_1072 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1073 = NL + "                        ";
  protected final String TEXT_1074 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1075 = ";";
  protected final String TEXT_1076 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1077 = NL + "            }" + NL + "    \t\t";
  protected final String TEXT_1078 = NL + "    \t";
  protected final String TEXT_1079 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1090 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1091 = " > 0) && (batchSize_";
  protected final String TEXT_1092 = " <= batchSizeCounter_";
  protected final String TEXT_1093 = ")) {" + NL + "                \ttry {" + NL + "                \t\t";
  protected final String TEXT_1094 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_1095 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1096 = NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1097 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1098 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1099 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_1100 = " = pstmt_";
  protected final String TEXT_1101 = ".getUpdateCount();" + NL + "        \t    \t";
  protected final String TEXT_1102 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_1103 = NL + "        \t    \t";
  protected final String TEXT_1104 = NL + "        \t    \t\tupdatedCount_";
  protected final String TEXT_1105 = NL + "        \t    \t";
  protected final String TEXT_1106 = NL + "        \t    \t    deletedCount_";
  protected final String TEXT_1107 = NL + "        \t    \t";
  protected final String TEXT_1108 = NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1109 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1110 = ":0);" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_1111 = " = 0;" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_1112 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1113 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1114 = " <= commitCounter_";
  protected final String TEXT_1115 = ") {" + NL + "" + NL + "\t                ";
  protected final String TEXT_1116 = NL + "\t                \tif(batchSizeCounter_";
  protected final String TEXT_1117 = " > 0){" + NL + "\t\t                try {" + NL + "\t\t                \t";
  protected final String TEXT_1118 = NL + "\t                \t\tpstmt_";
  protected final String TEXT_1119 = ".executeBatch();" + NL + "\t\t                \t";
  protected final String TEXT_1120 = NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_1121 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_1122 = NL + "\t\t                        System.err.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_1123 = NL + NL + "\t\t                }" + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1124 = " = pstmt_";
  protected final String TEXT_1125 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  protected final String TEXT_1126 = NL + "\t\t    \t    \t\tinsertedCount_";
  protected final String TEXT_1127 = NL + "\t\t    \t    \t";
  protected final String TEXT_1128 = NL + "\t\t    \t    \t\tupdatedCount_";
  protected final String TEXT_1129 = NL + "\t\t    \t    \t";
  protected final String TEXT_1130 = NL + "\t\t    \t    \t    deletedCount_";
  protected final String TEXT_1131 = NL + "\t\t    \t    \t";
  protected final String TEXT_1132 = NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1133 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1134 = ":0);" + NL + "\t\t    \t    \tbatchSizeCounter_";
  protected final String TEXT_1135 = " = 0;" + NL + "\t\t    \t    \t}" + NL + "\t                ";
  protected final String TEXT_1136 = NL + "\t                ";
  protected final String TEXT_1137 = NL + "                \tconn_";
  protected final String TEXT_1138 = ".commit();" + NL + "    \t\t\t\t";
  protected final String TEXT_1139 = NL + "                \tcommitCounter_";
  protected final String TEXT_1140 = "=0;" + NL + "                }";
