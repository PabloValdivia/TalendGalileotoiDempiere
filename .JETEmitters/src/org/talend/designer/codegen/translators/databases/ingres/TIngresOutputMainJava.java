...
public class TIngresOutputMainJava {
  ...
  protected final String TEXT_392 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_393 = " <= commitCounter_";
  protected final String TEXT_394 = ") {";
  protected final String TEXT_395 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_396 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_397 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_398 = NL + "\t                    for(int countEach_";
  protected final String TEXT_399 = ": pstmt_";
  protected final String TEXT_400 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_401 = " += (countEach_";
  protected final String TEXT_402 = " < 0 ? 0 : countEach_";
  protected final String TEXT_403 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_404 = NL + "\t                    ";
  protected final String TEXT_405 = NL + "\t                        insertedCount_";
  protected final String TEXT_406 = " += countSum_";
  protected final String TEXT_407 = ";" + NL + "\t                    ";
  protected final String TEXT_408 = NL + "\t                        updatedCount_";
  protected final String TEXT_409 = " += countSum_";
  protected final String TEXT_410 = ";" + NL + "\t                    ";
  protected final String TEXT_411 = NL + "\t                        deletedCount_";
  protected final String TEXT_412 = " += countSum_";
  protected final String TEXT_413 = ";" + NL + "\t                    ";
  protected final String TEXT_414 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_415 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_416 = NL + "                        throw(e);";
  protected final String TEXT_417 = NL + "                        int countSum_";
  protected final String TEXT_418 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_419 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_420 = " += (countEach_";
  protected final String TEXT_421 = " < 0 ? 0 : countEach_";
  protected final String TEXT_422 = ");" + NL + "                        }";
  protected final String TEXT_423 = NL + "                            insertedCount_";
  protected final String TEXT_424 = " += countSum_";
  protected final String TEXT_425 = ";";
  protected final String TEXT_426 = NL + "                            updatedCount_";
  protected final String TEXT_427 = " += countSum_";
  protected final String TEXT_428 = ";";
  protected final String TEXT_429 = NL + "                            deletedCount_";
  protected final String TEXT_430 = " += countSum_";
  protected final String TEXT_431 = ";";
  protected final String TEXT_432 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_433 = NL + "                }";
  protected final String TEXT_434 = NL + "                ";
  protected final String TEXT_435 = NL + "                conn_";
  protected final String TEXT_436 = ".commit();";
  protected final String TEXT_437 = NL + "                commitCounter_";
  protected final String TEXT_438 = "=0;" + NL + "            }";
