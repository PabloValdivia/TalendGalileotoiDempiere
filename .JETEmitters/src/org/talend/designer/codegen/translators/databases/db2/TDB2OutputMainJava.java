...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_390 = ".toUpperCase()";
  protected final String TEXT_391 = "+\") VALUES (";
  protected final String TEXT_392 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_393 = ".";
  protected final String TEXT_394 = ")+\")\";";
  protected final String TEXT_395 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_396 = " = \"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_402 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_412 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_425 = ".toUpperCase()";
  ...
  protected final String TEXT_430 = ".prepareStatement(update_";
  ...
  protected final String TEXT_475 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_491 = ".toUpperCase()";
  protected final String TEXT_492 = "+\") VALUES (";
  protected final String TEXT_493 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_494 = ".";
  protected final String TEXT_495 = ")+\")\";";
  protected final String TEXT_496 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_497 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_498 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_499 = ".";
  protected final String TEXT_500 = ", \"";
  protected final String TEXT_501 = "\")";
  protected final String TEXT_502 = ".toUpperCase()";
  protected final String TEXT_503 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_509 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_510 = ".";
  protected final String TEXT_511 = ", \"";
  protected final String TEXT_512 = "\")";
  protected final String TEXT_513 = ".toUpperCase()";
  protected final String TEXT_514 = "+\" WHERE ";
  protected final String TEXT_515 = "\";";
  protected final String TEXT_516 = NL + "\t\t\t\tString update_";
  protected final String TEXT_517 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_518 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_519 = ".";
  protected final String TEXT_520 = ", \"";
  protected final String TEXT_521 = "\")";
  protected final String TEXT_522 = ".toUpperCase()";
  ...
  protected final String TEXT_528 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_529 = " = conn_";
  protected final String TEXT_530 = ".prepareStatement(insert_";
  protected final String TEXT_531 = ");" + NL + "\t    ";
  protected final String TEXT_532 = NL + "\t    String delete_";
  protected final String TEXT_533 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_534 = " + \"\\\" WHERE ";
  protected final String TEXT_535 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_536 = " = conn_";
  protected final String TEXT_537 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_543 = NL + "\t\t\tupdate_";
  protected final String TEXT_544 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_545 = " = update_";
  protected final String TEXT_546 = ".split(\"\\\\?\");";
  protected final String TEXT_547 = NL + "\t\t\tupdate_";
  protected final String TEXT_548 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_549 = " = update_";
  protected final String TEXT_550 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_551 = " = insert_";
  protected final String TEXT_552 = ".split(\"\\\\?\");";
  protected final String TEXT_553 = NL + "\t\t\tdelete_";
  protected final String TEXT_554 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_555 = " = delete_";
  protected final String TEXT_556 = ".split(\"\\\\?\");";
  protected final String TEXT_557 = NL + "\t\t\treplace_";
  protected final String TEXT_558 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_559 = " = replace_";
  protected final String TEXT_560 = ".split(\"\\\\?\");";
  protected final String TEXT_561 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_562 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_563 = " = insertIgnore_";
  protected final String TEXT_564 = ".split(\"\\\\?\");";
  protected final String TEXT_565 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_566 = " = insert_";
  protected final String TEXT_567 = ".split(\"\\\\?\");";
  protected final String TEXT_568 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_569 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_570 = " = buffersSize_";
  protected final String TEXT_571 = ";";
  protected final String TEXT_572 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_573 = " = buffersSize_";
  protected final String TEXT_574 = ";";
  protected final String TEXT_575 = NL + "        whetherReject_";
  protected final String TEXT_576 = " = false;";
  protected final String TEXT_577 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_578 = ".setInsert_";
  protected final String TEXT_579 = "(";
  protected final String TEXT_580 = ",pstmt_";
  protected final String TEXT_581 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_582 = ",query_";
  protected final String TEXT_583 = ",insertSQLSplits_";
  ...
  protected final String TEXT_610 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_611 = " = insertedCount_";
  protected final String TEXT_612 = " + pstmt_";
  protected final String TEXT_613 = ".executeUpdate();";
  protected final String TEXT_614 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_620 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_621 = ".assign_";
  ...
  protected final String TEXT_631 = NL + "                        rejectedCount_";
  protected final String TEXT_632 = " = rejectedCount_";
  protected final String TEXT_633 = " + 1;";
  protected final String TEXT_634 = NL + "                        ";
  protected final String TEXT_635 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_636 = NL + "                        ";
  protected final String TEXT_637 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_638 = ";";
  protected final String TEXT_639 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_640 = NL + "            }";
  protected final String TEXT_641 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_642 = ".setUpdate_";
  protected final String TEXT_643 = "(";
  protected final String TEXT_644 = ",pstmt_";
  protected final String TEXT_645 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_646 = ",query_";
  protected final String TEXT_647 = ",updateSQLSplits_";
  ...
  protected final String TEXT_659 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_660 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_661 = ".";
  protected final String TEXT_662 = ", pstmt_";
  ...
  protected final String TEXT_688 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_689 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_690 = " = updatedCount_";
  protected final String TEXT_691 = " + pstmt_";
  protected final String TEXT_692 = ".executeUpdate();";
  protected final String TEXT_693 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_698 = "Struct();";
  protected final String TEXT_699 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_700 = ".assign_";
  ...
  protected final String TEXT_723 = NL + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_724 = " = pstmt_";
  protected final String TEXT_725 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_726 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_727 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_728 = " = rs_";
  protected final String TEXT_729 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_730 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_731 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_732 = ".setUpdate_";
  protected final String TEXT_733 = "(";
  protected final String TEXT_734 = ",pstmtUpdate_";
  protected final String TEXT_735 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_736 = ",query_";
  protected final String TEXT_737 = ",updateSQLSplits_";
  ...
  protected final String TEXT_768 = NL + "                    globalMap.put(\"";
  protected final String TEXT_769 = "_QUERY\", query_";
  protected final String TEXT_770 = ".toString().trim());";
  protected final String TEXT_771 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_772 = " = updatedCount_";
  protected final String TEXT_773 = " + pstmtUpdate_";
  protected final String TEXT_774 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_775 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_776 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_777 = " = true;";
  protected final String TEXT_778 = NL + "                        throw(e);";
  protected final String TEXT_779 = NL + "                    \tnb_line_";
  protected final String TEXT_780 = "++;" + NL + "                    \t";
  protected final String TEXT_781 = NL + "                            ";
  protected final String TEXT_782 = " = new ";
  protected final String TEXT_783 = "Struct();";
  protected final String TEXT_784 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_785 = ".assign_";
  ...
  protected final String TEXT_795 = NL + "                            rejectedCount_";
  protected final String TEXT_796 = " = rejectedCount_";
  protected final String TEXT_797 = " + 1;";
  protected final String TEXT_798 = NL + "                            ";
  protected final String TEXT_799 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_804 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_805 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_806 = ".setInsert_";
  protected final String TEXT_807 = "(";
  protected final String TEXT_808 = ",pstmtInsert_";
  protected final String TEXT_809 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_810 = ",query_";
  protected final String TEXT_811 = ",insertSQLSplits_";
  ...
  protected final String TEXT_836 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_837 = " = true;";
  protected final String TEXT_838 = NL + "                        throw(e);";
  protected final String TEXT_839 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_844 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_845 = ".assign_";
  protected final String TEXT_846 = "_";
  ...
  protected final String TEXT_864 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_865 = NL + "    \t    int updateFlag_";
  protected final String TEXT_866 = "=0;" + NL + "    \t    ";
  protected final String TEXT_867 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_868 = ".setUpdate_";
  protected final String TEXT_869 = "(";
  protected final String TEXT_870 = ",pstmtUpdate_";
  protected final String TEXT_871 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_872 = ",query_";
  ...
  protected final String TEXT_882 = ",updateSQLSplits_";
  protected final String TEXT_883 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_884 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_885 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_886 = ".";
  protected final String TEXT_887 = ", pstmtUpdate_";
  ...
  protected final String TEXT_908 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_909 = "=pstmtUpdate_";
  protected final String TEXT_910 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_911 = " = updatedCount_";
  protected final String TEXT_912 = " + updateFlag_";
  protected final String TEXT_913 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_914 = " == 0) {" + NL + "            \t";
  protected final String TEXT_915 = NL + "\t\t\t\tquery_";
  protected final String TEXT_916 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_917 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_918 = ".setInsert_";
  protected final String TEXT_919 = "(";
  protected final String TEXT_920 = ",pstmtInsert_";
  protected final String TEXT_921 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_922 = ",query_";
  protected final String TEXT_923 = ",insertSQLSplits_";
  ...
  protected final String TEXT_946 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_947 = "++;";
  protected final String TEXT_948 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_949 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_950 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_951 = " = true;";
  protected final String TEXT_952 = NL + "                        throw(e);";
  protected final String TEXT_953 = NL + "                    \tnb_line_";
  protected final String TEXT_954 = "++;" + NL + "                    \t";
  protected final String TEXT_955 = NL + "                            ";
  protected final String TEXT_956 = " = new ";
  protected final String TEXT_957 = "Struct();";
  protected final String TEXT_958 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_959 = ".assign_";
  ...
  protected final String TEXT_973 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_974 = NL + "                            ";
  protected final String TEXT_975 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_976 = ";";
  protected final String TEXT_977 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_991 = NL + "        \t\tpstmt_";
  protected final String TEXT_992 = ".addBatch();" + NL + "    \t\t\tnb_line_";
  protected final String TEXT_993 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_994 = NL + "        \t\t\tbatchSizeCounter_";
  protected final String TEXT_995 = "++;" + NL + "    \t\t";
  protected final String TEXT_996 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_997 = " = deletedCount_";
  protected final String TEXT_998 = " + pstmt_";
  protected final String TEXT_999 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_1000 = "++;";
  protected final String TEXT_1001 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1002 = " = true;";
  protected final String TEXT_1003 = NL + "                    throw(e);";
  protected final String TEXT_1004 = NL + "                \tnb_line_";
  protected final String TEXT_1005 = "++;" + NL + "                \t";
  protected final String TEXT_1006 = NL + "                        ";
  protected final String TEXT_1007 = " = new ";
  protected final String TEXT_1008 = "Struct();";
  protected final String TEXT_1009 = NL + "                            \tdataPropagateUtil_";
  protected final String TEXT_1010 = ".assign_";
  ...
  protected final String TEXT_1031 = NL + "            if(!whetherReject_";
  protected final String TEXT_1032 = ") {";
  protected final String TEXT_1033 = NL + "                            ";
  protected final String TEXT_1034 = " = new ";
  protected final String TEXT_1035 = "Struct();";
  protected final String TEXT_1036 = NL + "                                \tdataPropagateUtil_";
  protected final String TEXT_1037 = ".assign_";
  protected final String TEXT_1038 = "_";
  ...
  protected final String TEXT_1048 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1049 = " > 0) && (batchSize_";
  protected final String TEXT_1050 = " <= batchSizeCounter_";
  protected final String TEXT_1051 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1052 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1053 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1054 = ": pstmt_";
  protected final String TEXT_1055 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1056 = " += (countEach_";
  protected final String TEXT_1057 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1058 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1059 = NL + "            \t    \t";
  protected final String TEXT_1060 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1061 = " += countSum_";
  protected final String TEXT_1062 = ";" + NL + "            \t    \t";
  protected final String TEXT_1063 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1064 = " += countSum_";
  protected final String TEXT_1065 = ";" + NL + "            \t    \t";
  protected final String TEXT_1066 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1067 = " += countSum_";
  protected final String TEXT_1068 = ";" + NL + "            \t    \t";
  protected final String TEXT_1069 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1070 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1071 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1072 = NL + "                \tint countSum_";
  protected final String TEXT_1073 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1074 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1075 = " += (countEach_";
  protected final String TEXT_1076 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1087 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1088 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1089 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1090 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1091 = " <= commitCounter_";
  protected final String TEXT_1092 = ") {";
  protected final String TEXT_1093 = NL + "                if ((batchSize_";
  protected final String TEXT_1094 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1095 = " > 0)) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_1096 = " = 0;" + NL + "                \t\tint countSum_";
  protected final String TEXT_1097 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1098 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1099 = ": pstmt_";
  protected final String TEXT_1100 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1101 = " += (countEach_";
  protected final String TEXT_1102 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1103 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1104 = NL + "            \t    \t";
  protected final String TEXT_1105 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1106 = " += countSum_";
  protected final String TEXT_1107 = ";" + NL + "            \t    \t";
  protected final String TEXT_1108 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1109 = " += countSum_";
  protected final String TEXT_1110 = ";" + NL + "            \t    \t";
  protected final String TEXT_1111 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1112 = " += countSum_";
  protected final String TEXT_1113 = ";" + NL + "            \t    \t";
  protected final String TEXT_1114 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1115 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1116 = NL + "                \t\tint countSum_";
  protected final String TEXT_1117 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1118 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1119 = " += (countEach_";
  protected final String TEXT_1120 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1121 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1122 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1123 = " += countSum_";
  protected final String TEXT_1124 = ";" + NL + "            \t    \t";
  protected final String TEXT_1125 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1126 = " += countSum_";
  protected final String TEXT_1127 = ";" + NL + "            \t    \t";
  protected final String TEXT_1128 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1129 = " += countSum_";
  protected final String TEXT_1130 = ";" + NL + "            \t    \t";
  protected final String TEXT_1131 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1132 = NL + "                }" + NL + "                }";
  protected final String TEXT_1133 = NL + "                \t";
  protected final String TEXT_1134 = NL + "                \tconn_";
  protected final String TEXT_1135 = ".commit();" + NL + "                \t";
  protected final String TEXT_1136 = NL + "                \tcommitCounter_";
