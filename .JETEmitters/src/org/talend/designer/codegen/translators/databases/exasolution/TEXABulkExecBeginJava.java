...
public class TEXABulkExecBeginJava {
  protected static String nl;
  public static synchronized TEXABulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXABulkExecBeginJava result = new TEXABulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_71 = NL + NL + "int deletedCount_";
  protected final String TEXT_72 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_73 = " = 0;" + NL + "// schema is mandatory" + NL + "" + NL + "String dbschema_";
  protected final String TEXT_74 = " = null;";
  protected final String TEXT_75 = NL + "    dbschema_";
  protected final String TEXT_76 = " = (String)globalMap.get(\"schema_";
  protected final String TEXT_77 = "\");";
  protected final String TEXT_78 = NL + "    dbschema_";
  protected final String TEXT_79 = " = ";
  protected final String TEXT_80 = ";";
  protected final String TEXT_81 = NL + NL + "String tableName_";
  protected final String TEXT_82 = " = dbschema_";
  ...
  protected final String TEXT_87 = " = (java.sql.Connection) globalMap.get(\"conn_";
  protected final String TEXT_88 = "\");";
  protected final String TEXT_89 = NL + "try {" + NL + "\t java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\").newInstance();" + NL + "} catch (Exception e) {" + NL + "\t globalMap.put(\"";
  protected final String TEXT_90 = "_ERROR_MESSAGE\", \"Load driver failed: \" + e.getMessage());" + NL + "\t throw e;" + NL + "}";
  protected final String TEXT_91 = NL + "String url_";
  protected final String TEXT_92 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_93 = " + \":\" + ";
  protected final String TEXT_94 = "+ \";schema=\" + ";
  protected final String TEXT_95 = "; ";
  protected final String TEXT_96 = NL + "String url_";
  protected final String TEXT_97 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_98 = " + \":\" + ";
  protected final String TEXT_99 = " + \";schema=\" + ";
  ...
  protected final String TEXT_111 = ";" + NL + "" + NL + "try {    " + NL + "\t conn_";
  protected final String TEXT_112 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_113 = ", ";
  protected final String TEXT_114 = ", dbPwd_";
  protected final String TEXT_115 = ");" + NL + "} catch (Exception e) {" + NL + "\t String message = \"Connect failed: \" + e.getMessage();" + NL + "\t globalMap.put(\"";
  protected final String TEXT_116 = "_ERROR_MESSAGE\", message);" + NL + "\t throw e;" + NL + "}";
  protected final String TEXT_117 = NL;
  protected final String TEXT_118 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_122 = " - Droping table ";
  ...
  protected final String TEXT_130 = " - Drop table ";
  protected final String TEXT_131 = "\" + tableName_";
  protected final String TEXT_132 = " + \"";
  protected final String TEXT_133 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_135 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_139 = " - Creating table ";
  ...
  protected final String TEXT_147 = " - Create table ";
  protected final String TEXT_148 = "\" + tableName_";
  protected final String TEXT_149 = " + \"";
  protected final String TEXT_150 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_152 = ".close();" + NL + "\t\t";
  protected final String TEXT_153 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_174 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_175 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_176 = " = tableNameForSearch_";
  protected final String TEXT_177 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_178 = " = tableNameForSearch_";
  protected final String TEXT_179 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_180 = " = dbMetaData_";
  protected final String TEXT_181 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_182 = ", tableNameForSearch_";
  protected final String TEXT_183 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_184 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_185 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_186 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_193 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_199 = ".equalsIgnoreCase(";
  protected final String TEXT_200 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_201 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_202 = ") || dbschema_";
  protected final String TEXT_203 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_214 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_218 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_219 = ".equals(schema_";
  protected final String TEXT_220 = ") || (schema_";
  protected final String TEXT_221 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_222 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_231 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_232 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_233 = " == null || dbschema_";
  protected final String TEXT_234 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_241 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_242 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_243 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_258 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_265 = NL + "            \tString tableForSearch_";
  protected final String TEXT_266 = " = ";
  protected final String TEXT_267 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_268 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_269 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_270 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_271 = " =  tableForSearch_";
  protected final String TEXT_272 = ".substring(1,tableForSearch_";
  protected final String TEXT_273 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_274 = " =  tableForSearch_";
  protected final String TEXT_275 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_279 = ".getTables(null, conn_";
  protected final String TEXT_280 = ".getSchema(), tableForSearch_";
  protected final String TEXT_281 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_282 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_283 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_284 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_291 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_292 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_293 = " = rsTable_";
  protected final String TEXT_294 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_295 = ".equals";
  protected final String TEXT_296 = "IgnoreCase";
  protected final String TEXT_297 = "(";
  protected final String TEXT_298 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_299 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_300 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_301 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_302 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_306 = " - Creating table ";
  ...
  protected final String TEXT_314 = " - Create table ";
  ...
  protected final String TEXT_319 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_320 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_321 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_325 = " - Droping table ";
  ...
  protected final String TEXT_333 = " - Drop table ";
  protected final String TEXT_334 = "\" + tableName_";
  protected final String TEXT_335 = " + \"";
  protected final String TEXT_336 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_337 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_338 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_339 = " = conn_";
  protected final String TEXT_340 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_342 = " - Creating table ";
  protected final String TEXT_343 = "\" + tableName_";
  protected final String TEXT_344 = " + \"";
  protected final String TEXT_345 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_347 = ".execute(\"";
  protected final String TEXT_348 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_350 = " - Create table ";
  protected final String TEXT_351 = "\" + tableName_";
  protected final String TEXT_352 = " + \"";
  protected final String TEXT_353 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_355 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_360 = " - Clearing table ";
  ...
  protected final String TEXT_383 = " - Trancating table ";
  ...
  protected final String TEXT_391 = " - Truncate table ";
  protected final String TEXT_392 = "\" + tableName_";
  protected final String TEXT_393 = " + \"";
  protected final String TEXT_394 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_396 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  ...
  protected final String TEXT_400 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_401 = ".close();" + NL + "\t\t";
  protected final String TEXT_402 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_403 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_404 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_405 = NL + "\t";
  protected final String TEXT_406 = NL + "globalMap.put(\"";
  protected final String TEXT_407 = "_NB_LINE_DELETED\", deletedCount_";
  protected final String TEXT_408 = ");" + NL + "org.talend.database.exasol.imp.EXABulkUtil ";
  protected final String TEXT_409 = " = new org.talend.database.exasol.imp.EXABulkUtil();";
  protected final String TEXT_410 = NL;
  protected final String TEXT_411 = ".setConnection(conn_";
  protected final String TEXT_412 = ");";
  protected final String TEXT_413 = NL;
  protected final String TEXT_414 = ".setTable(tableName_";
  protected final String TEXT_415 = ");";
  protected final String TEXT_416 = NL + "// Source is a file" + NL + "// setup the format of date values if no dedicated pattern is provided for a column ";
  protected final String TEXT_417 = NL;
  protected final String TEXT_418 = ".setDefaultDateFormat(";
  protected final String TEXT_419 = ");";
  protected final String TEXT_420 = NL + "// setup the format of timestamp values if no dedicated pattern is provided for a column";
  protected final String TEXT_421 = NL;
  protected final String TEXT_422 = ".setDefaultTimestampFormat(";
  protected final String TEXT_423 = ");";
  protected final String TEXT_424 = NL + "// setup numeric separators, default if nothing set is the English format";
  protected final String TEXT_425 = NL;
  protected final String TEXT_426 = ".setDefaultNumericCharacters(";
  protected final String TEXT_427 = ", ";
  protected final String TEXT_428 = ");";
  protected final String TEXT_429 = NL;
  protected final String TEXT_430 = ".setFileOptColumnEnclosure(";
  protected final String TEXT_431 = ");";
  protected final String TEXT_432 = NL;
  protected final String TEXT_433 = ".setFileOptColumnEnclosure(";
  protected final String TEXT_434 = ");";
  protected final String TEXT_435 = NL;
  protected final String TEXT_436 = ".setFileOptColumnSeparator(";
  protected final String TEXT_437 = ");";
  protected final String TEXT_438 = NL;
  protected final String TEXT_439 = ".setFileOptEncoding(";
  protected final String TEXT_440 = ");";
  protected final String TEXT_441 = NL;
  protected final String TEXT_442 = ".setFileOptRowSeparator(";
  protected final String TEXT_443 = ");";
  protected final String TEXT_444 = NL;
  protected final String TEXT_445 = ".setFileOptTrim(\"";
  protected final String TEXT_446 = "\");";
  protected final String TEXT_447 = NL;
  protected final String TEXT_448 = ".setFileOptSkip(";
  protected final String TEXT_449 = ");";
  protected final String TEXT_450 = NL;
  protected final String TEXT_451 = ".setFileOptNullIdentifier(";
  protected final String TEXT_452 = ");";
  protected final String TEXT_453 = NL + "// add column configurations";
  protected final String TEXT_454 = NL;
  protected final String TEXT_455 = ".addCSVDateColumn(\"";
  protected final String TEXT_456 = "\", null, ";
  protected final String TEXT_457 = ");";
  protected final String TEXT_458 = NL;
  protected final String TEXT_459 = ".addCSVNumberColumn(\"";
  protected final String TEXT_460 = "\", null, ";
  protected final String TEXT_461 = ", ";
  protected final String TEXT_462 = ", ";
  protected final String TEXT_463 = ");";
  protected final String TEXT_464 = NL;
  protected final String TEXT_465 = ".addCSVColumn(\"";
  protected final String TEXT_466 = "\", null);";
  protected final String TEXT_467 = NL;
  protected final String TEXT_468 = ".setRemoteExistingConnectionName(";
  protected final String TEXT_469 = ");";
  protected final String TEXT_470 = NL;
  protected final String TEXT_471 = ".setRemoteUser(";
  protected final String TEXT_472 = ");";
  protected final String TEXT_473 = NL;
  protected final String TEXT_474 = ".setRemotePassword(";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL;
  protected final String TEXT_477 = ".setLocalFilePath(";
  protected final String TEXT_478 = ");";
  protected final String TEXT_479 = NL;
  protected final String TEXT_480 = ".setTransferSecure(";
  protected final String TEXT_481 = ");";
  protected final String TEXT_482 = NL;
  protected final String TEXT_483 = ".setRemoteFileUrl(";
  protected final String TEXT_484 = ");";
  protected final String TEXT_485 = NL;
  protected final String TEXT_486 = ".setRemoteFileUrlParameters(";
  protected final String TEXT_487 = ");";
  protected final String TEXT_488 = NL;
  protected final String TEXT_489 = ".setRemoteFileName(";
  protected final String TEXT_490 = ");";
  protected final String TEXT_491 = NL;
  protected final String TEXT_492 = ".setDbmsSourceType(\"EXA\");";
  protected final String TEXT_493 = NL;
  protected final String TEXT_494 = ".setRemoteDbmsUrl(";
  protected final String TEXT_495 = ");";
  protected final String TEXT_496 = NL;
  protected final String TEXT_497 = ".setDbmsSourceType(\"JDBC\");";
  protected final String TEXT_498 = NL;
  protected final String TEXT_499 = ".setRemoteDbmsUrl(";
  protected final String TEXT_500 = ");";
  protected final String TEXT_501 = NL;
  protected final String TEXT_502 = ".setDbmsSourceType(\"ORA\");";
  protected final String TEXT_503 = NL;
  protected final String TEXT_504 = ".setRemoteDbmsUrl(";
  protected final String TEXT_505 = ");";
  protected final String TEXT_506 = NL;
  protected final String TEXT_507 = ".setRemoteSourceSelect(";
  protected final String TEXT_508 = ");";
  protected final String TEXT_509 = NL;
  protected final String TEXT_510 = ".setRemoteSourceTable(";
  protected final String TEXT_511 = ", ";
  protected final String TEXT_512 = ");";
  protected final String TEXT_513 = NL;
  protected final String TEXT_514 = ".addRemoteSourceTableColumn(\"";
  protected final String TEXT_515 = "\", ";
  protected final String TEXT_516 = ", null);";
  protected final String TEXT_517 = NL;
  protected final String TEXT_518 = ".setErrorRejectLimit(";
  protected final String TEXT_519 = ");";
  protected final String TEXT_520 = NL + "// setup error monitoring to a log table";
  protected final String TEXT_521 = NL;
  protected final String TEXT_522 = ".setErrorTableWithCurrentTimestamp(";
  protected final String TEXT_523 = ");";
  protected final String TEXT_524 = NL;
  protected final String TEXT_525 = ".setErrorTable(";
  protected final String TEXT_526 = ");";
  protected final String TEXT_527 = NL + "// setup error monitoring to a local log file";
  protected final String TEXT_528 = NL;
  protected final String TEXT_529 = ".setLocalErrorFileWithCurrentTimestamp(";
  protected final String TEXT_530 = ");";
  protected final String TEXT_531 = NL;
  protected final String TEXT_532 = ".setLocalErrorFile(";
  protected final String TEXT_533 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_534 = "_ERROR_LOG_FILE\", ";
  protected final String TEXT_535 = ".getLocalErrorFile());";
  protected final String TEXT_536 = NL + "// execute the import" + NL + "try {";
  protected final String TEXT_537 = NL + "\t globalMap.put(\"";
  protected final String TEXT_538 = "_FILENAME\", ";
  protected final String TEXT_539 = ".getLocalFilePath());";
  protected final String TEXT_540 = NL + "    ";
  protected final String TEXT_541 = ".executeImport();" + NL + "    insertedCount_";
  protected final String TEXT_542 = " = ";
  protected final String TEXT_543 = ".getCountAffectedRows();";
  protected final String TEXT_544 = NL + "    ";
  protected final String TEXT_545 = ".commitAndClose();";
  protected final String TEXT_546 = NL + "    globalMap.put(\"";
  protected final String TEXT_547 = "_NB_LINE_INSERTED\", insertedCount_";
  protected final String TEXT_548 = "); " + NL + "} catch (Exception e) {" + NL + "\t globalMap.put(\"";
  protected final String TEXT_549 = "_ERROR_MESSAGE\", \"Import failed: \" + e.getMessage());";
  protected final String TEXT_550 = NL + "    ";
  protected final String TEXT_551 = ".rollbackAndClose();";
  protected final String TEXT_552 = NL + "\t throw e;" + NL + "}";
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append(numGroupSep);
    stringBuffer.append(TEXT_427);
    stringBuffer.append(numDecSep);
    stringBuffer.append(TEXT_428);
         if (fileOptColumnEnclosure != null && fileOptColumnEnclosure.trim().isEmpty() == false) { 
    stringBuffer.append(TEXT_429);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_430);
    stringBuffer.append(fileOptColumnEnclosure);
    ...
    stringBuffer.append(fileOptColumnSeparator);
    ...
    stringBuffer.append(fileOptEncoding);
    ...
    stringBuffer.append(fileOptRowSeparator);
    ...
    stringBuffer.append(fileOptTrim);
    ...
    stringBuffer.append(fileOptSkip);
    ...
    stringBuffer.append(fileOptNullString);
    ...
    stringBuffer.append(lengthStr);
    stringBuffer.append(TEXT_461);
    stringBuffer.append(precisionStr);
    ...
    stringBuffer.append(predefinedConnName);
    ...
    stringBuffer.append(secureTransfer);
    ...
    stringBuffer.append(remoteFileName);
    ...
    stringBuffer.append(remoteExaHost);
    ...
    stringBuffer.append(remoteJdbcUrl);
    ...
    stringBuffer.append(remoteOraUrl);
    ...
    stringBuffer.append(sourceQuery);
    stringBuffer.append(TEXT_508);
         } else { 
    stringBuffer.append(TEXT_509);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_510);
    stringBuffer.append(sourceSchema);
    ...
    stringBuffer.append(errorTableWithTimestamp);
    stringBuffer.append(TEXT_523);
    stringBuffer.append(TEXT_524);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_525);
    stringBuffer.append(errorTable);
    ...
    stringBuffer.append(localErrorFileWithTimestamp);
    stringBuffer.append(TEXT_530);
    stringBuffer.append(TEXT_531);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_532);
    stringBuffer.append(localErrorFile);
