...
public class TMysqlOutputMainJava {
  ...
  protected final String TEXT_253 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_254 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_255 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_256 = " = rsTable_";
  protected final String TEXT_257 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_258 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_262 = NL + "                                if(!whetherExist_";
  protected final String TEXT_263 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".createStatement();";
  protected final String TEXT_266 = NL + "                                                      stmtCreate_";
  protected final String TEXT_267 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_268 = "));";
  protected final String TEXT_269 = NL + "                                            stmtCreate_";
  protected final String TEXT_270 = ".execute(((\"";
  protected final String TEXT_271 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_287 = NL + "                                                      stmtDrop_";
  protected final String TEXT_288 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_289 = "));";
  protected final String TEXT_290 = NL + "                                    stmtDrop_";
  protected final String TEXT_291 = ".execute(\"";
  protected final String TEXT_292 = "\" ";
  protected final String TEXT_293 = ");";
  protected final String TEXT_294 = NL + "                                    stmtDrop_";
  protected final String TEXT_295 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_315 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_316 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_317 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_318 = " = conn_";
  protected final String TEXT_319 = ".createStatement();";
  protected final String TEXT_320 = NL + "                              stmtClear_";
  protected final String TEXT_321 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_322 = "));";
  protected final String TEXT_323 = NL + "            stmtClear_";
  protected final String TEXT_324 = ".executeUpdate(\"";
  protected final String TEXT_325 = "\");";
  protected final String TEXT_326 = NL + "            stmtClear_";
  ...
  protected final String TEXT_330 = ".createStatement();";
  protected final String TEXT_331 = NL + "                              stmtTruncCount_";
  protected final String TEXT_332 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_333 = "));";
  protected final String TEXT_334 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_335 = " = stmtTruncCount_";
  protected final String TEXT_336 = ".executeQuery(\"";
  protected final String TEXT_337 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_338 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_339 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_340 = " = rsTruncCount_";
  protected final String TEXT_341 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_342 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_343 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_344 = " = conn_";
  protected final String TEXT_345 = ".createStatement();";
  protected final String TEXT_346 = NL + "                              stmtTrunc_";
  protected final String TEXT_347 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_348 = "));";
  protected final String TEXT_349 = NL + "                conn_";
  protected final String TEXT_350 = ".commit();";
  protected final String TEXT_351 = NL + "            stmtTrunc_";
  protected final String TEXT_352 = ".executeUpdate(\"";
  protected final String TEXT_353 = "\");";
  protected final String TEXT_354 = NL + "                if(!conn_";
  protected final String TEXT_355 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_356 = ".commit();" + NL + "                }";
  protected final String TEXT_357 = NL + "            deletedCount_";
  protected final String TEXT_358 = " += rsTruncCountNumber_";
  protected final String TEXT_359 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_360 = ".close();";
  protected final String TEXT_361 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_362 = " = conn_";
  protected final String TEXT_363 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_364 = " = stmtTruncCount_";
  protected final String TEXT_365 = ".executeQuery(\"";
  protected final String TEXT_366 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_374 = NL + "            while(rsTruncCount_";
  protected final String TEXT_375 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_376 = " += rsTruncCount_";
  protected final String TEXT_377 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_378 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_379 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_380 = ".close();";
  protected final String TEXT_381 = NL + "            StringBuffer duplidateClause_";
  protected final String TEXT_382 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");";
  protected final String TEXT_383 = NL + "                        duplidateClause_";
  protected final String TEXT_384 = ".append(\",\");";
  protected final String TEXT_385 = NL + "                        duplidateClause_";
  protected final String TEXT_386 = ".append (\"`\" +  ";
  protected final String TEXT_387 = " + \"`\");" + NL + "                        duplidateClause_";
  protected final String TEXT_388 = ".append (\"=\");" + NL + "                        duplidateClause_";
  protected final String TEXT_389 = ".append (";
  protected final String TEXT_390 = ");";
  protected final String TEXT_391 = NL;
  protected final String TEXT_392 = NL + "                        String insert_";
  protected final String TEXT_393 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_394 = " + \"` (";
  protected final String TEXT_395 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_396 = ".";
  protected final String TEXT_397 = ", \"";
  protected final String TEXT_398 = "\")+\") VALUES (";
  protected final String TEXT_399 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = ")+\")\";";
  protected final String TEXT_402 = NL + "                        String insert_";
  protected final String TEXT_403 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_404 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_405 = ".";
  protected final String TEXT_406 = ", \"";
  protected final String TEXT_407 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_408 = ".";
  protected final String TEXT_409 = ")+\")\";";
  protected final String TEXT_410 = NL + "                insert_";
  protected final String TEXT_411 = " +=  duplidateClause_";
  protected final String TEXT_412 = ".toString();";
  protected final String TEXT_413 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_414 = " = new StringBuffer(insert_";
  protected final String TEXT_415 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_416 = ".insert(insert_";
  protected final String TEXT_417 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_418 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_419 = " =insertStringBuffer_";
  ...
  protected final String TEXT_424 = ".prepareStatement(insert_";
  protected final String TEXT_425 = ");";
  protected final String TEXT_426 = NL;
  protected final String TEXT_427 = NL + "                        pstmt_";
  protected final String TEXT_428 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_429 = " = conn_";
  protected final String TEXT_430 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_431 = " + \"]\";" + NL + "                        if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_432 = ")== null){" + NL + "                            pstmt_";
  protected final String TEXT_433 = " = conn_";
  protected final String TEXT_434 = ".prepareStatement(insert_";
  protected final String TEXT_435 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_436 = ", pstmt_";
  protected final String TEXT_437 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_438 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_439 = ");" + NL + "                        }";
  protected final String TEXT_440 = NL;
  protected final String TEXT_441 = NL + "                ////////////////////////////////////////////////////////////////////////////////////////////" + NL + "" + NL + "" + NL + "                StringBuilder extendInsertValueStmt_";
  protected final String TEXT_442 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_443 = ";i++){";
  protected final String TEXT_444 = NL + "                    extendInsertValueStmt_";
  protected final String TEXT_445 = ".append(\"(";
  protected final String TEXT_446 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_447 = ".";
  protected final String TEXT_448 = ")+\")\");";
  protected final String TEXT_449 = NL + "                    extendInsertValueStmt_";
  protected final String TEXT_450 = ".append(\"(";
  protected final String TEXT_451 = ")\");";
  protected final String TEXT_452 = NL + "                if (i!=";
  protected final String TEXT_453 = "-1) extendInsertValueStmt_";
  protected final String TEXT_454 = ".append(\",\");" + NL + "                }";
  protected final String TEXT_455 = NL + "                        insert_";
  protected final String TEXT_456 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_457 = " + \"` (";
  protected final String TEXT_458 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_459 = ".";
  protected final String TEXT_460 = ", \"";
  protected final String TEXT_461 = "\")+\") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_462 = ".toString();";
  ...
  protected final String TEXT_468 = "\")+\") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_473 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_474 = " = new StringBuffer(insert_";
  protected final String TEXT_475 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_476 = ".insert(insert_";
  protected final String TEXT_477 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_478 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_479 = " =insertStringBuffer_";
  protected final String TEXT_480 = ".toString(); ";
  protected final String TEXT_481 = "    " + NL + "                    pstmt_";
  protected final String TEXT_482 = " =  conn_";
  protected final String TEXT_483 = ".prepareStatement(insert_";
  protected final String TEXT_484 = ");";
  protected final String TEXT_485 = NL + NL + "                    insertColName";
  protected final String TEXT_486 = " = \"";
  protected final String TEXT_487 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_488 = ".";
  protected final String TEXT_489 = ", \"";
  protected final String TEXT_490 = "\");" + NL + "                    insertColValue";
  protected final String TEXT_491 = " =  \"";
  protected final String TEXT_492 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_493 = ".";
  protected final String TEXT_494 = ");";
  protected final String TEXT_495 = NL + "                    insertColName";
  ...
  protected final String TEXT_503 = NL + "                rowCount";
  protected final String TEXT_504 = " = 0;";
  protected final String TEXT_505 = NL + "                int rowCount";
  protected final String TEXT_506 = " = 0;";
  ...
  protected final String TEXT_513 = "\")+\") VALUES (";
  protected final String TEXT_514 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_522 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_523 = ".";
  protected final String TEXT_524 = ")+\")\";";
  protected final String TEXT_525 = NL + "                        insert_";
  protected final String TEXT_526 = " +=  duplidateClause_";
  protected final String TEXT_527 = ".toString();";
  protected final String TEXT_528 = NL + "                        batchSize_";
  protected final String TEXT_529 = " = ";
  protected final String TEXT_530 = ";" + NL + "                        batchSizeCounter_";
  protected final String TEXT_531 = "=0;";
  protected final String TEXT_532 = NL + "                        int batchSize_";
  protected final String TEXT_533 = " = ";
  protected final String TEXT_534 = ";" + NL + "                        int batchSizeCounter_";
  protected final String TEXT_535 = "=0;";
  ...
  protected final String TEXT_563 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_564 = " = new StringBuffer(update_";
  protected final String TEXT_565 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_566 = ".insert(update_";
  protected final String TEXT_567 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_568 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_569 = " =updateStringBuffer_";
  protected final String TEXT_570 = ".toString(); ";
  protected final String TEXT_571 = NL + "        pstmt_";
  protected final String TEXT_572 = " = conn_";
  protected final String TEXT_573 = ".prepareStatement(update_";
  ...
  protected final String TEXT_582 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_583 = ".";
  protected final String TEXT_584 = ")+\")\";";
  protected final String TEXT_585 = NL + "                    String insert_";
  protected final String TEXT_586 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_587 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_588 = ".";
  protected final String TEXT_589 = ", \"";
  protected final String TEXT_590 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_596 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_597 = ".";
  protected final String TEXT_598 = ", \"";
  protected final String TEXT_599 = "\")+\" WHERE ";
  protected final String TEXT_600 = "\";";
  protected final String TEXT_601 = NL + "                    String update_";
  protected final String TEXT_602 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_603 = " + \"` SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_610 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_611 = " + \"` WHERE ";
  protected final String TEXT_612 = "\");//String insert_";
  protected final String TEXT_613 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_614 = " + \"` (";
  protected final String TEXT_615 = ") VALUES (";
  protected final String TEXT_616 = ")\";";
  protected final String TEXT_617 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_618 = " = new StringBuffer(insert_";
  protected final String TEXT_619 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_620 = ".insert(insert_";
  protected final String TEXT_621 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_622 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_623 = " =insertStringBuffer_";
  protected final String TEXT_624 = ".toString(); ";
  protected final String TEXT_625 = "    " + NL + "        pstmtInsert_";
  protected final String TEXT_626 = " = conn_";
  protected final String TEXT_627 = ".prepareStatement(insert_";
  protected final String TEXT_628 = ");";
  protected final String TEXT_629 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_630 = " = new StringBuffer(update_";
  protected final String TEXT_631 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_632 = ".insert(update_";
  protected final String TEXT_633 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_634 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_635 = " =updateStringBuffer_";
  protected final String TEXT_636 = ".toString(); ";
  protected final String TEXT_637 = NL + "        pstmtUpdate_";
  protected final String TEXT_638 = " = conn_";
  protected final String TEXT_639 = ".prepareStatement(update_";
  protected final String TEXT_640 = ");";
  protected final String TEXT_641 = NL + "                    String insert_";
  protected final String TEXT_642 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_643 = " + \"` (";
  protected final String TEXT_644 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_645 = ".";
  protected final String TEXT_646 = ", \"";
  protected final String TEXT_647 = "\")+\") VALUES (";
  protected final String TEXT_648 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_649 = ".";
  protected final String TEXT_650 = ")+\")\";";
  protected final String TEXT_651 = NL + "                    String insert_";
  protected final String TEXT_652 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_653 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_654 = ".";
  protected final String TEXT_655 = ", \"";
  protected final String TEXT_656 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_657 = ".";
  protected final String TEXT_658 = ")+\")\";";
  protected final String TEXT_659 = NL + "                    String update_";
  protected final String TEXT_660 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_661 = " + \"` SET ";
  protected final String TEXT_662 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_663 = ".";
  protected final String TEXT_664 = ", \"";
  protected final String TEXT_665 = "\")+\" WHERE ";
  protected final String TEXT_666 = "\";";
  protected final String TEXT_667 = NL + "                    String update_";
  protected final String TEXT_668 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_669 = " + \"` SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_670 = ".";
  protected final String TEXT_671 = ", \"";
  protected final String TEXT_672 = "\")+\" WHERE ";
  protected final String TEXT_673 = "\";";
  protected final String TEXT_674 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_675 = " = new StringBuffer(update_";
  protected final String TEXT_676 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_677 = ".insert(update_";
  protected final String TEXT_678 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_679 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_680 = " =updateStringBuffer_";
  protected final String TEXT_681 = ".toString(); ";
  protected final String TEXT_682 = NL + "        pstmtUpdate_";
  protected final String TEXT_683 = " = conn_";
  protected final String TEXT_684 = ".prepareStatement(update_";
  protected final String TEXT_685 = ");";
  protected final String TEXT_686 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_687 = " = new StringBuffer(insert_";
  protected final String TEXT_688 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_689 = ".insert(insert_";
  protected final String TEXT_690 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_691 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_692 = " =insertStringBuffer_";
  protected final String TEXT_693 = ".toString(); ";
  protected final String TEXT_694 = "    " + NL + "        pstmtInsert_";
  protected final String TEXT_695 = " = conn_";
  protected final String TEXT_696 = ".prepareStatement(insert_";
  protected final String TEXT_697 = ");";
  protected final String TEXT_698 = NL + "        String delete_";
  protected final String TEXT_699 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_700 = " + \"` WHERE ";
  protected final String TEXT_701 = "\";";
  protected final String TEXT_702 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_703 = " = new StringBuffer(delete_";
  protected final String TEXT_704 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_705 = ".insert(delete_";
  protected final String TEXT_706 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_707 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_708 = " =deleteStringBuffer_";
  protected final String TEXT_709 = ".toString();  ";
  protected final String TEXT_710 = NL + "        pstmt_";
  protected final String TEXT_711 = " = conn_";
  protected final String TEXT_712 = ".prepareStatement(delete_";
  protected final String TEXT_713 = ");";
  protected final String TEXT_714 = NL + "        String replace_";
  protected final String TEXT_715 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_716 = " + \"` (";
  protected final String TEXT_717 = ") VALUES (";
  protected final String TEXT_718 = ")\";" + NL + "        pstmt_";
  protected final String TEXT_719 = " = conn_";
  protected final String TEXT_720 = ".prepareStatement(replace_";
  protected final String TEXT_721 = ");";
  protected final String TEXT_722 = NL + "        String insertIgnore_";
  protected final String TEXT_723 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_724 = " + \"` (";
  protected final String TEXT_725 = ") VALUES (";
  protected final String TEXT_726 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_727 = "\";" + NL + "        pstmt_";
  protected final String TEXT_728 = " = conn_";
  protected final String TEXT_729 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_730 = ");";
  protected final String TEXT_731 = NL + "        String insert_";
  protected final String TEXT_732 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_733 = " + \"` (";
  protected final String TEXT_734 = ") VALUES (";
  protected final String TEXT_735 = ")\";";
  protected final String TEXT_736 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_737 = " = new StringBuffer(insert_";
  protected final String TEXT_738 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_739 = ".insert(insert_";
  protected final String TEXT_740 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_741 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_742 = " =insertStringBuffer_";
  protected final String TEXT_743 = ".toString(); ";
  protected final String TEXT_744 = "    " + NL + "        pstmt_";
  protected final String TEXT_745 = " = conn_";
  protected final String TEXT_746 = ".prepareStatement(insert_";
  protected final String TEXT_747 = ");";
  protected final String TEXT_748 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_749 = " = insert_";
  protected final String TEXT_750 = ".split(\"\\\\?\");";
  protected final String TEXT_751 = NL + "\t\t\tupdate_";
  protected final String TEXT_752 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_753 = " = update_";
  protected final String TEXT_754 = ".split(\"\\\\?\");";
  protected final String TEXT_755 = NL + "\t\t\tupdate_";
  protected final String TEXT_756 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_757 = " = update_";
  protected final String TEXT_758 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_759 = " = insert_";
  protected final String TEXT_760 = ".split(\"\\\\?\");";
  protected final String TEXT_761 = NL + "\t\t\tdelete_";
  protected final String TEXT_762 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_763 = " = delete_";
  protected final String TEXT_764 = ".split(\"\\\\?\");";
  protected final String TEXT_765 = NL + "\t\t\treplace_";
  protected final String TEXT_766 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_767 = " = replace_";
  protected final String TEXT_768 = ".split(\"\\\\?\");";
  protected final String TEXT_769 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_770 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_771 = " = insertIgnore_";
  protected final String TEXT_772 = ".split(\"\\\\?\");";
  protected final String TEXT_773 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_774 = " = insert_";
  ...
  protected final String TEXT_782 = ".setNull(counter";
  protected final String TEXT_783 = ",java.sql.Types.CHAR);";
  protected final String TEXT_784 = NL + "                if(";
  protected final String TEXT_785 = ".";
  protected final String TEXT_786 = "==null){";
  protected final String TEXT_787 = NL + "                    ";
  protected final String TEXT_788 = ".setNull(counter";
  protected final String TEXT_789 = ",java.sql.Types.DATE);";
  ...
  protected final String TEXT_795 = ",java.sql.Types.ARRAY);";
  ...
  protected final String TEXT_801 = ",java.sql.Types.INTEGER);";
  ...
  protected final String TEXT_807 = ",java.sql.Types.VARCHAR);";
  ...
  protected final String TEXT_813 = ",java.sql.Types.OTHER);";
  ...
  protected final String TEXT_819 = ",java.sql.Types.BOOLEAN);";
  ...
  protected final String TEXT_825 = ",java.sql.Types.DOUBLE);";
  ...
  protected final String TEXT_831 = ",java.sql.Types.FLOAT);";
  protected final String TEXT_832 = NL + "                }else{";
  protected final String TEXT_833 = NL + "                    if(";
  protected final String TEXT_834 = ".";
  protected final String TEXT_835 = "==null){";
  protected final String TEXT_836 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_837 = ".";
  protected final String TEXT_838 = ").toLowerCase())){";
  protected final String TEXT_839 = NL + "                ";
  protected final String TEXT_840 = ".setNull(counter";
  protected final String TEXT_841 = ",java.sql.Types.CHAR);" + NL + "" + NL + "                }else if(";
  protected final String TEXT_842 = ".";
  protected final String TEXT_843 = " == '\\0'){" + NL;
  protected final String TEXT_844 = NL + "                    ";
  protected final String TEXT_845 = ".setString(counter";
  ...
  protected final String TEXT_849 = ",String.valueOf(";
  protected final String TEXT_850 = ".";
  protected final String TEXT_851 = "));" + NL + "                }";
  protected final String TEXT_852 = NL + "                if(";
  protected final String TEXT_853 = ".";
  protected final String TEXT_854 = "!=null){" + NL + "                    // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "                    date_";
  protected final String TEXT_855 = " = ";
  protected final String TEXT_856 = ".";
  protected final String TEXT_857 = ".getTime();" + NL + "                    if (date_";
  protected final String TEXT_858 = " < year1_";
  protected final String TEXT_859 = " || date_";
  protected final String TEXT_860 = " >= year10000_";
  protected final String TEXT_861 = ") {";
  protected final String TEXT_862 = NL + "                        ";
  protected final String TEXT_863 = ".setString(counter";
  protected final String TEXT_864 = ", \"0000-00-00 00:00:00\");" + NL + "                    } else {";
  protected final String TEXT_865 = NL + "                        ";
  protected final String TEXT_866 = ".setTimestamp(counter";
  protected final String TEXT_867 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_868 = "));" + NL + "                    }" + NL + "                }else{" + NL;
  protected final String TEXT_869 = NL + "                    ";
  protected final String TEXT_870 = ".setNull(counter";
  protected final String TEXT_871 = ",java.sql.Types.DATE);" + NL + "" + NL + "                }";
  protected final String TEXT_872 = NL + "                ";
  protected final String TEXT_873 = ".set";
  protected final String TEXT_874 = "(counter";
  protected final String TEXT_875 = ",";
  protected final String TEXT_876 = ".";
  protected final String TEXT_877 = ");";
  protected final String TEXT_878 = NL + NL + "                }" + NL;
  protected final String TEXT_879 = NL + "        query_";
  protected final String TEXT_880 = " = new StringBuffer(\"\");";
  protected final String TEXT_881 = NL + "                commitEvery_";
  protected final String TEXT_882 = " = buffersSize_";
  protected final String TEXT_883 = ";";
  protected final String TEXT_884 = NL + "                    batchSize_";
  protected final String TEXT_885 = " = buffersSize_";
  protected final String TEXT_886 = ";";
  protected final String TEXT_887 = NL;
  protected final String TEXT_888 = NL + "        whetherReject_";
  protected final String TEXT_889 = " = false;";
  protected final String TEXT_890 = NL + "                        int counter";
  protected final String TEXT_891 = " = rowCount";
  protected final String TEXT_892 = " * ";
  protected final String TEXT_893 = " + 1;";
  protected final String TEXT_894 = NL + "                            counter";
  protected final String TEXT_895 = "++;";
  protected final String TEXT_896 = NL + "                            int count_dyn_";
  protected final String TEXT_897 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_898 = ".";
  protected final String TEXT_899 = ", pstmt_";
  protected final String TEXT_900 = ", counter";
  protected final String TEXT_901 = "-1, \"";
  protected final String TEXT_902 = "\");" + NL + "                            counter";
  protected final String TEXT_903 = "+=count_dyn_";
  protected final String TEXT_904 = ";";
  protected final String TEXT_905 = NL + NL + "                    exInsertColValue";
  protected final String TEXT_906 = " = new BufferLine_";
  ...
  protected final String TEXT_913 = NL + "                    );" + NL + "" + NL + "                    exInsertColValueList";
  protected final String TEXT_914 = ".add(exInsertColValue";
  protected final String TEXT_915 = ");" + NL + "" + NL + "                    rowCount";
  protected final String TEXT_916 = "++;";
  protected final String TEXT_917 = NL + "                nb_line_";
  protected final String TEXT_918 = "++;";
  protected final String TEXT_919 = NL + "                    if(rowCount";
  protected final String TEXT_920 = " == ";
  protected final String TEXT_921 = "){" + NL + "                        try{" + NL + "                            insertedCount_";
  protected final String TEXT_922 = " = insertedCount_";
  protected final String TEXT_923 = " + pstmt_";
  protected final String TEXT_924 = ".executeUpdate();" + NL + "                        }catch(java.lang.Exception e){";
  protected final String TEXT_925 = NL + "                             throw e;";
  protected final String TEXT_926 = NL + "                             System.err.println(e.getMessage());";
  protected final String TEXT_927 = NL + "                        }" + NL + "                        exInsertColValueList";
  protected final String TEXT_928 = ".clear();" + NL + "                        rowCount";
  protected final String TEXT_929 = " = 0;" + NL + "                        counter";
  protected final String TEXT_930 = "=1;" + NL + "                    }";
  protected final String TEXT_931 = NL + "                            ";
  protected final String TEXT_932 = NL + "                                query_";
  protected final String TEXT_933 = " = ";
  protected final String TEXT_934 = ";";
  protected final String TEXT_935 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  ...
  protected final String TEXT_950 = NL + "                    pstmt_";
  protected final String TEXT_951 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_952 = "++;" + NL;
  protected final String TEXT_953 = NL + "                      batchSizeCounter_";
  protected final String TEXT_954 = "++;";
  protected final String TEXT_955 = NL + "                    try {" + NL + "                        nb_line_";
  protected final String TEXT_956 = "++;" + NL + "                        insertedCount_";
  protected final String TEXT_957 = " = insertedCount_";
  protected final String TEXT_958 = " + pstmt_";
  protected final String TEXT_959 = ".executeUpdate();";
  protected final String TEXT_960 = NL + "                    } catch(java.lang.Exception e) {" + NL + "                        whetherReject_";
  protected final String TEXT_961 = " = true;";
  protected final String TEXT_962 = NL + "                            throw(e);";
  protected final String TEXT_963 = NL + "                                ";
  protected final String TEXT_964 = " = new ";
  protected final String TEXT_965 = "Struct();";
  protected final String TEXT_966 = NL + "                                    ";
  protected final String TEXT_967 = ".";
  protected final String TEXT_968 = " = ";
  protected final String TEXT_969 = ".";
  protected final String TEXT_970 = ";";
  protected final String TEXT_971 = NL + "                                rejectedCount_";
  protected final String TEXT_972 = " =  rejectedCount_";
  protected final String TEXT_973 = "+ 1;";
  protected final String TEXT_974 = NL + "                                ";
  protected final String TEXT_975 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_976 = NL + "                                ";
  protected final String TEXT_977 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_978 = ";";
  protected final String TEXT_979 = NL + "                                System.err.print(e.getMessage());";
  protected final String TEXT_980 = NL + "                    }";
  protected final String TEXT_981 = NL + "                        ";
  protected final String TEXT_982 = NL + "                            query_";
  protected final String TEXT_983 = " = ";
  protected final String TEXT_984 = ";";
  protected final String TEXT_985 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_986 = ",";
  protected final String TEXT_987 = ".";
  protected final String TEXT_988 = ", ";
  protected final String TEXT_989 = ",insertSQLSplits_";
  protected final String TEXT_990 = ");";
  protected final String TEXT_991 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1000 = NL + "                try {" + NL + "                    nb_line_";
  ...
  protected final String TEXT_1004 = ".executeUpdate();";
  protected final String TEXT_1005 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1006 = " = true;";
  protected final String TEXT_1007 = NL + "                        throw(e);";
  ...
  protected final String TEXT_1027 = NL + "                        query_";
  protected final String TEXT_1028 = " = ";
  protected final String TEXT_1029 = ";";
  protected final String TEXT_1030 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1031 = ",";
  protected final String TEXT_1032 = ".";
  protected final String TEXT_1033 = ", ";
  protected final String TEXT_1034 = ",updateSQLSplits_";
  protected final String TEXT_1035 = ");";
  protected final String TEXT_1036 = NL + NL + "                    int count_";
  protected final String TEXT_1037 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1038 = ".";
  protected final String TEXT_1039 = ", pstmt_";
  ...
  protected final String TEXT_1059 = NL + "                globalMap.put(\"";
  protected final String TEXT_1060 = "_QUERY\", query_";
  protected final String TEXT_1061 = ".toString().trim());";
  ...
  protected final String TEXT_1068 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_1069 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_1070 = " = updatedCount_";
  protected final String TEXT_1071 = " + pstmt_";
  protected final String TEXT_1072 = ".executeUpdate();";
  protected final String TEXT_1073 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1074 = " = true;";
  protected final String TEXT_1075 = NL + "                    throw(e);";
  ...
  protected final String TEXT_1096 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_1097 = " = pstmt_";
  protected final String TEXT_1098 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_1099 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_1100 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_1101 = " = rs_";
  protected final String TEXT_1102 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_1103 = " > 0) {";
  protected final String TEXT_1104 = NL + "                        ";
  protected final String TEXT_1105 = NL + "                            query_";
  protected final String TEXT_1106 = " = ";
  protected final String TEXT_1107 = ";";
  protected final String TEXT_1108 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1109 = ",";
  protected final String TEXT_1110 = ".";
  protected final String TEXT_1111 = ", ";
  protected final String TEXT_1112 = ",updateSQLSplits_";
  protected final String TEXT_1113 = ");";
  protected final String TEXT_1114 = NL + NL + "                        int count_";
  protected final String TEXT_1115 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1116 = ".";
  protected final String TEXT_1117 = ", pstmtUpdate_";
  ...
  protected final String TEXT_1130 = NL + "                            query_";
  protected final String TEXT_1131 = " = ";
  protected final String TEXT_1132 = ";";
  protected final String TEXT_1133 = NL + "                            query_";
  protected final String TEXT_1134 = " = ";
  protected final String TEXT_1135 = ";";
  protected final String TEXT_1136 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1137 = "_QUERY\", query_";
  protected final String TEXT_1138 = ".toString().trim());";
  protected final String TEXT_1139 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_1140 = " = updatedCount_";
  protected final String TEXT_1141 = " + pstmtUpdate_";
  protected final String TEXT_1142 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1143 = "++;";
  protected final String TEXT_1144 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1145 = " = true;";
  protected final String TEXT_1146 = NL + "                        throw(e);";
  protected final String TEXT_1147 = NL + "                        nb_line_";
  protected final String TEXT_1148 = "++;";
  protected final String TEXT_1149 = NL + "                        ";
  protected final String TEXT_1150 = " = new ";
  protected final String TEXT_1151 = "Struct();";
  protected final String TEXT_1152 = NL + "                                ";
  protected final String TEXT_1153 = ".";
  protected final String TEXT_1154 = " = ";
  protected final String TEXT_1155 = ".";
  protected final String TEXT_1156 = ";";
  protected final String TEXT_1157 = NL + "                            rejectedCount_";
  protected final String TEXT_1158 = " =  rejectedCount_";
  protected final String TEXT_1159 = "+ 1;";
  protected final String TEXT_1160 = NL + "                            ";
  protected final String TEXT_1161 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1162 = NL + "                            ";
  protected final String TEXT_1163 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1164 = ";";
  protected final String TEXT_1165 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1166 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_1167 = NL + "                        ";
  protected final String TEXT_1168 = NL + "                            query_";
  protected final String TEXT_1169 = " = ";
  protected final String TEXT_1170 = ";";
  protected final String TEXT_1171 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1172 = ",";
  protected final String TEXT_1173 = ".";
  protected final String TEXT_1174 = ", ";
  protected final String TEXT_1175 = ",insertSQLSplits_";
  protected final String TEXT_1176 = ");";
  protected final String TEXT_1177 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1178 = ".";
  protected final String TEXT_1179 = ", pstmtInsert_";
  protected final String TEXT_1180 = ", ";
  protected final String TEXT_1181 = ", \"";
  protected final String TEXT_1182 = "\");";
  protected final String TEXT_1183 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1184 = "_QUERY\", query_";
  protected final String TEXT_1185 = ".toString().trim());";
  protected final String TEXT_1186 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_1187 = " = insertedCount_";
  protected final String TEXT_1188 = " + pstmtInsert_";
  protected final String TEXT_1189 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1190 = "++;";
  protected final String TEXT_1191 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1192 = " = true;";
  protected final String TEXT_1193 = NL + "                        throw(e);";
  protected final String TEXT_1194 = NL + "                        nb_line_";
  protected final String TEXT_1195 = "++;";
  protected final String TEXT_1196 = NL + "                        ";
  protected final String TEXT_1197 = " = new ";
  protected final String TEXT_1198 = "Struct();";
  ...
  protected final String TEXT_1204 = NL + "                            rejectedCount_";
  protected final String TEXT_1205 = " =  rejectedCount_";
  protected final String TEXT_1206 = "+ 1;";
  protected final String TEXT_1207 = NL + "                            ";
  protected final String TEXT_1208 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1209 = NL + "                            ";
  protected final String TEXT_1210 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1211 = ";";
  protected final String TEXT_1212 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1213 = NL + "                }" + NL + "            }";
  protected final String TEXT_1214 = NL + "            int updateFlag_";
  protected final String TEXT_1215 = "=0;";
  ...
  protected final String TEXT_1220 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1221 = ",";
  protected final String TEXT_1222 = ".";
  protected final String TEXT_1223 = ", ";
  protected final String TEXT_1224 = ",updateSQLSplits_";
  protected final String TEXT_1225 = ");";
  protected final String TEXT_1226 = NL + NL + "                    int count_";
  protected final String TEXT_1227 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1235 = NL + "                        query_";
  protected final String TEXT_1236 = " = ";
  protected final String TEXT_1237 = ";";
  protected final String TEXT_1238 = NL + "                        query_";
  ...
  protected final String TEXT_1246 = NL + "                        query_";
  protected final String TEXT_1247 = " = ";
  protected final String TEXT_1248 = ";";
  protected final String TEXT_1249 = NL + "                globalMap.put(\"";
  protected final String TEXT_1250 = "_QUERY\", query_";
  protected final String TEXT_1251 = ".toString().trim());";
  protected final String TEXT_1252 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_1253 = "=pstmtUpdate_";
  protected final String TEXT_1254 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1255 = " = updatedCount_";
  protected final String TEXT_1256 = "+updateFlag_";
  protected final String TEXT_1257 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_1258 = " == 0) {" + NL;
  protected final String TEXT_1259 = NL + "                query_";
  protected final String TEXT_1260 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_1265 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1266 = ",";
  protected final String TEXT_1267 = ".";
  protected final String TEXT_1268 = ", ";
  protected final String TEXT_1269 = ",insertSQLSplits_";
  protected final String TEXT_1270 = ");";
  protected final String TEXT_1271 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1272 = ".";
  protected final String TEXT_1273 = ", pstmtInsert_";
  ...
  protected final String TEXT_1280 = NL + "                    insertedCount_";
  protected final String TEXT_1281 = " = insertedCount_";
  protected final String TEXT_1282 = " + pstmtInsert_";
  protected final String TEXT_1283 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1284 = "++;";
  protected final String TEXT_1285 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_1286 = "++;";
  protected final String TEXT_1287 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1288 = " = true;";
  protected final String TEXT_1289 = NL + "                        throw(e);";
  protected final String TEXT_1290 = NL + "                        nb_line_";
  ...
  protected final String TEXT_1300 = NL + "                            rejectedCount_";
  protected final String TEXT_1301 = " =  rejectedCount_";
  protected final String TEXT_1302 = "+ 1;";
  protected final String TEXT_1303 = NL + "                            ";
  protected final String TEXT_1304 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1305 = NL + "                            ";
  protected final String TEXT_1306 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1307 = ";";
  protected final String TEXT_1308 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1309 = NL + "                }";
  protected final String TEXT_1310 = NL + "                        ";
  protected final String TEXT_1311 = NL + "                            query_";
  protected final String TEXT_1312 = " = ";
  protected final String TEXT_1313 = ";";
  protected final String TEXT_1314 = NL + "                    ";
  protected final String TEXT_1315 = NL + "                        query_";
  protected final String TEXT_1316 = " = ";
  protected final String TEXT_1317 = ";";
  protected final String TEXT_1318 = NL + "                globalMap.put(\"";
  protected final String TEXT_1319 = "_QUERY\", query_";
  protected final String TEXT_1320 = ".toString().trim());";
  protected final String TEXT_1321 = NL + "            pstmt_";
  protected final String TEXT_1322 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_1323 = "++;";
  protected final String TEXT_1324 = NL + "              batchSizeCounter_";
  protected final String TEXT_1325 = "++;";
  protected final String TEXT_1326 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1327 = " = deletedCount_";
  protected final String TEXT_1328 = " + pstmt_";
  protected final String TEXT_1329 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_1344 = NL + "                        rejectedCount_";
  protected final String TEXT_1345 = " =  rejectedCount_";
  protected final String TEXT_1346 = "+ 1;";
  protected final String TEXT_1347 = NL + "                        ";
  protected final String TEXT_1348 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1349 = NL + "                        ";
  protected final String TEXT_1350 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1351 = ";" + NL;
  protected final String TEXT_1352 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1353 = NL + "            }";
  protected final String TEXT_1354 = NL + "                    ";
  protected final String TEXT_1355 = NL + "                        query_";
  protected final String TEXT_1356 = " = ";
  protected final String TEXT_1357 = ";";
  protected final String TEXT_1358 = NL + "                globalMap.put(\"";
  protected final String TEXT_1359 = "_QUERY\", query_";
  protected final String TEXT_1360 = ".toString().trim());";
  protected final String TEXT_1361 = NL + "            int replaceCount_";
  protected final String TEXT_1362 = " = 0;" + NL + "            try {" + NL + "                replaceCount_";
  protected final String TEXT_1363 = " = pstmt_";
  protected final String TEXT_1364 = ".executeUpdate();";
  protected final String TEXT_1365 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1366 = " = true;";
  protected final String TEXT_1367 = NL + "                    throw(e);";
  protected final String TEXT_1368 = NL + "                        ";
  protected final String TEXT_1369 = " = new ";
  protected final String TEXT_1370 = "Struct();";
  ...
  protected final String TEXT_1376 = NL + "                        rejectedCount_";
  protected final String TEXT_1377 = " =  rejectedCount_";
  protected final String TEXT_1378 = "+ 1;";
  protected final String TEXT_1379 = NL + "                        ";
  protected final String TEXT_1380 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1381 = NL + "                        ";
  protected final String TEXT_1382 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1383 = ";";
  protected final String TEXT_1384 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1385 = NL + "            }" + NL + "            if(replaceCount_";
  protected final String TEXT_1386 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1387 = " += replaceCount_";
  protected final String TEXT_1388 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1389 = " += 1;" + NL + "                deletedCount_";
  protected final String TEXT_1390 = " += replaceCount_";
  protected final String TEXT_1391 = " - 1;" + NL + "            }";
  protected final String TEXT_1392 = NL + "                    ";
  protected final String TEXT_1393 = NL + "                        query_";
  protected final String TEXT_1394 = " = ";
  protected final String TEXT_1395 = ";";
  protected final String TEXT_1396 = NL + "                    ";
  protected final String TEXT_1397 = NL + "                        query_";
  protected final String TEXT_1398 = " = ";
  protected final String TEXT_1399 = ";";
  protected final String TEXT_1400 = NL + "                globalMap.put(\"";
  protected final String TEXT_1401 = "_QUERY\", query_";
  protected final String TEXT_1402 = ".toString().trim());";
  protected final String TEXT_1403 = NL + "            int count_on_duplicate_key_";
  protected final String TEXT_1404 = " = 0;" + NL + "            try {" + NL + "                count_on_duplicate_key_";
  protected final String TEXT_1405 = " = pstmt_";
  protected final String TEXT_1406 = ".executeUpdate();";
  protected final String TEXT_1407 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1408 = " = true;";
  protected final String TEXT_1409 = NL + "                    throw(e);";
  ...
  protected final String TEXT_1422 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1423 = NL + "                        ";
  protected final String TEXT_1424 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1425 = ";";
  protected final String TEXT_1426 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1427 = NL + "            }" + NL + "            if(count_on_duplicate_key_";
  protected final String TEXT_1428 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1429 = " += count_on_duplicate_key_";
  protected final String TEXT_1430 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1431 = " += 1;" + NL + "                updatedCount_";
  protected final String TEXT_1432 = " += count_on_duplicate_key_";
  protected final String TEXT_1433 = " - 1;" + NL + "            }";
  protected final String TEXT_1434 = NL + "                        ";
  protected final String TEXT_1435 = NL + "                            query_";
  protected final String TEXT_1436 = " = ";
  protected final String TEXT_1437 = ";";
  protected final String TEXT_1438 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1439 = "_QUERY\", query_";
  protected final String TEXT_1440 = ".toString().trim());";
  protected final String TEXT_1441 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_1442 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_1443 = " = insertedCount_";
  protected final String TEXT_1444 = " + pstmt_";
  protected final String TEXT_1445 = ".executeUpdate();";
  protected final String TEXT_1446 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1447 = " = true;";
  protected final String TEXT_1448 = NL + "                        throw(e);";
  protected final String TEXT_1449 = NL + "                            ";
  protected final String TEXT_1450 = " = new ";
  protected final String TEXT_1451 = "Struct();";
  ...
  protected final String TEXT_1457 = NL + "                            rejectedCount_";
  protected final String TEXT_1458 = " =  rejectedCount_";
  protected final String TEXT_1459 = "+ 1;";
  protected final String TEXT_1460 = NL + "                            ";
  protected final String TEXT_1461 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1462 = NL + "                            ";
  protected final String TEXT_1463 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1464 = ";";
  protected final String TEXT_1465 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1466 = NL + "                }";
  protected final String TEXT_1467 = NL + "            if(!whetherReject_";
  protected final String TEXT_1468 = ") {";
  protected final String TEXT_1469 = NL + "                            ";
  protected final String TEXT_1470 = " = new ";
  protected final String TEXT_1471 = "Struct();";
  ...
  protected final String TEXT_1478 = NL + "                if ( batchSize_";
  protected final String TEXT_1479 = " <= batchSizeCounter_";
  protected final String TEXT_1480 = ") {";
  protected final String TEXT_1481 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1482 = " = 0;";
  protected final String TEXT_1483 = NL + "                        for(int countEach_";
  protected final String TEXT_1484 = ": pstmt_";
  protected final String TEXT_1485 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1486 = " += (countEach_";
  protected final String TEXT_1487 = " < 0 ? 0 : 1);" + NL + "                        }";
  protected final String TEXT_1488 = NL + "                        insertedCount_";
  protected final String TEXT_1489 = " += countSum_";
  protected final String TEXT_1490 = ";";
  protected final String TEXT_1491 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1492 = NL + "                        throw(e);";
  protected final String TEXT_1493 = NL + "                    int countSum_";
  protected final String TEXT_1494 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1495 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_1496 = " += (countEach_";
  protected final String TEXT_1497 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1498 = ");" + NL + "                    }";
  protected final String TEXT_1499 = NL + "                    insertedCount_";
  protected final String TEXT_1500 = " += countSum_";
  protected final String TEXT_1501 = ";";
  protected final String TEXT_1502 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1503 = NL + "                }";
  protected final String TEXT_1504 = NL + NL + "                batchSizeCounter_";
  protected final String TEXT_1505 = " = 0;" + NL + "            }";
  ...
  protected final String TEXT_1510 = " = 0;";
  ...
  protected final String TEXT_1515 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1516 = ");" + NL + "                        }";
  protected final String TEXT_1517 = NL + "                        updatedCount_";
  protected final String TEXT_1518 = " += countSum_";
  protected final String TEXT_1519 = ";";
  protected final String TEXT_1520 = NL + "                        deletedCount_";
  protected final String TEXT_1521 = " += countSum_";
  protected final String TEXT_1522 = ";";
  protected final String TEXT_1523 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1524 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1525 = NL + "                        throw(e);";
  protected final String TEXT_1526 = NL + "                    int countSum_";
  protected final String TEXT_1527 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1528 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_1529 = " += (countEach_";
  protected final String TEXT_1530 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1531 = ");" + NL + "                    }";
  protected final String TEXT_1532 = NL + "                    updatedCount_";
  protected final String TEXT_1533 = " += countSum_";
  protected final String TEXT_1534 = ";";
  protected final String TEXT_1535 = NL + "                    deletedCount_";
  protected final String TEXT_1536 = " += countSum_";
  protected final String TEXT_1537 = ";";
  protected final String TEXT_1538 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1539 = NL + "                }";
  protected final String TEXT_1540 = NL + NL + NL + NL + "                }";
  protected final String TEXT_1541 = NL + "                commitCounter_";
  protected final String TEXT_1542 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_1543 = " <= commitCounter_";
  protected final String TEXT_1544 = ") {" + NL;
  protected final String TEXT_1545 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1546 = " = 0;";
  protected final String TEXT_1547 = NL + "                        for(int countEach_";
  protected final String TEXT_1548 = ": pstmt_";
  protected final String TEXT_1549 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1550 = " += (countEach_";
  protected final String TEXT_1551 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_1562 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1563 = NL + "                        throw(e);";
  ...
  protected final String TEXT_1573 = NL + "                    updatedCount_";
  protected final String TEXT_1574 = " += countSum_";
  protected final String TEXT_1575 = ";";
  protected final String TEXT_1576 = NL + "                    deletedCount_";
  protected final String TEXT_1577 = " += countSum_";
  protected final String TEXT_1578 = ";";
  protected final String TEXT_1579 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1580 = NL + NL + "                }";
  protected final String TEXT_1581 = NL + "                    conn_";
  protected final String TEXT_1582 = ".commit();";
  protected final String TEXT_1583 = NL + "                    commitCounter_";
  protected final String TEXT_1584 = "=0;" + NL + "" + NL + "                }" + NL;
