...
public class TRedshiftBulkExecBeginJava {
  ...
  protected final String TEXT_98 = " = \"com.amazon.redshift.jdbc41.Driver\";" + NL + "\t\tClass.forName(driverClass_";
  protected final String TEXT_99 = ").newInstance();" + NL + "\t\t";
  protected final String TEXT_100 = NL + "\t\t\tString url_";
  protected final String TEXT_101 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_102 = " + \":\" + ";
  protected final String TEXT_103 = " + \"/\" + ";
  protected final String TEXT_104 = ";" + NL + "\t\t";
  protected final String TEXT_105 = NL + "\t\t\tString url_";
  protected final String TEXT_106 = " = \"jdbc:redshift://\" + ";
  ...
  protected final String TEXT_411 = NL + "\tStringBuilder command_";
  protected final String TEXT_412 = " = new StringBuilder();";
  protected final String TEXT_413 = NL + "\t\tchar fieldSeparator_";
  protected final String TEXT_414 = " = ";
  protected final String TEXT_415 = NL + "\t\t',';";
  protected final String TEXT_416 = NL + "\t\tString.valueOf(";
  protected final String TEXT_417 = ").charAt(0);";
  protected final String TEXT_418 = NL + "\t\tchar textEnclosure_";
  protected final String TEXT_419 = " = ";
  protected final String TEXT_420 = NL + "\t\t'\\0';" + NL + "\t";
  protected final String TEXT_421 = NL + "\t\t'\"';";
  protected final String TEXT_422 = NL + "\t\tString.valueOf(";
  protected final String TEXT_423 = ").charAt(0);";
  protected final String TEXT_424 = NL + "\tcommand_";
  protected final String TEXT_425 = ".append(\"COPY \").append(tableName2_";
  protected final String TEXT_426 = ")" + NL + "\t";
  protected final String TEXT_427 = NL + "\t\t.append(\" (\")";
  protected final String TEXT_428 = NL + "\t\t\t.append(\"";
  protected final String TEXT_429 = "\")";
  protected final String TEXT_430 = NL + "\t\t\t.append(\",\")";
  protected final String TEXT_431 = NL + "\t\t.append(\")\")";
  protected final String TEXT_432 = NL + "\t.append(\" FROM '\");";
  protected final String TEXT_433 = NL + "\t";
  protected final String TEXT_434 = " " + NL + "\tfinal String decryptedPwd_";
  protected final String TEXT_435 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_436 = ");" + NL + "\t";
  protected final String TEXT_437 = NL + "\tfinal String decryptedPwd_";
  protected final String TEXT_438 = " = ";
  protected final String TEXT_439 = "; " + NL + "\t";
  protected final String TEXT_440 = NL + "\t";
  protected final String TEXT_441 = NL + "\t\tcommand_";
  protected final String TEXT_442 = ".append(\"s3://\").append(";
  protected final String TEXT_443 = ").append(\"/\").append(";
  protected final String TEXT_444 = ")";
  protected final String TEXT_445 = NL + "\t\tString hdfspath_";
  protected final String TEXT_446 = " = ";
  protected final String TEXT_447 = ";" + NL + "\t\tif(hdfspath_";
  protected final String TEXT_448 = "!=null && hdfspath_";
  protected final String TEXT_449 = ".startsWith(\"/\")) {" + NL + "\t\t\thdfspath_";
  protected final String TEXT_450 = " = hdfspath_";
  protected final String TEXT_451 = ".substring(1);" + NL + "\t\t}" + NL + "\t\tcommand_";
  protected final String TEXT_452 = ".append(\"emr://\").append(";
  protected final String TEXT_453 = ").append(\"/\").append(hdfspath_";
  protected final String TEXT_454 = ")";
  protected final String TEXT_455 = NL + "\t\tcommand_";
  protected final String TEXT_456 = ".append(\"dynamodb://\").append(";
  protected final String TEXT_457 = ")";
  protected final String TEXT_458 = NL + "\t\tcommand_";
  protected final String TEXT_459 = ".append(\"s3://\").append(";
  protected final String TEXT_460 = ").append(\"/\").append(";
  protected final String TEXT_461 = ")";
  protected final String TEXT_462 = NL + "\t.append(\"' \")" + NL + "\t" + NL + "\t.append(\"credentials 'aws_access_key_id=\").append(";
  protected final String TEXT_463 = ").append(\";aws_secret_access_key=\").append(decryptedPwd_";
  protected final String TEXT_464 = ")";
  protected final String TEXT_465 = NL + "\t\t.append(\";master_symmetric_key=\").append(";
  protected final String TEXT_466 = ")";
  protected final String TEXT_467 = NL + "\t.append(\"' \")";
  protected final String TEXT_468 = NL + "\t.append(\"READRATIO \").append(";
  protected final String TEXT_469 = ").append(\" \");";
  protected final String TEXT_470 = NL + "\t.append(\"SSH \")";
  protected final String TEXT_471 = NL + "\t.append(\"DELIMITER '\").append(fieldSeparator_";
  protected final String TEXT_472 = ").append(\"' \")";
  protected final String TEXT_473 = NL + "\t.append(\"JSON '\").append(";
  protected final String TEXT_474 = ").append(\"' \")";
  protected final String TEXT_475 = NL + "\t.append(\"AVRO '\").append(";
  protected final String TEXT_476 = ").append(\"' \")";
  protected final String TEXT_477 = NL + "\t.append(\"FIXEDWIDTH '\").append(";
  protected final String TEXT_478 = ").append(\"' \")";
  protected final String TEXT_479 = NL + "\t;";
  protected final String TEXT_480 = NL + "\tif(textEnclosure_";
  protected final String TEXT_481 = "!='\\0') {" + NL + "\t\tcommand_";
  protected final String TEXT_482 = ".append(\"CSV QUOTE '\").append(textEnclosure_";
  protected final String TEXT_483 = ").append(\"' \");" + NL + "\t}";
  protected final String TEXT_484 = NL + "\t\tcommand_";
  protected final String TEXT_485 = ".append(\"ENCODING \").append(";
  protected final String TEXT_486 = ").append(\" \");";
  protected final String TEXT_487 = NL + "\t\t\tcommand_";
  protected final String TEXT_488 = ".append(\"";
  protected final String TEXT_489 = " '\").append(";
  protected final String TEXT_490 = ").append(\"' \");";
  protected final String TEXT_491 = NL + "\t\t\tcommand_";
  protected final String TEXT_492 = ".append(\"";
  protected final String TEXT_493 = " \");";
  protected final String TEXT_494 = NL + "\t\t\tcommand_";
  protected final String TEXT_495 = ".append(\"";
  protected final String TEXT_496 = " \").append(";
  protected final String TEXT_497 = ").append(\" \");";
  protected final String TEXT_498 = NL + "\t\t\tcommand_";
  protected final String TEXT_499 = ".append(\"MAXERROR \").append(";
  protected final String TEXT_500 = ").append(\" \");";
  protected final String TEXT_501 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_502 = ".append(\"ACCEPTINVCHARS \");";
  protected final String TEXT_503 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_504 = ".append(\"ACCEPTINVCHARS '\").append(";
  protected final String TEXT_505 = ").append(\"' \");";
  protected final String TEXT_506 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_507 = ".append(\"";
  protected final String TEXT_508 = " ON \");";
  protected final String TEXT_509 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_510 = ".append(\"";
  protected final String TEXT_511 = " OFF \");";
  protected final String TEXT_512 = NL + "\t\tcommand_";
  protected final String TEXT_513 = ".append(\"ENCRYPTED \");";
  protected final String TEXT_514 = NL + "\t\tcommand_";
  protected final String TEXT_515 = ".append(\"";
  protected final String TEXT_516 = " \");";
  protected final String TEXT_517 = NL + "\t\tcommand_";
  protected final String TEXT_518 = ".append(\"DATEFORMAT '\").append(";
  protected final String TEXT_519 = ").append(\"' \");";
  protected final String TEXT_520 = NL + "\t\tcommand_";
  protected final String TEXT_521 = ".append(\"DATEFORMAT 'auto' \");";
  protected final String TEXT_522 = NL + "\t\tcommand_";
  protected final String TEXT_523 = ".append(\"TIMEFORMAT '\").append(";
  protected final String TEXT_524 = ").append(\"' \");";
  protected final String TEXT_525 = NL + "\t\tcommand_";
  protected final String TEXT_526 = ".append(\"TIMEFORMAT 'auto' \");";
  protected final String TEXT_527 = NL + "\t\tcommand_";
  protected final String TEXT_528 = ".append(\"TIMEFORMAT 'epochsecs' \");";
  protected final String TEXT_529 = NL + "\t\tcommand_";
  protected final String TEXT_530 = ".append(\"TIMEFORMAT 'epochmillisecs' \");";
  protected final String TEXT_531 = NL + "\t" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_532 = "=conn_";
  protected final String TEXT_533 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_534 = ".execute(command_";
  protected final String TEXT_535 = ".toString());";
  protected final String TEXT_536 = NL + "\t\tif(stmt_";
  protected final String TEXT_537 = ".getWarnings()!=null) {";
  protected final String TEXT_538 = NL + "\t\t\tlog.warn(\"";
  protected final String TEXT_539 = " - \" + stmt_";
  protected final String TEXT_540 = ".getWarnings().getMessage());";
  protected final String TEXT_541 = NL + "\t\t\tSystem.err.println(stmt_";
  protected final String TEXT_542 = ".getWarnings().getMessage());";
  protected final String TEXT_543 = NL + "\t\t}";
  protected final String TEXT_544 = NL + "\t";
  protected final String TEXT_545 = NL + "\t\tlog.info(\"";
  protected final String TEXT_546 = " - Finish loading data to table : \" + tableName2_";
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append(hdfs_filepath);
    ...
    stringBuffer.append(emr_cluster_id);
