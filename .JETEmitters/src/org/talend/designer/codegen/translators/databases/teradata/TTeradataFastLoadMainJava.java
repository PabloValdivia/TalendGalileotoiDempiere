...
public class TTeradataFastLoadMainJava {
  ...
  protected final String TEXT_166 = NL + "\t\t\tif (nb_line_";
  protected final String TEXT_167 = " == 0) {" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_168 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_169 = " + \" (";
  protected final String TEXT_170 = " \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_171 = ".";
  protected final String TEXT_172 = ", \"teradata_id\")+\") VALUES (";
  protected final String TEXT_173 = "\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_174 = ".";
  protected final String TEXT_175 = ")+\")\";" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".prepareStatement(insert_";
  protected final String TEXT_178 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_179 = NL + "\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_180 = ".";
  protected final String TEXT_181 = ", pstmt_";
  protected final String TEXT_182 = ", ";
  protected final String TEXT_183 = ", \"teradata_id\");" + NL + "\t\t";
  protected final String TEXT_184 = NL + "\t\t" + NL + "\t\ttry{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_185 = ".addBatch();" + NL + "\t\t   }catch(java.lang.Exception e){" + NL + "\t\t            ";
  ...
  protected final String TEXT_195 = NL + "\t\t                    System.err.print(e.getMessage());" + NL + "\t\t                    ";
  ...
  protected final String TEXT_202 = NL + "\t    commitCounter_";
  protected final String TEXT_203 = "++;" + NL + "\t    nb_line_";
  protected final String TEXT_204 = "++;";
  protected final String TEXT_205 = NL + "        if(commitEvery_";
  protected final String TEXT_206 = " <= commitCounter_";
  protected final String TEXT_207 = "){" + NL + "\t\t\tint[] resultArr = pstmt_";
  protected final String TEXT_208 = ".executeBatch();" + NL + "\t\t\tpstmt_";
  protected final String TEXT_209 = ".clearBatch();" + NL + "        \tcommitCounter_";
  protected final String TEXT_210 = "=0;" + NL + "        \tint sum = 0;" + NL + "        \tfor(int i : resultArr){" + NL + "  \t\t    \tsum += (i<0 ? 0 : i);" + NL + "        \t}" + NL + "        \tinsertedCount_";
  protected final String TEXT_211 = " += sum;" + NL + "        }" + NL + "\t";
