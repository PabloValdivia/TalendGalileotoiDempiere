...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_277 = NL + "            \tString tableForSearch_";
  protected final String TEXT_278 = " = ";
  protected final String TEXT_279 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_280 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_281 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_282 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_283 = " =  tableForSearch_";
  protected final String TEXT_284 = ".substring(1,tableForSearch_";
  protected final String TEXT_285 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_286 = " =  tableForSearch_";
  protected final String TEXT_287 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_291 = ".getTables(null, conn_";
  protected final String TEXT_292 = ".getSchema(), tableForSearch_";
  protected final String TEXT_293 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_294 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_295 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_296 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_303 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_304 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_305 = " = rsTable_";
  protected final String TEXT_306 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_313 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_314 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_318 = " - Creating table ";
  ...
  protected final String TEXT_326 = " - Create table ";
  protected final String TEXT_327 = "\" + tableName_";
  protected final String TEXT_328 = " + \"";
  protected final String TEXT_329 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_330 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_331 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_332 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_333 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_354 = " - Creating table ";
  ...
  protected final String TEXT_362 = " - Create table ";
  ...
  protected final String TEXT_367 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_372 = " - Clearing table ";
  ...
  protected final String TEXT_380 = "- Clear table ";
  ...
  protected final String TEXT_393 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_395 = " - Trancating table ";
  protected final String TEXT_396 = "\" + tableName_";
  protected final String TEXT_397 = " + \"";
  protected final String TEXT_398 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_400 = ".executeUpdate(\"";
  protected final String TEXT_401 = "\");" + NL + "   \t    \t";
  protected final String TEXT_402 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_403 = " - Truncate table ";
  protected final String TEXT_404 = "\" + tableName_";
  protected final String TEXT_405 = " + \"";
  protected final String TEXT_406 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_414 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_415 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_416 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_417 = " " + NL;
  protected final String TEXT_418 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_419 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_420 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_421 = " + \";HDR=";
  protected final String TEXT_422 = "].[\" + fileName_";
  protected final String TEXT_423 = " + \"]\";" + NL + "\t\tjava.sql.Statement stmt_";
  ...
  protected final String TEXT_427 = " - Bulk SQL:\"+bulkInsert_";
  protected final String TEXT_428 = "+\".\");" + NL + "    \t\tlog.info(\"";
  protected final String TEXT_429 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_430 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_431 = NL + "\t\tstmt_";
  protected final String TEXT_432 = ".execute(bulkInsert_";
  protected final String TEXT_433 = ");" + NL + "" + NL + "\t\tstmt_";
  protected final String TEXT_434 = ".close();" + NL + "\t\t";
  protected final String TEXT_435 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_436 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_437 = " + \" has finished.\");" + NL + "    \t";
