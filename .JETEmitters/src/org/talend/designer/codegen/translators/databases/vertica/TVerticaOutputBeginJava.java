...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_142 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_149 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_153 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_154 = "));";
  protected final String TEXT_155 = NL + "                    stmtCreate_";
  protected final String TEXT_156 = ".execute(((\"";
  protected final String TEXT_157 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = ", \"";
  protected final String TEXT_160 = "\")";
  protected final String TEXT_161 = ".toUpperCase()";
  ...
  protected final String TEXT_169 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_170 = " = conn_";
  protected final String TEXT_171 = ".createStatement();";
  protected final String TEXT_172 = NL + "                              stmtCreate_";
  protected final String TEXT_173 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_269 = ".toUpperCase()";
  ...
  protected final String TEXT_275 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_276 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_280 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_281 = " = conn_";
  protected final String TEXT_282 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_283 = " = dbMetaData_";
  protected final String TEXT_284 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_285 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_286 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_287 = " == null || dbschema_";
  protected final String TEXT_288 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_289 = " = conn_";
  protected final String TEXT_290 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_291 = " = stmtSchema_";
  protected final String TEXT_292 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_293 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_294 = " = rsSchema_";
  protected final String TEXT_295 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_296 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_297 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_298 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_299 = " = rsTable_";
  protected final String TEXT_300 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_301 = " = rsTable_";
  protected final String TEXT_302 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  ...
  protected final String TEXT_311 = " ==null || dbschema_";
  protected final String TEXT_312 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_313 = ".equals";
  protected final String TEXT_314 = "IgnoreCase";
  protected final String TEXT_315 = "(schema_";
  ...
  protected final String TEXT_319 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_320 = " = ";
  protected final String TEXT_321 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_322 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_323 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_324 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_325 = " =  tableForSearch_";
  protected final String TEXT_326 = ".substring(1,tableForSearch_";
  protected final String TEXT_327 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_328 = " =  tableForSearch_";
  protected final String TEXT_329 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_330 = " = conn_";
  protected final String TEXT_331 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_332 = " = dbMetaData_";
  protected final String TEXT_333 = ".getTables(null, conn_";
  protected final String TEXT_334 = ".getSchema(), tableForSearch_";
  protected final String TEXT_335 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_336 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_337 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_338 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_339 = ".close();";
  protected final String TEXT_340 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_341 = " = conn_";
  protected final String TEXT_342 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_343 = " = dbMetaData_";
  protected final String TEXT_344 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_345 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_346 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_347 = " = rsTable_";
  protected final String TEXT_348 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_349 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_354 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_362 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_363 = ".";
  protected final String TEXT_364 = ", \"";
  protected final String TEXT_365 = "\")";
  protected final String TEXT_366 = ".toUpperCase()";
  protected final String TEXT_367 = ")+\")";
  protected final String TEXT_368 = "\"));";
  protected final String TEXT_369 = NL + "                                        stmtCreate_";
  protected final String TEXT_370 = ".execute(\"";
  protected final String TEXT_371 = ")\");";
  protected final String TEXT_372 = NL + "                                    stmtCreate_";
  protected final String TEXT_373 = ".close();" + NL + "                                }";
  protected final String TEXT_374 = NL + "                                if(whetherExist_";
  protected final String TEXT_375 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_381 = NL + "                                    stmtDrop_";
  protected final String TEXT_382 = ".execute(\"";
  protected final String TEXT_383 = "\" ";
  protected final String TEXT_384 = ");";
  protected final String TEXT_385 = NL + "                                    stmtDrop_";
  protected final String TEXT_386 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_394 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_395 = ".";
  protected final String TEXT_396 = ", \"";
  protected final String TEXT_397 = "\")";
  protected final String TEXT_398 = ".toUpperCase()";
  ...
  protected final String TEXT_406 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_407 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_408 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_409 = " = conn_";
  protected final String TEXT_410 = ".createStatement();";
  protected final String TEXT_411 = NL + "                              stmtClear_";
  protected final String TEXT_412 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_413 = "));";
  protected final String TEXT_414 = NL + "            stmtClear_";
  protected final String TEXT_415 = ".executeUpdate(\"";
  protected final String TEXT_416 = "\");";
  protected final String TEXT_417 = NL + "            stmtClear_";
  protected final String TEXT_418 = ".close();";
  protected final String TEXT_419 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_420 = " = conn_";
  protected final String TEXT_421 = ".createStatement();";
  protected final String TEXT_422 = NL + "                              stmtTruncCount_";
  protected final String TEXT_423 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_424 = "));";
  protected final String TEXT_425 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_438 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_439 = "));";
  protected final String TEXT_440 = NL + "                conn_";
  protected final String TEXT_441 = ".commit();";
  ...
  protected final String TEXT_448 = NL + "            deletedCount_";
  protected final String TEXT_449 = " += rsTruncCountNumber_";
  protected final String TEXT_450 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_451 = ".close();";
  protected final String TEXT_452 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_453 = " = conn_";
  protected final String TEXT_454 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_455 = " = stmtTruncCount_";
  protected final String TEXT_456 = ".executeQuery(\"";
  protected final String TEXT_457 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_458 = " = conn_";
  protected final String TEXT_459 = ".createStatement();";
  protected final String TEXT_460 = NL + "                conn_";
  protected final String TEXT_461 = ".commit();";
  ...
  protected final String TEXT_472 = NL + "\t\t\t\tjava.sql.Statement stmtCreateProjection_";
  protected final String TEXT_473 = " = conn_";
  protected final String TEXT_474 = ".createStatement();" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_475 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_476 = " + \"_proj (";
  protected final String TEXT_477 = ") AS SELECT ";
  protected final String TEXT_478 = " FROM \" + tableName_";
  protected final String TEXT_479 = ");" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_480 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_481 = NL + "\t\t\t\tif(!whetherExist_";
  ...
  protected final String TEXT_487 = ") VALUES (";
  ...
  protected final String TEXT_492 = NL + "        int batchCount_";
  ...
  protected final String TEXT_502 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_503 = " = conn_";
  protected final String TEXT_504 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_510 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_511 = " = conn_";
  protected final String TEXT_512 = ".prepareStatement(insert_";
  protected final String TEXT_513 = ");" + NL + "        String update_";
  protected final String TEXT_514 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_515 = " + \" SET ";
  protected final String TEXT_516 = " WHERE ";
  protected final String TEXT_517 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_525 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_526 = " = conn_";
  protected final String TEXT_527 = ".prepareStatement(update_";
  protected final String TEXT_528 = ");" + NL + "        String insert_";
  protected final String TEXT_529 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_530 = " + \" (";
  protected final String TEXT_531 = ") VALUES (";
  protected final String TEXT_532 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_533 = " = conn_";
  protected final String TEXT_534 = ".prepareStatement(insert_";
  protected final String TEXT_535 = ");";
  protected final String TEXT_536 = NL + "        String delete_";
  protected final String TEXT_537 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_541 = ".prepareStatement(delete_";
  protected final String TEXT_542 = ");";
  protected final String TEXT_543 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_544 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_545 = " = conn_";
  protected final String TEXT_546 = ".createStatement();" + NL + "        String template_";
  protected final String TEXT_547 = " = \"COPY \" + tableName_";
  protected final String TEXT_548 = " +\" (";
  protected final String TEXT_549 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_550 = "DIRECT";
  ...
  protected final String TEXT_555 = " = insert_";
  ...
  protected final String TEXT_559 = " = update_";
  ...
  protected final String TEXT_564 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_565 = " = insert_";
  protected final String TEXT_566 = ".split(\"\\\\?\");";
  protected final String TEXT_567 = NL + "\t\t\tdelete_";
  protected final String TEXT_568 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_569 = " = delete_";
  protected final String TEXT_570 = ".split(\"\\\\?\");";
  protected final String TEXT_571 = NL + "\t\t\treplace_";
  protected final String TEXT_572 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_573 = " = replace_";
  protected final String TEXT_574 = ".split(\"\\\\?\");";
  protected final String TEXT_575 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_576 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_577 = " = insertIgnore_";
  protected final String TEXT_578 = ".split(\"\\\\?\");";
  protected final String TEXT_579 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_580 = " = insert_";
  protected final String TEXT_581 = ".split(\"\\\\?\");";
  protected final String TEXT_582 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_583 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_584 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_585 = " =null;";
  protected final String TEXT_586 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_587 = " = null;" + NL + "\t\t";
  protected final String TEXT_588 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_589 = " = null;";
  protected final String TEXT_590 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_591 = " =  null;";
  protected final String TEXT_592 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_593 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_594 = " = null;";
  protected final String TEXT_595 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_596 = " = null;";
  protected final String TEXT_597 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_598 = " = null;";
  protected final String TEXT_599 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_600 = " = null;";
  protected final String TEXT_601 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_602 = " = null;";
  protected final String TEXT_603 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_604 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_605 = " = null;" + NL + "\t\tString template_";
