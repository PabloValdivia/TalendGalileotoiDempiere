...
public class TParAccelOutputMainJava {
  ...
  protected final String TEXT_341 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_342 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_343 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_344 = NL + "\t                    for(int countEach_";
  protected final String TEXT_345 = ": pstmt_";
  protected final String TEXT_346 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_347 = " += (countEach_";
  protected final String TEXT_348 = " < 0 ? 0 : countEach_";
  protected final String TEXT_349 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_350 = NL + "\t                    ";
  protected final String TEXT_351 = NL + "\t                        insertedCount_";
  protected final String TEXT_352 = " += countSum_";
  protected final String TEXT_353 = ";" + NL + "\t                    ";
  protected final String TEXT_354 = NL + "\t                        updatedCount_";
  protected final String TEXT_355 = " += countSum_";
  protected final String TEXT_356 = ";" + NL + "\t                    ";
  protected final String TEXT_357 = NL + "\t                        deletedCount_";
  protected final String TEXT_358 = " += countSum_";
  protected final String TEXT_359 = ";" + NL + "\t                    ";
  protected final String TEXT_360 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_361 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_362 = NL + "                        throw(e);";
  protected final String TEXT_363 = NL + "                        int countSum_";
  protected final String TEXT_364 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_365 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_366 = " += (countEach_";
  protected final String TEXT_367 = " < 0 ? 0 : countEach_";
  protected final String TEXT_368 = ");" + NL + "                        }";
  protected final String TEXT_369 = NL + "                            insertedCount_";
  protected final String TEXT_370 = " += countSum_";
  protected final String TEXT_371 = ";";
  protected final String TEXT_372 = NL + "                            updatedCount_";
  ...
  protected final String TEXT_378 = NL + "                        System.err.println(e.getMessage());";
  ...
  protected final String TEXT_384 = "=0;" + NL + "            }";
