...
public class TRedshiftInputBeginJava
{
  ...
  protected final String TEXT_175 = " > 0) {" + NL + "\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_176 = " = new java.io.FileWriter(";
  protected final String TEXT_177 = ", true);" + NL + "\t\t\t\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_178 = ",true));" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tStringBuilder sbuilder_";
  protected final String TEXT_179 = " = new StringBuilder();" + NL + "\t\t\tsbuilder_";
  protected final String TEXT_180 = ".append(\"jdbc:redshift://\").append(";
  protected final String TEXT_181 = ").append(\":\").append(";
  protected final String TEXT_182 = ").append(\"/\").append(";
  protected final String TEXT_183 = ").append(\"?loglevel=\").append(";
  protected final String TEXT_184 = ");" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "        \t\tsbuilder_";
  protected final String TEXT_186 = ".append(\"&\").append(";
  protected final String TEXT_187 = ");" + NL + "        \t";
  protected final String TEXT_188 = NL + "            String url_";
  protected final String TEXT_189 = " = sbuilder_";
  protected final String TEXT_190 = ".toString();";
  protected final String TEXT_191 = NL + "                stmt_";
  protected final String TEXT_192 = ".setFetchSize(";
