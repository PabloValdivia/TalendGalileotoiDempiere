...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_137 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_144 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_148 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_164 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_168 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_169 = "));";
  protected final String TEXT_170 = NL + "                    stmtCreate_";
  protected final String TEXT_171 = ".execute(((\"";
  protected final String TEXT_172 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_183 = ".close();";
  protected final String TEXT_184 = NL;
  protected final String TEXT_185 = NL + "                    String keyCheckTable_";
  protected final String TEXT_186 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_193 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_196 = " + \"]\";";
  protected final String TEXT_197 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_198 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_199 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_200 = ")== null){//}";
  protected final String TEXT_201 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_204 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_205 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_206 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_207 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_208 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  protected final String TEXT_209 = ".close();";
  protected final String TEXT_210 = NL + "                                ";
  protected final String TEXT_211 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_214 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_215 = " = tableNameForSearch_";
  protected final String TEXT_216 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_217 = " = tableNameForSearch_";
  protected final String TEXT_218 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_219 = " = dbMetaData_";
  protected final String TEXT_220 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_221 = ", tableNameForSearch_";
  protected final String TEXT_222 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_223 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_224 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_225 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_241 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_246 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  protected final String TEXT_247 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_257 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_258 = " = rsTable_";
  protected final String TEXT_259 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_260 = ".equals";
  protected final String TEXT_261 = "IgnoreCase";
  protected final String TEXT_262 = "((";
  protected final String TEXT_263 = ")";
  protected final String TEXT_264 = ".toUpperCase()";
  ...
  protected final String TEXT_270 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_271 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_280 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_281 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_282 = " == null || dbschema_";
  protected final String TEXT_283 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_284 = " = conn_";
  protected final String TEXT_285 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_286 = " = stmtSchema_";
  protected final String TEXT_287 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_288 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_289 = " = rsSchema_";
  protected final String TEXT_290 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_291 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_292 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_306 = " ==null || dbschema_";
  protected final String TEXT_307 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_308 = ".equals";
  protected final String TEXT_309 = "IgnoreCase";
  protected final String TEXT_310 = "(schema_";
  ...
  protected final String TEXT_314 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_315 = " = ";
  protected final String TEXT_316 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_317 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_318 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_319 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_320 = " =  tableForSearch_";
  protected final String TEXT_321 = ".substring(1,tableForSearch_";
  protected final String TEXT_322 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_323 = " =  tableForSearch_";
  protected final String TEXT_324 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_325 = " = conn_";
  protected final String TEXT_326 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_327 = " = dbMetaData_";
  protected final String TEXT_328 = ".getTables(null, conn_";
  protected final String TEXT_329 = ".getSchema(), tableForSearch_";
  protected final String TEXT_330 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_331 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_332 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_333 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_334 = ".close();";
  protected final String TEXT_335 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_336 = " = conn_";
  protected final String TEXT_337 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_338 = " = dbMetaData_";
  protected final String TEXT_339 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_340 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_341 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_342 = " = rsTable_";
  protected final String TEXT_343 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_344 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_348 = NL + "                                if(!whetherExist_";
  protected final String TEXT_349 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_350 = " = conn_";
  protected final String TEXT_351 = ".createStatement();";
  protected final String TEXT_352 = NL + "                                                      stmtCreate_";
  protected final String TEXT_353 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_370 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_376 = NL + "                                    stmtDrop_";
  protected final String TEXT_377 = ".execute(\"";
  protected final String TEXT_378 = "\" ";
  protected final String TEXT_379 = ");";
  protected final String TEXT_380 = NL + "                                    stmtDrop_";
  protected final String TEXT_381 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_382 = " = conn_";
  protected final String TEXT_383 = ".createStatement();";
  protected final String TEXT_384 = NL + "                                                  stmtCreate_";
  protected final String TEXT_385 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_386 = "));";
  protected final String TEXT_387 = NL + "                                        stmtCreate_";
  protected final String TEXT_388 = ".execute(((\"";
  protected final String TEXT_389 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_390 = ".";
  protected final String TEXT_391 = ", \"";
  protected final String TEXT_392 = "\")";
  protected final String TEXT_393 = ".toUpperCase()";
  ...
  protected final String TEXT_400 = ".close();";
  protected final String TEXT_401 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_402 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_403 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_404 = " = conn_";
  protected final String TEXT_405 = ".createStatement();";
  protected final String TEXT_406 = NL + "                              stmtClear_";
  protected final String TEXT_407 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_408 = "));";
  protected final String TEXT_409 = NL + "            stmtClear_";
  protected final String TEXT_410 = ".executeUpdate(\"";
  protected final String TEXT_411 = "\");";
  protected final String TEXT_412 = NL + "            stmtClear_";
  protected final String TEXT_413 = ".close();";
  protected final String TEXT_414 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_415 = " = conn_";
  protected final String TEXT_416 = ".createStatement();";
  protected final String TEXT_417 = NL + "                              stmtTruncCount_";
  protected final String TEXT_418 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_419 = "));";
  protected final String TEXT_420 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_421 = " = stmtTruncCount_";
  protected final String TEXT_422 = ".executeQuery(\"";
  protected final String TEXT_423 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_424 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_425 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_426 = " = rsTruncCount_";
  protected final String TEXT_427 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_428 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_429 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_430 = " = conn_";
  protected final String TEXT_431 = ".createStatement();";
  protected final String TEXT_432 = NL + "                              stmtTrunc_";
  protected final String TEXT_433 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_434 = "));";
  protected final String TEXT_435 = NL + "                conn_";
  protected final String TEXT_436 = ".commit();";
  protected final String TEXT_437 = NL + "            stmtTrunc_";
  protected final String TEXT_438 = ".executeUpdate(\"";
  protected final String TEXT_439 = "\");";
  protected final String TEXT_440 = NL + "                if(!conn_";
  protected final String TEXT_441 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_442 = ".commit();" + NL + "                }";
  protected final String TEXT_443 = NL + "            deletedCount_";
  protected final String TEXT_444 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_454 = ".createStatement();";
  protected final String TEXT_455 = NL + "                conn_";
  protected final String TEXT_456 = ".commit();";
  protected final String TEXT_457 = NL + "            stmtTrunc_";
  protected final String TEXT_458 = ".executeUpdate(\"";
  protected final String TEXT_459 = "\");";
  protected final String TEXT_460 = NL + "            while(rsTruncCount_";
  protected final String TEXT_461 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_462 = " += rsTruncCount_";
  protected final String TEXT_463 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_464 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_465 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_466 = ".close();";
  protected final String TEXT_467 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_468 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_469 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_470 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_471 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_472 = ".append (\"`\" +  ";
  protected final String TEXT_473 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_474 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_479 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_480 = " + \"` (";
  protected final String TEXT_481 = ") VALUES (";
  ...
  protected final String TEXT_495 = "    " + NL + "" + NL + "                java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_499 = NL + "\t            class BufferLine_";
  protected final String TEXT_500 = " {" + NL + "    \t            ";
  protected final String TEXT_501 = NL + "                            ";
  protected final String TEXT_502 = " ";
  protected final String TEXT_503 = ";";
  protected final String TEXT_504 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_505 = "(";
  protected final String TEXT_506 = NL + "                                ,";
  protected final String TEXT_507 = NL + "                            ";
  protected final String TEXT_508 = " ";
  protected final String TEXT_509 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_510 = NL + "                                this.";
  protected final String TEXT_511 = " = ";
  protected final String TEXT_512 = ";";
  protected final String TEXT_513 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_514 = "> exInsertColValueList";
  protected final String TEXT_515 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_516 = " exInsertColValue";
  protected final String TEXT_517 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_518 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_519 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_520 = ".append(\"(";
  protected final String TEXT_521 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_522 = "-1) extendInsertValueStmt_";
  protected final String TEXT_523 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_524 = " = \"INSERT INTO `\"+";
  protected final String TEXT_525 = "+\"` (";
  protected final String TEXT_526 = ") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_532 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_533 = " = new StringBuffer(insert_";
  protected final String TEXT_534 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_535 = ".insert(insert_";
  protected final String TEXT_536 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_537 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_538 = " =insertStringBuffer_";
  protected final String TEXT_539 = ".toString(); ";
  protected final String TEXT_540 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_541 = " =  conn_";
  protected final String TEXT_542 = ".prepareStatement(insert_";
  protected final String TEXT_543 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_544 = " = \"";
  protected final String TEXT_545 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_546 = " =  \"";
  protected final String TEXT_547 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_548 = " = 0;";
  protected final String TEXT_549 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_550 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_551 = " + \"` (";
  protected final String TEXT_552 = ") VALUES (";
  protected final String TEXT_553 = ")\";";
  protected final String TEXT_554 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_555 = " += \tduplidateClause_";
  protected final String TEXT_556 = ".toString();";
  protected final String TEXT_557 = NL + "\t\t        int batchSize_";
  protected final String TEXT_558 = " = ";
  protected final String TEXT_559 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_560 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_561 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_562 = " = new StringBuffer(insert_";
  protected final String TEXT_563 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_564 = ".insert(insert_";
  protected final String TEXT_565 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_566 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_567 = " =insertStringBuffer_";
  protected final String TEXT_568 = ".toString(); ";
  protected final String TEXT_569 = "    " + NL + "\t\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_570 = " = conn_";
  protected final String TEXT_571 = ".prepareStatement(insert_";
  protected final String TEXT_572 = ");" + NL;
  protected final String TEXT_573 = NL + "\t    String update_";
  protected final String TEXT_574 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_586 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_592 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_593 = " + \"` WHERE ";
  protected final String TEXT_594 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_595 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_596 = " + \"` (";
  protected final String TEXT_597 = ") VALUES (";
  protected final String TEXT_598 = ")\";" + NL + "\t    ";
  protected final String TEXT_599 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_600 = " = new StringBuffer(insert_";
  protected final String TEXT_601 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_602 = ".insert(insert_";
  protected final String TEXT_603 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_604 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_605 = " =insertStringBuffer_";
  protected final String TEXT_606 = ".toString(); ";
  protected final String TEXT_607 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_608 = " = conn_";
  protected final String TEXT_609 = ".prepareStatement(insert_";
  protected final String TEXT_610 = ");" + NL + "\t    String update_";
  protected final String TEXT_611 = " = \"UPDATE `\" + ";
  protected final String TEXT_612 = " + \"` SET ";
  protected final String TEXT_613 = " WHERE ";
  protected final String TEXT_614 = "\";" + NL + "\t    ";
  protected final String TEXT_615 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_616 = " = new StringBuffer(update_";
  protected final String TEXT_617 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_618 = ".insert(update_";
  protected final String TEXT_619 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_620 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_621 = " =updateStringBuffer_";
  protected final String TEXT_622 = ".toString(); ";
  protected final String TEXT_623 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_624 = " = conn_";
  protected final String TEXT_625 = ".prepareStatement(update_";
  protected final String TEXT_626 = ");" + NL + "\t    ";
  protected final String TEXT_627 = NL + "\t    String update_";
  protected final String TEXT_628 = " = \"UPDATE `\" + ";
  protected final String TEXT_629 = " + \"` SET ";
  protected final String TEXT_630 = " WHERE ";
  protected final String TEXT_631 = "\";" + NL + "\t    ";
  protected final String TEXT_632 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_633 = " = new StringBuffer(update_";
  protected final String TEXT_634 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_635 = ".insert(update_";
  protected final String TEXT_636 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_637 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_638 = " =updateStringBuffer_";
  protected final String TEXT_639 = ".toString(); ";
  protected final String TEXT_640 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_641 = " = conn_";
  protected final String TEXT_642 = ".prepareStatement(update_";
  protected final String TEXT_643 = ");" + NL + "\t    String insert_";
  protected final String TEXT_644 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_645 = " + \"` (";
  protected final String TEXT_646 = ") VALUES (";
  protected final String TEXT_647 = ")\";" + NL + "\t     ";
  protected final String TEXT_648 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_649 = " = new StringBuffer(insert_";
  protected final String TEXT_650 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_651 = ".insert(insert_";
  protected final String TEXT_652 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_653 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_654 = " =insertStringBuffer_";
  protected final String TEXT_655 = ".toString(); ";
  protected final String TEXT_656 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_657 = " = conn_";
  protected final String TEXT_658 = ".prepareStatement(insert_";
  protected final String TEXT_659 = ");" + NL + "\t    ";
  protected final String TEXT_660 = NL + "\t    String delete_";
  protected final String TEXT_661 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_662 = " + \"` WHERE ";
  protected final String TEXT_663 = "\";" + NL + "\t    ";
  protected final String TEXT_664 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_665 = " = new StringBuffer(delete_";
  protected final String TEXT_666 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_667 = ".insert(delete_";
  protected final String TEXT_668 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_669 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_670 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_674 = ".prepareStatement(delete_";
  protected final String TEXT_675 = ");" + NL + "\t    ";
  protected final String TEXT_676 = NL + "\t    String replace_";
  protected final String TEXT_677 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_678 = " + \"` (";
  protected final String TEXT_679 = ") VALUES (";
  protected final String TEXT_680 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_681 = " = conn_";
  protected final String TEXT_682 = ".prepareStatement(replace_";
  protected final String TEXT_683 = ");" + NL + "\t    ";
  protected final String TEXT_684 = NL + "\t    String insertIgnore_";
  protected final String TEXT_685 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_686 = " + \"` (";
  protected final String TEXT_687 = ") VALUES (";
  protected final String TEXT_688 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_689 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_690 = " = conn_";
  protected final String TEXT_691 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_692 = ");" + NL + "\t    ";
  protected final String TEXT_693 = NL + "\t    String insert_";
  protected final String TEXT_694 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_695 = " + \"` (";
  protected final String TEXT_696 = ") VALUES (";
  ...
  protected final String TEXT_706 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_710 = NL + "        StringBuffer query_";
  protected final String TEXT_711 = " = null;" + NL + "       \t";
  protected final String TEXT_712 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_713 = " = insert_";
  protected final String TEXT_714 = ".split(\"\\\\?\");";
  protected final String TEXT_715 = NL + "\t\t\tupdate_";
  protected final String TEXT_716 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_717 = " = update_";
  protected final String TEXT_718 = ".split(\"\\\\?\");";
  protected final String TEXT_719 = NL + "\t\t\tupdate_";
  protected final String TEXT_720 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_721 = " = update_";
  protected final String TEXT_722 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_723 = " = insert_";
  protected final String TEXT_724 = ".split(\"\\\\?\");";
  protected final String TEXT_725 = NL + "\t\t\tdelete_";
  protected final String TEXT_726 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_727 = " = delete_";
  protected final String TEXT_728 = ".split(\"\\\\?\");";
  protected final String TEXT_729 = NL + "\t\t\treplace_";
  protected final String TEXT_730 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_731 = " = replace_";
  protected final String TEXT_732 = ".split(\"\\\\?\");";
  protected final String TEXT_733 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_734 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_735 = " = insertIgnore_";
  protected final String TEXT_736 = ".split(\"\\\\?\");";
  protected final String TEXT_737 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_738 = " = insert_";
  protected final String TEXT_739 = ".split(\"\\\\?\");";
  protected final String TEXT_740 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_741 = " {" + NL + "    \t            ";
  protected final String TEXT_742 = NL + "                            ";
  protected final String TEXT_743 = " ";
  protected final String TEXT_744 = ";";
  protected final String TEXT_745 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_746 = ";" + NL + "\t\t\t";
  protected final String TEXT_747 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_748 = "(";
  protected final String TEXT_749 = NL + "                                ,";
  protected final String TEXT_750 = NL + "                            ";
  protected final String TEXT_751 = " ";
  protected final String TEXT_752 = NL + "\t\t\t\t, routines.system.Dynamic ";
  protected final String TEXT_753 = NL + "\t\t\t";
  protected final String TEXT_754 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_755 = NL + "                                this.";
  protected final String TEXT_756 = " = ";
  protected final String TEXT_757 = ";";
  protected final String TEXT_758 = NL + "\t\t\t\tthis.";
  protected final String TEXT_759 = "=";
  protected final String TEXT_760 = ";" + NL + "\t\t\t";
  protected final String TEXT_761 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_762 = "> exInsertColValueList";
  protected final String TEXT_763 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_764 = " exInsertColValue";
  protected final String TEXT_765 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_766 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_767 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_768 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_769 = "=1;";
  protected final String TEXT_770 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_771 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_772 = "=0;";
  protected final String TEXT_773 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_774 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_775 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_776 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_777 = "=0;" + NL + "\t";
  protected final String TEXT_778 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_779 = " = null;" + NL + "\t\t";
  protected final String TEXT_780 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_781 = " = null;";
  protected final String TEXT_782 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_783 = " =  null;";
  protected final String TEXT_784 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_785 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_786 = " = null;";
  protected final String TEXT_787 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_788 = " = null;";
  protected final String TEXT_789 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_790 = " = null;";
  protected final String TEXT_791 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_792 = " = null;";
  protected final String TEXT_793 = NL + "\t\t \tString[] insertSQLSplits_";
