...
public class TTeradataSCDELTEndJava {
  protected static String nl;
  public static synchronized TTeradataSCDELTEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataSCDELTEndJava result = new TTeradataSCDELTEndJava();
    nl = null;
    return result;
  }
