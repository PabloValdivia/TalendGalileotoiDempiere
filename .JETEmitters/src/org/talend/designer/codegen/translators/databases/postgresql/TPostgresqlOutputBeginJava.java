...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_151 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_152 = ")));";
  protected final String TEXT_153 = NL + "            stmtDrop_";
  protected final String TEXT_154 = ".execute(\"";
  protected final String TEXT_155 = "\" ";
  protected final String TEXT_156 = ");";
  protected final String TEXT_157 = NL + "            stmtDrop_";
  protected final String TEXT_158 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_162 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_178 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_179 = " = conn_";
  protected final String TEXT_180 = ".createStatement();";
  protected final String TEXT_181 = NL + "                              stmtCreate_";
  protected final String TEXT_182 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_199 = NL + "                    String keyCheckTable_";
  protected final String TEXT_200 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_207 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_210 = " + \"]\";";
  protected final String TEXT_211 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_212 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_213 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_214 = ")== null){//}";
  protected final String TEXT_215 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_216 = " = conn_";
  protected final String TEXT_217 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_218 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_219 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_220 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_221 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_222 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_227 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_228 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_229 = " = tableNameForSearch_";
  protected final String TEXT_230 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_231 = " = tableNameForSearch_";
  protected final String TEXT_232 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_233 = " = dbMetaData_";
  protected final String TEXT_234 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_235 = ", tableNameForSearch_";
  protected final String TEXT_236 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_237 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_238 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_239 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_240 = ".close();" + NL;
  protected final String TEXT_241 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_244 = " = dbMetaData_";
  protected final String TEXT_245 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_246 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_247 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_248 = " = rsTable_";
  protected final String TEXT_249 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_250 = " = rsTable_";
  protected final String TEXT_251 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_252 = ".equals";
  protected final String TEXT_253 = "IgnoreCase";
  protected final String TEXT_254 = "(";
  protected final String TEXT_255 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_259 = ") || dbschema_";
  protected final String TEXT_260 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_284 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_285 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_294 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_295 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_296 = " == null || dbschema_";
  protected final String TEXT_297 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_298 = " = conn_";
  protected final String TEXT_299 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_300 = " = stmtSchema_";
  protected final String TEXT_301 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_302 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_303 = " = rsSchema_";
  protected final String TEXT_304 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_305 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_306 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_307 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_308 = " = rsTable_";
  protected final String TEXT_309 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_310 = " = rsTable_";
  protected final String TEXT_311 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_312 = ".equals";
  protected final String TEXT_313 = "IgnoreCase";
  protected final String TEXT_314 = "(";
  protected final String TEXT_315 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_319 = ") || ((dbschema_";
  protected final String TEXT_320 = " ==null || dbschema_";
  protected final String TEXT_321 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_322 = ".equals";
  protected final String TEXT_323 = "IgnoreCase";
  protected final String TEXT_324 = "(schema_";
  protected final String TEXT_325 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_326 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_327 = ".close();";
  protected final String TEXT_328 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_329 = " = ";
  protected final String TEXT_330 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_331 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_332 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_333 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_334 = " =  tableForSearch_";
  protected final String TEXT_335 = ".substring(1,tableForSearch_";
  protected final String TEXT_336 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_337 = " =  tableForSearch_";
  protected final String TEXT_338 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_339 = " = conn_";
  protected final String TEXT_340 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_341 = " = dbMetaData_";
  protected final String TEXT_342 = ".getTables(null, conn_";
  protected final String TEXT_343 = ".getSchema(), tableForSearch_";
  protected final String TEXT_344 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_345 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_346 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_347 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_348 = ".close();";
  protected final String TEXT_349 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_350 = " = conn_";
  protected final String TEXT_351 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_352 = " = dbMetaData_";
  protected final String TEXT_353 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_354 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_355 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_356 = " = rsTable_";
  protected final String TEXT_357 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_358 = ".equalsIgnoreCase(";
  protected final String TEXT_359 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_360 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_361 = ".close();";
  protected final String TEXT_362 = NL + "                                if(!whetherExist_";
  protected final String TEXT_363 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_371 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_372 = ".";
  protected final String TEXT_373 = ", \"";
  protected final String TEXT_374 = "\")";
  protected final String TEXT_375 = ".toUpperCase()";
  ...
  protected final String TEXT_388 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_389 = "));";
  protected final String TEXT_390 = NL + "                                    stmtDrop_";
  protected final String TEXT_391 = ".execute(\"";
  protected final String TEXT_392 = "\" ";
  protected final String TEXT_393 = ");";
  protected final String TEXT_394 = NL + "                                    stmtDrop_";
  protected final String TEXT_395 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_399 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_400 = "));";
  protected final String TEXT_401 = NL + "                                        stmtCreate_";
  protected final String TEXT_402 = ".execute(((\"";
  protected final String TEXT_403 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = ", \"";
  protected final String TEXT_406 = "\")";
  protected final String TEXT_407 = ".toUpperCase()";
  protected final String TEXT_408 = ")+\")";
  protected final String TEXT_409 = "\"));";
  protected final String TEXT_410 = NL + "                                    stmtCreate_";
  protected final String TEXT_411 = ".execute(\"";
  protected final String TEXT_412 = ")\");";
  protected final String TEXT_413 = NL + "                                stmtCreate_";
  protected final String TEXT_414 = ".close();";
  protected final String TEXT_415 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_416 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_428 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_429 = " = conn_";
  protected final String TEXT_430 = ".createStatement();";
  protected final String TEXT_431 = NL + "                              stmtTruncCount_";
  protected final String TEXT_432 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_433 = "));";
  protected final String TEXT_434 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_435 = " = stmtTruncCount_";
  protected final String TEXT_436 = ".executeQuery(\"";
  protected final String TEXT_437 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_438 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_439 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_440 = " = rsTruncCount_";
  protected final String TEXT_441 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_442 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_443 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_444 = " = conn_";
  protected final String TEXT_445 = ".createStatement();";
  protected final String TEXT_446 = NL + "                              stmtTrunc_";
  protected final String TEXT_447 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_448 = "));";
  protected final String TEXT_449 = NL + "                conn_";
  protected final String TEXT_450 = ".commit();";
  protected final String TEXT_451 = NL + "            stmtTrunc_";
  protected final String TEXT_452 = ".executeUpdate(\"";
  protected final String TEXT_453 = "\");";
  protected final String TEXT_454 = NL + "                if(!conn_";
  protected final String TEXT_455 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_456 = ".commit();" + NL + "                }";
  protected final String TEXT_457 = NL + "            deletedCount_";
  protected final String TEXT_458 = " += rsTruncCountNumber_";
  protected final String TEXT_459 = ";" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_463 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_464 = " = stmtTruncCount_";
  protected final String TEXT_465 = ".executeQuery(\"";
  protected final String TEXT_466 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_467 = " = conn_";
  protected final String TEXT_468 = ".createStatement();";
  protected final String TEXT_469 = NL + "                conn_";
  protected final String TEXT_470 = ".commit();";
  protected final String TEXT_471 = NL + "            stmtTrunc_";
  protected final String TEXT_472 = ".executeUpdate(\"";
  protected final String TEXT_473 = "\");";
  protected final String TEXT_474 = NL + "            while(rsTruncCount_";
  protected final String TEXT_475 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_476 = " += rsTruncCount_";
  protected final String TEXT_477 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_478 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_479 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_484 = ") VALUES (";
  protected final String TEXT_485 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_486 = " = conn_";
  protected final String TEXT_487 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_505 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_506 = " = conn_";
  protected final String TEXT_507 = ".prepareStatement(insert_";
  protected final String TEXT_508 = ");" + NL + "\t    String update_";
  protected final String TEXT_509 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_510 = " + \"\\\" SET ";
  protected final String TEXT_511 = " WHERE ";
  protected final String TEXT_512 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_513 = " = conn_";
  protected final String TEXT_514 = ".prepareStatement(update_";
  ...
  protected final String TEXT_518 = " + \"\\\" SET ";
  protected final String TEXT_519 = " WHERE ";
  protected final String TEXT_520 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_526 = ") VALUES (";
  protected final String TEXT_527 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_528 = " = conn_";
  protected final String TEXT_529 = ".prepareStatement(insert_";
  protected final String TEXT_530 = ");" + NL + "\t    ";
  protected final String TEXT_531 = NL + "\t    String delete_";
  protected final String TEXT_532 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_533 = " + \"\\\" WHERE ";
  protected final String TEXT_534 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_535 = " = conn_";
  protected final String TEXT_536 = ".prepareStatement(delete_";
  protected final String TEXT_537 = ");" + NL + "\t    ";
  protected final String TEXT_538 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_562 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_568 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_569 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_570 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_571 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_572 = " = true;" + NL + "    \t";
  protected final String TEXT_573 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_574 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_575 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_576 = " =null;" + NL + "\t";
  protected final String TEXT_577 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_578 = " = null;" + NL + "\t\t";
  protected final String TEXT_579 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_583 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_584 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_585 = " = null;";
  protected final String TEXT_586 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_587 = " = null;";
  protected final String TEXT_588 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_589 = " = null;";
  protected final String TEXT_590 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
