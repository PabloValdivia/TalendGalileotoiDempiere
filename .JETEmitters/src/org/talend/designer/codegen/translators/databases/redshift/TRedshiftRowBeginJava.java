...
public class TRedshiftRowBeginJava
{
  protected static String nl;
  public static synchronized TRedshiftRowBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftRowBeginJava result = new TRedshiftRowBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_122 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_123 = " + \":\" + ";
  protected final String TEXT_124 = " + \"/\" + ";
  protected final String TEXT_125 = ";";
  protected final String TEXT_126 = NL + "\t\t\t\tString url_";
  protected final String TEXT_127 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_128 = " + \":\" + ";
  protected final String TEXT_129 = " + \"/\" + ";
  protected final String TEXT_130 = " + \"?\" + ";
  protected final String TEXT_131 = ";";
  protected final String TEXT_132 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_133 = " = null;" + NL + "\tString query_";
  protected final String TEXT_134 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_135 = " = false;";
  protected final String TEXT_136 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_137 = " = conn_";
  protected final String TEXT_138 = ".prepareStatement(";
  protected final String TEXT_139 = ");\t" + NL + "\t";
  protected final String TEXT_140 = NL + "\t\tjava.sql.Statement stmt_";
