...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_516 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_517 = " = insert_";
  protected final String TEXT_518 = ".split(\"\\\\?\");";
  protected final String TEXT_519 = NL + "\t\t\tupdate_";
  protected final String TEXT_520 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_521 = " = update_";
  protected final String TEXT_522 = ".split(\"\\\\?\");";
  protected final String TEXT_523 = NL + "\t\t\tupdate_";
  protected final String TEXT_524 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_525 = " = update_";
  protected final String TEXT_526 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_527 = " = insert_";
  protected final String TEXT_528 = ".split(\"\\\\?\");";
  protected final String TEXT_529 = NL + "\t\t\tdelete_";
  protected final String TEXT_530 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_531 = " = delete_";
  protected final String TEXT_532 = ".split(\"\\\\?\");";
  protected final String TEXT_533 = NL + "\t\t\treplace_";
  protected final String TEXT_534 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_535 = " = replace_";
  protected final String TEXT_536 = ".split(\"\\\\?\");";
  protected final String TEXT_537 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_538 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_539 = " = insertIgnore_";
  protected final String TEXT_540 = ".split(\"\\\\?\");";
  protected final String TEXT_541 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_542 = " = insert_";
  protected final String TEXT_543 = ".split(\"\\\\?\");";
  protected final String TEXT_544 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_545 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_546 = " = buffersSize_";
  protected final String TEXT_547 = ";";
  protected final String TEXT_548 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_549 = " = buffersSize_";
  protected final String TEXT_550 = ";";
  protected final String TEXT_551 = NL + "        whetherReject_";
  protected final String TEXT_552 = " = false;";
  protected final String TEXT_553 = NL + "                    ";
  protected final String TEXT_554 = NL + "                        query_";
  protected final String TEXT_555 = " = ";
  protected final String TEXT_556 = ";";
  protected final String TEXT_557 = NL + "                            geometryColumnName_";
  protected final String TEXT_558 = " = \"";
  protected final String TEXT_559 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_560 = ") {" + NL + "                                dimension_";
  protected final String TEXT_561 = " = 2;" + NL + "" + NL + "                                // A null first geometry will lead to unknown coordinate system" + NL + "                                if (";
  protected final String TEXT_562 = ".";
  protected final String TEXT_563 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_564 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_565 = " =" + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_566 = ".";
  protected final String TEXT_567 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_568 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_569 = " = refSys_";
  protected final String TEXT_570 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_571 = " = refSys_";
  protected final String TEXT_572 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_573 = " == null || ident_";
  protected final String TEXT_574 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_575 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_576 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_577 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_578 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_579 = " = Integer.parseInt(code_";
  protected final String TEXT_580 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            String SRIDError_";
  protected final String TEXT_581 = " = \"SRID_";
  protected final String TEXT_582 = " could not be determined\";";
  protected final String TEXT_583 = NL + "                                            System.out.println(SRIDError_";
  protected final String TEXT_584 = ");" + NL + "                                            SRID_";
  protected final String TEXT_585 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_586 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_587 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_588 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_589 = ",";
  protected final String TEXT_590 = ".";
  protected final String TEXT_591 = ", ";
  protected final String TEXT_592 = ",insertSQLSplits_";
  protected final String TEXT_593 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_594 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_609 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_610 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_611 = NL + "                \tsp_";
  protected final String TEXT_612 = " = conn_";
  protected final String TEXT_613 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_614 = NL + "                insertedCount_";
  protected final String TEXT_615 = " = insertedCount_";
  protected final String TEXT_616 = " + pstmt_";
  protected final String TEXT_617 = ".executeUpdate();";
  protected final String TEXT_618 = NL + "\t\t\t\t";
  protected final String TEXT_619 = NL + "\t                conn_";
  protected final String TEXT_620 = ".releaseSavepoint(sp_";
  protected final String TEXT_621 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_622 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_623 = NL + "\t                conn_";
  protected final String TEXT_624 = ".rollback(sp_";
  protected final String TEXT_625 = ");" + NL + "\t            ";
  protected final String TEXT_626 = NL + "                whetherReject_";
  protected final String TEXT_627 = " = true;";
  protected final String TEXT_628 = NL + "                    throw(e);";
  protected final String TEXT_629 = NL + "                        ";
  protected final String TEXT_630 = " = new ";
  protected final String TEXT_631 = "Struct();";
  protected final String TEXT_632 = NL + "                            ";
  protected final String TEXT_633 = ".";
  protected final String TEXT_634 = " = ";
  protected final String TEXT_635 = ".";
  protected final String TEXT_636 = ";";
  protected final String TEXT_637 = NL + "                        rejectedCount_";
  protected final String TEXT_638 = " = rejectedCount_";
  protected final String TEXT_639 = " + 1;";
  protected final String TEXT_640 = NL + "                        ";
  protected final String TEXT_641 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_642 = NL + "                        ";
  protected final String TEXT_643 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_644 = ";";
  protected final String TEXT_645 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_651 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_652 = ",";
  protected final String TEXT_653 = ".";
  protected final String TEXT_654 = ", ";
  protected final String TEXT_655 = ",updateSQLSplits_";
  protected final String TEXT_656 = ");";
  protected final String TEXT_657 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_690 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_695 = NL + "                updatedCount_";
  protected final String TEXT_696 = " = updatedCount_";
  protected final String TEXT_697 = " + pstmt_";
  protected final String TEXT_698 = ".executeUpdate();";
  protected final String TEXT_699 = NL + "\t\t\t\t";
  protected final String TEXT_700 = NL + "                \tconn_";
  protected final String TEXT_701 = ".releaseSavepoint(sp_";
  protected final String TEXT_702 = ");";
  protected final String TEXT_703 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_704 = NL + "\t                conn_";
  protected final String TEXT_705 = ".rollback(sp_";
  protected final String TEXT_706 = ");" + NL + "\t            ";
  protected final String TEXT_707 = NL + "                whetherReject_";
  ...
  protected final String TEXT_712 = "Struct();";
  protected final String TEXT_713 = NL + "                            ";
  protected final String TEXT_714 = ".";
  protected final String TEXT_715 = " = ";
  protected final String TEXT_716 = ".";
  protected final String TEXT_717 = ";";
  protected final String TEXT_718 = NL + "                        rejectedCount_";
  protected final String TEXT_719 = " = rejectedCount_";
  protected final String TEXT_720 = " + 1;";
  protected final String TEXT_721 = NL + "                        ";
  protected final String TEXT_722 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_723 = NL + "                        ";
  protected final String TEXT_724 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_725 = ";";
  protected final String TEXT_726 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_727 = NL + "            }";
  protected final String TEXT_728 = NL + "                    \t";
  protected final String TEXT_729 = NL + "                    ";
  protected final String TEXT_730 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_731 = " = pstmt_";
  protected final String TEXT_732 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_733 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_734 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_735 = " = rs_";
  protected final String TEXT_736 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_737 = " > 0) {";
  protected final String TEXT_738 = NL + "                        ";
  protected final String TEXT_739 = NL + "                            query_";
  protected final String TEXT_740 = " = ";
  protected final String TEXT_741 = ";";
  protected final String TEXT_742 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_743 = ",";
  protected final String TEXT_744 = ".";
  protected final String TEXT_745 = ", ";
  protected final String TEXT_746 = ",updateSQLSplits_";
  protected final String TEXT_747 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_748 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_749 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_772 = NL + "                    globalMap.put(\"";
  protected final String TEXT_773 = "_QUERY\", query_";
  protected final String TEXT_774 = ".toString().trim());";
  protected final String TEXT_775 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_776 = NL + "\t                    sp_";
  protected final String TEXT_777 = " = conn_";
  protected final String TEXT_778 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_779 = NL + "                    updatedCount_";
  protected final String TEXT_780 = " = updatedCount_";
  protected final String TEXT_781 = " + pstmtUpdate_";
  protected final String TEXT_782 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_783 = "++;";
  protected final String TEXT_784 = NL + "\t\t\t\t\t";
  protected final String TEXT_785 = NL + "    \t                conn_";
  protected final String TEXT_786 = ".releaseSavepoint(sp_";
  protected final String TEXT_787 = ");" + NL + "    \t            ";
  protected final String TEXT_788 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_789 = NL + "    \t                conn_";
  protected final String TEXT_790 = ".rollback(sp_";
  protected final String TEXT_791 = ");" + NL + "    \t            ";
  protected final String TEXT_792 = NL + "                    whetherReject_";
  ...
  protected final String TEXT_805 = NL + "                            rejectedCount_";
  protected final String TEXT_806 = " = rejectedCount_";
  protected final String TEXT_807 = " + 1;";
  protected final String TEXT_808 = NL + "                            ";
  protected final String TEXT_809 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_810 = NL + "                            ";
  protected final String TEXT_811 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_812 = ";";
  protected final String TEXT_813 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_814 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_823 = ",insertSQLSplits_";
  protected final String TEXT_824 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_825 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_826 = ".";
  protected final String TEXT_827 = ", pstmtInsert_";
  ...
  protected final String TEXT_834 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_835 = NL + "\t                    sp_";
  protected final String TEXT_836 = " = conn_";
  protected final String TEXT_837 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_838 = NL + "                    insertedCount_";
  ...
  protected final String TEXT_844 = NL + "    \t                conn_";
  protected final String TEXT_845 = ".releaseSavepoint(sp_";
  protected final String TEXT_846 = ");" + NL + "    \t            ";
  protected final String TEXT_847 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_848 = NL + "    \t                conn_";
  protected final String TEXT_849 = ".rollback(sp_";
  protected final String TEXT_850 = ");" + NL + "    \t            ";
  protected final String TEXT_851 = NL + "                    whetherReject_";
  protected final String TEXT_852 = " = true;";
  protected final String TEXT_853 = NL + "                        throw(e);";
  protected final String TEXT_854 = NL + "                        nb_line_";
  ...
  protected final String TEXT_864 = NL + "                            rejectedCount_";
  protected final String TEXT_865 = " = rejectedCount_";
  protected final String TEXT_866 = " + 1;";
  protected final String TEXT_867 = NL + "                            ";
  protected final String TEXT_868 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_872 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_873 = NL + "                }" + NL + "            }";
  protected final String TEXT_874 = NL + "            int updateFlag_";
  protected final String TEXT_875 = "=0;";
  protected final String TEXT_876 = NL + "                    ";
  protected final String TEXT_877 = NL + "                        query_";
  protected final String TEXT_878 = " = ";
  protected final String TEXT_879 = ";";
  protected final String TEXT_880 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_881 = ",";
  protected final String TEXT_882 = ".";
  protected final String TEXT_883 = ", ";
  protected final String TEXT_884 = ",updateSQLSplits_";
  ...
  protected final String TEXT_905 = NL + "\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_911 = NL + "                globalMap.put(\"";
  protected final String TEXT_912 = "_QUERY\", query_";
  protected final String TEXT_913 = ".toString().trim());";
  protected final String TEXT_914 = NL + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_915 = NL + "\t                sp_";
  protected final String TEXT_916 = " = conn_";
  protected final String TEXT_917 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_918 = NL + "                updateFlag_";
  protected final String TEXT_919 = "=pstmtUpdate_";
  protected final String TEXT_920 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_921 = " = updatedCount_";
  protected final String TEXT_922 = "+updateFlag_";
  protected final String TEXT_923 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_924 = NL + "\t                conn_";
  protected final String TEXT_925 = ".releaseSavepoint(sp_";
  protected final String TEXT_926 = ");" + NL + "\t            ";
  protected final String TEXT_927 = NL + "            if(updateFlag_";
  protected final String TEXT_928 = " == 0) {" + NL + "            \t";
  protected final String TEXT_929 = NL + "\t\t\t\tquery_";
  protected final String TEXT_930 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_943 = ", pstmtInsert_";
  ...
  protected final String TEXT_951 = NL + "\t                    sp_";
  protected final String TEXT_952 = " = conn_";
  protected final String TEXT_953 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_954 = NL + "                    insertedCount_";
  protected final String TEXT_955 = " = insertedCount_";
  protected final String TEXT_956 = " + pstmtInsert_";
  protected final String TEXT_957 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_958 = "++;";
  protected final String TEXT_959 = NL + "\t\t\t\t\t";
  protected final String TEXT_960 = NL + "    \t                conn_";
  protected final String TEXT_961 = ".releaseSavepoint(sp_";
  protected final String TEXT_962 = ");" + NL + "    \t            ";
  protected final String TEXT_963 = NL + "    \t            }else{" + NL + "    \t\t\t\t\tnb_line_";
  protected final String TEXT_964 = "++;" + NL + "     \t\t\t\t\t";
  protected final String TEXT_965 = NL + "    \t\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_966 = NL + "    \t                conn_";
  protected final String TEXT_967 = ".rollback(sp_";
  protected final String TEXT_968 = ");" + NL + "    \t            ";
  protected final String TEXT_969 = NL + "                    whetherReject_";
  protected final String TEXT_970 = " = true;";
  protected final String TEXT_971 = NL + "                        throw(e);";
  protected final String TEXT_972 = NL + "                        nb_line_";
  ...
  protected final String TEXT_1004 = NL + "    \t\tpstmt_";
  protected final String TEXT_1005 = ".addBatch();" + NL + "\t\t\tnb_line_";
  protected final String TEXT_1006 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_1007 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_1008 = "++;" + NL + "    \t\t";
  protected final String TEXT_1009 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_1010 = NL + "\t                sp_";
  protected final String TEXT_1011 = " = conn_";
  protected final String TEXT_1012 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_1013 = NL + "                deletedCount_";
  protected final String TEXT_1014 = " = deletedCount_";
  protected final String TEXT_1015 = " + pstmt_";
  protected final String TEXT_1016 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1017 = "++;";
  protected final String TEXT_1018 = NL + "\t\t\t\t";
  protected final String TEXT_1019 = NL + "\t                conn_";
  protected final String TEXT_1020 = ".releaseSavepoint(sp_";
  protected final String TEXT_1021 = ");" + NL + "\t            ";
  protected final String TEXT_1022 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_1023 = NL + "\t                conn_";
  protected final String TEXT_1024 = ".rollback(sp_";
  protected final String TEXT_1025 = ");" + NL + "\t            ";
  protected final String TEXT_1026 = NL + "                whetherReject_";
  protected final String TEXT_1027 = " = true;";
  protected final String TEXT_1028 = NL + "                    throw(e);";
  ...
  protected final String TEXT_1043 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1044 = NL + "                        ";
  protected final String TEXT_1045 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1046 = ";";
  protected final String TEXT_1047 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1048 = NL + "            }";
  protected final String TEXT_1049 = NL + "            if(!whetherReject_";
  protected final String TEXT_1050 = ") {";
  protected final String TEXT_1051 = NL + "                            ";
  protected final String TEXT_1052 = " = new ";
  protected final String TEXT_1053 = "Struct();";
  ...
  protected final String TEXT_1060 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1061 = " > 0) && (batchSize_";
  protected final String TEXT_1062 = " <= batchSizeCounter_";
  protected final String TEXT_1063 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1064 = " = 0;" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_1065 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1066 = ": pstmt_";
  protected final String TEXT_1067 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1068 = " += (countEach_";
  protected final String TEXT_1069 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1070 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_1071 = NL + "\t\t\t\t    \t";
  protected final String TEXT_1072 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1073 = " += countSum_";
  protected final String TEXT_1074 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1075 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1076 = " += countSum_";
  protected final String TEXT_1077 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1078 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_1079 = " += countSum_";
  protected final String TEXT_1080 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1081 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1082 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1083 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1084 = NL + "                \tint countSum_";
  protected final String TEXT_1085 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1086 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1087 = " += (countEach_";
  protected final String TEXT_1088 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1089 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1090 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1091 = " += countSum_";
  protected final String TEXT_1092 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1093 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1094 = " += countSum_";
  protected final String TEXT_1095 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1096 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1097 = " += countSum_";
  protected final String TEXT_1098 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1099 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1100 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1101 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1102 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1103 = " <= commitCounter_";
  protected final String TEXT_1104 = ") {";
  protected final String TEXT_1105 = NL + "                if ((batchSize_";
  protected final String TEXT_1106 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1107 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1108 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_1109 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1110 = ": pstmt_";
  protected final String TEXT_1111 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1112 = " += (countEach_";
  protected final String TEXT_1113 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1114 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_1115 = NL + "            \t    \t";
  protected final String TEXT_1116 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1117 = " += countSum_";
  protected final String TEXT_1118 = ";" + NL + "            \t    \t";
  protected final String TEXT_1119 = NL + "            \t    \t\tupdatedCount_";
  ...
  protected final String TEXT_1125 = NL + "                batchSizeCounter_";
  protected final String TEXT_1126 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1127 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1128 = NL + "                \t\tint countSum_";
  protected final String TEXT_1129 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1130 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1131 = " += (countEach_";
  protected final String TEXT_1132 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1133 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1134 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1135 = " += countSum_";
  protected final String TEXT_1136 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1137 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1138 = " += countSum_";
  protected final String TEXT_1139 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1140 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_1141 = " += countSum_";
  protected final String TEXT_1142 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1143 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1144 = NL + "                }" + NL + "            }";
  protected final String TEXT_1145 = NL + "                \tconn_";
  protected final String TEXT_1146 = ".commit();" + NL + "                \t";
  protected final String TEXT_1147 = NL + "                \tcommitCounter_";
  protected final String TEXT_1148 = "=0;" + NL + "                }";
