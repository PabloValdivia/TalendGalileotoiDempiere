...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_176 = ".createStatement();";
  protected final String TEXT_177 = NL + "                              stmtDrop_";
  protected final String TEXT_178 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_179 = ")));";
  protected final String TEXT_180 = NL + "            stmtDrop_";
  protected final String TEXT_181 = ".execute(\"";
  protected final String TEXT_182 = "\" ";
  protected final String TEXT_183 = ");";
  protected final String TEXT_184 = NL + "            stmtDrop_";
  protected final String TEXT_185 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_209 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_226 = NL + "                    String keyCheckTable_";
  protected final String TEXT_227 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_234 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_237 = " + \"]\";";
  protected final String TEXT_238 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_239 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_240 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_241 = ")== null){//}";
  protected final String TEXT_242 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_245 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_246 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_247 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_248 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_249 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_259 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_260 = " = dbMetaData_";
  protected final String TEXT_261 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_262 = ", tableNameForSearch_";
  protected final String TEXT_263 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_264 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_265 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_266 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_287 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_292 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_293 = " = dbMetaData_";
  protected final String TEXT_294 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_295 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_305 = ".toUpperCase()";
  protected final String TEXT_306 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_310 = ") || (dbschema_";
  protected final String TEXT_311 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_312 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_321 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_322 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_323 = " == null || dbschema_";
  protected final String TEXT_324 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_325 = " = conn_";
  protected final String TEXT_326 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_327 = " = stmtSchema_";
  protected final String TEXT_328 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_329 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_330 = " = rsSchema_";
  protected final String TEXT_331 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_332 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_333 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_347 = " ==null || dbschema_";
  protected final String TEXT_348 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_349 = ".equals";
  protected final String TEXT_350 = "IgnoreCase";
  protected final String TEXT_351 = "(schema_";
  protected final String TEXT_352 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_353 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_354 = ".close();";
  protected final String TEXT_355 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_356 = " = ";
  protected final String TEXT_357 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_358 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_359 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_360 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_361 = " =  tableForSearch_";
  protected final String TEXT_362 = ".substring(1,tableForSearch_";
  protected final String TEXT_363 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_364 = " =  tableForSearch_";
  protected final String TEXT_365 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_366 = " = conn_";
  protected final String TEXT_367 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_368 = " = dbMetaData_";
  protected final String TEXT_369 = ".getTables(null, conn_";
  protected final String TEXT_370 = ".getSchema(), tableForSearch_";
  protected final String TEXT_371 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_372 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_373 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_374 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_381 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_382 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_383 = " = rsTable_";
  protected final String TEXT_384 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_385 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_394 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_410 = NL + "                                if(whetherExist_";
  protected final String TEXT_411 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_412 = " = conn_";
  protected final String TEXT_413 = ".createStatement();";
  protected final String TEXT_414 = NL + "                                                      stmtDrop_";
  protected final String TEXT_415 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_416 = "));";
  protected final String TEXT_417 = NL + "                                    stmtDrop_";
  protected final String TEXT_418 = ".execute(\"";
  protected final String TEXT_419 = "\" ";
  protected final String TEXT_420 = ");";
  protected final String TEXT_421 = NL + "                                    stmtDrop_";
  protected final String TEXT_422 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_428 = NL + "                                        stmtCreate_";
  protected final String TEXT_429 = ".execute(((\"";
  protected final String TEXT_430 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_440 = NL + "                                stmtCreate_";
  protected final String TEXT_441 = ".close();";
  protected final String TEXT_442 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_443 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_444 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".createStatement();";
  protected final String TEXT_447 = NL + "                              stmtClear_";
  protected final String TEXT_448 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_449 = "));";
  protected final String TEXT_450 = NL + "            stmtClear_";
  protected final String TEXT_451 = ".executeUpdate(\"";
  protected final String TEXT_452 = "\");";
  protected final String TEXT_453 = NL + "            stmtClear_";
  protected final String TEXT_454 = ".close();";
  protected final String TEXT_455 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_456 = " = conn_";
  protected final String TEXT_457 = ".createStatement();";
  protected final String TEXT_458 = NL + "                              stmtTruncCount_";
  protected final String TEXT_459 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_460 = "));";
  protected final String TEXT_461 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_462 = " = stmtTruncCount_";
  protected final String TEXT_463 = ".executeQuery(\"";
  protected final String TEXT_464 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_465 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_466 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_470 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_471 = " = conn_";
  protected final String TEXT_472 = ".createStatement();";
  protected final String TEXT_473 = NL + "                              stmtTrunc_";
  protected final String TEXT_474 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_481 = NL + "                if(!conn_";
  protected final String TEXT_482 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_483 = ".commit();" + NL + "                }";
  protected final String TEXT_484 = NL + "            deletedCount_";
  protected final String TEXT_485 = " += rsTruncCountNumber_";
  protected final String TEXT_486 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_487 = ".close();";
  protected final String TEXT_488 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_489 = " = conn_";
  protected final String TEXT_490 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_491 = " = stmtTruncCount_";
  protected final String TEXT_492 = ".executeQuery(\"";
  protected final String TEXT_493 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_494 = " = conn_";
  protected final String TEXT_495 = ".createStatement();";
  protected final String TEXT_496 = NL + "                conn_";
  protected final String TEXT_497 = ".commit();";
  protected final String TEXT_498 = NL + "            stmtTrunc_";
  protected final String TEXT_499 = ".executeUpdate(\"";
  protected final String TEXT_500 = "\");";
  protected final String TEXT_501 = NL + "            while(rsTruncCount_";
  protected final String TEXT_502 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_503 = " += rsTruncCount_";
  protected final String TEXT_504 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_505 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_506 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_511 = ") VALUES (";
  ...
  protected final String TEXT_521 = "    " + NL + "" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_526 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_544 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_545 = " + \" WHERE ";
  protected final String TEXT_546 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_547 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_563 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_596 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_613 = " = \"DELETE FROM \" + tableName_";
  ...
  protected final String TEXT_628 = NL + "        StringBuffer query_";
  protected final String TEXT_629 = " = null;" + NL + "\t   ";
  protected final String TEXT_630 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_631 = " = insert_";
  protected final String TEXT_632 = ".split(\"\\\\?\");";
  protected final String TEXT_633 = NL + "\t\t\tupdate_";
  protected final String TEXT_634 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_635 = " = update_";
  protected final String TEXT_636 = ".split(\"\\\\?\");";
  protected final String TEXT_637 = NL + "\t\t\tupdate_";
  protected final String TEXT_638 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_639 = " = update_";
  protected final String TEXT_640 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_641 = " = insert_";
  protected final String TEXT_642 = ".split(\"\\\\?\");";
  protected final String TEXT_643 = NL + "\t\t\tdelete_";
  protected final String TEXT_644 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_645 = " = delete_";
  protected final String TEXT_646 = ".split(\"\\\\?\");";
  protected final String TEXT_647 = NL + "\t\t\treplace_";
  protected final String TEXT_648 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_649 = " = replace_";
  protected final String TEXT_650 = ".split(\"\\\\?\");";
  protected final String TEXT_651 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_652 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_653 = " = insertIgnore_";
  protected final String TEXT_654 = ".split(\"\\\\?\");";
  protected final String TEXT_655 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_656 = " = insert_";
  protected final String TEXT_657 = ".split(\"\\\\?\");";
  protected final String TEXT_658 = NL + "\t   ";
  protected final String TEXT_659 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_660 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_661 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_662 = " = true;" + NL + "    \t";
  protected final String TEXT_663 = NL + NL + "\tclass ClobTypeUtil_";
  protected final String TEXT_664 = " {" + NL + "\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t        }" + NL + "\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\ttempClob.close();" + NL + "\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "\t  \t\t\t";
  protected final String TEXT_665 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t  \t\t\t";
  protected final String TEXT_666 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\texp.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t\treturn tempClob;" + NL + "\t\t}" + NL + "\t}" + NL + "\tClobTypeUtil_";
  protected final String TEXT_667 = " clobTypeUtil_";
  protected final String TEXT_668 = "=new ClobTypeUtil_";
  protected final String TEXT_669 = "();";
  protected final String TEXT_670 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_671 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_672 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_673 = " =null;" + NL + "\t";
  protected final String TEXT_674 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_675 = " = null;" + NL + "\t\t";
  protected final String TEXT_676 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_677 = " = null;";
  protected final String TEXT_678 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_679 = " =  null;";
  protected final String TEXT_680 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_681 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_682 = " = null;";
  protected final String TEXT_683 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_684 = " = null;";
  protected final String TEXT_685 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_686 = " = null;";
  protected final String TEXT_687 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
