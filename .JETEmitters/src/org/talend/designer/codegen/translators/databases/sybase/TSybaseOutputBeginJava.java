...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_129 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_130 = ")));";
  protected final String TEXT_131 = NL + "            stmtDrop_";
  protected final String TEXT_132 = ".execute(\"";
  protected final String TEXT_133 = "\" ";
  protected final String TEXT_134 = ");";
  protected final String TEXT_135 = NL + "            stmtDrop_";
  protected final String TEXT_136 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_164 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_165 = ".";
  protected final String TEXT_166 = ", \"";
  protected final String TEXT_167 = "\")";
  protected final String TEXT_168 = ".toUpperCase()";
  ...
  protected final String TEXT_193 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_196 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_197 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_198 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_199 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_200 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_238 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_257 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_258 = ".equals";
  protected final String TEXT_259 = "IgnoreCase";
  protected final String TEXT_260 = "(dbschema_";
  protected final String TEXT_261 = ") || (dbschema_";
  protected final String TEXT_262 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_263 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_272 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_273 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_274 = " == null || dbschema_";
  protected final String TEXT_275 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_276 = " = conn_";
  protected final String TEXT_277 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_278 = " = stmtSchema_";
  protected final String TEXT_279 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_280 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_281 = " = rsSchema_";
  protected final String TEXT_282 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_283 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_284 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_285 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_286 = " = rsTable_";
  protected final String TEXT_287 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_288 = " = rsTable_";
  protected final String TEXT_289 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_290 = ".equals";
  protected final String TEXT_291 = "IgnoreCase";
  protected final String TEXT_292 = "(";
  protected final String TEXT_293 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_294 = ".equals";
  protected final String TEXT_295 = "IgnoreCase";
  protected final String TEXT_296 = "(dbschema_";
  protected final String TEXT_297 = ") || ((dbschema_";
  protected final String TEXT_298 = " ==null || dbschema_";
  protected final String TEXT_299 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_300 = ".equals";
  protected final String TEXT_301 = "IgnoreCase";
  protected final String TEXT_302 = "(schema_";
  ...
  protected final String TEXT_306 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_307 = " = ";
  protected final String TEXT_308 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_309 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_310 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_311 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_312 = " =  tableForSearch_";
  protected final String TEXT_313 = ".substring(1,tableForSearch_";
  protected final String TEXT_314 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_315 = " =  tableForSearch_";
  protected final String TEXT_316 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_320 = ".getTables(null, conn_";
  protected final String TEXT_321 = ".getSchema(), tableForSearch_";
  protected final String TEXT_322 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_323 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_324 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_325 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_336 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_340 = NL + "                                if(!whetherExist_";
  protected final String TEXT_341 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_349 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_350 = ".";
  protected final String TEXT_351 = ", \"";
  protected final String TEXT_352 = "\")";
  protected final String TEXT_353 = ".toUpperCase()";
  ...
  protected final String TEXT_365 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_372 = NL + "                                    stmtDrop_";
  protected final String TEXT_373 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_374 = " = conn_";
  protected final String TEXT_375 = ".createStatement();";
  protected final String TEXT_376 = NL + "                                                  stmtCreate_";
  protected final String TEXT_377 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_378 = "));";
  protected final String TEXT_379 = NL + "                                        stmtCreate_";
  protected final String TEXT_380 = ".execute(((\"";
  protected final String TEXT_381 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_382 = ".";
  protected final String TEXT_383 = ", \"";
  protected final String TEXT_384 = "\")";
  protected final String TEXT_385 = ".toUpperCase()";
  ...
  protected final String TEXT_393 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_394 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_395 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_401 = NL + "            stmtClear_";
  ...
  protected final String TEXT_409 = NL + "                              stmtTruncCount_";
  protected final String TEXT_410 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_411 = "));";
  protected final String TEXT_412 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_425 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_426 = "));";
  protected final String TEXT_427 = NL + "                conn_";
  protected final String TEXT_428 = ".commit();";
  protected final String TEXT_429 = NL + "            stmtTrunc_";
  protected final String TEXT_430 = ".executeUpdate(\"";
  protected final String TEXT_431 = "\");";
  protected final String TEXT_432 = NL + "                if(!conn_";
  protected final String TEXT_433 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_434 = ".commit();" + NL + "                }";
  protected final String TEXT_435 = NL + "            deletedCount_";
  protected final String TEXT_436 = " += rsTruncCountNumber_";
  protected final String TEXT_437 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_438 = ".close();";
  protected final String TEXT_439 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_440 = " = conn_";
  protected final String TEXT_441 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_442 = " = stmtTruncCount_";
  protected final String TEXT_443 = ".executeQuery(\"";
  protected final String TEXT_444 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_448 = ".commit();";
  ...
  protected final String TEXT_467 = NL + "\t    String update_";
  protected final String TEXT_468 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_469 = " + \" SET ";
  protected final String TEXT_470 = " WHERE ";
  ...
  protected final String TEXT_483 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_490 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_509 = NL + "\t    String delete_";
  protected final String TEXT_510 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_511 = " + \" WHERE ";
  protected final String TEXT_512 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_516 = NL + "        StringBuffer query_";
  protected final String TEXT_517 = " = null;" + NL + "       \t";
  protected final String TEXT_518 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_519 = " = insert_";
  protected final String TEXT_520 = ".split(\"\\\\?\");";
  protected final String TEXT_521 = NL + "\t\t\tupdate_";
  protected final String TEXT_522 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_523 = " = update_";
  protected final String TEXT_524 = ".split(\"\\\\?\");";
  protected final String TEXT_525 = NL + "\t\t\tupdate_";
  protected final String TEXT_526 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_527 = " = update_";
  protected final String TEXT_528 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_529 = " = insert_";
  protected final String TEXT_530 = ".split(\"\\\\?\");";
  protected final String TEXT_531 = NL + "\t\t\tdelete_";
  protected final String TEXT_532 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_533 = " = delete_";
  protected final String TEXT_534 = ".split(\"\\\\?\");";
  protected final String TEXT_535 = NL + "\t\t\treplace_";
  protected final String TEXT_536 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_537 = " = replace_";
  protected final String TEXT_538 = ".split(\"\\\\?\");";
  protected final String TEXT_539 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_540 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_541 = " = insertIgnore_";
  protected final String TEXT_542 = ".split(\"\\\\?\");";
  protected final String TEXT_543 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_544 = " = insert_";
  protected final String TEXT_545 = ".split(\"\\\\?\");";
  protected final String TEXT_546 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_547 = " = conn_";
  protected final String TEXT_548 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_549 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_550 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_551 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_552 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_553 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_554 = " =null;" + NL + "\t";
  protected final String TEXT_555 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_559 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_560 = " =  null;";
  protected final String TEXT_561 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_562 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_563 = " = null;";
  protected final String TEXT_564 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_565 = " = null;";
  protected final String TEXT_566 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_567 = " = null;";
  protected final String TEXT_568 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_569 = " = null;";
  protected final String TEXT_570 = NL + "\t\t \tString[] insertSQLSplits_";
