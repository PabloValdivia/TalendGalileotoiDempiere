...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_317 = NL + "            \tString tableForSearch_";
  protected final String TEXT_318 = " = ";
  protected final String TEXT_319 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_320 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_321 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_322 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_323 = " =  tableForSearch_";
  protected final String TEXT_324 = ".substring(1,tableForSearch_";
  protected final String TEXT_325 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_326 = " =  tableForSearch_";
  protected final String TEXT_327 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_331 = ".getTables(null, conn_";
  protected final String TEXT_332 = ".getSchema(), tableForSearch_";
  protected final String TEXT_333 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_334 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_335 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_336 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_337 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_338 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_342 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_343 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_344 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_345 = " = rsTable_";
  protected final String TEXT_346 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_356 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_357 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_358 = " - Creating table ";
  protected final String TEXT_359 = "\" + tableName_";
  ...
  protected final String TEXT_366 = " - Create table ";
  ...
  protected final String TEXT_371 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_372 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_373 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_374 = " = conn_";
  protected final String TEXT_375 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_376 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_377 = " - Droping table ";
  protected final String TEXT_378 = "\" + tableName_";
  ...
  protected final String TEXT_385 = " - Drop table ";
  protected final String TEXT_386 = "\" + tableName_";
  protected final String TEXT_387 = " + \"";
  protected final String TEXT_388 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_389 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_390 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_410 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_412 = " - Clearing table ";
  protected final String TEXT_413 = "\" + tableName_";
  protected final String TEXT_414 = " + \"";
  protected final String TEXT_415 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_416 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_417 = ".executeUpdate(\"";
  protected final String TEXT_418 = "\");" + NL + "\t\t\t";
  protected final String TEXT_419 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_420 = "- Clear table ";
  protected final String TEXT_421 = "\" + tableName_";
  protected final String TEXT_422 = " + \"";
  protected final String TEXT_423 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_424 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_434 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_435 = " - Trancating table ";
  ...
  protected final String TEXT_443 = " - Truncate table ";
  ...
  protected final String TEXT_454 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_455 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_456 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_457 = NL + "\t";
  protected final String TEXT_458 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_459 = " = conn_";
  protected final String TEXT_460 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_461 = NL + "\t";
  protected final String TEXT_462 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_463 = " - Paralle bulk SQL:\"+xpxSQL_";
  protected final String TEXT_464 = "+\".\");" + NL + "\t\tlog.debug(\"";
  protected final String TEXT_465 = " - Executing parallel bulk SQL.\");" + NL + "\t";
  protected final String TEXT_466 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_467 = " = conn_";
  protected final String TEXT_468 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_469 = ".execute(xpxSQL_";
  protected final String TEXT_470 = ");";
  protected final String TEXT_471 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_472 = " - Execute parallel bulk SQL has finished.\");" + NL + "\t";
  protected final String TEXT_473 = NL + "    stmtXPX_";
  protected final String TEXT_474 = ".close();    ";
  protected final String TEXT_475 = NL + "\t";
  protected final String TEXT_476 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_477 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_478 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_479 = " - Bulk inserting data into ";
  protected final String TEXT_480 = "\" + tableName_";
  protected final String TEXT_481 = " + \"";
  protected final String TEXT_482 = ".\" );" + NL + "\t";
  protected final String TEXT_483 = NL + "    stmtBulk_";
  protected final String TEXT_484 = ".execute(bulkSQL_";
  ...
  protected final String TEXT_490 = " has finished.\");" + NL + "\t";
  protected final String TEXT_491 = NL + "    stmtBulk_";
