...
public class TEXAOutputMainJava {
  ...
  protected final String TEXT_572 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_573 = "++;";
  protected final String TEXT_574 = NL + "              batchSizeCounter_";
  protected final String TEXT_575 = "++;";
  protected final String TEXT_576 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_577 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_578 = " = insertedCount_";
  protected final String TEXT_579 = " + pstmt_";
  protected final String TEXT_580 = ".executeUpdate();";
  protected final String TEXT_581 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_582 = " = true;";
  protected final String TEXT_583 = NL + "                    throw(e);";
  protected final String TEXT_584 = NL + "                        ";
  protected final String TEXT_585 = " = new ";
  protected final String TEXT_586 = "Struct();";
  protected final String TEXT_587 = NL + "                            ";
  protected final String TEXT_588 = ".";
  protected final String TEXT_589 = " = ";
  protected final String TEXT_590 = ".";
  protected final String TEXT_591 = ";";
  protected final String TEXT_592 = NL + "                        rejectedCount_";
  protected final String TEXT_593 = " = rejectedCount_";
  protected final String TEXT_594 = " + 1;";
  protected final String TEXT_595 = NL + "                        ";
  protected final String TEXT_596 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_597 = NL + "                        ";
  protected final String TEXT_598 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_599 = ";";
  protected final String TEXT_600 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_601 = NL + "            }";
  protected final String TEXT_602 = NL + "                    ";
  protected final String TEXT_603 = NL + "                        query_";
  protected final String TEXT_604 = " = ";
  protected final String TEXT_605 = ";";
  protected final String TEXT_606 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_607 = ",";
  protected final String TEXT_608 = ".";
  protected final String TEXT_609 = ", ";
  protected final String TEXT_610 = ",updateSQLSplits_";
  protected final String TEXT_611 = ");";
  protected final String TEXT_612 = NL + "                    int count_";
  protected final String TEXT_613 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_614 = ".";
  protected final String TEXT_615 = ", pstmt_";
  ...
  protected final String TEXT_635 = NL + "                globalMap.put(\"";
  protected final String TEXT_636 = "_QUERY\", query_";
  protected final String TEXT_637 = ".toString().trim());";
  protected final String TEXT_638 = NL + "            pstmt_";
  protected final String TEXT_639 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_640 = "++;";
  protected final String TEXT_641 = NL + "              batchSizeCounter_";
  protected final String TEXT_642 = "++;";
  protected final String TEXT_643 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_644 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_645 = " = updatedCount_";
  protected final String TEXT_646 = " + pstmt_";
  protected final String TEXT_647 = ".executeUpdate();";
  protected final String TEXT_648 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_649 = " = true;";
  protected final String TEXT_650 = NL + "                    throw(e);";
  protected final String TEXT_651 = NL + "                        ";
  protected final String TEXT_652 = " = new ";
  protected final String TEXT_653 = "Struct();";
  protected final String TEXT_654 = NL + "                            ";
  protected final String TEXT_655 = ".";
  protected final String TEXT_656 = " = ";
  protected final String TEXT_657 = ".";
  protected final String TEXT_658 = ";";
  protected final String TEXT_659 = NL + "                        rejectedCount_";
  protected final String TEXT_660 = " = rejectedCount_";
  protected final String TEXT_661 = " + 1;";
  protected final String TEXT_662 = NL + "                        ";
  protected final String TEXT_663 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_664 = NL + "                        ";
  protected final String TEXT_665 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_666 = ";";
  protected final String TEXT_667 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_668 = NL + "            }";
  protected final String TEXT_669 = NL + "                        ";
  protected final String TEXT_670 = NL + "                    ";
  protected final String TEXT_671 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_672 = " = pstmt_";
  protected final String TEXT_673 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_674 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_675 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_676 = " = rs_";
  protected final String TEXT_677 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_678 = " > 0) {";
  protected final String TEXT_679 = NL + "                        ";
  protected final String TEXT_680 = NL + "                            query_";
  protected final String TEXT_681 = " = ";
  protected final String TEXT_682 = ";";
  protected final String TEXT_683 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_684 = ",";
  protected final String TEXT_685 = ".";
  protected final String TEXT_686 = ", ";
  protected final String TEXT_687 = ",updateSQLSplits_";
  protected final String TEXT_688 = ");";
  protected final String TEXT_689 = NL + NL + "                        int count_";
  protected final String TEXT_690 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_691 = ".";
  protected final String TEXT_692 = ", pstmtUpdate_";
  protected final String TEXT_693 = ", ";
  protected final String TEXT_694 = ", \"";
  protected final String TEXT_695 = "\");";
  protected final String TEXT_696 = NL + "                    ";
  protected final String TEXT_697 = NL + "                    ";
  protected final String TEXT_698 = NL + "                                query_";
  ...
  protected final String TEXT_711 = NL + "                    globalMap.put(\"";
  protected final String TEXT_712 = "_QUERY\", query_";
  protected final String TEXT_713 = ".toString().trim());";
  protected final String TEXT_714 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_715 = " = updatedCount_";
  protected final String TEXT_716 = " + pstmtUpdate_";
  protected final String TEXT_717 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_718 = "++;";
  protected final String TEXT_719 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_720 = " = true;";
  protected final String TEXT_721 = NL + "                        throw(e);";
  protected final String TEXT_722 = NL + "                        nb_line_";
  protected final String TEXT_723 = "++;";
  protected final String TEXT_724 = NL + "                            ";
  protected final String TEXT_725 = " = new ";
  protected final String TEXT_726 = "Struct();";
  protected final String TEXT_727 = NL + "                                ";
  protected final String TEXT_728 = ".";
  protected final String TEXT_729 = " = ";
  protected final String TEXT_730 = ".";
  protected final String TEXT_731 = ";";
  protected final String TEXT_732 = NL + "                            rejectedCount_";
  protected final String TEXT_733 = " = rejectedCount_";
  protected final String TEXT_734 = " + 1;";
  protected final String TEXT_735 = NL + "                            ";
  protected final String TEXT_736 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_737 = NL + "                            ";
  protected final String TEXT_738 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_739 = ";";
  protected final String TEXT_740 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_741 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_742 = NL + "                        ";
  protected final String TEXT_743 = NL + "                            query_";
  protected final String TEXT_744 = " = ";
  protected final String TEXT_745 = ";";
  protected final String TEXT_746 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_747 = ",";
  protected final String TEXT_748 = ".";
  protected final String TEXT_749 = ", ";
  protected final String TEXT_750 = ",insertSQLSplits_";
  protected final String TEXT_751 = ");";
  protected final String TEXT_752 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_753 = ".";
  protected final String TEXT_754 = ", pstmtInsert_";
  protected final String TEXT_755 = ", ";
  protected final String TEXT_756 = ", \"";
  protected final String TEXT_757 = "\");";
  protected final String TEXT_758 = NL + "                    globalMap.put(\"";
  protected final String TEXT_759 = "_QUERY\", query_";
  protected final String TEXT_760 = ".toString().trim());";
  protected final String TEXT_761 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_762 = " = insertedCount_";
  protected final String TEXT_763 = " + pstmtInsert_";
  protected final String TEXT_764 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_769 = NL + "                        nb_line_";
  protected final String TEXT_770 = "++;";
  protected final String TEXT_771 = NL + "                            ";
  protected final String TEXT_772 = " = new ";
  protected final String TEXT_773 = "Struct();";
  protected final String TEXT_774 = NL + "                                ";
  protected final String TEXT_775 = ".";
  protected final String TEXT_776 = " = ";
  protected final String TEXT_777 = ".";
  protected final String TEXT_778 = ";";
  protected final String TEXT_779 = NL + "                            rejectedCount_";
  protected final String TEXT_780 = " = rejectedCount_";
  protected final String TEXT_781 = " + 1;";
  protected final String TEXT_782 = NL + "                            ";
  protected final String TEXT_783 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_784 = NL + "                            ";
  protected final String TEXT_785 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_786 = ";";
  protected final String TEXT_787 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_788 = NL + "                }" + NL + "            }";
  protected final String TEXT_789 = NL + "            int updateFlag_";
  protected final String TEXT_790 = "=0;";
  protected final String TEXT_791 = NL + "                    ";
  protected final String TEXT_792 = NL + "                        query_";
  protected final String TEXT_793 = " = ";
  protected final String TEXT_794 = ";";
  protected final String TEXT_795 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_796 = ",";
  protected final String TEXT_797 = ".";
  protected final String TEXT_798 = ", ";
  protected final String TEXT_799 = ",updateSQLSplits_";
  ...
  protected final String TEXT_818 = NL + "                        query_";
  ...
  protected final String TEXT_827 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_828 = " = pstmtUpdate_";
  protected final String TEXT_829 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_830 = " = updatedCount_";
  protected final String TEXT_831 = "+updateFlag_";
  protected final String TEXT_832 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_833 = " == 0) {";
  protected final String TEXT_834 = NL + "                query_";
  protected final String TEXT_835 = " = new StringBuffer(\"\");";
  protected final String TEXT_836 = NL + "                        ";
  protected final String TEXT_837 = NL + "                            query_";
  protected final String TEXT_838 = " = ";
  protected final String TEXT_839 = ";";
  protected final String TEXT_840 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_841 = ",";
  protected final String TEXT_842 = ".";
  protected final String TEXT_843 = ", ";
  protected final String TEXT_844 = ",insertSQLSplits_";
  protected final String TEXT_845 = ");";
  protected final String TEXT_846 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_847 = ".";
  protected final String TEXT_848 = ", pstmtInsert_";
  protected final String TEXT_849 = ", ";
  protected final String TEXT_850 = ", \"";
  protected final String TEXT_851 = "\");";
  protected final String TEXT_852 = NL + "                    globalMap.put(\"";
  protected final String TEXT_853 = "_QUERY\", query_";
  protected final String TEXT_854 = ".toString().trim());";
  protected final String TEXT_855 = NL + "                    insertedCount_";
  protected final String TEXT_856 = " = insertedCount_";
  protected final String TEXT_857 = " + pstmtInsert_";
  protected final String TEXT_858 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_859 = "++;";
  protected final String TEXT_860 = NL + "                    }else{" + NL + "                        nb_line_";
  protected final String TEXT_861 = "++;";
  protected final String TEXT_862 = NL + "                    }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_863 = " = true;";
  protected final String TEXT_864 = NL + "                        throw(e);";
  protected final String TEXT_865 = NL + "                        nb_line_";
  protected final String TEXT_866 = "++;";
  protected final String TEXT_867 = NL + "                            ";
  protected final String TEXT_868 = " = new ";
  protected final String TEXT_869 = "Struct();";
  protected final String TEXT_870 = NL + "                                ";
  protected final String TEXT_871 = ".";
  protected final String TEXT_872 = " = ";
  protected final String TEXT_873 = ".";
  protected final String TEXT_874 = ";";
  protected final String TEXT_875 = NL + "                            rejectedCount_";
  protected final String TEXT_876 = " = rejectedCount_";
  protected final String TEXT_877 = " + 1;";
  protected final String TEXT_878 = NL + "                            ";
  protected final String TEXT_879 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_880 = NL + "                            ";
  protected final String TEXT_881 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_882 = ";";
  protected final String TEXT_883 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_897 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_898 = "++;";
  protected final String TEXT_899 = NL + "              batchSizeCounter_";
  protected final String TEXT_900 = "++;";
  protected final String TEXT_901 = NL + "            try {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_906 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_907 = " = true;";
  protected final String TEXT_908 = NL + "                    throw(e);";
  protected final String TEXT_909 = NL + "                    nb_line_";
  ...
  protected final String TEXT_919 = NL + "                        rejectedCount_";
  protected final String TEXT_920 = " = rejectedCount_";
  protected final String TEXT_921 = " + 1;";
  protected final String TEXT_922 = NL + "                        ";
  protected final String TEXT_923 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_924 = NL + "                        ";
  protected final String TEXT_925 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_926 = ";";
  protected final String TEXT_927 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_928 = NL + "            }";
  protected final String TEXT_929 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_940 = NL + "                if ((batchSize_";
  protected final String TEXT_941 = " > 0) && (batchSize_";
  protected final String TEXT_942 = " <= batchSizeCounter_";
  protected final String TEXT_943 = ")) {" + NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_944 = " = 0;";
  protected final String TEXT_945 = NL + "                        for(int countEach_";
  protected final String TEXT_946 = ": pstmt_";
  protected final String TEXT_947 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_954 = NL + "                            updatedCount_";
  protected final String TEXT_955 = " += countSum_";
  protected final String TEXT_956 = ";";
  protected final String TEXT_957 = NL + "                            deletedCount_";
  protected final String TEXT_958 = " += countSum_";
  protected final String TEXT_959 = ";";
  protected final String TEXT_960 = NL + "                        batchSizeCounter_";
  protected final String TEXT_961 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_962 = NL + "                        throw(e);";
  protected final String TEXT_963 = NL + "                    int countSum_";
  protected final String TEXT_964 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_965 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_966 = " += (countEach_";
  protected final String TEXT_967 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_972 = NL + "                        updatedCount_";
  protected final String TEXT_973 = " += countSum_";
  protected final String TEXT_974 = ";";
  protected final String TEXT_975 = NL + "                        deletedCount_";
  protected final String TEXT_976 = " += countSum_";
  protected final String TEXT_977 = ";";
  protected final String TEXT_978 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_979 = NL + "                }" + NL + "                }";
  protected final String TEXT_980 = NL + "                commitCounter_";
  protected final String TEXT_981 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_982 = " <= commitCounter_";
  protected final String TEXT_983 = ") {";
  protected final String TEXT_984 = NL + "                if ((batchSize_";
  protected final String TEXT_985 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_986 = " > 0)) {" + NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_987 = " = 0;";
  protected final String TEXT_988 = NL + "                        for(int countEach_";
  protected final String TEXT_989 = ": pstmt_";
  protected final String TEXT_990 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_991 = " += (countEach_";
  protected final String TEXT_992 = " < 0 ? 0 : countEach_";
  protected final String TEXT_993 = ");" + NL + "                        }";
  protected final String TEXT_994 = NL + "                            insertedCount_";
  ...
  protected final String TEXT_1003 = NL + "                    batchSizeCounter_";
  protected final String TEXT_1004 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1005 = NL + "                        throw(e);";
  protected final String TEXT_1006 = NL + "                        int countSum_";
  protected final String TEXT_1007 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_1008 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1012 = NL + "                            insertedCount_";
  protected final String TEXT_1013 = " += countSum_";
  protected final String TEXT_1014 = ";";
  protected final String TEXT_1015 = NL + "                            updatedCount_";
  protected final String TEXT_1016 = " += countSum_";
  protected final String TEXT_1017 = ";";
  protected final String TEXT_1018 = NL + "                            deletedCount_";
  protected final String TEXT_1019 = " += countSum_";
  protected final String TEXT_1020 = ";";
  protected final String TEXT_1021 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1022 = NL + "                }" + NL + "            }";
  protected final String TEXT_1023 = NL + "                    conn_";
  protected final String TEXT_1024 = ".commit();";
  protected final String TEXT_1025 = NL + "                    commitCounter_";
