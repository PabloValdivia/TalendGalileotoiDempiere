...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_459 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_514 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_518 = ".prepareStatement(delete_";
  protected final String TEXT_519 = ");" + NL + "\t    ";
  protected final String TEXT_520 = NL + "       \t";
  protected final String TEXT_521 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_522 = " = insert_";
  protected final String TEXT_523 = ".split(\"\\\\?\");";
  protected final String TEXT_524 = NL + "\t\t\tupdate_";
  protected final String TEXT_525 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_526 = " = update_";
  protected final String TEXT_527 = ".split(\"\\\\?\");";
  protected final String TEXT_528 = NL + "\t\t\tupdate_";
  protected final String TEXT_529 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_530 = " = update_";
  protected final String TEXT_531 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_532 = " = insert_";
  protected final String TEXT_533 = ".split(\"\\\\?\");";
  protected final String TEXT_534 = NL + "\t\t\tdelete_";
  protected final String TEXT_535 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_536 = " = delete_";
  protected final String TEXT_537 = ".split(\"\\\\?\");";
  protected final String TEXT_538 = NL + "\t\t\treplace_";
  protected final String TEXT_539 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_540 = " = replace_";
  protected final String TEXT_541 = ".split(\"\\\\?\");";
  protected final String TEXT_542 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_543 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_544 = " = insertIgnore_";
  protected final String TEXT_545 = ".split(\"\\\\?\");";
  protected final String TEXT_546 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_547 = " = insert_";
  protected final String TEXT_548 = ".split(\"\\\\?\");";
  protected final String TEXT_549 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_550 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_551 = " = buffersSize_";
  protected final String TEXT_552 = ";";
  protected final String TEXT_553 = NL + "\t\t\t\t\tbatchSize_";
  protected final String TEXT_554 = " = buffersSize_";
  protected final String TEXT_555 = ";";
  protected final String TEXT_556 = NL + NL;
  protected final String TEXT_557 = NL + "        whetherReject_";
  ...
  protected final String TEXT_563 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_564 = ",";
  protected final String TEXT_565 = ".";
  protected final String TEXT_566 = ", ";
  protected final String TEXT_567 = ",insertSQLSplits_";
  protected final String TEXT_568 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_569 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_570 = ".";
  protected final String TEXT_571 = ", pstmt_";
  protected final String TEXT_572 = ", ";
  protected final String TEXT_573 = ", \"";
  protected final String TEXT_574 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_575 = NL + "                globalMap.put(\"";
  protected final String TEXT_576 = "_QUERY\", query_";
  protected final String TEXT_577 = ".toString().trim());";
  protected final String TEXT_578 = NL;
  protected final String TEXT_579 = NL + "    \t\tpstmt_";
  protected final String TEXT_580 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_581 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_582 = "++;";
  protected final String TEXT_583 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_584 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_585 = " = insertedCount_";
  protected final String TEXT_586 = " + pstmt_";
  protected final String TEXT_587 = ".executeUpdate();";
  protected final String TEXT_588 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_607 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_608 = NL + "            }";
  protected final String TEXT_609 = NL + "                    ";
  protected final String TEXT_610 = NL + "                        query_";
  protected final String TEXT_611 = " = ";
  protected final String TEXT_612 = ";";
  protected final String TEXT_613 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_614 = ",";
  protected final String TEXT_615 = ".";
  protected final String TEXT_616 = ", ";
  protected final String TEXT_617 = ",updateSQLSplits_";
  protected final String TEXT_618 = ");";
  protected final String TEXT_619 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_620 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_630 = NL + "\t\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_644 = NL + "                globalMap.put(\"";
  protected final String TEXT_645 = "_QUERY\", query_";
  protected final String TEXT_646 = ".toString().trim());";
  protected final String TEXT_647 = NL;
  protected final String TEXT_648 = NL + "    \t\tpstmt_";
  protected final String TEXT_649 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_650 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_651 = "++;";
  protected final String TEXT_652 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_653 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_654 = " = updatedCount_";
  protected final String TEXT_655 = " + pstmt_";
  protected final String TEXT_656 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_657 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_658 = " = true;";
  protected final String TEXT_659 = NL + "                    throw(e);";
  protected final String TEXT_660 = NL + "                        ";
  protected final String TEXT_661 = " = new ";
  protected final String TEXT_662 = "Struct();";
  protected final String TEXT_663 = NL + "                            ";
  protected final String TEXT_664 = ".";
  protected final String TEXT_665 = " = ";
  protected final String TEXT_666 = ".";
  protected final String TEXT_667 = ";";
  protected final String TEXT_668 = NL + "                        rejectedCount_";
  protected final String TEXT_669 = " = rejectedCount_";
  protected final String TEXT_670 = " + 1;";
  protected final String TEXT_671 = NL + "                        ";
  protected final String TEXT_672 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_673 = NL + "                        ";
  protected final String TEXT_674 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_675 = ";";
  protected final String TEXT_676 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_681 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_682 = " = pstmt_";
  protected final String TEXT_683 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_684 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_685 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_686 = " = rs_";
  protected final String TEXT_687 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_699 = NL + NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_723 = NL + "                    globalMap.put(\"";
  protected final String TEXT_724 = "_QUERY\", query_";
  protected final String TEXT_725 = ".toString().trim());";
  protected final String TEXT_726 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_727 = " = updatedCount_";
  protected final String TEXT_728 = " + pstmtUpdate_";
  protected final String TEXT_729 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_730 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_731 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_732 = " = true;";
  protected final String TEXT_733 = NL + "                        throw(e);";
  protected final String TEXT_734 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_779 = " = true;";
  protected final String TEXT_780 = NL + "                        throw(e);";
  protected final String TEXT_781 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_807 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_808 = ",";
  protected final String TEXT_809 = ".";
  protected final String TEXT_810 = ", ";
  protected final String TEXT_811 = ",updateSQLSplits_";
  protected final String TEXT_812 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_813 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_814 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_815 = ".";
  protected final String TEXT_816 = ", pstmtUpdate_";
  ...
  protected final String TEXT_838 = NL + "                globalMap.put(\"";
  protected final String TEXT_839 = "_QUERY\", query_";
  protected final String TEXT_840 = ".toString().trim());";
  protected final String TEXT_841 = NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_842 = "=pstmtUpdate_";
  protected final String TEXT_843 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_844 = " = updatedCount_";
  protected final String TEXT_845 = " + updateFlag_";
  protected final String TEXT_846 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_847 = " == 0) {" + NL + "            \t";
  protected final String TEXT_848 = NL + "\t\t\t\tquery_";
  protected final String TEXT_849 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_850 = NL + "                        ";
  protected final String TEXT_851 = NL + "                            query_";
  protected final String TEXT_852 = " = ";
  protected final String TEXT_853 = ";";
  protected final String TEXT_854 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_855 = ",";
  protected final String TEXT_856 = ".";
  protected final String TEXT_857 = ", ";
  protected final String TEXT_858 = ",insertSQLSplits_";
  ...
  protected final String TEXT_869 = NL + "                    insertedCount_";
  protected final String TEXT_870 = " = insertedCount_";
  protected final String TEXT_871 = " + pstmtInsert_";
  protected final String TEXT_872 = ".executeUpdate();" + NL + "             \t\tnb_line_";
  protected final String TEXT_873 = "++;";
  protected final String TEXT_874 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_875 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_876 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_877 = " = true;";
  protected final String TEXT_878 = NL + "                        throw(e);";
  protected final String TEXT_879 = NL + "                    \tnb_line_";
  protected final String TEXT_880 = "++;" + NL + "                    \t";
  protected final String TEXT_881 = NL + "                            ";
  protected final String TEXT_882 = " = new ";
  protected final String TEXT_883 = "Struct();";
  protected final String TEXT_884 = NL + "                                ";
  protected final String TEXT_885 = ".";
  protected final String TEXT_886 = " = ";
  protected final String TEXT_887 = ".";
  protected final String TEXT_888 = ";";
  protected final String TEXT_889 = NL + "                            rejectedCount_";
  protected final String TEXT_890 = " = rejectedCount_";
  protected final String TEXT_891 = " + 1;";
  protected final String TEXT_892 = NL + "                            ";
  protected final String TEXT_893 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_894 = NL + "                            ";
  protected final String TEXT_895 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_896 = ";";
  protected final String TEXT_897 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_908 = NL + "                globalMap.put(\"";
  protected final String TEXT_909 = "_QUERY\", query_";
  protected final String TEXT_910 = ".toString().trim());";
  protected final String TEXT_911 = NL;
  protected final String TEXT_912 = NL + "\t\t    \t\tpstmt_";
  protected final String TEXT_913 = ".addBatch();" + NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_914 = "++;" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_915 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_916 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_917 = " = deletedCount_";
  protected final String TEXT_918 = " + pstmt_";
  protected final String TEXT_919 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_920 = "++;";
  protected final String TEXT_921 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_922 = " = true;";
  protected final String TEXT_923 = NL + "                    throw(e);";
  protected final String TEXT_924 = NL + "                \tnb_line_";
  ...
  protected final String TEXT_938 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_939 = NL + "                        ";
  protected final String TEXT_940 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_941 = ";";
  protected final String TEXT_942 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_943 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_944 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_955 = NL + "\t\t\t\tif ((batchSize_";
  protected final String TEXT_956 = " > 0) && (batchSize_";
  protected final String TEXT_957 = " <= batchSizeCounter_";
  protected final String TEXT_958 = ")) {" + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_959 = " = 0;" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_960 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_961 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_962 = ": pstmt_";
  protected final String TEXT_963 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_971 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_972 = " += countSum_";
  protected final String TEXT_973 = ";" + NL + "            \t    \t";
  protected final String TEXT_974 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_975 = " += countSum_";
  protected final String TEXT_976 = ";" + NL + "            \t    \t";
  protected final String TEXT_977 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_978 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_979 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_980 = NL + "                \t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_981 = NL + "            commitCounter_";
  protected final String TEXT_982 = "++;" + NL + "" + NL + "            if(commitEvery_";
  protected final String TEXT_983 = "<=commitCounter_";
  protected final String TEXT_984 = ") {" + NL + "            \t";
  protected final String TEXT_985 = NL + "                conn_";
  protected final String TEXT_986 = ".commit();";
  protected final String TEXT_987 = NL + "                commitCounter_";
  protected final String TEXT_988 = " = 0;" + NL + "" + NL + "            }" + NL;
