...
public class TFileInputPositionalBeginJava
{
  ...
  protected final String TEXT_530 = " = null;" + NL + "            org.talend.fileprocess.delimited.RowParser reader_";
  protected final String TEXT_531 = " = null; " + NL + "" + NL + "\t\t\t";
  protected final String TEXT_532 = NL + NL + "\t\t\t";
  protected final String TEXT_533 = NL + "                java.util.zip.ZipInputStream zis_";
  protected final String TEXT_534 = " = null;" + NL + "                try {" + NL + "                \tif(filename_";
  protected final String TEXT_535 = " instanceof java.io.InputStream){" + NL + "                \t\tzis_";
  protected final String TEXT_536 = " = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream((java.io.InputStream)filename_";
  protected final String TEXT_537 = "));" + NL + "                \t}else{" + NL + "                \t\tzis_";
  protected final String TEXT_538 = " = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_539 = "))));" + NL + "                \t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                \t";
  ...
  protected final String TEXT_544 = NL + "                \t\t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_545 = NL + "                }" + NL + "                java.util.zip.ZipEntry entry_";
  protected final String TEXT_546 = " = null;" + NL + "                while (true) {" + NL + "                \ttry {" + NL + "                \t\tentry_";
  protected final String TEXT_547 = " = zis_";
  protected final String TEXT_548 = ".getNextEntry();" + NL + "                \t} catch(java.lang.Exception e) {" + NL + "                \t\t";
  protected final String TEXT_549 = NL + "                \t\t\tthrow e;" + NL + "                \t\t";
  protected final String TEXT_550 = NL + "                \t\t\t";
  protected final String TEXT_551 = NL + "                \t\t\t\tlog.error(\"";
  protected final String TEXT_552 = " - \" +e.getMessage());" + NL + "                \t\t\t";
  protected final String TEXT_553 = NL + "                    \t\tSystem.err.println(e.getMessage());" + NL + "                    \t\tbreak;" + NL + "                \t\t";
  protected final String TEXT_554 = NL + "                \t}" + NL + "                \tif(entry_";
  protected final String TEXT_555 = " == null) {" + NL + "                \t\tbreak;" + NL + "                \t}" + NL + "                \tif(entry_";
  protected final String TEXT_556 = ".isDirectory()){ //directory" + NL + "                \t\tcontinue;" + NL + "                \t}" + NL + "                \tString row_";
  protected final String TEXT_557 = " = null;" + NL + "                \tint rowLen_";
  protected final String TEXT_558 = " = 0;" + NL + "                \t";
  protected final String TEXT_559 = NL + "                \t\t\tbyte[] byteArray_";
  protected final String TEXT_560 = " = new byte[0];" + NL + "                    \t";
  protected final String TEXT_561 = NL + "                \t\tString column_";
  protected final String TEXT_562 = " = null;" + NL + "                \t";
  protected final String TEXT_563 = NL + "                \t\t\tbyte[][] byteArray_";
  protected final String TEXT_564 = " = new byte[";
  protected final String TEXT_565 = "][];" + NL + "                \t\t";
  protected final String TEXT_566 = NL + "                \t\tString[] columnValue";
  protected final String TEXT_567 = "=new String[";
  protected final String TEXT_568 = "];" + NL + "                \t";
  protected final String TEXT_569 = NL + "                \ttry {//TD110 begin" + NL + "                \t\tin_";
  protected final String TEXT_570 = " = new java.io.BufferedReader(new java.io.InputStreamReader(zis_";
  protected final String TEXT_571 = ", ";
  protected final String TEXT_572 = "));" + NL + "    \t\t";
  protected final String TEXT_573 = NL + "                String row_";
  protected final String TEXT_574 = " = null;" + NL + "                int rowLen_";
  protected final String TEXT_575 = " = 0;";
  protected final String TEXT_576 = NL + "            \t\t\tbyte[] byteArray_";
  protected final String TEXT_577 = " = new byte[0];";
  protected final String TEXT_578 = NL + "\t\t\t\t\tString column_";
  protected final String TEXT_579 = " = null;";
  protected final String TEXT_580 = NL + "\t\t                byte[][] byteArray_";
  protected final String TEXT_581 = " = new byte[";
  protected final String TEXT_582 = "][];" + NL + "        \t        ";
  protected final String TEXT_583 = NL + "                \tString[] columnValue";
  protected final String TEXT_584 = "=new String[";
  protected final String TEXT_585 = "];";
  protected final String TEXT_586 = " " + NL + "                try {//TD110 begin" + NL + "                \tif(filename_";
  protected final String TEXT_587 = " instanceof java.io.InputStream){" + NL + "                \t\tin_";
  protected final String TEXT_588 = " = " + NL + "                \t\t\t\tnew java.io.BufferedReader(new java.io.InputStreamReader((java.io.InputStream)filename_";
  protected final String TEXT_589 = ", ";
  protected final String TEXT_590 = "));" + NL + "                \t}else{" + NL + "                \t\tin_";
  protected final String TEXT_591 = " = " + NL + "                \t\t\tnew java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_592 = ")), ";
  protected final String TEXT_593 = "));" + NL + "                \t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_594 = NL + "\t\t\t\tint rowLength_";
  protected final String TEXT_595 = " = 0;" + NL + "\t\t\t\t";
  protected final String TEXT_596 = NL + "\t\t\t\t\t\trowLength_";
  protected final String TEXT_597 = " += sizes_";
  protected final String TEXT_598 = "[";
  protected final String TEXT_599 = "];" + NL + "\t\t\t\t\t";
  protected final String TEXT_600 = NL + "\t\t\t\t\tfor(int i_";
  protected final String TEXT_601 = "=0;i_";
  protected final String TEXT_602 = "<positions_";
  protected final String TEXT_603 = ".length;i_";
  protected final String TEXT_604 = "++){" + NL + "\t\t\t\t\t\trowLength_";
  protected final String TEXT_605 = " += Integer.parseInt(positions_";
  protected final String TEXT_606 = "[i_";
  protected final String TEXT_607 = "]);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_608 = NL + "\t\t\t\treader_";
  protected final String TEXT_609 = " = new org.talend.fileprocess.delimited.RowParser(in_";
  protected final String TEXT_610 = ", rowLength_";
  protected final String TEXT_611 = ");" + NL + "\t\t\t";
  protected final String TEXT_612 = NL + "\t\t\t\treader_";
  protected final String TEXT_613 = " = new org.talend.fileprocess.delimited.RowParser(in_";
  protected final String TEXT_614 = ", ";
  protected final String TEXT_615 = ", ";
  protected final String TEXT_616 = ");" + NL + "\t\t\t";
  protected final String TEXT_617 = NL + "            reader_";
  protected final String TEXT_618 = ".setSafetySwitch(";
  protected final String TEXT_619 = ");" + NL + "            reader_";
  protected final String TEXT_620 = ".skipHeaders(";
  protected final String TEXT_621 = ");" + NL + "            if(footer_";
  protected final String TEXT_622 = " > 0){" + NL + "            \tint available_";
  protected final String TEXT_623 = " = (int)reader_";
  protected final String TEXT_624 = ".getAvailableRowCount(footer_";
  protected final String TEXT_625 = ");" + NL + "            \treader_";
  protected final String TEXT_626 = ".close();" + NL + "            \tif(filename_";
  protected final String TEXT_627 = " instanceof java.io.InputStream){" + NL + "            \t\tin_";
  protected final String TEXT_628 = " = new java.io.BufferedReader(new java.io.InputStreamReader((java.io.InputStream)filename_";
  protected final String TEXT_629 = ", ";
  protected final String TEXT_630 = "));" + NL + "            \t}else{" + NL + "            \t\tin_";
  protected final String TEXT_631 = " = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_632 = ")), ";
  protected final String TEXT_633 = "));" + NL + "            \t}" + NL + "\t\t\t\t";
  protected final String TEXT_634 = NL + "\t\t\t\t\treader_";
  protected final String TEXT_635 = " = new org.talend.fileprocess.delimited.RowParser(in_";
  protected final String TEXT_636 = ", rowLength_";
  protected final String TEXT_637 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_638 = NL + "\t\t\t\t\treader_";
  protected final String TEXT_639 = " = new org.talend.fileprocess.delimited.RowParser(in_";
  protected final String TEXT_640 = ", ";
  protected final String TEXT_641 = ", ";
  protected final String TEXT_642 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_643 = "\t" + NL + "\t\t\t\treader_";
  protected final String TEXT_644 = ".skipHeaders(";
  protected final String TEXT_645 = ");" + NL + "\t" + NL + "            \tif ( nb_limit_";
  protected final String TEXT_646 = " >= 0 ){" + NL + "            \t\tnb_limit_";
  protected final String TEXT_647 = " = ( nb_limit_";
  protected final String TEXT_648 = " > available_";
  protected final String TEXT_649 = ") ? available_";
  protected final String TEXT_650 = " : nb_limit_";
  protected final String TEXT_651 = ";" + NL + "            \t}else{" + NL + "            \t\tnb_limit_";
  protected final String TEXT_652 = " = available_";
  protected final String TEXT_653 = ";" + NL + "            \t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t} catch(java.lang.Exception e) {//TD110 end" + NL + "        \t";
  protected final String TEXT_654 = NL + "        \t\tthrow e;" + NL + "        \t";
  protected final String TEXT_655 = NL + "        \t\t";
  protected final String TEXT_656 = NL + "        \t\t\tlog.error(\"";
  protected final String TEXT_657 = " - \" +e.getMessage());" + NL + "        \t\t";
  protected final String TEXT_658 = NL + "    \t\t\tSystem.err.println(e.getMessage());" + NL + "        \t";
  protected final String TEXT_659 = NL + "        }" + NL + "\t\t" + NL + "        while (nb_limit_";
  protected final String TEXT_660 = " != 0 && reader_";
  protected final String TEXT_661 = "!=null && reader_";
  protected final String TEXT_662 = ".readRecord()) {" + NL + "        \trow_";
  protected final String TEXT_663 = " = reader_";
  protected final String TEXT_664 = ".getRowRecord();" + NL + "\t\t\t";
  protected final String TEXT_665 = NL + "\t\t\t\trowLen_";
  protected final String TEXT_666 = " = row_";
  protected final String TEXT_667 = ".getBytes(";
  protected final String TEXT_668 = ").length;" + NL + "\t\t\t";
  protected final String TEXT_669 = NL + "\t\t\t\trowLen_";
  protected final String TEXT_670 = " = row_";
  protected final String TEXT_671 = ".length();" + NL + "\t\t\t";
  protected final String TEXT_672 = NL + "\t\t\t";
  protected final String TEXT_673 = NL + "    \t\t\t\t\t\t";
  protected final String TEXT_674 = " = null;\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_675 = NL + "        \t\t\t" + NL + "            \t\t\tboolean whetherReject_";
  protected final String TEXT_676 = " = false;" + NL + "            \t\t\t";
  protected final String TEXT_677 = " = new ";
  protected final String TEXT_678 = "Struct();" + NL + "            \t\t\ttry {" + NL + "    \t\t\t" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_679 = NL + "                      \t\t\t\t\tpositionalUtil_";
  protected final String TEXT_680 = ".setValue_";
  protected final String TEXT_681 = "(";
  protected final String TEXT_682 = ",begins_";
  protected final String TEXT_683 = ",ends_";
  protected final String TEXT_684 = ",rowLen_";
  protected final String TEXT_685 = "," + NL + "                          \t\t\t\t";
  protected final String TEXT_686 = "byteArray_";
  protected final String TEXT_687 = ",arrays_";
  protected final String TEXT_688 = ",";
  protected final String TEXT_689 = "column_";
  protected final String TEXT_690 = ",row_";
  protected final String TEXT_691 = ");          " + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_692 = NL + "                            \tint substringBegin";
  protected final String TEXT_693 = "=0,substringEnd";
  protected final String TEXT_694 = "=0;" + NL + "                            \tint[]begin_end_";
  protected final String TEXT_695 = "=new int[2];" + NL + "                            \t" + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_696 = NL + "                        \t\t\t\tsubstringBegin";
  protected final String TEXT_697 = " = positionalUtil_";
  protected final String TEXT_698 = ".parseValue_";
  protected final String TEXT_699 = "(row_";
  protected final String TEXT_700 = ", substringBegin";
  protected final String TEXT_701 = ", substringEnd";
  protected final String TEXT_702 = ", rowLen_";
  protected final String TEXT_703 = ", columnValue";
  protected final String TEXT_704 = " ";
  protected final String TEXT_705 = ", arrays_";
  protected final String TEXT_706 = ", byteArray_";
  protected final String TEXT_707 = ", dynamic_";
  protected final String TEXT_708 = ");" + NL + "                        \t\t\t\tsubstringEnd";
  protected final String TEXT_709 = " = substringBegin";
  protected final String TEXT_710 = ";" + NL + "                    \t\t\t\t";
  protected final String TEXT_711 = NL + "      \t \t\t\t\t\t\t\t\tpositionalUtil_";
  protected final String TEXT_712 = ".setValue_";
  ...
  protected final String TEXT_718 = "=dynamic_";
  protected final String TEXT_719 = ";" + NL + "    \t\t\t\t\t\t\t";
  protected final String TEXT_720 = NL + "    \t\t" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_721 = " ";
  protected final String TEXT_722 = " = null; ";
  protected final String TEXT_723 = "        \t\t\t" + NL + "            \t\t\t" + NL + "    \t\t\t\t\t} catch (java.lang.Exception e) {" + NL + "        \t\t\t\t\twhetherReject_";
  ...
  protected final String TEXT_728 = "Struct();";
  ...
  protected final String TEXT_735 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_736 = ";";
  protected final String TEXT_737 = NL + "                                    ";
  protected final String TEXT_738 = " = null;";
  protected final String TEXT_739 = NL + "                    \t\t\t\t\tlog.error(\"";
  protected final String TEXT_740 = " - \" +e.getMessage());" + NL + "                    \t\t\t\t";
  protected final String TEXT_741 = NL + "                                    System.err.println(e.getMessage());";
  protected final String TEXT_742 = NL + "                                    ";
  protected final String TEXT_743 = " = null;";
  protected final String TEXT_744 = NL + "                                \t";
  protected final String TEXT_745 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_746 = ";";
  protected final String TEXT_747 = NL + "                        }" + NL + "        \t\t\t" + NL + "        \t\t\t";
  protected final String TEXT_748 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_749 = "if(!whetherReject_";
  ...
  protected final String TEXT_754 = "Struct();" + NL + "         \t\t\t\t\t\t}\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
