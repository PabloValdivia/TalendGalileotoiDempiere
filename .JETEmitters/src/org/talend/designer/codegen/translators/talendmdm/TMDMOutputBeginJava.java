...
public class TMDMOutputBeginJava
{
  ...
  protected final String TEXT_84 = NL + "    javax.xml.ws.BindingProvider stub_";
  protected final String TEXT_85 = "_";
  protected final String TEXT_86 = " = (javax.xml.ws.BindingProvider) globalMap.get(\"";
  protected final String TEXT_87 = "\");" + NL + "    java.util.Map<String, Object> context_";
  protected final String TEXT_88 = "_";
  protected final String TEXT_89 = " = stub_";
  protected final String TEXT_90 = "_";
  protected final String TEXT_91 = ".getRequestContext();" + NL + "" + NL + "    org.talend.mdm.webservice.TMDMService_Service service_service_";
  protected final String TEXT_92 = " = new org.talend.mdm.webservice.TMDMService_Service(null);" + NL + "    org.talend.mdm.webservice.TMDMService service_";
  ...
  protected final String TEXT_96 = ";" + NL + "    stub_";
  protected final String TEXT_97 = ".getRequestContext().put(javax.xml.ws.BindingProvider.SESSION_MAINTAIN_PROPERTY, false);" + NL + "" + NL + "    java.util.Map<String, Object> context_";
  protected final String TEXT_98 = " = stub_";
  protected final String TEXT_99 = ".getRequestContext();" + NL + "    context_";
  protected final String TEXT_100 = ".put(javax.xml.ws.BindingProvider.USERNAME_PROPERTY, context_";
  protected final String TEXT_101 = "_";
  protected final String TEXT_102 = ".get(javax.xml.ws.BindingProvider.USERNAME_PROPERTY));" + NL + "    context_";
  protected final String TEXT_103 = ".put(javax.xml.ws.BindingProvider.ENDPOINT_ADDRESS_PROPERTY, context_";
  protected final String TEXT_104 = "_";
  protected final String TEXT_105 = ".get(javax.xml.ws.BindingProvider.ENDPOINT_ADDRESS_PROPERTY));" + NL + "    context_";
  protected final String TEXT_106 = ".put(javax.xml.ws.BindingProvider.PASSWORD_PROPERTY, context_";
  protected final String TEXT_107 = "_";
  protected final String TEXT_108 = ".get(javax.xml.ws.BindingProvider.PASSWORD_PROPERTY));";
  protected final String TEXT_109 = NL + "\torg.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_110 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(\"";
  protected final String TEXT_111 = "\");";
  protected final String TEXT_112 = NL + NL + "org.talend.mdm.webservice.WSDataClusterPK dataCluster_";
  protected final String TEXT_113 = " = new org.talend.mdm.webservice.WSDataClusterPK(";
  protected final String TEXT_114 = " + \"";
  protected final String TEXT_115 = "\");" + NL + "org.talend.mdm.webservice.WSDataModelPK dataModel_";
  protected final String TEXT_116 = " = new org.talend.mdm.webservice.WSDataModelPK(";
  protected final String TEXT_117 = ");" + NL + "" + NL + "String input_";
  protected final String TEXT_118 = ";" + NL + "" + NL + "java.util.List<org.talend.mdm.webservice.WSItemPK> wspks_";
  protected final String TEXT_119 = ";" + NL + "org.talend.mdm.webservice.WSItemPK wspk_";
