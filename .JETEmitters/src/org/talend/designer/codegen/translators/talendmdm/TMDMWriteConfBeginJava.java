...
public class TMDMWriteConfBeginJava
{
  ...
  protected final String TEXT_82 = NL + "    javax.xml.ws.BindingProvider stub_";
  protected final String TEXT_83 = "_";
  protected final String TEXT_84 = " = (javax.xml.ws.BindingProvider) globalMap.get(\"";
  protected final String TEXT_85 = "\");" + NL + "    java.util.Map<String, Object> context_";
  protected final String TEXT_86 = "_";
  protected final String TEXT_87 = " = stub_";
  protected final String TEXT_88 = "_";
  protected final String TEXT_89 = ".getRequestContext();" + NL + "" + NL + "    org.talend.mdm.webservice.TMDMService_Service service_service_";
  protected final String TEXT_90 = " = new org.talend.mdm.webservice.TMDMService_Service(null);" + NL + "    org.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_91 = " = service_service_";
  protected final String TEXT_92 = ".getTMDMPort();" + NL + "    javax.xml.ws.BindingProvider stub_";
  protected final String TEXT_93 = " = (javax.xml.ws.BindingProvider) service_";
  protected final String TEXT_94 = ";" + NL + "    stub_";
  protected final String TEXT_95 = ".getRequestContext().put(javax.xml.ws.BindingProvider.SESSION_MAINTAIN_PROPERTY, false);" + NL + "" + NL + "    java.util.Map<String, Object> context_";
  protected final String TEXT_96 = " = stub_";
  protected final String TEXT_97 = ".getRequestContext();" + NL + "    context_";
  protected final String TEXT_98 = ".put(javax.xml.ws.BindingProvider.USERNAME_PROPERTY, context_";
  protected final String TEXT_99 = "_";
  protected final String TEXT_100 = ".get(javax.xml.ws.BindingProvider.USERNAME_PROPERTY));" + NL + "    context_";
  protected final String TEXT_101 = ".put(javax.xml.ws.BindingProvider.ENDPOINT_ADDRESS_PROPERTY, context_";
  protected final String TEXT_102 = "_";
  protected final String TEXT_103 = ".get(javax.xml.ws.BindingProvider.ENDPOINT_ADDRESS_PROPERTY));" + NL + "    context_";
  protected final String TEXT_104 = ".put(javax.xml.ws.BindingProvider.PASSWORD_PROPERTY, context_";
  protected final String TEXT_105 = "_";
  protected final String TEXT_106 = ".get(javax.xml.ws.BindingProvider.PASSWORD_PROPERTY));\t    ";
  protected final String TEXT_107 = NL + "\torg.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_108 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(\"";
  protected final String TEXT_109 = "\");";
  protected final String TEXT_110 = NL + NL + "org.talend.mdm.webservice.WSDataClusterPK dataCluster_";
  protected final String TEXT_111 = " = new org.talend.mdm.webservice.WSDataClusterPK(";
  protected final String TEXT_112 = " + \"";
  protected final String TEXT_113 = "\");" + NL + "org.talend.mdm.webservice.WSDataModelPK dataModel_";
  protected final String TEXT_114 = " = new org.talend.mdm.webservice.WSDataModelPK(";
  protected final String TEXT_115 = ");" + NL + "" + NL + "String input_";
  protected final String TEXT_116 = ";" + NL + "" + NL + "java.util.List<org.talend.mdm.webservice.WSItemPK> wspks_";
  protected final String TEXT_117 = ";" + NL + "org.talend.mdm.webservice.WSItemPK wspk_";
  protected final String TEXT_118 = ";" + NL;
  protected final String TEXT_119 = NL + "\tjava.util.Queue<String> queue_";
  protected final String TEXT_120 = " = new java.util.concurrent.ConcurrentLinkedQueue<String>();" + NL + "\t";
  protected final String TEXT_121 = NL + "\t\tjava.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_122 = " = java.util.Collections.synchronizedList(new java.util.ArrayList<java.util.Map<String,String>>());" + NL + "\t\tint flowNum_";
  protected final String TEXT_123 = " = 0;" + NL + "\t";
  protected final String TEXT_124 = NL + "\tclass ThreadXMLField_";
  protected final String TEXT_125 = " extends Thread {" + NL + "\t\tjava.util.Queue<String> queue;" + NL + "\t\tjava.util.List<java.util.Map<String,String>> flows;" + NL + "\t\tjava.lang.Exception lastException;" + NL + "\t\tString currentComponent;" + NL + "\t\t" + NL + "\t\tThreadXMLField_";
  protected final String TEXT_126 = "(java.util.Queue q) {" + NL + "\t\t\tthis.queue = q;" + NL + "\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_127 = "\", queue);" + NL + "\t\t\tlastException = null;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tThreadXMLField_";
  protected final String TEXT_128 = "(java.util.Queue q, java.util.List<java.util.Map<String,String>> l) {" + NL + "\t\t\tthis.queue = q;" + NL + "\t\t\tthis.flows = l;" + NL + "\t\t\tlastException = null;" + NL + "\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_129 = "\", queue);" + NL + "\t\t\tglobalMap.put(\"flows_";
  protected final String TEXT_130 = "\", flows);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic java.lang.Exception getLastException() {" + NL + "\t\t\treturn this.lastException;" + NL + "\t\t}" + NL + "\t\tpublic String getCurrentComponent() {" + NL + "\t\t\treturn this.currentComponent;" + NL + "\t\t}" + NL + "\t" + NL + "\t\t@Override" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_131 = "Process(globalMap);" + NL + "\t\t\t} catch (TalendException te) {" + NL + "\t\t\t\tthis.lastException = te.getException();" + NL + "\t\t\t\tthis.currentComponent = te.getCurrentComponent();" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_132 = "_FINISH\" + (this.queue==null?\"\":this.queue.hashCode()), \"true\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_133 = NL + "\t\tThreadXMLField_";
  protected final String TEXT_134 = " txf_";
  protected final String TEXT_135 = " = new ThreadXMLField_";
  protected final String TEXT_136 = "(queue_";
  protected final String TEXT_137 = ", xmlFlowList_";
  protected final String TEXT_138 = ");" + NL + "\t";
  protected final String TEXT_139 = NL + "\t\tThreadXMLField_";
  protected final String TEXT_140 = " txf_";
  protected final String TEXT_141 = " = new ThreadXMLField_";
  protected final String TEXT_142 = "(queue_";
  protected final String TEXT_143 = ");" + NL + "\t";
  protected final String TEXT_144 = NL + "\ttxf_";
  protected final String TEXT_145 = ".start();";
  protected final String TEXT_146 = NL + "\t\tjava.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_147 = " = (java.util.List<java.util.Map<String,String>>)globalMap.get(\"flows_";
  protected final String TEXT_148 = "\");" + NL + "\t\tint flowNum_";
  protected final String TEXT_149 = " = 0;" + NL + "\t";
  protected final String TEXT_150 = NL + "\tjava.util.Queue<String> queue_";
  protected final String TEXT_151 = " = (java.util.Queue<String>) globalMap.get(\"queue_";
  protected final String TEXT_152 = "\"); ";
  protected final String TEXT_153 = NL + "\tString readFinishMarkWithPipeId_";
  protected final String TEXT_154 = " = \"";
  protected final String TEXT_155 = "_FINISH\"+(queue_";
  protected final String TEXT_156 = "==null?\"\":queue_";
  protected final String TEXT_157 = ".hashCode());" + NL + "\twhile(!globalMap.containsKey(readFinishMarkWithPipeId_";
  protected final String TEXT_158 = ") || !queue_";
  protected final String TEXT_159 = ".isEmpty()) { " + NL + "\t\tif (!queue_";
  protected final String TEXT_160 = ".isEmpty()) {";
