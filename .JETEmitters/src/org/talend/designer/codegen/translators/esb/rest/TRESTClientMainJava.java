...
public class TRESTClientMainJava
{
  ...
  protected final String TEXT_120 = ".getHttpConduit();" + NL + "\t" + NL + "\t";
  protected final String TEXT_121 = NL + "\t    " + NL + "        org.apache.cxf.configuration.jsse.TLSClientParameters tlsClientParameters_";
  protected final String TEXT_122 = " = new org.apache.cxf.configuration.jsse.TLSClientParameters();" + NL + "        tlsClientParameters_";
  protected final String TEXT_123 = ".setDisableCNCheck(true);" + NL + "        conduit_";
  protected final String TEXT_124 = ".setTlsClientParameters(tlsClientParameters_";
  protected final String TEXT_125 = ");" + NL + "\t       " + NL + "\t";
  protected final String TEXT_126 = NL + "\t" + NL + "\tif (use_auth_";
  protected final String TEXT_127 = " && \"BASIC\".equals(";
  protected final String TEXT_128 = ")) {" + NL + "\t\t// set BASIC auth" + NL + "\t\t";
  ...
  protected final String TEXT_136 = NL + NL + "\t\torg.apache.cxf.configuration.security.AuthorizationPolicy authPolicy_";
  protected final String TEXT_137 = " = new org.apache.cxf.configuration.security.AuthorizationPolicy();" + NL + "\t\t\tauthPolicy_";
  protected final String TEXT_138 = ".setAuthorizationType(\"Basic\");" + NL + "\t\t\tauthPolicy_";
  protected final String TEXT_139 = ".setUserName(";
  protected final String TEXT_140 = ");" + NL + "\t\t\tauthPolicy_";
  protected final String TEXT_141 = ".setPassword(decryptedPassword_";
  protected final String TEXT_142 = ");" + NL + "\t\tconduit_";
  protected final String TEXT_143 = ".setAuthorization(authPolicy_";
  protected final String TEXT_144 = ");" + NL + "\t} else if (use_auth_";
  protected final String TEXT_145 = " && \"HTTP Digest\".equals(";
  protected final String TEXT_146 = ")) {" + NL + "\t\t// set Digest auth" + NL + "\t\t";
  ...
  protected final String TEXT_156 = ".setAuthorizationType(\"Digest\");" + NL + "\t\tauthPolicy_";
  ...
  protected final String TEXT_162 = ");" + NL + "\t}" + NL + "" + NL + "\tif (!inOSGi) {" + NL + "\t\tconduit_";
  protected final String TEXT_163 = ".getClient().setReceiveTimeout((long)(";
  protected final String TEXT_164 = " * 1000L));" + NL + "\t\tconduit_";
  protected final String TEXT_165 = ".getClient().setConnectionTimeout((long)(";
  protected final String TEXT_166 = " * 1000L));" + NL + "\t\tboolean use_proxy_";
  protected final String TEXT_167 = " = ";
  protected final String TEXT_168 = ";" + NL + "\t\tif (use_proxy_";
  ...
  protected final String TEXT_174 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_175 = " = ";
  protected final String TEXT_176 = "; ";
  protected final String TEXT_177 = NL + NL + "\t\t\tconduit_";
  protected final String TEXT_178 = ".getClient().setProxyServer(";
  protected final String TEXT_179 = ");" + NL + "\t\t\tconduit_";
  protected final String TEXT_180 = ".getClient().setProxyServerPort(Integer.valueOf(";
  protected final String TEXT_181 = "));" + NL + "\t\t\tconduit_";
  protected final String TEXT_182 = ".getProxyAuthorization().setUserName(";
  protected final String TEXT_183 = ");" + NL + "\t\t\tconduit_";
  protected final String TEXT_184 = ".getProxyAuthorization().setPassword(decryptedPassword_";
  protected final String TEXT_185 = ");" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_186 = NL + "\t\tconduit_";
  protected final String TEXT_187 = ".getClient().setAutoRedirect(true);" + NL + "\t\tclientConfig_";
  protected final String TEXT_188 = ".getRequestContext().put(\"http.redirect.relative.uri\", true);" + NL + "\t\tclientConfig_";
  protected final String TEXT_189 = ".getRequestContext().put(\"http.redirect.same.host.only\", ";
  protected final String TEXT_190 = ");" + NL + "\t";
  protected final String TEXT_191 = NL + NL + "\t";
  protected final String TEXT_192 = NL + "\t\tconduit_";
  protected final String TEXT_193 = ".getClient().setAllowChunking(false);" + NL + "\t";
  protected final String TEXT_194 = NL + NL + "\t";
  protected final String TEXT_195 = NL + "\t\t// set Content-Type" + NL + "\t\twebClient_";
  protected final String TEXT_196 = ".type(\"";
  protected final String TEXT_197 = "\");" + NL + "\t";
  protected final String TEXT_198 = NL + NL + "\t";
  protected final String TEXT_199 = NL + "\t\t// set Accept-Type" + NL + "\t\twebClient_";
  protected final String TEXT_200 = ".accept(\"";
  protected final String TEXT_201 = "\");" + NL + "\t";
  protected final String TEXT_202 = NL + NL + "\t";
  protected final String TEXT_203 = NL + "\t\t// set optional query and header properties if any" + NL + "\t";
  protected final String TEXT_204 = NL + "\t\twebClient_";
  protected final String TEXT_205 = ".header(";
  protected final String TEXT_206 = ", ";
  protected final String TEXT_207 = ");" + NL + "\t";
  protected final String TEXT_208 = NL + "\tif (use_auth_";
  protected final String TEXT_209 = " && \"OAUTH2_BEARER\".equals(";
  protected final String TEXT_210 = ")) {" + NL + "\t\t// set oAuth2 bearer token" + NL + "\t\twebClient_";
  protected final String TEXT_211 = ".header(\"Authorization\", \"Bearer \" + ";
  protected final String TEXT_212 = ");" + NL + "\t}" + NL + "" + NL + "\t// if FORM request then capture query parameters into Form, otherwise set them as queries" + NL + "\t";
  protected final String TEXT_213 = NL + "\t\tjavax.ws.rs.core.Form form_";
  protected final String TEXT_214 = " = new javax.ws.rs.core.Form();" + NL + "\t\t";
  protected final String TEXT_215 = NL + "\t\t\tform_";
  protected final String TEXT_216 = ".param(";
  protected final String TEXT_217 = " ,";
  protected final String TEXT_218 = ");" + NL + "\t\t";
  protected final String TEXT_219 = NL + "\t\trequestBody_";
  protected final String TEXT_220 = " = form_";
  protected final String TEXT_221 = ";" + NL + "\t";
  protected final String TEXT_222 = NL + "\t\t";
  protected final String TEXT_223 = NL + "\t\t\twebClient_";
  protected final String TEXT_224 = ".query(";
  protected final String TEXT_225 = " ,";
  protected final String TEXT_226 = ");" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\t";
  protected final String TEXT_228 = NL + NL + NL + "\ttry {" + NL + "\t\t// start send request" + NL + "\t\t";
  protected final String TEXT_229 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_230 = " = webClient_";
  protected final String TEXT_231 = ".get(responseClass_";
  protected final String TEXT_232 = ");" + NL + "\t\t";
  protected final String TEXT_233 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_234 = " = webClient_";
  protected final String TEXT_235 = ".post(requestBody_";
  protected final String TEXT_236 = ", responseClass_";
  protected final String TEXT_237 = ");" + NL + "\t\t";
  protected final String TEXT_238 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_239 = " = webClient_";
  protected final String TEXT_240 = ".put(requestBody_";
  protected final String TEXT_241 = ", responseClass_";
  protected final String TEXT_242 = ");" + NL + "\t\t";
  protected final String TEXT_243 = NL + "\t\t\torg.apache.cxf.jaxrs.client.WebClient.getConfig(webClient_";
  protected final String TEXT_244 = ").getRequestContext().put(\"use.httpurlconnection.method.reflection\", true);" + NL + "\t\t\tresponseDoc_";
  protected final String TEXT_245 = " = webClient_";
  protected final String TEXT_246 = ".invoke(\"PATCH\", requestBody_";
  protected final String TEXT_247 = ", responseClass_";
  protected final String TEXT_248 = ");" + NL + "\t\t";
  protected final String TEXT_249 = NL + "\t\t\twebClient_";
  protected final String TEXT_250 = ".invoke(\"";
  protected final String TEXT_251 = "\", requestBody_";
  protected final String TEXT_252 = ");" + NL + "\t\t";
  protected final String TEXT_253 = NL + NL + NL + "\t\tint webClientResponseStatus_";
  protected final String TEXT_254 = " = webClient_";
  protected final String TEXT_255 = ".getResponse().getStatus();" + NL + "\t\tif (webClientResponseStatus_";
  protected final String TEXT_256 = " >= 300) {" + NL + "\t\t\tthrow new javax.ws.rs.WebApplicationException(webClient_";
  protected final String TEXT_257 = ".getResponse());" + NL + "\t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_258 = NL + "\t\t\tif (";
  protected final String TEXT_259 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_260 = " = new ";
  protected final String TEXT_261 = "Struct();" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_262 = ".statusCode = webClientResponseStatus_";
  protected final String TEXT_263 = ";" + NL + "\t\t\tif (responseDoc_";
  protected final String TEXT_264 = " != null) {" + NL + "\t\t\t\tif (responseClass_";
  protected final String TEXT_265 = " == String.class) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_266 = ".string = (String) responseDoc_";
  protected final String TEXT_267 = ";" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\troutines.system.Document responseTalendDoc_";
  protected final String TEXT_268 = " = null;" + NL + "\t\t\t\t\tif (null != responseDoc_";
  protected final String TEXT_269 = ") {" + NL + "\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_270 = " = new routines.system.Document();" + NL + "\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_271 = ".setDocument((org.dom4j.Document) responseDoc_";
  protected final String TEXT_272 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_273 = ".body = responseTalendDoc_";
  protected final String TEXT_274 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_275 = "_HEADERS\", webClient_";
  protected final String TEXT_276 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_277 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_278 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_279 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_280 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_281 = NL + "\t\t";
  protected final String TEXT_282 = NL + NL + "\t} catch (javax.ws.rs.WebApplicationException ex_";
  protected final String TEXT_283 = ") {" + NL + "\t\t";
  protected final String TEXT_284 = NL + "\t\t\tif (";
  protected final String TEXT_285 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_286 = " = new ";
  protected final String TEXT_287 = "Struct();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_288 = ".errorCode = ex_";
  protected final String TEXT_289 = ".getResponse().getStatus();" + NL + "" + NL + "\t\t\tString errorMessage_";
  protected final String TEXT_290 = " = null;" + NL + "\t\t\ttry {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_291 = " = ex_";
  protected final String TEXT_292 = ".getResponse().readEntity(String.class);" + NL + "\t\t\t} catch (Exception exe_";
  protected final String TEXT_293 = ") {" + NL + "\t\t\t\t// ignore" + NL + "\t\t\t}" + NL + "\t\t\tif (null == errorMessage_";
  protected final String TEXT_294 = " || 0 == errorMessage_";
  protected final String TEXT_295 = ".trim().length()) {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_296 = " = ex_";
  protected final String TEXT_297 = ".getMessage();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_298 = ".errorMessage = errorMessage_";
  protected final String TEXT_299 = ";" + NL + "" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_300 = "_HEADERS\", ex_";
  protected final String TEXT_301 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_303 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_304 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_305 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_306 = NL + "\t\t";
  protected final String TEXT_307 = NL + "\t\t\tthrow ex_";
  protected final String TEXT_308 = ";" + NL + "\t\t";
  protected final String TEXT_309 = NL + "\t}" + NL + "" + NL + "} catch(Exception e_";
  protected final String TEXT_310 = ") {" + NL + "\t";
  protected final String TEXT_311 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_312 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_313 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_314 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
