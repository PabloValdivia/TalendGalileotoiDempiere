				...
				try {
					...
					while (rs_tAccessInput_1.next()) {
						...
						{ // start of Var scope
							...
							insert_bp_tmp.created = TalendDate.getCurrentDate();
							insert_bp_tmp.createdby = 100.00;
							insert_bp_tmp.updated = TalendDate.getCurrentDate();
							...
							insert_bp_tmp.address1 = StringHandling
									.BTRIM(row1.INDICA);
							insert_bp_tmp.address2 = null;
							insert_bp_tmp.postal = row1.CAPOCA;
							insert_bp_tmp.postal_add = null;
							insert_bp_tmp.city = StringHandling
									.BTRIM(row1.LOCACA);
							insert_bp_tmp.c_region_id = null;
							insert_bp_tmp.regionname = StringHandling
									.BTRIM(row1.PROVCA);
							insert_bp_tmp.c_country_id = null;
							insert_bp_tmp.countrycode = StringHandling.LEFT(
									row1.NAZICA, 2);
						...
						if (insert_bp != null) {
							...
							if (checkCount_tPostgresqlOutput_1 > 0) {
								...
								if (insert_bp.contactdescription == null) {
									...
									pstmtUpdate_tPostgresqlOutput_1.setString(
											32, insert_bp.contactdescription);
								}
								...
								if (insert_bp.bpcontactgreeting == null) {
									...
									pstmtUpdate_tPostgresqlOutput_1.setString(
											41, insert_bp.bpcontactgreeting);
								}
								...
								if (insert_bp.r_interestarea_id == null) {
									...
									pstmtUpdate_tPostgresqlOutput_1.setDouble(
											45, insert_bp.r_interestarea_id);
								}
								...
								if (insert_bp.contactdescription == null) {
									...
									pstmtInsert_tPostgresqlOutput_1.setString(
											33, insert_bp.contactdescription);
								}
								...
								if (insert_bp.bpcontactgreeting == null) {
									...
									pstmtInsert_tPostgresqlOutput_1.setString(
											42, insert_bp.bpcontactgreeting);
								}
								...
								if (insert_bp.r_interestarea_id == null) {
									...
									pstmtInsert_tPostgresqlOutput_1.setDouble(
											46, insert_bp.r_interestarea_id);
								}
...
/************************************************************************************************
 * 188041 characters generated by Talend Open Studio for Data Integration on the
 * 7 luglio 2016 8.34.15 CEST
 ************************************************************************************************/
